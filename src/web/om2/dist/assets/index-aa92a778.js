...
</div>`,$t=`<div class="TOPRIGHT-topHalf-right-content">
    <!-- playback controls -->
...
</div>`,Yt=`<div class="QUEUE-environment" id="QUEUEenvironment">
...
</div>`,Ft="/assets/volume_null-e39cf06f.svg",Qt="/assets/recently_added-a0a983c6.svg",zt="/assets/volume_3-c8ab0a75.svg",Vt="/assets/orange_music_text_logo_black-12e7386c.svg",Kt="/assets/volume_2-cfdac9da.svg",Wt="/assets/browse_2-85030bba.svg",Xt="/assets/volume_1-27e93416.svg",Zt="/assets/orange_music_logo_white-2a680ea2.svg",en="/assets/search_icon-4f5e4381.svg",tn="/assets/orange_music_text_logo_black-91f9e706.png",nn="/assets/up_next_queue_button-14fedba2.svg",on="/assets/orange_music_logo_yellow-a109ff64.svg",sn="/assets/playlist-c6e9024f.svg",an="/assets/loop_button-aef56865.svg",rn="/assets/help_icon-867fec9d.svg",cn="/assets/play_button-b1e2d3a4.svg",dn="/assets/browse-14744f27.svg",ln="/assets/orange_music_text_logo_white-7f0ba909.svg",un="/assets/back_button-8128cade.svg",mn="/assets/Albums-2e81dc74.svg",pn="/assets/songs-016b7188.svg",gn="/assets/orange_music_logo_black-4d7e4591.svg",_n="/assets/your_uploaded_songs-06535705.svg",fn="/assets/artist-ab677d43.svg",vn="/assets/shuffle_button-c2f06bc4.svg",En="/assets/orange_music_text_logo_white-4907051e.png",yn="/assets/listen_now-c7438154.svg",bn="/assets/derpy-21c20ae5.svg",hn="/assets/next_button-9a850710.svg",Tn="/assets/recently_added-7ff28139.svg",In="/assets/play_button-5eeedbe6.svg",Cn="/assets/browse-e8be8609.svg",wn="/assets/albums-681507b8.svg",Ln="/assets/listen_now.2-bfa293ac.svg",Pn="/assets/your_uploads-02e5c93c.svg",On="/assets/play_button.2-fc90fac7.svg",Bn="/assets/listen_now-fb02ffce.svg",Mn="/assets/browse.2-15b501dd.svg",Sn="/assets/place_holder_image-d4006a96.svg",xn="/assets/icons_MOGitems_add-19e679f7.svg",Dn="/assets/back-9279721d.svg",Rn="/assets/forwards-605bd405.svg",An="/assets/icons_close-57e87944.svg",Nn="/assets/icons_pause-8012f8cc.svg",Un="/assets/icons_loop-32d1576c.svg",jn="/assets/icons_loop_song-87f53dc7.svg",kn="/assets/icons_play-a5074c5b.svg",Gn="/assets/icons_settings-793063fb.svg",Jn="/assets/love-07ac5006.svg",Hn="/assets/upload-3bad9145.svg",I={icons_volumeNull:Ft,icons_recentlyAdded:Qt,icons_volume3:zt,icons_orangeMusicTextLogoBlack:Vt,icons_volume2:Kt,icons_browse2:Wt,icons_volume1:Xt,icons_orangeMusicLogoWhite:Zt,icons_searchIcon:en,icons_orangeMusicTextLogoBlackPng:tn,icons_queueButton:nn,icons_orangeMusicLogoYellow:on,icons_playlist:sn,icons_loopButton:an,icons_helpIcon:rn,icons_playButton:cn,icons_browse:dn,icons_menuOptionsButton:ot,icons_orangeMusicTextLogoWhite:ln,icons_backButton:un,icons_Albums:mn,icons_songs:pn,icons_orangeMusicLogoBlack:gn,icons_yourUploadedSongs:_n,icons_artist:fn,icons_shuffleButton:vn,icons_orangeMusicTextLogoWhitePng:En,icons_listenNow:yn,icons_derpy:bn,icons_nextButton:hn,icons_recentlyAddedV2:Tn,icons_playButtonV2:In,icons_browseV2:Cn,icons_albumsV2:wn,icons_listenNow2V2:Ln,icons_yourUploads:Pn,icons_playButton2:On,icons_listenNowV2:Bn,icons_browse2V2:Mn,v3_placeholder:Sn,icons_MOGitems_add:xn,icons_back:Dn,icons_forwards:Rn,icons_close:An,icons_pause:Nn,icons_loop:Un,icons_loop_song:jn,icons_play:kn,icons_settings:Gn,current_year:new Date().getFullYear(),icons_love:Jn,icons_upload:Hn};function qn(){let e="topleftContentArea",t=qt;for(const[n,o]of Object.entries(I)){const i=new RegExp(`\\{${n}\\}`,"g");t=t.replace(i,o)}document.getElementById(e).innerHTML=t}function $n(){let e="toprightContentArea",t=$t;for(const[n,o]of Object.entries(I)){const i=new RegExp(`\\{${n}\\}`,"g");t=t.replace(i,o)}document.getElementById(e).innerHTML=t}function Yn(){let e="MAINcontentContainer",t=Yt;for(const[n,o]of Object.entries(I)){const i=new RegExp(`\\{${n}\\}`,"g");t=t.replace(i,o)}document.getElementById(e).innerHTML+=t}const Fn=`<div class="QUEUE-item-container" draggable="true">
...
`;let fe=!1;function co(){const e=document.getElementById("MAINcontentContainer"),t=document.getElementById("uploadQueueModal"),n=document.getElementById("uploadQueueButton");e.innerHTML+=ao,n.addEventListener("click",function(o){fe==!1?uo(o):ge()}),t.innerHTML=ro}function lo(){const e=document.getElementById("UPLOAD_INDICATOR_container"),t=document.getElementById("uploadQueueButtonContainer");e.style.opacity="100%",t.style.visibility="visible"}function Ne(){const e=document.getElementById("uploadQueueButtonContainer"),t=document.getElementById("UPLOAD_INDICATOR_container");t.style.opacity="",e.style.visibility="",fe==!0&&x.length>0||ge()}function de(e){const t=document.getElementById("UPLOADQUEUEBOTTOM_songName"),n=document.getElementById("UPLOADQUEUEBOTTOM_fileSize");if(x.length>0){t.innerHTML=x[0].file.name,n.innerHTML=X(x[0].file.size*1.75),mo(document.getElementById("specificChart"),e,!0);const i=document.getElementById("UPLOADQUEUEbottomContainer");for(;i.childNodes.length>2;)i.removeChild(i.lastChild);let s="";for(var o=x.length-1;o>=1;o--){const a=x[o].file.name,r=X(x[o].file.size*1.75);s+=`<div class="UPLOADQUEUE-bottom-items-next"><div class="itemName">${a}</div><div class="itemSize">${r}</div></div>`}i.innerHTML+=s}}let Ue;function uo(e){fe=!0,Ue=document.activeElement;let t=e.clientX,n=e.clientY;const o=document.getElementById("uploadQueueModal");let i=t+"px",s=n+"px";MENUmodalEnvironment.addEventListener("click",ge),o.style.left=i,o.style.top=s;let a="mouse";if(e.webkitForce==1||e.webkitForce==0?e.webkitForce==0&&(a="keyboard"):e.pointerType!=="mouse"&&(a="keyboard"),a=="keyboard"){const p=Ue.getBoundingClientRect();t=p.left+window.scrollX,n=p.top+window.scrollY;let E=t+"px",y=n+"px";o.style.left=E,o.style.top=y}const r=o.offsetWidth,c=o.offsetHeight,d=Tt("uploadQueueModal");o.style.visibility="visible",document.addEventListener("keydown",m),d.xOverflow==!0&&(i=t-r+"px",o.style.left=i),d.yOverflow==!0&&(s=n-c+"px",o.style.top=s);function m(p){(p.key==="Escape"||p.keyCode===27)&&(document.removeEventListener("keydown",m),ge())}}function ge(){fe=!1;const e=document.getElementById("uploadQueueModal");e.style.visibility=""}function mo(e,t,n){t=Math.round(t),t>100?t=100:t<0&&(t=0);var o=Math.round(360*(t/100)),i=e.querySelector(".pie"),s=e.querySelector(".right-side");t>50?(i.style.clip="rect(auto, auto, auto, auto)",s.style.transform="rotate(180deg)"):(i.style.clip="rect(0, 1em, 1em, 0.5em)",s.style.transform="rotate(0deg)"),n?(s.style.borderWidth="0.1em",e.querySelector(".left-side").style.borderWidth="0.1em",e.querySelector(".shadow").style.borderWidth="0.1em"):(s.style.borderWidth="0.5em",e.querySelector(".left-side").style.borderWidth="0.5em",e.querySelector(".shadow").style.borderWidth="0.5em"),e.querySelector(".num").textContent=t,e.querySelector(".left-side").style.transform="rotate("+o+"deg)"}const je=1500;let at=0,Le=[],Ce;function j(e,t){const o=new Date().getTime();Le.push({notificationText:e,notificationType:t,time:o}),rt()}function rt(){const t=new Date().getTime(),n=Le.at(at);Le.length>1?t-Ce>je?(ke(n.notificationText,n.notificationType),Ce=t):setTimeout(rt,je):(ke(n.notificationText,n.notificationType),Ce=t)}function ke(e,t){const n=document.getElementById("noticationContainer");let o;at+=1,t=="error"?o="var(--whoopsie)":t=="success"?o="var(--success)":t=="background"?o="var(--background)":t=="orange"?o="var(--orange)":t=="primary"?o="var(--primary)":t=="secondary"&&(o="var(--secondary)");const i=document.createElement("div");i.style.backgroundColor=o,i.textContent=e,n.appendChild(i)}const po=`<div class="MOG-container" id="MOGcontainer">
...
</button>`,ct=30;let Z=0;async function fo(){try{const e=document.getElementById("MAINcontentPages");vo();const t=await ft(ct,Z);Z+=t.length,Eo(t);return}catch(e){console.error("Error in initMusicObjectsGrid:",e)}}function dt(){Z=0;const e=document.getElementById("MAINcontentPages"),t=document.getElementById("MOGcontainer");t!==null&&t.removeEventListener("click",lt),e.innerHTML=""}function vo(){let e="MAINcontentPages",t=po;for(const[n,o]of Object.entries(I)){const i=new RegExp(`\\{${n}\\}`,"g");t=t.replace(i,o)}document.getElementById(e).innerHTML+=t}function Eo(e){const t=document.getElementById("MOGgridContainer");t.innerHTML="";let n=go;for(const[a,r]of Object.entries(I)){const c=new RegExp(`\\{${a}\\}`,"g");n=n.replace(c,r)}t.innerHTML+=n,Ge(e);const o=document.getElementById("MOGcontainer");o.addEventListener("click",function(a){lt(a,e)});let i;o.addEventListener("touchstart",function(a){a.timeStamp,i=setTimeout(function(){s(a,e)},500)}),o.addEventListener("touchend",function(a){a.timeStamp,clearTimeout(i)});function s(a,r){navigator.vibrate(1e3);const d=a.target.id.split("-")[1],m=r[d].project_id;console.log(m),ut(a,m)}t.addEventListener("scroll",async function(){const a=t.scrollTop,r=t.scrollHeight,c=t.clientHeight;if(a>=r-c){const d=await ft(ct,Z);Z+=d.length,d.length>0&&Ge(d)}})}function Ge(e){const t=document.getElementById("MOGgridContainer"),n=e.length;for(var o=0;o<=n-1;o++){const i=["MOG_image","MOG_text1","MOG_text2","MOG_checkedDate","MOGI_placeholder_itemID"],s=o,a=e[o].img,r=e[o].top,c=e[o].bottom,d=e[o].days,m=zn(d);let p=_o;for(const[E,y]of Object.entries(I)){const l=new RegExp(`\\{${E}\\}`,"g");p=p.replace(l,y)}for(let E=0;E<i.length;E++){const y=i[E].toString(),l=new RegExp(`\\{${y}\\}`,"g");let g="";y==="MOG_image"?g=`${T}/${a}/3`:y==="MOG_text1"?g=r:y==="MOG_text2"?g=c:y==="MOG_checkedDate"?g=m:y==="MOGI_placeholder_itemID"&&(g=s),p=p.replace(l,g)}t.innerHTML+=p}}async function lt(e,t){const n=e.target;if(n.classList.contains("MOG-item-controls-play")){const o=n.id.split("-")[1],i=t[o].project_id,s=await ve(i),a=JSON.parse(s);a.ProjectID=i,Ot(a)}if(n.classList.contains("MOG-item-controls-menu")){const o=n.id.split("-")[1],i=t[o].project_id;ut(e,i)}if(n.classList.contains("MOG-itemContainer")&&n.id!=="MOGaddNewItem"){const o=n.id.split("-")[1],i=t[o].project_id;G(`/projects/${i}`)}n.id==="MOGaddNewItem"&&yo()}function ut(e,t){e.stopPropagation(),Y([{displayText:"Play next",optionalSVG:"icons_playlist",optionalParams:{PROJECT_ID:t,QUEUE_POSITION:"next"},function:"PLAYBACK_add_songs_to_queue"},{displayText:"Play later",optionalSVG:"icons_playlist",optionalParams:{PROJECT_ID:t,QUEUE_POSITION:"later"},function:"PLAYBACK_add_songs_to_queue"}],e)}function yo(){G("/new-project/")}const bo=`<div class="ADMINusersTableInfoRow">
    <div>
...
<p>You are not an admin user</p>`;function mt(e,t,n){const o=document.getElementById(t);let i;o.addEventListener("touchstart",function(a){a.timeStamp,i=setTimeout(function(){s(a,e,n)},500)}),o.addEventListener("touchend",function(a){a.timeStamp,clearTimeout(i)}),o.addEventListener("dblclick",function(a){s(a,e,n)});function s(a,r,c){Io(a,r,c)}}function Io(e,t,n){e.target;const o={project_id:t};e.stopPropagation(),Y(o,e,n)}const Co=`<h1>General</h1>
...
<p>Double click your profile picture to change it.</p>`,Lo=`<div class="settings_container">
...
</div>`;let Be;async function Po(){const e=document.getElementById("TOPRIGHTaccountImg");try{const t=await Me("profile_picture"),n=`${T}/${t}/1`;Be=t;const o=document.getElementById("TOPRIGHTaccountImgButton");e.src=n,o.addEventListener("click",Oo)}catch(t){console.error("Error initializing account image:",t)}}function Oo(e){e.stopPropagation(),Bo(e)}function Bo(e){Y([{displayText:"Help",optionalSVG:"icons_helpIcon",function:"None"},{displayText:"Settings",optionalSVG:"icons_settings",function:"OPEN_SETTINGS_PAGE"},{displayText:"Sign Out",optionalSVG:"None",function:"SIGN_OUT_USER"}],e)}async function Mo(){await $o()}let pt="general";const me=[{name:"general",markup:Co,button_id:"settings_button_general",function:xo},{name:"user",markup:wo,button_id:"settings_button_user",function:Do},{name:"admin",markup:To,button_id:"settings_button_admin",function:Ro}];function So(){const e=document.getElementById("MAINcontentPages");let t=Lo;for(const[i,s]of Object.entries(I)){const a=new RegExp(`\\{${i}\\}`,"g");t=t.replace(a,s)}e.innerHTML=t;const n=document.getElementById("settings_go_to_other_content_button");Je(pt);for(var o=me.length-1;o>=0;o--){const i=me[o].button_id;document.getElementById(i).addEventListener("click",function(a){const r=a.srcElement.id,d=me.find(m=>m.button_id===r).name;Je(d)})}n.addEventListener("click",function(){G("/")})}function gt(){const e=document.getElementById("MAINcontentPages");e.innerHTML=""}function Je(e){pt=e;const t=["users_img"],n=document.getElementById("view_container"),o=me.find(s=>s.name===e);let i=o.markup;for(const[s,a]of Object.entries(I)){const r=new RegExp(`\\{${s}\\}`,"g");i=i.replace(r,a)}for(let s=0;s<t.length;s++){const a=t[s].toString(),r=new RegExp(`\\{${a}\\}`,"g");let c="";a==="users_img"&&(c=`${T}/${Be}/4/`),i=i.replace(r,c)}n.innerHTML=i,o.function()}function xo(){}function Do(){mt("user-id","settings_views_user_pfp_img","update_user_pfp")}let W=[];async function Ro(){if(await Me("admin")!=="true")return;const t=["users_img"],n=document.getElementById("view_container");let o=ho;for(const[s,a]of Object.entries(I)){const r=new RegExp(`\\{${s}\\}`,"g");o=o.replace(r,a)}for(let s=0;s<t.length;s++){const a=t[s].toString(),r=new RegExp(`\\{${a}\\}`,"g");let c="";a==="users_img"&&(c=`${T}/${Be}/4/`),o=o.replace(r,c)}n.innerHTML=o,_t(),document.getElementById("SETTINGS_ADMIN_UPDATE_COLUMN_submit_button").addEventListener("click",function(s){const a=document.getElementById("SETTINGS_ADMIN_UDPATE_COLUMN_column_to_updated"),r=document.getElementById("SETTINGS_ADMIN_UDPATE_COLUMN_new_data");if(a.value==""||r.value=="")j("Error Updating Column: empty inputs","error");else for(var c=W.length-1;c>=0;c--){const d=W[c];qo(d,a.value,r.value)}})}let k;async function _t(){const e=await Ho();k=JSON.parse(e);const t=document.getElementById("usersTableInforRowsContainer");t.innerHTML="";for(let n=0;n<k.length;n++){const o=["Username","Email","UUID","Verified","Space_Used","Storage_Allowance","profile_picture_url","checkbox_number","Admin"],i=k[n].username,s=k[n].uuid,a=k[n].verified,r=k[n].email;let c=k[n].storage_allowance;c=X(c);const d=k[n].admin,m=n;let p=k[n].storage_used;p=X(p);let E=bo,y=k[n].profile_picture;y=`${T}/${y}/1/`;for(let l=0;l<o.length;l++){const g=o[l].toString(),b=new RegExp(`\\{${g}\\}`,"g");let f="";g==="Username"?f=i:g==="Email"?f=r:g==="UUID"?f=s:g==="Verified"?f=a:g==="Space_Used"?f=p:g==="Storage_Allowance"?f=c:g==="profile_picture_url"?f=y:g==="checkbox_number"?f=m:g==="Admin"&&(f=d),E=E.replace(b,f)}t.innerHTML+=E}t.addEventListener("change",function(n){n.target&&n.target.type==="checkbox"&&Ao()})}function Ao(){W=[];const t=usersTableEnvironment.querySelectorAll('input[type="checkbox"]'),n=[],o=document.getElementById("settings_admin_selected_items_visualition");t.forEach(function(i){if(i.checked){const r={id:i.id.replace("admin_users_table_check_box_",""),value:i.value};n.push(r)}}),n.forEach(function(i){const a=k[i.id].uuid;W.push(a)}),o.innerHTML=`Selected Items: ${W.length}`}async function No(){const e=await Me("last_state"),t=JSON.parse(e),n=new Map;setInterval(s,1e4);let o="";if(window.addEventListener("popstate",a),t!=null){const r=window.location.pathname;G(r),Gi(t)}else a();function i(r){return JSON.stringify(r)}function s(){const r=window.location.pathname,c=u,d=_,m=Fi();m.current_path=r,m.current_queue=c,m.current_index=d;const p=i(m);p!==o&&(Go("last_state",m),o=p,n.set("playback_states",p))}function a(){G(currentPath)}}function Uo(){Et(),gt(),fo()}function jo(e){dt(),gt(),zo(e)}function He(){dt(),Et(),So()}const qe={"/":Uo,"/new-project/":le,"/new-project":le,"/new/":le,"/new":le,"/projects/:projectID":jo,"/settings/":He,"/settings":He};function ko(){const e=window.location.pathname,t=document.getElementById("MAINcontentPages");setTimeout(n,4e3),t.innerHTML+=`
    <br><br>
    <br><br>
    <br><br>    
    ...
    `;function n(){G("/")}}function G(e){const t=Object.keys(qe);for(const n of t){const o=new RegExp(`^${n.replace(/:[^\s/]+/g,"([^/]+)")}$`),i=e.match(o);if(i){const s=qe[n],a=i.slice(1);s(...a),e!=="/new-project/"&&history.pushState({},"",e);return}}ko()}async function Go(e,t){try{const n={column_to_be_updated:e,new_data:JSON.stringify(t)};if((await(await fetch(`${O}/users/update_user_details`,{method:"POST",headers:{"Content-Type":"application/json"},credentials:"include",body:JSON.stringify(n)})).json()).updated==="success")return;console.log("there was an error")}catch(n){console.error("Error:",n)}}async function Jo(e,t){const n=t.split("-"),o=n[0],i=n[1];try{(await(await fetch(`${O}/projects/delete_song/${e}?s=${o}&v=${i}`,{method:"DELETE",headers:{"Content-Type":"application/json"},credentials:"include"})).json()).error&&j("There was an error deleting the song","error");return}catch(s){console.error("Error:",s);return}}async function Me(e){try{return(await(await fetch(`${O}/users/get_user_details/${e}`,{method:"GET",headers:{"Content-Type":"application/json"},credentials:"include"})).json()).response}catch(t){console.error("Error:",t)}}async function ee(e,t,n){try{const o={project_id:e,column_to_be_updated:t,new_data:n};if((await(await fetch(`${O}/projects/update_details`,{method:"POST",headers:{"Content-Type":"application/json"},credentials:"include",body:JSON.stringify(o)})).json()).updated==="success")return"yes";console.log("there was an error, yes")}catch(o){console.error("Error:",o)}}async function ve(e){try{return(await(await fetch(`${O}/projects/get_project_details/${e}`,{method:"GET",headers:{"Content-Type":"application/json"},credentials:"include"})).json()).project_details}catch(t){console.error("Error:",t)}}async function ft(e,t){try{const i=(await(await fetch(`${O}/projects/get_projects?l=${e}&c=${t}`,{method:"GET",headers:{"Content-Type":"application/json"},credentials:"include"})).json()).projects;return Array.isArray(i)?i.map(a=>({img:a.PictureURL,top:a.ProjectName,bottom:a.ProjectContributors,days:a.TimeCreated,project_id:a.ProjectID})):[]}catch(n){return console.error("Error:",n),[]}}async function le(){try{const o=`/projects/${(await(await fetch(`${O}/projects/get_new_project_id`,{method:"GET",headers:{"Content-Type":"application/json"},credentials:"include"})).json()).projectID}`;G(o)}catch(e){console.error("Error:",e)}}async function Ho(){try{return(await(await fetch(`${O}/admin/get_users_table`,{method:"GET",headers:{"Content-Type":"application/json"},credentials:"include"})).json()).response}catch(e){console.error("Error:",e)}}async function qo(e,t,n){try{const o={user_to_update_uuid:e,column_to_be_updated:t,new_data:n},s=await(await fetch(`${O}/admin/update_user_details`,{method:"POST",headers:{"Content-Type":"application/json"},credentials:"include",body:JSON.stringify(o)})).json();if(s.updated==="success"){j("Table Updated Successfully","success"),_t();return}else{j(`Error Updating Column ${t}: ${s.Error}`,"error");return}}catch(o){j(`Error Updating Column ${t}: ${o}`,"error");return}}async function $o(){try{const t=await(await fetch(`${O}/meta/signout`,{method:"GET",headers:{"Content-Type":"application/json"},credentials:"include"})).json();console.log(t)}catch(e){console.error("Error:",e)}}const Yo=`<div class="PROJECTview-projectTable" id="PROJECTview-projectTable" draggable="false" style="user-select: none; pointer-events: none;">
    ...
    <div class="PROJECTviewMOREdescriptionboxEnvironment" id="PROJECTviewMOREdescriptionboxEnvironment">
...
</div>`;let $e;function vt(e){return new Promise((t,n)=>{$e=document.activeElement;let o="mouse";event.webkitForce==1||event.webkitForce==0?event.webkitForce==0&&(o="keyboard"):event.pointerType!=="mouse"&&(o="keyboard");const i=document.getElementById("confirmModal"),s=`
        ...
        `;i.innerHTML=s,i.style.visibility="visible";const a=document.getElementById("CONFIRMmodalDeleteButton"),r=document.getElementById("CONFIRMmodalCancelButton");function c(){Ye(),t("delete")}function d(){$e.focus(),Ye(),t("cancel")}i.addEventListener("click",m=>{const p=m.target;p===a?c():(p===r||p===i)&&d()}),o==="keyboard"&&!D()?r.focus():o=="mouse"&&!D()&&(J(),r.focus(),r.blur())})}function Ye(){const e=document.getElementById("confirmModal");e.style.visibility="hidden"}const x=[];let pe=!1,Fe=!0,v,Ee=!1;async function zo(e){let t;Ee=!0,it()==!0?t={ProjectName:"..",ProjectContributors:"...",TimeCreated:0,PictureURL:"static/loading_img_text_dark"}:t={ProjectName:"..",ProjectContributors:"...",TimeCreated:0,PictureURL:"static/loading_img_text_light"},Ko(t),sessionStorage.setItem("description","."),Qe(),document.getElementById("PROJECTviewMobileStickyHeaderBackButton").addEventListener("click",()=>{G("/")});const o=await ve(e);if(o=="")console.log(o);else{const s=JSON.parse(o);s.ProjectID=e,v=s,i(),Vo()}function i(){Pe(),sessionStorage.setItem("description",v.Description),Qe(),Wo(),Zo(),ei(),ti(),yt(),li(),ht(v.ProjectName),mt(v.ProjectID,"PROJECTviewDisplayImage","update_project_image"),ci()}}function Et(){const e=document.getElementById("MAINcontentPages");e.innerHTML="",Ee=!1}async function ye(){if(!Ee)return;const e=v.ProjectID,t=await ve(e);if(t!=""){const n=JSON.parse(t);n.ProjectID=e,v=n,yt();const o=document.getElementById("PROJECTviewDisplayImage_imgTag"),i=`${T}/${v.PictureURL}/5`;o.src=i}}function Pe(){const e=document.getElementById("PROJECTviewDisplayTitleH1"),t=document.getElementById("PROJECTviewDisplayTitleH3"),n=document.getElementById("PROJECTviewDisplayImage_imgTag"),o=document.getElementById("PROJECTVIEW_DESCRIPTION_more_title"),i=document.getElementById("PROJECTVIEW_DESCRIPTION_more_artist_year"),s=`${T}/${v.PictureURL}/5`;e.innerText=v.ProjectName,t.innerText=v.ProjectContributors,n.src=s,o.innerText=v.ProjectName,i.innerText=`${v.ProjectContributors} | ${st(v.TimeCreated)}`}function Vo(){const e=document.getElementById("PROJECTviewDisplayTitleH1"),t=document.getElementById("PROJECTviewDisplayTitleH3");let n=document.getElementById("PROJECTviewDisplayTitleH1").innerText,o=document.getElementById("PROJECTviewDisplayTitleH3").innerText;e.addEventListener("blur",function(i){const s=e.innerText;s!==n&&(ht(s),ee(v.ProjectID,"project_name",s),v.ProjectName=s,Pe())}),t.addEventListener("blur",function(i){const s=t.innerText;s!==o&&(ee(v.ProjectID,"project_contributors",s),v.ProjectContributors=s,Pe())})}function Ko(e){let t="MAINcontentPages",n=Qo;for(const[i,s]of Object.entries(I)){const a=new RegExp(`\\{${i}\\}`,"g");n=n.replace(a,s)}const o=["PROJECTviewMOREtitle","PROJECTviewMOREartist","PROJECTviewMOREyear","PROJECTviewDisplayImage"];for(let i=0;i<o.length;i++){const s=o[i].toString(),a=new RegExp(`\\{${s}\\}`,"g");let r="";s==="PROJECTviewMOREtitle"?r=e.ProjectName:s==="PROJECTviewMOREartist"?r=e.ProjectContributors:s==="PROJECTviewMOREyear"?r=st(e.TimeCreated):s==="MOG_checkedDate"?r="checkedIndicator":s==="MOGI_placeholder_itemID"?r="temporaryIidentifier":s==="PROJECTviewDisplayImage"&&(r=`${T}/${e.PictureURL}/5`),n=n.replace(a,r)}document.getElementById(t).innerHTML=n}function Qe(){let e=sessionStorage.getItem("description");const t=document.getElementById("PROJECTviewDescriptionP");t.innerText=e}function Wo(){const e=document.getElementById("PROJECTviewDescriptionMoreButton"),t=document.getElementById("PROJECTviewDisplayDescription"),n=document.getElementById("PROJECTviewMOREdescriptionboxEnvironment"),o=document.querySelector("main");function i(){n.style.display="grid",D()&&(o.style.zIndex="40")}e.addEventListener("click",function(){i()}),t.addEventListener("dblclick",function(){i()});let s=0;t.addEventListener("touchend",function(a){const r=new Date().getTime();r-s<300&&(a.stopPropagation(),i()),s=r})}function Xo(){const e=sessionStorage.getItem("description"),t=document.getElementById("PROJECTviewDescriptionP");t.innerText=e}function Zo(){const e=sessionStorage.getItem("description");document.getElementById("PROJECTviewMOREdescriptionC");const t=document.getElementById("PROJECTviewMOREdescriptionP");t.innerText=e}function ei(){const e=document.getElementById("PROJECTviewMOREcloseButton"),t=document.getElementById("PROJECTviewMOREdescriptionboxEnvironment");e.addEventListener("click",function(){ze(v)}),t.addEventListener("click",function(n){n.target===t&&ze(v)})}function ze(e){const n=document.getElementById("PROJECTviewMOREdescriptionP").value,o=document.getElementById("PROJECTviewMOREdescriptionboxEnvironment"),i=document.querySelector("main");sessionStorage.setItem("description",n),ee(e.ProjectID,"description",n),o.style.display="none",Xo(),i.style.zIndex=""}async function ti(){const e=document.getElementById("PROJECTviewDescriptionTopPlayButton"),t=document.getElementById("PROJECTviewDescriptionTopShuffleButton"),n=document.getElementById("PROJECTviewDisplayMenuButton"),o=document.getElementById("PROJECTviewMobileStickyHeaderMenuButton");e.addEventListener("click",function(){Ot(v)}),t.addEventListener("click",function(){ki(v)}),n.addEventListener("click",function(){Ve(event)}),o.addEventListener("click",function(){Ve(event)})}function Ve(e){e.stopPropagation(),e.target;const t=v.ProjectID;Y([{displayText:"Play next",optionalSVG:"icons_playlist",optionalParams:{PROJECT_ID:t,QUEUE_POSITION:"next"},function:"PLAYBACK_add_songs_to_queue"},{displayText:"Play later",optionalSVG:"icons_playlist",optionalParams:{PROJECT_ID:t,QUEUE_POSITION:"later"},function:"PLAYBACK_add_songs_to_queue"},{displayText:"Delete",optionalSVG:"None",function:"PROJECT_VIEW_delete_project",optionalParams:{PROJECT_ID:t},colour:"hsl(0, 100%, 55%)"}],e)}async function ni(e){const t=`Are you sure that you want to delete <em><b>${v.ProjectName}</b></em>? This action is not reversable.`,n=await vt(t);if(n==="cancel")J();else if(n==="delete"){const o="/";await oi(),J(),G(o)}else J()}async function oi(e){const t=v.ProjectID;try{const o=await(await fetch(`${O}/projects/delete_project/${t}`,{method:"DELETE",headers:{"Content-Type":"application/json"},credentials:"include"})).json()}catch(n){console.error("Error:",n)}}function yt(){const e=document.getElementById("PROJECTview-projectTable");e!==null&&e.remove(),document.getElementById("PROJECTview_projectAreaContainer"),ai();const t=document.getElementById("PROJECTview-projectTable"),n=v.ProjectJSON,o=eo("--orange"),i=l=>`#${l.match(/^rgb\((\d+),\s*(\d+),\s*(\d+)\)$/).slice(1).map(g=>parseInt(g,10).toString(16).padStart(2,"0")).join("")}`;let s;if(n==null)return;const a=[];if(n)for(const l of n)a.push({img:v.PictureURL,songTitle:l.SongName,artistName:v.ProjectContributors,projectName:X(l.FolderSize),songDuration:`${Math.floor(l.Duration/60)}:${(l.Duration%60).toString().padStart(2,"0")}`,songSequence:l.SongSequence,version:l.Version,url:l.URL});for(let l=0;l<a.length;l++){a[l].ProjectID=l;const g=a[l],b=ri(g);t.insertAdjacentHTML("beforeend",b);const f=t.lastElementChild;f.addEventListener("dragstart",r),f.addEventListener("dragover",d),f.addEventListener("drop",m)}function r(l){l.dataTransfer.setData("text/plain",l.target.dataset.rowId),l.dataTransfer.getData("text/plain"),s=l.srcElement,Vn(l.srcElement)}const c=Kn(Wn,0);function d(l){l.preventDefault(),l.dataTransfer.dropEffect="move";const g=l.target.closest(".PROJECTview-projectTable-rowContainer");if(g!==s){const b=getComputedStyle(g).backgroundColor,f=i(b);c(g,f,o)}}function m(l){l.preventDefault(),s.style,s.style.backgroundColor="yellow !important";const g=l.dataTransfer.getData("text/plain"),b=document.querySelector(`[data-row-id="${g}"]`),f=l.target.closest(".PROJECTview-projectTable-rowContainer");if(f){const h=f.getAttribute("data-row-id");f.before(b);const N=`${g}|${h}`;setTimeout(async()=>{await ee(v.ProjectID,"SongsTableChangeSongSequenceOrder",N),ye()},1)}}t.addEventListener("click",function(l){const g=l.target;if(l.stopPropagation(),g.tagName==="BUTTON"){const b=g.closest(".PROJECTview-projectTable-rowContainer");b&&(b.getAttribute("data-row-id"),ii(l))}});const p=t.querySelectorAll("[contenteditable]"),E=[],y=l=>{const b=l.target.closest(".PROJECTview-projectTable-rowContainer").getAttribute("data-row-id"),f=l.target.textContent,h=E.find(w=>w.dataRowIDField===b);if((h?h.currentText:"Row ID not found")==f)return;for(var B=E.length-1;B>=0;B--)E[B].dataRowIDField===b&&(E[B].currentText=f);const C=`${b}-${f}`;ee(v.ProjectID,"project_song_title",C)};p.forEach(l=>{l.addEventListener("blur",y),E.push({dataRowIDField:l.parentElement.parentElement.getAttribute("data-row-id"),currentText:l.innerText})})}function ii(e){e.stopPropagation();const t=e.target,n=t.parentElement.parentElement.getAttribute("data-row-id"),o=t.parentElement.parentElement.firstElementChild.lastElementChild.innerText;Y([{displayText:"Delete",optionalSVG:"None",function:"PROJECT_VIEW_delete_song",optionalParams:{songID:n,songName:o}}],e)}async function si(e){const t=`Are you sure that you want to delete <em><b>${e.songName}</b></em>? This action is not reversable.`,n=await vt(t);n==="cancel"||(n==="delete"?(await Jo(v.ProjectID,e.songID),J(),ye()):console.error("a statement was returned that isn't valid"))}function ai(){let e="PROJECTview_projectAreaContainer",t=Yo;for(const[n,o]of Object.entries(I)){const i=new RegExp(`\\{${n}\\}`,"g");t=t.replace(i,o)}document.getElementById(e).innerHTML+=t}function ri(e){let t=Fo;for(const[o,i]of Object.entries(I)){const s=new RegExp(`\\{${o}\\}`,"g");t=t.replace(s,i)}const n=["PROJECTviewRow_img","PROJECTviewRow_songTitle","PROJECTviewRow_artistName","PROJECTviewRow_projectName","PROJECTviewRow_songDuration","PROJECTviewRow_projectID","PROJECTviewRow_contentEditable"];for(let o=0;o<n.length;o++){const i=n[o].toString(),s=new RegExp(`\\{${i}\\}`,"g");let a="";i==="PROJECTviewRow_img"?a=`${T}/${e.img}/3`:i==="PROJECTviewRow_songTitle"?a=e.songTitle:i==="PROJECTviewRow_artistName"?a=e.artistName:i==="PROJECTviewRow_projectName"?a=e.projectName:i==="PROJECTviewRow_songDuration"?a=e.songDuration:i==="PROJECTviewRow_projectID"?a=`${e.songSequence}-${e.version}`:i==="PROJECTviewRow_contentEditable"&&Fe===!0?a=!0:i==="PROJECTviewRow_contentEditable"&&Fe===!1&&(a=!1),t=t.replace(s,a)}return t}function ci(){const e=document.getElementById("PROJECTview_dropArea");document.getElementById("PROJECTview_dropArea_submit_button"),e.addEventListener("dragenter",o=>{o.preventDefault(),e.classList.add("dragover")}),e.addEventListener("dragover",o=>{o.preventDefault()}),e.addEventListener("dragleave",()=>{e.classList.remove("dragover")}),e.addEventListener("drop",o=>{o.preventDefault(),e.classList.remove("dragover");const i=o.dataTransfer.files;n(i)});let t=[];e.addEventListener("click",o=>{const i=o.target.id,s=document.createElement("input");i!=="PROJECTview_dropArea_submit_button"?(s.type="file",s.accept="audio/*",s.multiple=!0,s.addEventListener("change",()=>{t=s.files}),s.click()):n(t)});function n(o,i){di(o)}}async function bt(e,t){const n=new FormData,o=new XMLHttpRequest;pe=!0,lo(),n.append("file",e),n.append("project_id",t),o.upload.onprogress=function(i){if(i.lengthComputable){const s=i.loaded/i.total*100;de(s),s===100&&de(s)}},o.onload=async function(){if(o.responseText=="StorageLimit Reached"){j("Storage limit reached","error");for(var s=x.length-1;s>=0;s--)x.shift();pe=!1,Ne(),de(0)}if(pe=!1,x.shift(),Ne(),de(0),x.length>0){const a=x[0];await bt(a.file,a.ProjectID)}v.ProjectID==t&&Ee==!0&&ye()},o.onerror=function(){j("Upload Failed","error")},o.open("POST",`${O}/files/upload_audio/${t}`,!0),o.send(n)}async function di(e,t){document.getElementById("uploadsContainer");for(const n of e){const o={ProjectID:v.ProjectID,file:n};if(x.push(o),!pe){const i=x[0];await bt(i.file,i.ProjectID)}}}function ht(e){const t=document.getElementById("PROJECTviewMobileStickyHeaderProjectNameContainer");t.innerText=e}function li(){const e=new IntersectionObserver(i,{threshold:.1}),t=document.querySelector(".PROJECTviewDisplayImage"),n=document.getElementById("PROJECTviewMobileStickyHeader"),o=document.getElementById("PROJECTviewMobileStickyHeaderProjectNameContainer");e.observe(t);function i(s,a){s.forEach(r=>{r.isIntersecting&&D()?(n.style.backdropFilter="none",n.style.backgroundColor="transparent",o.style.visibility="hidden"):r.isIntersecting&&!D()||!r.isIntersecting&&!D()?(n.style.backdropFilter="var(--PROJECTviewDesktopHeaderFilter)",o.style.visibility="hidden"):!r.isIntersecting&&D()&&(n.style.backdropFilter="blur(15px)",n.style.backgroundColor="var(--background-transparent)",o.style.visibility="visible")})}}const ui=`<button class="MENUmodalItemContainer" tabindex="0">
...
</div>`;let _e,q=!1;function Y(e,t,n){n===void 0?fi(e,t):n!==void 0&&n==="update_project_image"?Ke(e,t,"update_project_image"):n!==void 0&&n==="update_user_pfp"?Ke(e,t,"update_user_pfp"):n!==void 0&&n==="lcd_mobile_body"?_i():console.log("invalid menu display inputs")}function _i(e){const t=document.querySelector("main"),n=document.querySelector(".topHalf-container"),o=document.getElementById("MENUmodalEnvironment");let i=so;const s=document.getElementById("audio"),a=["LCD_mobile_body_container_l2","LCD_mobile_body_img","LCD_mobile_body_title_area_container","LCD_mobile_body_song_title","LCD_mobile_body_artist_title","LCD_mobile_body_progress_bar","LCD_mobile_body_menu","LCD_mobile_body_queue_container","LCD_mobile_body_secondary_seek_indicator"];let r=0,c=0;D()&&(t.style.zIndex="40",n.style.zIndex="0");for(const[P,A]of Object.entries(I)){const U=new RegExp(`\\{${P}\\}`,"g");i=i.replace(U,A)}o.style.display="block",o.innerHTML=i;const d=document.getElementById("LCD_mobile_body_song_title"),m=document.getElementById("LCD_mobile_body_artist_title"),p=document.getElementById("LCD_mobile_body_img"),E=s.duration,l=s.currentTime/E*100,g=document.getElementById("LCDMB_seek_input"),b=document.getElementById("LCDMB_seek_indicator");document.getElementById("LCDMB_menu_button");const f=document.getElementById("LCDMB_back"),h=document.getElementById("LCDMB_play"),N=document.getElementById("LCDMB_play_icon"),B=document.getElementById("LCDMB_next"),C=document.getElementById("LCDMB_queue_button");s.addEventListener("ended",()=>{w(),q===!0&&H()}),w(),R(),b.style.width=`${l}%`,s.addEventListener("timeupdate",()=>{const P=s.duration,U=s.currentTime/P*100;b.style.width=`${U}%`}),g.addEventListener("input",function(){const P=s.duration,A=g.value;s.currentTime=P*(A/100)}),f.addEventListener("click",()=>{Mt(),w(),q===!0&&H()}),h.addEventListener("click",()=>{be(),w(),R()}),B.addEventListener("click",()=>{Bt(),w(),q===!0&&H()}),C.addEventListener("click",()=>{q===!1?(xe(),q=!0):(De(),q=!1)}),q===!0?xe():De(),o.addEventListener("touchstart",oe,!1),o.addEventListener("touchmove",ie,!1),o.addEventListener("touchend",se,!1);function w(){p.src=wt,d.innerText=Lt,m.innerText=Pt}function R(){s.paused?N.src=I.icons_playButtonV2:N.src=I.icons_derpy}function H(){const P=document.getElementById("LCD_mobile_queue_content_container");P.innerHTML="";for(let A=_+1;A<u.length;A++){const U=u[A],ae=["queue_item_img","queue_item_song_name","queue_item_song_artist","icons_menuOptionsButton","QUEUE_item_timeIndicator"],K=U.img,Gt=U.song_name,Jt=U.project_contributors;let he=io;for(let Te=0;Te<ae.length;Te++){const re=ae[Te].toString(),Ht=new RegExp(`\\{${re}\\}`,"g");let ce="";re==="queue_item_img"?ce=`${T}/${K}/3`:re==="queue_item_song_name"?ce=Gt:re==="queue_item_song_artist"&&(ce=Jt),he=he.replace(Ht,ce)}P.innerHTML+=he}}function xe(){function P(A){A.forEach(U=>{document.querySelectorAll("."+U).forEach(K=>{K.classList.add("queue_visible")})})}P(a),o.removeEventListener("touchstart",oe),o.removeEventListener("touchmove",ie),o.removeEventListener("touchend",se),H()}function De(){function P(A){A.forEach(U=>{document.querySelectorAll("."+U).forEach(K=>{K.classList.remove("queue_visible")})})}P(a),o.addEventListener("touchstart",oe,!1),o.addEventListener("touchmove",ie,!1),o.addEventListener("touchend",se,!1)}function oe(P){q===!1&&(r=P.touches[0].clientY)}function ie(P){P.preventDefault()}function se(P){c=P.changedTouches[0].clientY,c-r>70&&(J(),o.removeEventListener("touchstart",oe),o.removeEventListener("touchmove",ie),o.removeEventListener("touchend",se))}}function fi(e,t){_e=document.activeElement;let n=t.clientX,o=t.clientY;const i=document.querySelector("main"),s=document.querySelector(".topHalf-container");D()&&(i.style.zIndex="40",s.style.zIndex="0");const a=document.getElementById("MENUmodalEnvironment");a.innerHTML=gi,a.style.display="block";const r=document.getElementById("MENUmodalBody");let c=n+"px",d=o+"px";a.addEventListener("click",It),r.style.left=c,r.style.top=d;let m="mouse";if(t.webkitForce==1||t.webkitForce==0?t.webkitForce==0&&(m="keyboard"):t.pointerType!=="mouse"&&(m="keyboard"),m=="keyboard"){const h=_e.getBoundingClientRect();n=h.left+window.scrollX,o=h.top+window.scrollY;let N=n+"px",B=o+"px";r.style.left=N,r.style.top=B}for(let h=0;h<e.length;h++)yi(e[h]);const E=r.children[0],y=r.offsetWidth,l=r.offsetHeight,g=Tt("MENUmodalBody"),b=r.getElementsByClassName("MENUmodalItemContainer");m==="keyboard"&&!D()?E.focus():m=="mouse"&&!D()&&(E.focus(),E.blur()),document.addEventListener("keydown",f),g.xOverflow==!0&&(c=n-y+"px",r.style.left=c),g.yOverflow==!0&&(d=o-l+"px",r.style.top=d);for(let h=0;h<b.length;h++){const N=b[h];N.setAttribute("data-menu-item-id",h),N.addEventListener("click",function(B){B.stopPropagation();const w=B.target.getAttribute("data-menu-item-id"),R=e[w].function,H=e[w].optionalParams;if(R=="TEST")console.log("the button worked");else if(R!="None"){bi[R](H);return}else return})}function f(h){(h.key==="Escape"||h.keyCode===27)&&(document.removeEventListener("keydown",f),J())}}function Ke(e,t,n){const o=t.clientX,i=t.clientY,s=document.querySelector("main"),a=document.querySelector(".topHalf-container"),r=document.getElementById("MENUmodalEnvironment");let c=o+"px",d=i+"px";D()&&(s.style.zIndex="40",a.style.zIndex="0"),e.MenuType=n,s.style.zIndex="2",r.innerHTML=oo,r.style.display="block",r.addEventListener("click",It);const m=document.getElementById("MENUmodalBody"),p=document.getElementById("MENUmodalBody_image_select_file_drop_area"),E=document.getElementById("MENUmodalBody_image_select_file_select_button"),y=document.getElementById("MENUmodalBody_image_select_preview_area"),l=document.getElementById("MENUmodalBody_image_select_submit_button"),g=document.getElementById("MENUmodalBody_image_select_submit_button_container");m.style.left=c,m.style.top=d;let b,f;function h(C,w){return function(){const R=this,H=arguments;clearTimeout(f),f=setTimeout(()=>{C.apply(R,H)},w)}}function N(C,w,R){h(pi,100)(C,w,R)}function B(C){if(b){const w=URL.createObjectURL(b),R=document.getElementById("MENUmodalBody_image_submit_area_loader_spinner");y.src=w,l.style.visibility="visible",g.style.outline="3px solid var(--primary)",l.addEventListener("click",()=>{N(b,C.project_id,C.MenuType),R.style.visibility="visible"})}else console.log("No file selected.")}p.addEventListener("dragover",C=>{C.preventDefault()}),p.addEventListener("drop",C=>{C.preventDefault(),b=C.dataTransfer.files[0],B(e)}),E.addEventListener("click",()=>{const C=document.createElement("input");C.type="file",C.accept="image/*",C.addEventListener("change",w=>{b=w.target.files[0],B(e)}),C.click()})}function vi(){const e=document.getElementById("MENUmodalBody_image_submit_area_loader_spinner");e.style.visibility="hidden",J(),ye()}function Ei(){const e=document.getElementById("MENUmodalBody_image_submit_area_loader_spinner");e.style.visibility="hidden",J()}function Tt(e){const t=document.getElementById(e),n=document.documentElement.clientWidth,o=document.documentElement.clientHeight,i=t.offsetWidth,s=t.getBoundingClientRect().left,a=t.getBoundingClientRect().top,r=t.getBoundingClientRect().height,c=i+s,d=r+a;let m=!1,p=!1;return c>n&&(m=!0),d>o&&(p=!0),{xOverflow:m,yOverflow:p}}function yi(e){const t=e.displayText,n=e.optionalSVG,o=document.getElementById("MENUmodalBody");let i;"colour"in e?i=e.colour:(i="var(--text)",D()&&(i="var(--text)"));let s=new RegExp("\\{MENU_item_text\\}","g"),a=ui.replace(s,t);if(s=new RegExp("\\{MENU_item_colour\\}","g"),a=a.replace(s,i),n!=="None"){s=new RegExp("\\{MENU_item_image\\}","g");const r="{"+n+"}";a=a.replace(s,r);for(const[c,d]of Object.entries(I)){const m=new RegExp(`\\{${c}\\}`,"g");a=a.replace(m,d)}o.innerHTML+=a;return}else{a=a.replace(/<img[^>]+>/g,""),o.innerHTML+=a;return}}function It(e){const t=document.getElementById("MENUmodalEnvironment"),n=document.querySelector("main"),o=window.matchMedia("screen and (orientation: portrait) and (max-width: 768px) and (pointer: coarse) "),i=document.querySelector(".topHalf-container");if(e.target===t){t.style.display="none",o.matches&&(n.style.zIndex="1",i.style.zIndex="10");return}}function J(){const e=document.getElementById("MENUmodalEnvironment"),t=document.querySelector("main"),n=window.matchMedia("screen and (orientation: portrait) and (max-width: 768px) and (pointer: coarse) "),o=document.querySelector(".topHalf-container");e.style.display="none",n.matches&&(t.style.zIndex="1",o.style.zIndex="10"),_e&&_e.focus()}const bi={PROJECT_VIEW_delete_project(e){ni()},PLAYBACK_add_songs_to_queue(e){Ji(e)},SIGN_OUT_USER(e){Mo()},OPEN_SETTINGS_PAGE(e){G("/settings/")},PROJECT_VIEW_delete_song(e){si(e)}};let F="hidden";function hi(){Yn();const e=document.getElementById("queueButton"),t=document.getElementById("QUEUEclearQueueButton");Oe(F),e.addEventListener("click",Ti),t.addEventListener("click",Ii),$()}function Ti(){if(F==="hidden"){F="visible",Oe(F);return}if(F==="visible"){F="hidden",Oe(F);return}}function Oe(e){document.getElementById("queueButton");const t=document.getElementById("queueIcon"),n=document.getElementById("QUEUEenvironment");if(e=="visible"){t.style.filter="var(--make-svg-grey)",document.documentElement.style.cssText="--TOPRIGHT-accountcontrols-queue-opacity: 100%",n.style.right="0%",it&&(t.style.filter="var(--make-svg-white)");return}if(e=="hidden"){t.style.filter="var(--make-svg-black)",document.documentElement.style.cssText="--TOPRIGHT-accountcontrols-queue-opacity: 0%",n.style.right="calc((var(--width-of-left-bar-fortop) + 5rem) * -1)";return}}function $(){const e=document.getElementById("QUEUEbottomContainer");e.innerHTML="";for(let t=_+1;t<u.length;t++){u[t].id=t;const n=u[t],o=Mi(n),i=document.createElement("div");i.innerHTML=o,i.addEventListener("click",function(r){r.target.dataset.songId}),i.dataset.songId=n.id,i.addEventListener("click",Bi),i.dataset.songId=n.id;const s=i.querySelector(".QUEUE-item-image-removeIndicator"),a=i.querySelector(".QUEUE-item-up-next-queue-item-context-call");s.addEventListener("click",Pi),s.dataset.songID=n.id,a.dataset.songSet=n.id,a.addEventListener("click",function(r){r.target===a&&Oi(r)}),i.addEventListener("dragstart",Ci),i.addEventListener("dragover",wi),i.addEventListener("drop",Li),e.appendChild(i)}}function Ii(){const e=_+1;e>=0&&e<u.length?u.splice(e):u.length=0,$()}function Ci(e){const t=e.target;e.dataTransfer.setData("text/plain",t.dataset.songId)}function wi(e){e.preventDefault(),e.dataTransfer.dropEffect="move"}function Li(e){e.preventDefault();const t=e.dataTransfer.getData("text/plain"),n=e.target,o=u.find(r=>r.id===parseInt(t)),i=u.find(r=>r.id===parseInt(n.dataset.songId)),s=u.indexOf(o),a=u.indexOf(i);s!==-1&&a!==-1&&(u.splice(s,1),u.splice(a,0,o),S.splice(s,1),S.splice(a,0,o),$())}function Pi(e){e.stopPropagation();const t=e.target,n=parseInt(t.dataset.songID),o=u.findIndex(i=>i.id===n);o!==-1&&(u.splice(o,1),S.splice(o,1)),$()}function Oi(e){e.stopPropagation();const o=[{displayText:"Play next",optionalSVG:"icons_playlist",function:"MENU_ACTION_playNext",optionalParams:{queueID:e.target.getAttribute("data-song-set")}},{displayText:"Play later",optionalSVG:"icons_backButton",function:"None"},{displayText:"Love",optionalSVG:"None",function:"None"},{displayText:"Less like this",optionalSVG:"None",function:"None"},{displayText:"Rate",optionalSVG:"None",function:"None"}];Y(o,e)}function Bi(e){}function Mi(e){const t=["QUEUE_item_image","QUEUE_item_title","QUEUE_item_artist","icons_menuOptionsButton","QUEUE_item_timeIndicator"],n=e.img,o=e.song_name,i=e.project_contributors,s=`${Math.floor(e.duration/60)}:${(e.duration%60).toString().padStart(2,"0")}`;let a=Fn;for(let c=0;c<t.length;c++){const d=t[c].toString(),m=new RegExp(`\\{${d}\\}`,"g");let p="";d==="QUEUE_item_image"?p=`${T}/${n}/3`:d==="QUEUE_item_title"?p=o:d==="QUEUE_item_artist"?p=i:d==="icons_menuOptionsButton"?p=ot:d==="QUEUE_item_timeIndicator"&&(p=s),a=a.replace(m,p)}a=a.replace("<div",`<div data-song-id="${e.id}"`);const r=document.createElement("div");return r.querySelector(".QUEUE-item-image-removeIndicator"),r.innerHTML=a,r.innerHTML}const Si=`<div class="LCDbody">
