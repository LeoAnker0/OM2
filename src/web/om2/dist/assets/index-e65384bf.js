...
<p>Double click your profile picture to change it.</p>`,Co=`<div class="settings_container">
...
</div>`;let Pe;async function Lo(){const e=document.getElementById("TOPRIGHTaccountImg");try{const t=await Oe("profile_picture"),n=`${T}/${t}/1`;Pe=t;const o=document.getElementById("TOPRIGHTaccountImgButton");e.src=n,o.addEventListener("click",Po)}catch(t){console.error("Error initializing account image:",t)}}function Po(e){e.stopPropagation(),Oo(e)}function Oo(e){Y([{displayText:"Help",optionalSVG:"icons_helpIcon",function:"None"},{displayText:"Settings",optionalSVG:"icons_settings",function:"OPEN_SETTINGS_PAGE"},{displayText:"Sign Out",optionalSVG:"None",function:"SIGN_OUT_USER"}],e)}async function Bo(){await Ho()}let ut="general";const me=[{name:"general",markup:Io,button_id:"settings_button_general",function:So},{name:"user",markup:wo,button_id:"settings_button_user",function:xo},{name:"admin",markup:ho,button_id:"settings_button_admin",function:Do}];function Mo(){const e=document.getElementById("MAINcontentPages");let t=Co;for(const[i,s]of Object.entries(I)){const a=new RegExp(`\\{${i}\\}`,"g");t=t.replace(a,s)}e.innerHTML=t;const n=document.getElementById("settings_go_to_other_content_button");Ge(ut);for(var o=me.length-1;o>=0;o--){const i=me[o].button_id;document.getElementById(i).addEventListener("click",function(a){const r=a.srcElement.id,d=me.find(m=>m.button_id===r).name;Ge(d)})}n.addEventListener("click",function(){G("/")})}function mt(){const e=document.getElementById("MAINcontentPages");e.innerHTML=""}function Ge(e){ut=e;const t=["users_img"],n=document.getElementById("view_container"),o=me.find(s=>s.name===e);let i=o.markup;for(const[s,a]of Object.entries(I)){const r=new RegExp(`\\{${s}\\}`,"g");i=i.replace(r,a)}for(let s=0;s<t.length;s++){const a=t[s].toString(),r=new RegExp(`\\{${a}\\}`,"g");let c="";a==="users_img"&&(c=`${T}/${Pe}/4/`),i=i.replace(r,c)}n.innerHTML=i,o.function()}function So(){}function xo(){lt("user-id","settings_views_user_pfp_img","update_user_pfp")}let W=[];async function Do(){if(await Oe("admin")!=="true")return;const t=["users_img"],n=document.getElementById("view_container");let o=bo;for(const[s,a]of Object.entries(I)){const r=new RegExp(`\\{${s}\\}`,"g");o=o.replace(r,a)}for(let s=0;s<t.length;s++){const a=t[s].toString(),r=new RegExp(`\\{${a}\\}`,"g");let c="";a==="users_img"&&(c=`${T}/${Pe}/4/`),o=o.replace(r,c)}n.innerHTML=o,pt(),document.getElementById("SETTINGS_ADMIN_UPDATE_COLUMN_submit_button").addEventListener("click",function(s){const a=document.getElementById("SETTINGS_ADMIN_UDPATE_COLUMN_column_to_updated"),r=document.getElementById("SETTINGS_ADMIN_UDPATE_COLUMN_new_data");if(a.value==""||r.value=="")k("Error Updating Column: empty inputs","error");else for(var c=W.length-1;c>=0;c--){const d=W[c];Jo(d,a.value,r.value)}})}let j;async function pt(){const e=await Go();j=JSON.parse(e);const t=document.getElementById("usersTableInforRowsContainer");t.innerHTML="";for(let n=0;n<j.length;n++){const o=["Username","Email","UUID","Verified","Space_Used","Storage_Allowance","profile_picture_url","checkbox_number","Admin"],i=j[n].username,s=j[n].uuid,a=j[n].verified,r=j[n].email;let c=j[n].storage_allowance;c=X(c);const d=j[n].admin,m=n;let p=j[n].storage_used;p=X(p);let v=yo,E=j[n].profile_picture;E=`${T}/${E}/1/`;for(let l=0;l<o.length;l++){const g=o[l].toString(),y=new RegExp(`\\{${g}\\}`,"g");let f="";g==="Username"?f=i:g==="Email"?f=r:g==="UUID"?f=s:g==="Verified"?f=a:g==="Space_Used"?f=p:g==="Storage_Allowance"?f=c:g==="profile_picture_url"?f=E:g==="checkbox_number"?f=m:g==="Admin"&&(f=d),v=v.replace(y,f)}t.innerHTML+=v}t.addEventListener("change",function(n){n.target&&n.target.type==="checkbox"&&Ro()})}function Ro(){W=[];const t=usersTableEnvironment.querySelectorAll('input[type="checkbox"]'),n=[],o=document.getElementById("settings_admin_selected_items_visualition");t.forEach(function(i){if(i.checked){const r={id:i.id.replace("admin_users_table_check_box_",""),value:i.value};n.push(r)}}),n.forEach(function(i){const a=j[i.id].uuid;W.push(a)}),o.innerHTML=`Selected Items: ${W.length}`}async function Ao(){const e=await Oe("last_state"),t=JSON.parse(e),n=new Map;setInterval(s,1e4);let o="";if(window.addEventListener("popstate",a),t!=null){const r=window.location.pathname;G(r),ki(t)}else a();function i(r){return JSON.stringify(r)}function s(){const r=window.location.pathname,c=u,d=_,m=Yi();m.current_path=r,m.current_queue=c,m.current_index=d;const p=i(m);p!==o&&(ko("last_state",m),o=p,n.set("playback_states",p))}function a(){G(currentPath)}}function No(){ft(),mt(),_o()}function Uo(e){rt(),mt(),Fo(e)}function Je(){rt(),ft(),Mo()}const He={"/":No,"/new-project/":le,"/new-project":le,"/new/":le,"/new":le,"/projects/:projectID":Uo,"/settings/":Je,"/settings":Je};function jo(){const e=window.location.pathname,t=document.getElementById("MAINcontentPages");setTimeout(n,4e3),t.innerHTML+=`
    <br><br>
    <br><br>
    <br><br>    
...
</div>`,$o=`<div class="PROJECTview-projectTable-rowContainer" data-row-id="{PROJECTviewRow_projectID}" draggable="{PROJECTviewRow_contentEditable}" style="user-select: auto; pointer-events: auto;">
...
</div>`,Yo=`<div class="PROJECTviewContainerEnvironment">
    ...
    <div class="PROJECTviewMOREdescriptionboxEnvironment" id="PROJECTviewMOREdescriptionboxEnvironment">
        ...
        `;i.innerHTML=s,i.style.visibility="visible";const a=document.getElementById("CONFIRMmodalDeleteButton"),r=document.getElementById("CONFIRMmodalCancelButton");function c(){$e(),t("delete")}function d(){qe.focus(),$e(),t("cancel")}i.addEventListener("click",m=>{const p=m.target;p===a?c():(p===r||p===i)&&d()}),o==="keyboard"&&!D()?r.focus():o=="mouse"&&!D()&&(J(),r.focus(),r.blur())})}function $e(){const e=document.getElementById("confirmModal");e.style.visibility="hidden"}const x=[];let pe=!1,Ye=!0,b,Ee=!1;async function Fo(e){let t;Ee=!0,ot()==!0?t={ProjectName:"Hi!",ProjectContributors:"Loading",TimeCreated:0,PictureURL:"static/loading_img_text_dark"}:t={ProjectName:"Hi!",ProjectContributors:"Loading",TimeCreated:0,PictureURL:"static/loading_img_text_light"},Vo(t),sessionStorage.setItem("description","Wonderful notes are loading..."),Fe(),document.getElementById("PROJECTviewMobileStickyHeaderBackButton").addEventListener("click",()=>{G("/")});const o=await ve(e);if(o=="")console.log(o);else{const s=JSON.parse(o);s.ProjectID=e,b=s,i(),zo()}function i(){Qo(),sessionStorage.setItem("description",b.Description),Fe(),Ko(),Xo(),Zo(),ei(),vt(),di(),yt(b.ProjectName),lt(b.ProjectID,"PROJECTviewDisplayImage","update_project_image"),ri()}}function ft(){const e=document.getElementById("MAINcontentPages");e.innerHTML="",Ee=!1}async function Be(){if(!Ee)return;const e=b.ProjectID,t=await ve(e);if(t!=""){const n=JSON.parse(t);n.ProjectID=e,b=n,vt();const o=document.getElementById("PROJECTviewDisplayImage_imgTag"),i=`${T}/${b.PictureURL}/5`;o.src=i}}function Qo(){const e=document.getElementById("PROJECTviewDisplayTitleH1"),t=document.getElementById("PROJECTviewDisplayTitleH3"),n=document.getElementById("PROJECTviewDisplayImage_imgTag"),o=`${T}/${b.PictureURL}/5`;e.innerText=b.ProjectName,t.innerText=b.ProjectContributors,n.src=o}function zo(){const e=document.getElementById("PROJECTviewDisplayTitleH1"),t=document.getElementById("PROJECTviewDisplayTitleH3");let n=document.getElementById("PROJECTviewDisplayTitleH1").innerText,o=document.getElementById("PROJECTviewDisplayTitleH3").innerText;e.addEventListener("blur",function(i){const s=e.innerText;s!==n&&(yt(s),ee(b.ProjectID,"project_name",s),n=s)}),t.addEventListener("blur",function(i){const s=t.innerText;s!==o&&(ee(b.ProjectID,"project_contributors",s),o=s)})}function Vo(e){let t="MAINcontentPages",n=Yo;for(const[i,s]of Object.entries(I)){const a=new RegExp(`\\{${i}\\}`,"g");n=n.replace(a,s)}const o=["PROJECTviewMOREtitle","PROJECTviewMOREartist","PROJECTviewMOREyear","PROJECTviewDisplayImage"];for(let i=0;i<o.length;i++){const s=o[i].toString(),a=new RegExp(`\\{${s}\\}`,"g");let r="";s==="PROJECTviewMOREtitle"?r=e.ProjectName:s==="PROJECTviewMOREartist"?r=e.ProjectContributors:s==="PROJECTviewMOREyear"?r=Qn(e.TimeCreated):s==="MOG_checkedDate"?r="checkedIndicator":s==="MOGI_placeholder_itemID"?r="temporaryIidentifier":s==="PROJECTviewDisplayImage"&&(r=`${T}/${e.PictureURL}/5`),n=n.replace(a,r)}document.getElementById(t).innerHTML=n}function Fe(){let e=sessionStorage.getItem("description");const t=document.getElementById("PROJECTviewDescriptionP");t.innerText=e}function Ko(){const e=document.getElementById("PROJECTviewDescriptionMoreButton"),t=document.getElementById("PROJECTviewDisplayDescription"),n=document.getElementById("PROJECTviewMOREdescriptionboxEnvironment"),o=document.querySelector("main");function i(){n.style.display="grid",D()&&(o.style.zIndex="40")}e.addEventListener("click",function(){i()}),t.addEventListener("dblclick",function(){i()});let s=0;t.addEventListener("touchend",function(a){const r=new Date().getTime();r-s<300&&(a.stopPropagation(),i()),s=r})}function Wo(){const e=sessionStorage.getItem("description"),t=document.getElementById("PROJECTviewDescriptionP");t.innerText=e}function Xo(){const e=sessionStorage.getItem("description");document.getElementById("PROJECTviewMOREdescriptionC");const t=document.getElementById("PROJECTviewMOREdescriptionP");t.innerText=e}function Zo(){const e=document.getElementById("PROJECTviewMOREcloseButton"),t=document.getElementById("PROJECTviewMOREdescriptionboxEnvironment");e.addEventListener("click",function(){Qe(b)}),t.addEventListener("click",function(n){n.target===t&&Qe(b)})}function Qe(e){const n=document.getElementById("PROJECTviewMOREdescriptionP").value,o=document.getElementById("PROJECTviewMOREdescriptionboxEnvironment"),i=document.querySelector("main");sessionStorage.setItem("description",n),ee(e.ProjectID,"description",n),o.style.display="none",Wo(),i.style.zIndex="1"}async function ei(){const e=document.getElementById("PROJECTviewDescriptionTopPlayButton"),t=document.getElementById("PROJECTviewDescriptionTopShuffleButton"),n=document.getElementById("PROJECTviewDisplayMenuButton"),o=document.getElementById("PROJECTviewMobileStickyHeaderMenuButton");e.addEventListener("click",function(){Lt(b)}),t.addEventListener("click",function(){ji(b)}),n.addEventListener("click",function(){ze(event)}),o.addEventListener("click",function(){ze(event)})}function ze(e){e.stopPropagation(),e.target;const t=b.ProjectID;Y([{displayText:"Play next",optionalSVG:"icons_playlist",optionalParams:{PROJECT_ID:t,QUEUE_POSITION:"next"},function:"PLAYBACK_add_songs_to_queue"},{displayText:"Play later",optionalSVG:"icons_playlist",optionalParams:{PROJECT_ID:t,QUEUE_POSITION:"later"},function:"PLAYBACK_add_songs_to_queue"},{displayText:"Delete",optionalSVG:"None",function:"PROJECT_VIEW_delete_project",optionalParams:{PROJECT_ID:t},colour:"hsl(0, 100%, 55%)"}],e)}async function ti(e){const t=`Are you sure that you want to delete <em><b>${b.ProjectName}</b></em>? This action is not reversable.`,n=await _t(t);if(n==="cancel")J();else if(n==="delete"){const o="/";ni(),J(),G(o)}else J()}async function ni(e){const t=b.ProjectID;try{const o=await(await fetch(`${O}/projects/delete_project/${t}`,{method:"DELETE",headers:{"Content-Type":"application/json"},credentials:"include"})).json()}catch(n){console.error("Error:",n)}}function vt(){const e=document.getElementById("PROJECTview-projectTable");e!==null&&e.remove(),document.getElementById("PROJECTview_projectAreaContainer"),si();const t=document.getElementById("PROJECTview-projectTable"),n=b.ProjectJSON,o=Zn("--orange"),i=l=>`#${l.match(/^rgb\((\d+),\s*(\d+),\s*(\d+)\)$/).slice(1).map(g=>parseInt(g,10).toString(16).padStart(2,"0")).join("")}`;let s;if(n==null)return;const a=[];if(n)for(const l of n)a.push({img:b.PictureURL,songTitle:l.SongName,artistName:b.ProjectContributors,projectName:X(l.FolderSize),songDuration:`${Math.floor(l.Duration/60)}:${(l.Duration%60).toString().padStart(2,"0")}`,songSequence:l.SongSequence,version:l.Version,url:l.URL});for(let l=0;l<a.length;l++){a[l].ProjectID=l;const g=a[l],y=ai(g);t.insertAdjacentHTML("beforeend",y);const f=t.lastElementChild;f.addEventListener("dragstart",r),f.addEventListener("dragover",d),f.addEventListener("drop",m)}function r(l){l.dataTransfer.setData("text/plain",l.target.dataset.rowId),l.dataTransfer.getData("text/plain"),s=l.srcElement,zn(l.srcElement)}const c=Vn(Kn,0);function d(l){l.preventDefault(),l.dataTransfer.dropEffect="move";const g=l.target.closest(".PROJECTview-projectTable-rowContainer");if(g!==s){const y=getComputedStyle(g).backgroundColor,f=i(y);c(g,f,o)}}function m(l){l.preventDefault(),s.style,s.style.backgroundColor="yellow !important";const g=l.dataTransfer.getData("text/plain"),y=document.querySelector(`[data-row-id="${g}"]`),f=l.target.closest(".PROJECTview-projectTable-rowContainer");if(f){const h=f.getAttribute("data-row-id");f.before(y);const N=`${g}|${h}`;setTimeout(async()=>{await ee(b.ProjectID,"SongsTableChangeSongSequenceOrder",N),Be()},1)}}t.addEventListener("click",function(l){const g=l.target;if(l.stopPropagation(),g.tagName==="BUTTON"){const y=g.closest(".PROJECTview-projectTable-rowContainer");y&&(y.getAttribute("data-row-id"),oi(l))}});const p=t.querySelectorAll("[contenteditable]"),v=[],E=l=>{const y=l.target.closest(".PROJECTview-projectTable-rowContainer").getAttribute("data-row-id"),f=l.target.textContent,h=v.find(C=>C.dataRowIDField===y);if((h?h.currentText:"Row ID not found")==f)return;for(var B=v.length-1;B>=0;B--)v[B].dataRowIDField===y&&(v[B].currentText=f);const w=`${y}-${f}`;ee(b.ProjectID,"project_song_title",w)};p.forEach(l=>{l.addEventListener("blur",E),v.push({dataRowIDField:l.parentElement.parentElement.getAttribute("data-row-id"),currentText:l.innerText})})}function oi(e){e.stopPropagation();const t=e.target,n=t.parentElement.parentElement.getAttribute("data-row-id"),o=t.parentElement.parentElement.firstElementChild.lastElementChild.innerText;Y([{displayText:"Delete",optionalSVG:"None",function:"PROJECT_VIEW_delete_song",optionalParams:{songID:n,songName:o}}],e)}async function ii(e){const t=`Are you sure that you want to delete <em><b>${e.songName}</b></em>? This action is not reversable.`,n=await _t(t);n==="cancel"||(n==="delete"?(console.log("delete the song"),console.log(e),J()):console.error("a statement was returned that isn't valid"))}function si(){let e="PROJECTview_projectAreaContainer",t=qo;for(const[n,o]of Object.entries(I)){const i=new RegExp(`\\{${n}\\}`,"g");t=t.replace(i,o)}document.getElementById(e).innerHTML+=t}function ai(e){let t=$o;for(const[o,i]of Object.entries(I)){const s=new RegExp(`\\{${o}\\}`,"g");t=t.replace(s,i)}const n=["PROJECTviewRow_img","PROJECTviewRow_songTitle","PROJECTviewRow_artistName","PROJECTviewRow_projectName","PROJECTviewRow_songDuration","PROJECTviewRow_projectID","PROJECTviewRow_contentEditable"];for(let o=0;o<n.length;o++){const i=n[o].toString(),s=new RegExp(`\\{${i}\\}`,"g");let a="";i==="PROJECTviewRow_img"?a=`${T}/${e.img}/3`:i==="PROJECTviewRow_songTitle"?a=e.songTitle:i==="PROJECTviewRow_artistName"?a=e.artistName:i==="PROJECTviewRow_projectName"?a=e.projectName:i==="PROJECTviewRow_songDuration"?a=e.songDuration:i==="PROJECTviewRow_projectID"?a=`${e.songSequence}-${e.version}`:i==="PROJECTviewRow_contentEditable"&&Ye===!0?a=!0:i==="PROJECTviewRow_contentEditable"&&Ye===!1&&(a=!1),t=t.replace(s,a)}return t}function ri(){const e=document.getElementById("PROJECTview_dropArea");document.getElementById("PROJECTview_dropArea_submit_button"),e.addEventListener("dragenter",o=>{o.preventDefault(),e.classList.add("dragover")}),e.addEventListener("dragover",o=>{o.preventDefault()}),e.addEventListener("dragleave",()=>{e.classList.remove("dragover")}),e.addEventListener("drop",o=>{o.preventDefault(),e.classList.remove("dragover");const i=o.dataTransfer.files;n(i)});let t=[];e.addEventListener("click",o=>{const i=o.target.id,s=document.createElement("input");i!=="PROJECTview_dropArea_submit_button"?(s.type="file",s.accept="audio/*",s.multiple=!0,s.addEventListener("change",()=>{t=s.files}),s.click()):n(t)});function n(o,i){ci(o)}}async function Et(e,t){const n=new FormData,o=new XMLHttpRequest;pe=!0,co(),n.append("file",e),n.append("project_id",t),o.upload.onprogress=function(i){if(i.lengthComputable){const s=i.loaded/i.total*100;de(s),s===100&&de(s)}},o.onload=async function(){if(o.responseText=="StorageLimit Reached"){k("Storage limit reached","error");for(var s=x.length-1;s>=0;s--)x.shift();pe=!1,Ae(),de(0)}if(pe=!1,x.shift(),Ae(),de(0),x.length>0){const a=x[0];await Et(a.file,a.ProjectID)}b.ProjectID==t&&Ee==!0&&Be()},o.onerror=function(){k("Upload Failed","error")},o.open("POST",`${O}/files/upload_audio/${t}`,!0),o.send(n)}async function ci(e,t){document.getElementById("uploadsContainer");for(const n of e){const o={ProjectID:b.ProjectID,file:n};if(x.push(o),!pe){const i=x[0];await Et(i.file,i.ProjectID)}}}function yt(e){const t=document.getElementById("PROJECTviewMobileStickyHeaderProjectNameContainer");t.innerText=e}function di(){const e=new IntersectionObserver(i,{threshold:.1}),t=document.querySelector(".PROJECTviewDisplayImage"),n=document.getElementById("PROJECTviewMobileStickyHeader"),o=document.getElementById("PROJECTviewMobileStickyHeaderProjectNameContainer");e.observe(t);function i(s,a){s.forEach(r=>{r.isIntersecting&&D()?(n.style.backdropFilter="none",n.style.backgroundColor="transparent",o.style.visibility="hidden"):r.isIntersecting&&!D()||!r.isIntersecting&&!D()?(n.style.backdropFilter="var(--PROJECTviewDesktopHeaderFilter)",o.style.visibility="hidden"):!r.isIntersecting&&D()&&(n.style.backdropFilter="blur(15px)",n.style.backgroundColor="var(--background-transparent)",o.style.visibility="visible")})}}const li=`<button class="MENUmodalItemContainer" tabindex="0">
    <div class="MENUmodalTextArranger" style="color: {MENU_item_colour}">{MENU_item_text}</div>
    <div class="MENUmodalSVGcontainer">
        <img src="{MENU_item_image}" class="MENUmodalSVG">
    </div>
</button>`;async function ui(e,t,n){const o=new XMLHttpRequest,i=new FormData;i.append("file",e),o.upload.onprogress=function(s){s.lengthComputable&&s.loaded/s.total*100},o.onload=function(){o.status>=200&&o.status<300?(o.responseText=="StorageLimit Reached"&&k("Storage limit reached","error"),n!=="update_user_pfp"?fi():(vi(),location.reload())):console.error("Error during upload. Status:",o.status,"Response:",o.responseText)},o.onerror=function(){console.log("there was an error with the upload")},o.open("POST",`${O}/files/upload_photo?pi=${t}&mt=${n}`,!0),o.send(i)}async function mi(e,t,n){Array.isArray(e)||(e=[e]);for(const o of e)await ui(o,t,n)}const pi=`<div class="MENUmodalBody" id="MENUmodalBody">
</div>`;let _e,q=!1;function Y(e,t,n){n===void 0?_i(e,t):n!==void 0&&n==="update_project_image"?Ve(e,t,"update_project_image"):n!==void 0&&n==="update_user_pfp"?Ve(e,t,"update_user_pfp"):n!==void 0&&n==="lcd_mobile_body"?gi():console.log("invalid menu display inputs")}function gi(e){const t=document.querySelector("main"),n=document.querySelector(".topHalf-container"),o=document.getElementById("MENUmodalEnvironment");let i=io;const s=document.getElementById("audio"),a=["LCD_mobile_body_container_l2","LCD_mobile_body_img","LCD_mobile_body_title_area_container","LCD_mobile_body_song_title","LCD_mobile_body_artist_title","LCD_mobile_body_progress_bar","LCD_mobile_body_menu","LCD_mobile_body_queue_container","LCD_mobile_body_secondary_seek_indicator"];let r=0,c=0;D()&&(t.style.zIndex="40",n.style.zIndex="0");for(const[P,A]of Object.entries(I)){const U=new RegExp(`\\{${P}\\}`,"g");i=i.replace(U,A)}o.style.display="block",o.innerHTML=i;const d=document.getElementById("LCD_mobile_body_song_title"),m=document.getElementById("LCD_mobile_body_artist_title"),p=document.getElementById("LCD_mobile_body_img"),v=s.duration,l=s.currentTime/v*100,g=document.getElementById("LCDMB_seek_input"),y=document.getElementById("LCDMB_seek_indicator");document.getElementById("LCDMB_menu_button");const f=document.getElementById("LCDMB_back"),h=document.getElementById("LCDMB_play"),N=document.getElementById("LCDMB_play_icon"),B=document.getElementById("LCDMB_next"),w=document.getElementById("LCDMB_queue_button");s.addEventListener("ended",()=>{C(),q===!0&&H()}),C(),R(),y.style.width=`${l}%`,s.addEventListener("timeupdate",()=>{const P=s.duration,U=s.currentTime/P*100;y.style.width=`${U}%`}),g.addEventListener("input",function(){const P=s.duration,A=g.value;s.currentTime=P*(A/100)}),f.addEventListener("click",()=>{Ot(),C(),q===!0&&H()}),h.addEventListener("click",()=>{ye(),C(),R()}),B.addEventListener("click",()=>{Pt(),C(),q===!0&&H()}),w.addEventListener("click",()=>{q===!1?(Se(),q=!0):(xe(),q=!1)}),q===!0?Se():xe(),o.addEventListener("touchstart",oe,!1),o.addEventListener("touchmove",ie,!1),o.addEventListener("touchend",se,!1);function C(){p.src=It,d.innerText=wt,m.innerText=Ct}function R(){s.paused?N.src=I.icons_playButtonV2:N.src=I.icons_derpy}function H(){const P=document.getElementById("LCD_mobile_queue_content_container");P.innerHTML="";for(let A=_+1;A<u.length;A++){const U=u[A],ae=["queue_item_img","queue_item_song_name","queue_item_song_artist","icons_menuOptionsButton","QUEUE_item_timeIndicator"],K=U.img,jt=U.song_name,kt=U.project_contributors;let be=oo;for(let he=0;he<ae.length;he++){const re=ae[he].toString(),Gt=new RegExp(`\\{${re}\\}`,"g");let ce="";re==="queue_item_img"?ce=`${T}/${K}/3`:re==="queue_item_song_name"?ce=jt:re==="queue_item_song_artist"&&(ce=kt),be=be.replace(Gt,ce)}P.innerHTML+=be}}function Se(){function P(A){A.forEach(U=>{document.querySelectorAll("."+U).forEach(K=>{K.classList.add("queue_visible")})})}P(a),o.removeEventListener("touchstart",oe),o.removeEventListener("touchmove",ie),o.removeEventListener("touchend",se),H()}function xe(){function P(A){A.forEach(U=>{document.querySelectorAll("."+U).forEach(K=>{K.classList.remove("queue_visible")})})}P(a),o.addEventListener("touchstart",oe,!1),o.addEventListener("touchmove",ie,!1),o.addEventListener("touchend",se,!1)}function oe(P){q===!1&&(r=P.touches[0].clientY)}function ie(P){P.preventDefault()}function se(P){c=P.changedTouches[0].clientY,c-r>70&&(J(),o.removeEventListener("touchstart",oe),o.removeEventListener("touchmove",ie),o.removeEventListener("touchend",se))}}function _i(e,t){_e=document.activeElement;let n=t.clientX,o=t.clientY;const i=document.querySelector("main"),s=document.querySelector(".topHalf-container");D()&&(i.style.zIndex="40",s.style.zIndex="0");const a=document.getElementById("MENUmodalEnvironment");a.innerHTML=pi,a.style.display="block";const r=document.getElementById("MENUmodalBody");let c=n+"px",d=o+"px";a.addEventListener("click",ht),r.style.left=c,r.style.top=d;let m="mouse";if(t.webkitForce==1||t.webkitForce==0?t.webkitForce==0&&(m="keyboard"):t.pointerType!=="mouse"&&(m="keyboard"),m=="keyboard"){const h=_e.getBoundingClientRect();n=h.left+window.scrollX,o=h.top+window.scrollY;let N=n+"px",B=o+"px";r.style.left=N,r.style.top=B}for(let h=0;h<e.length;h++)Ei(e[h]);const v=r.children[0],E=r.offsetWidth,l=r.offsetHeight,g=bt("MENUmodalBody"),y=r.getElementsByClassName("MENUmodalItemContainer");m==="keyboard"&&!D()?v.focus():m=="mouse"&&!D()&&(v.focus(),v.blur()),document.addEventListener("keydown",f),g.xOverflow==!0&&(c=n-E+"px",r.style.left=c),g.yOverflow==!0&&(d=o-l+"px",r.style.top=d);for(let h=0;h<y.length;h++){const N=y[h];N.setAttribute("data-menu-item-id",h),N.addEventListener("click",function(B){B.stopPropagation();const C=B.target.getAttribute("data-menu-item-id"),R=e[C].function,H=e[C].optionalParams;if(R=="TEST")console.log("the button worked");else if(R!="None"){yi[R](H);return}else return})}function f(h){(h.key==="Escape"||h.keyCode===27)&&(document.removeEventListener("keydown",f),J())}}function Ve(e,t,n){const o=t.clientX,i=t.clientY,s=document.querySelector("main"),a=document.querySelector(".topHalf-container"),r=document.getElementById("MENUmodalEnvironment");let c=o+"px",d=i+"px";D()&&(s.style.zIndex="40",a.style.zIndex="0"),e.MenuType=n,s.style.zIndex="2",r.innerHTML=no,r.style.display="block",r.addEventListener("click",ht);const m=document.getElementById("MENUmodalBody"),p=document.getElementById("MENUmodalBody_image_select_file_drop_area"),v=document.getElementById("MENUmodalBody_image_select_file_select_button"),E=document.getElementById("MENUmodalBody_image_select_preview_area"),l=document.getElementById("MENUmodalBody_image_select_submit_button"),g=document.getElementById("MENUmodalBody_image_select_submit_button_container");m.style.left=c,m.style.top=d;let y,f;function h(w,C){return function(){const R=this,H=arguments;clearTimeout(f),f=setTimeout(()=>{w.apply(R,H)},C)}}function N(w,C,R){h(mi,100)(w,C,R)}function B(w){if(y){const C=URL.createObjectURL(y),R=document.getElementById("MENUmodalBody_image_submit_area_loader_spinner");E.src=C,l.style.visibility="visible",g.style.outline="3px solid var(--primary)",l.addEventListener("click",()=>{N(y,w.project_id,w.MenuType),R.style.visibility="visible"})}else console.log("No file selected.")}p.addEventListener("dragover",w=>{w.preventDefault()}),p.addEventListener("drop",w=>{w.preventDefault(),y=w.dataTransfer.files[0],B(e)}),v.addEventListener("click",()=>{const w=document.createElement("input");w.type="file",w.accept="image/*",w.addEventListener("change",C=>{y=C.target.files[0],B(e)}),w.click()})}function fi(){const e=document.getElementById("MENUmodalBody_image_submit_area_loader_spinner");e.style.visibility="hidden",J(),Be()}function vi(){const e=document.getElementById("MENUmodalBody_image_submit_area_loader_spinner");e.style.visibility="hidden",J()}function bt(e){const t=document.getElementById(e),n=document.documentElement.clientWidth,o=document.documentElement.clientHeight,i=t.offsetWidth,s=t.getBoundingClientRect().left,a=t.getBoundingClientRect().top,r=t.getBoundingClientRect().height,c=i+s,d=r+a;let m=!1,p=!1;return c>n&&(m=!0),d>o&&(p=!0),{xOverflow:m,yOverflow:p}}function Ei(e){const t=e.displayText,n=e.optionalSVG,o=document.getElementById("MENUmodalBody");let i;"colour"in e?i=e.colour:(i="var(--text)",D()&&(i="var(--text)"));let s=new RegExp("\\{MENU_item_text\\}","g"),a=li.replace(s,t);if(s=new RegExp("\\{MENU_item_colour\\}","g"),a=a.replace(s,i),n!=="None"){s=new RegExp("\\{MENU_item_image\\}","g");const r="{"+n+"}";a=a.replace(s,r);for(const[c,d]of Object.entries(I)){const m=new RegExp(`\\{${c}\\}`,"g");a=a.replace(m,d)}o.innerHTML+=a;return}else{a=a.replace(/<img[^>]+>/g,""),o.innerHTML+=a;return}}function ht(e){const t=document.getElementById("MENUmodalEnvironment"),n=document.querySelector("main"),o=window.matchMedia("screen and (orientation: portrait) and (max-width: 768px) and (pointer: coarse) "),i=document.querySelector(".topHalf-container");if(e.target===t){t.style.display="none",o.matches&&(n.style.zIndex="1",i.style.zIndex="10");return}}function J(){const e=document.getElementById("MENUmodalEnvironment"),t=document.querySelector("main"),n=window.matchMedia("screen and (orientation: portrait) and (max-width: 768px) and (pointer: coarse) "),o=document.querySelector(".topHalf-container");e.style.display="none",n.matches&&(t.style.zIndex="1",o.style.zIndex="10"),_e&&_e.focus()}const yi={PROJECT_VIEW_delete_project(e){ti()},PLAYBACK_add_songs_to_queue(e){Gi(e)},SIGN_OUT_USER(e){Bo()},OPEN_SETTINGS_PAGE(e){G("/settings/")},PROJECT_VIEW_delete_song(e){ii(e)}};let F="hidden";function bi(){qn();const e=document.getElementById("queueButton"),t=document.getElementById("QUEUEclearQueueButton");Le(F),e.addEventListener("click",hi),t.addEventListener("click",Ti),$()}function hi(){if(F==="hidden"){F="visible",Le(F);return}if(F==="visible"){F="hidden",Le(F);return}}function Le(e){document.getElementById("queueButton");const t=document.getElementById("queueIcon"),n=document.getElementById("QUEUEenvironment");if(e=="visible"){t.style.filter="var(--make-svg-grey)",document.documentElement.style.cssText="--TOPRIGHT-accountcontrols-queue-opacity: 100%",n.style.right="0%",ot&&(t.style.filter="var(--make-svg-white)");return}if(e=="hidden"){t.style.filter="var(--make-svg-black)",document.documentElement.style.cssText="--TOPRIGHT-accountcontrols-queue-opacity: 0%",n.style.right="calc((var(--width-of-left-bar-fortop) + 5rem) * -1)";return}}function $(){const e=document.getElementById("QUEUEbottomContainer");e.innerHTML="";for(let t=_+1;t<u.length;t++){u[t].id=t;const n=u[t],o=Bi(n),i=document.createElement("div");i.innerHTML=o,i.addEventListener("click",function(r){r.target.dataset.songId}),i.dataset.songId=n.id,i.addEventListener("click",Oi),i.dataset.songId=n.id;const s=i.querySelector(".QUEUE-item-image-removeIndicator"),a=i.querySelector(".QUEUE-item-up-next-queue-item-context-call");s.addEventListener("click",Li),s.dataset.songID=n.id,a.dataset.songSet=n.id,a.addEventListener("click",function(r){r.target===a&&Pi(r)}),i.addEventListener("dragstart",Ii),i.addEventListener("dragover",wi),i.addEventListener("drop",Ci),e.appendChild(i)}}function Ti(){const e=_+1;e>=0&&e<u.length?u.splice(e):u.length=0,$()}function Ii(e){const t=e.target;e.dataTransfer.setData("text/plain",t.dataset.songId)}function wi(e){e.preventDefault(),e.dataTransfer.dropEffect="move"}function Ci(e){e.preventDefault();const t=e.dataTransfer.getData("text/plain"),n=e.target,o=u.find(r=>r.id===parseInt(t)),i=u.find(r=>r.id===parseInt(n.dataset.songId)),s=u.indexOf(o),a=u.indexOf(i);s!==-1&&a!==-1&&(u.splice(s,1),u.splice(a,0,o),S.splice(s,1),S.splice(a,0,o),$())}function Li(e){e.stopPropagation();const t=e.target,n=parseInt(t.dataset.songID),o=u.findIndex(i=>i.id===n);o!==-1&&(u.splice(o,1),S.splice(o,1)),$()}function Pi(e){e.stopPropagation();const o=[{displayText:"Play next",optionalSVG:"icons_playlist",function:"MENU_ACTION_playNext",optionalParams:{queueID:e.target.getAttribute("data-song-set")}},{displayText:"Play later",optionalSVG:"icons_backButton",function:"None"},{displayText:"Love",optionalSVG:"None",function:"None"},{displayText:"Less like this",optionalSVG:"None",function:"None"},{displayText:"Rate",optionalSVG:"None",function:"None"}];Y(o,e)}function Oi(e){}function Bi(e){const t=["QUEUE_item_image","QUEUE_item_title","QUEUE_item_artist","icons_menuOptionsButton","QUEUE_item_timeIndicator"],n=e.img,o=e.song_name,i=e.project_contributors,s=`${Math.floor(e.duration/60)}:${(e.duration%60).toString().padStart(2,"0")}`;let a=$n;for(let c=0;c<t.length;c++){const d=t[c].toString(),m=new RegExp(`\\{${d}\\}`,"g");let p="";d==="QUEUE_item_image"?p=`${T}/${n}/3`:d==="QUEUE_item_title"?p=o:d==="QUEUE_item_artist"?p=i:d==="icons_menuOptionsButton"?p=nt:d==="QUEUE_item_timeIndicator"&&(p=s),a=a.replace(m,p)}a=a.replace("<div",`<div data-song-id="${e.id}"`);const r=document.createElement("div");return r.querySelector(".QUEUE-item-image-removeIndicator"),r.innerHTML=a,r.innerHTML}const Mi=`<div class="LCDbody">
...
</div>`,rs=`<div class="SETTINGSmodalEnvironment" id="SETTINGSmodalID">
...
</div>`;function cs(){setTimeout(()=>{let e="MAINcontentPages",t=rs;document.getElementById(e).innerHTML+=t,document.getElementById("SETTINGSsignupForm").addEventListener("submit",ds)},1)}async function ds(e){console.log("the signup event was caught"),e.preventDefault(),ls();const t=document.getElementById("SETTINGSsignupForm"),n={};try{for(const i of t.elements)i.type==="email"&&(n[i.name]=i.value);const o=await fetch(`${O}/signup/`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(n)});if(o.ok){const i=await o.json();n.token=i.token;for(const a of t.elements)if(a.type==="file"){const r=a.files[0];if(r){const c=await convertImageToBase64(r);n[a.name]=c}}else n[a.name]=a.value;const s=await fetch(`${O}/signup/complete/`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(n)});if(s.ok){const a=await s.json();we(),us(),setTimeout(function(){console.log("signup very successful move to normal pages and stuff"),window.location.href="/"},2e3)}else{const a=await s.json();alert("There was an error, try again")}}else{const i=await o.json(),s="There was an error with the email, check that the details are correct.";we(),We(),alert(s)}}catch{we(),We(),alert("There was an error, try again")}}function ls(){const e=document.getElementById("spinner");e.style.display="block"}function we(){const e=document.getElementById("spinner");e.style.display="none"}function us(){const e=document.querySelector(".SETTINGSmodalStatusIndicatorOuterCircle");e.classList.remove("SETTINGSanimateError","SETTINGSanimateGreen"),e.classList.add("SETTINGSanimateGreen"),e.addEventListener("animationend",()=>{e.classList.remove("SETTINGSanimateGreen")})}function We(){const e=document.querySelector(".SETTINGSmodalStatusIndicatorOuterCircle");e.classList.remove("SETTINGSanimateError","SETTINGSanimateGreen"),e.classList.add("SETTINGSanimateError"),e.addEventListener("animationend",()=>{e.classList.remove("SETTINGSanimateError")})}let ue=!1,Xe=!1,Ze=!1,et=!1;async function ms(){await _s()?Ut():Xe||(ps(),Xe=!0)}function ps(){fs();const e=document.getElementById("SETTINGSmodalSignupButton");let t;fetch(`${O}/meta/are_signups_allowed`).then(s=>{if(!s.ok)throw new Error("Network response was not ok");return s.json()}).then(s=>{t=s.signups_allowed,t==="true"&&(e.style.display="inline-block",e.addEventListener("click",()=>{console.log("signup button was pressed"),tt(),cs()}))}).catch(s=>{console.error("Fetch error:",s)});const n=document.getElementById("SETTINGSloginForm"),o=document.getElementById("email"),i=document.getElementById("password");n.addEventListener("submit",async s=>{if(s.preventDefault(),ue)return!1;ue=!0;const a=o.value,r=i.value;try{await gs(a,r)?(et=!0,k("Login Successful","success"),Ut(),tt()):(et=!1,k("Error Logging In","error")),ue=!1}catch(c){console.error("Error:",c),ue=!1}return!1})}async function gs(e,t){try{return(await(await fetch(`${O}/users/login`,{method:"POST",headers:{"Content-Type":"application/json"},credentials:"include",body:JSON.stringify({email:e,password:t})})).json()).Authenticated===!0}catch(n){return n.toString()=="SyntaxError: Unexpected end of JSON input"?k("The server is down","error"):console.error(n),!1}}async function _s(){try{const e=await fetch(`${O}/users/prelogin`,{method:"GET",headers:{"Content-Type":"application/json"},credentials:"include"}),t=await e.json();return!e.ok&&e.status===401&&t.Authenticated==!1?!1:e.ok?e.ok&&t.Authenticated==!0?!0:e.ok?(console.log("The response was ok, but the correct data wasn't sent."),!1):(console.log("Catch all that shouldn't be needed."),!1):(console.log("There was an unknown error:",e),!1)}catch(e){e.toString()=="SyntaxError: Unexpected end of JSON input"&&k("The server is down","error")}}function fs(){let e="MAINcontentPages",t=as;document.getElementById(e).innerHTML+=t}function tt(){if(Ze===!0)return;Ze=!0;const e=document.getElementById("SETTINGSmodalID");try{e.remove()}catch{}}const O="/apis",T="/media";async function Ut(){Hi(),Jn(),Hn(),Si(),Wi(),ss(),os(),Lo(),bi(),Ao(),ro()}window.hasCodeRun||(ms(),window.hasCodeRun=!0);
