...
<p>You are not an admin user</p>`;function Fe(e,t,n){const o=document.getElementById(t);let i;o.addEventListener("touchstart",function(a){a.timeStamp,i=setTimeout(function(){s(a,e,n)},500)}),o.addEventListener("touchend",function(a){a.timeStamp,clearTimeout(i)}),o.addEventListener("dblclick",function(a){s(a,e,n)});function s(a,c,l){Wn(a,c,l)}}function Wn(e,t,n){e.target;const o={project_id:t};e.stopPropagation(),J(o,e,n)}const Xn=`<h1>General</h1>
...
</div>`;let fe;async function to(){const e=document.getElementById("TOPRIGHTaccountImg");try{const t=await ve("profile_picture"),n=`${w}/${t}/1`;fe=t;const o=document.getElementById("TOPRIGHTaccountImgButton");e.src=n,o.addEventListener("click",no)}catch(t){console.error("Error initializing account image:",t)}}function no(e){e.stopPropagation(),oo(e)}function oo(e){J([{displayText:"Help",optionalSVG:"icons_helpIcon",function:"None"},{displayText:"Settings",optionalSVG:"icons_settings",function:"OPEN_SETTINGS_PAGE"},{displayText:"Sign Out",optionalSVG:"None",function:"SIGN_OUT_USER"}],e)}async function io(){await Eo()}let Qe="general";const ae=[{name:"general",markup:Xn,button_id:"settings_button_general",function:ao},{name:"user",markup:Zn,button_id:"settings_button_user",function:co},{name:"admin",markup:Kn,button_id:"settings_button_admin",function:ro}];function so(){const e=document.getElementById("MAINcontentPages");let t=eo;for(const[i,s]of Object.entries(L)){const a=new RegExp(`\\{${i}\\}`,"g");t=t.replace(a,s)}e.innerHTML=t;const n=document.getElementById("settings_go_to_other_content_button");Le(Qe);for(var o=ae.length-1;o>=0;o--){const i=ae[o].button_id;document.getElementById(i).addEventListener("click",function(a){const c=a.srcElement.id,r=ae.find(m=>m.button_id===c).name;Le(r)})}n.addEventListener("click",function(){k("/")})}function ze(){const e=document.getElementById("MAINcontentPages");e.innerHTML=""}function Le(e){Qe=e;const t=["users_img"],n=document.getElementById("view_container"),o=ae.find(s=>s.name===e);let i=o.markup;for(const[s,a]of Object.entries(L)){const c=new RegExp(`\\{${s}\\}`,"g");i=i.replace(c,a)}for(let s=0;s<t.length;s++){const a=t[s].toString(),c=new RegExp(`\\{${a}\\}`,"g");let l="";a==="users_img"&&(l=`${w}/${fe}/4/`),i=i.replace(c,l)}n.innerHTML=i,o.function()}function ao(){}function co(){Fe("user-id","settings_views_user_pfp_img","update_user_pfp")}async function ro(){if((await ve("admin"))[0].admin!==!0)return;const n=["users_img"],o=document.getElementById("view_container");let i=Vn,s=[];for(const[r,m]of Object.entries(L)){const p=new RegExp(`\\{${r}\\}`,"g");i=i.replace(p,m)}for(let r=0;r<n.length;r++){const m=n[r].toString(),p=new RegExp(`\\{${m}\\}`,"g");let b="";m==="users_img"&&(b=`${w}/${fe}/4/`),i=i.replace(p,b)}o.innerHTML=i;const a=await vo(),c=document.getElementById("usersTableInforRowsContainer");c.innerHTML="";for(let r=0;r<a.length;r++){const m=["Username","Email","UUID","Verified","Space_Used","profile_picture_url","checkbox_number","Admin"],p=a[r].username,b=a[r].uuid,E=a[r].verified,d=a[r].email,_=a[r].admin,g=r;let h=a[r].storage_used;h=Je(h);let y=zn,O=a[r].profile_picture;O=`${w}/${O}/1/`;for(let P=0;P<m.length;P++){const f=m[P].toString(),I=new RegExp(`\\{${f}\\}`,"g");let C="";f==="Username"?C=p:f==="Email"?C=d:f==="UUID"?C=b:f==="Verified"?C=E:f==="Space_Used"?C=h:f==="profile_picture_url"?C=O:f==="checkbox_number"?C=g:f==="Admin"&&(C=_),y=y.replace(I,C)}c.innerHTML+=y}c.addEventListener("change",function(r){r.target&&r.target.type==="checkbox"&&l()});function l(){s=[];const m=c.querySelectorAll('input[type="checkbox"]'),p=[],b=document.getElementById("settings_admin_selected_items_visualition");m.forEach(function(E){if(E.checked){const g={id:E.id.replace("admin_users_table_check_box_",""),value:E.value};p.push(g)}}),p.forEach(function(E){const _=a[E.id].uuid;s.push(_)}),b.innerHTML=`Selected Items: ${s.length}`}}async function lo(){const e=await ve("last_state"),t=JSON.parse(e),n=new Map;setInterval(s,1e4);let o="";if(window.addEventListener("popstate",a),t!=null){const c=window.location.pathname;k(c),gi(t)}else a();function i(c){return JSON.stringify(c)}function s(){const c=window.location.pathname,l=u,r=v,m=yi();m.current_path=c,m.current_queue=l,m.current_index=r;const p=i(m);p!==o&&(_o("last_state",m),o=p,n.set("playback_states",p))}function a(){k(currentPath)}}function uo(){We(),ze(),qn()}function mo(e){$e(),ze(),Io(e)}function go(){$e(),We(),so()}const Pe={"/":uo,"/new-project/":fo,"/projects/:projectID":mo,"/settings/":go};function po(){const e=window.location.pathname,t=document.getElementById("MAINcontentPages");setTimeout(n,4e3),t.innerHTML+=`
    <br><br>
    <br><br>
    <br><br>    
...
</div>`;function Ni(){setTimeout(()=>{let e="MAINcontentPages",t=Ai;document.getElementById(e).innerHTML+=t,document.getElementById("SETTINGSsignupForm").addEventListener("submit",ki)},1)}async function ki(e){console.log("the signup event was caught"),e.preventDefault(),ji();const t=document.getElementById("SETTINGSsignupForm"),n={};try{for(const i of t.elements)i.type==="email"&&(n[i.name]=i.value);const o=await fetch(`${S}/signup/`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(n)});if(o.ok){const i=await o.json();n.token=i.token;for(const a of t.elements)if(a.type==="file"){const c=a.files[0];if(c){const l=await convertImageToBase64(c);n[a.name]=l}}else n[a.name]=a.value;const s=await fetch(`${S}/signup/complete/`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(n)});if(s.ok){const a=await s.json();ge(),Ui(),setTimeout(function(){console.log("signup very successful move to normal pages and stuff"),window.location.href="/"},2e3)}else{const a=await s.json();alert("There was an error, try again")}}else{const i=await o.json(),s="There was an error with the email, check that the details are correct.";ge(),De(),alert(s)}}catch{ge(),De(),alert("There was an error, try again")}}function ji(){const e=document.getElementById("spinner");e.style.display="block"}function ge(){const e=document.getElementById("spinner");e.style.display="none"}function Ui(){const e=document.querySelector(".SETTINGSmodalStatusIndicatorOuterCircle");e.classList.remove("SETTINGSanimateError","SETTINGSanimateGreen"),e.classList.add("SETTINGSanimateGreen"),e.addEventListener("animationend",()=>{e.classList.remove("SETTINGSanimateGreen")})}function De(){const e=document.querySelector(".SETTINGSmodalStatusIndicatorOuterCircle");e.classList.remove("SETTINGSanimateError","SETTINGSanimateGreen"),e.classList.add("SETTINGSanimateError"),e.addEventListener("animationend",()=>{e.classList.remove("SETTINGSanimateError")})}let se=!1,Ae=!1,Ne=!1,ke=!1;async function Gi(){await $i()?bt():Ae||(Ji(),Ae=!0)}function Ji(){qi();const e=document.getElementById("SETTINGSmodalSignupButton");let t;fetch(`${S}/meta/are_signups_allowed`).then(s=>{if(!s.ok)throw new Error("Network response was not ok");return s.json()}).then(s=>{t=s.signups_allowed,t==="true"&&(e.style.display="inline-block",e.addEventListener("click",()=>{console.log("signup button was pressed"),je(),Ni()}))}).catch(s=>{console.error("Fetch error:",s)});const n=document.getElementById("SETTINGSloginForm"),o=document.getElementById("email"),i=document.getElementById("password");n.addEventListener("submit",async s=>{if(s.preventDefault(),se)return!1;se=!0;const a=o.value,c=i.value;try{await Hi(a,c)?(ke=!0,Yi(),bt(),setTimeout(je,2e3)):(ke=!1,Fi(),console.log("Login failed. Retry!")),se=!1}catch(l){console.error("Error:",l),se=!1}return!1})}async function Hi(e,t){try{const o=await(await fetch(`${S}/users/login`,{method:"POST",headers:{"Content-Type":"application/json"},credentials:"include",body:JSON.stringify({email:e,password:t})})).json();if(o.Authenticated===!0){const i=o.jwt;localStorage.setItem("JWT",i)}return o.Authenticated}catch(n){return console.error(n),!1}}async function $i(){const e=await fetch(`${S}/users/prelogin`,{method:"GET",headers:{"Content-Type":"application/json"},credentials:"include"}),t=await e.json();return!e.ok&&e.status===401&&t.Authenticated==!1?!1:e.ok?e.ok&&t.Authenticated==!0?!0:e.ok?(console.log("The response was ok, but the correct data wasn't sent."),!1):(console.log("Catch all that shouldn't be needed."),!1):(console.log("There was an unknown error:",e),!1)}function qi(){let e="MAINcontentPages",t=Di;document.getElementById(e).innerHTML+=t}function je(){if(Ne===!0)return;Ne=!0;const e=document.getElementById("SETTINGSmodalID");try{e.remove()}catch{}}function Yi(){const e=document.querySelector(".SETTINGSmodalStatusIndicatorOuterCircle");e.classList.remove("SETTINGSanimateError","SETTINGSanimateGreen"),e.classList.add("SETTINGSanimateGreen"),e.addEventListener("animationend",()=>{e.classList.remove("SETTINGSanimateGreen")})}function Fi(){const e=document.querySelector(".SETTINGSmodalStatusIndicatorOuterCircle");e.classList.remove("SETTINGSanimateError","SETTINGSanimateGreen"),e.classList.add("SETTINGSanimateError"),e.addEventListener("animationend",()=>{e.classList.remove("SETTINGSanimateError")})}const Qi=`<!-- audio tag -->
...
-->`;const S="/apis",w="/media";async function bt(){fi(),In(),Cn(),si(),wi(),Ri(),Si(),to(),zo(),lo()}if(!window.hasCodeRun){let e=Qi;for(const[t,n]of Object.entries(L)){const o=new RegExp(`\\{${t}\\}`,"g");e=e.replace(o,n)}document.getElementById("app").innerHTML=e,Gi(),window.hasCodeRun=!0}
