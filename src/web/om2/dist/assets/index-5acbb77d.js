...
</button>`,fo=`<button tabindex="0" class="MOG-itemContainer" id="MOGI_itemContainer-{MOGI_placeholder_itemID}" draggable="false">
...
</details>`,Io=`<h1>Admin</h1>
<p>You are not an admin user</p>`;function pt(e,t,n){const o=document.getElementById(t);let i;o.addEventListener("touchstart",function(a){a.timeStamp,i=setTimeout(function(){s(a,e,n)},500)}),o.addEventListener("touchend",function(a){a.timeStamp,clearTimeout(i)}),o.addEventListener("dblclick",function(a){s(a,e,n)});function s(a,r,c){Co(a,r,c)}}function Co(e,t,n){e.target;const o={project_id:t};e.stopPropagation(),$(o,e,n)}const wo=`<h1>General</h1>
...
<br>
<p>Thank you for using OM2 <img style="filter: var(--make-svg-orange);" src="{icons_love}" height="20"></p>`,Lo=`<h1>User</h1>
...
</div>`;let Me;async function Oo(){const e=document.getElementById("TOPRIGHTaccountImg");try{const t=await xe("profile_picture"),n=`${I}/${t}/1`;Me=t;const o=document.getElementById("TOPRIGHTaccountImgButton");e.src=n,o.addEventListener("click",Bo)}catch(t){console.error("Error initializing account image:",t)}}function Bo(e){e.stopPropagation(),So(e)}function So(e){$([{displayText:"Help",optionalSVG:"icons_helpIcon",function:"None"},{displayText:"Settings",optionalSVG:"icons_settings",function:"OPEN_SETTINGS_PAGE"},{displayText:"Sign Out",optionalSVG:"None",function:"SIGN_OUT_USER"}],e)}async function Mo(){await $o()}let gt="general";const me=[{name:"general",markup:wo,button_id:"settings_button_general",function:Do},{name:"user",markup:Lo,button_id:"settings_button_user",function:Ro},{name:"admin",markup:Io,button_id:"settings_button_admin",function:Ao}];function xo(){const e=document.getElementById("MAINcontentPages");let t=Po;for(const[i,s]of Object.entries(C)){const a=new RegExp(`\\{${i}\\}`,"g");t=t.replace(a,s)}e.innerHTML=t;const n=document.getElementById("settings_go_to_other_content_button");qe(gt);for(var o=me.length-1;o>=0;o--){const i=me[o].button_id;document.getElementById(i).addEventListener("click",function(a){const r=a.srcElement.id,d=me.find(m=>m.button_id===r).name;qe(d)})}n.addEventListener("click",function(){G("/")})}function _t(){const e=document.getElementById("MAINcontentPages");e.innerHTML=""}function qe(e){gt=e;const t=["users_img"],n=document.getElementById("view_container"),o=me.find(s=>s.name===e);let i=o.markup;for(const[s,a]of Object.entries(C)){const r=new RegExp(`\\{${s}\\}`,"g");i=i.replace(r,a)}for(let s=0;s<t.length;s++){const a=t[s].toString(),r=new RegExp(`\\{${a}\\}`,"g");let c="";a==="users_img"&&(c=`${I}/${Me}/4/`),i=i.replace(r,c)}n.innerHTML=i,o.function()}function Do(){}function Ro(){pt("user-id","settings_views_user_pfp_img","update_user_pfp")}let X=[];async function Ao(){if(await xe("admin")!=="true")return;const t=["users_img"],n=document.getElementById("view_container");let o=To;for(const[s,a]of Object.entries(C)){const r=new RegExp(`\\{${s}\\}`,"g");o=o.replace(r,a)}for(let s=0;s<t.length;s++){const a=t[s].toString(),r=new RegExp(`\\{${a}\\}`,"g");let c="";a==="users_img"&&(c=`${I}/${Me}/4/`),o=o.replace(r,c)}n.innerHTML=o,ft(),document.getElementById("SETTINGS_ADMIN_UPDATE_COLUMN_submit_button").addEventListener("click",function(s){const a=document.getElementById("SETTINGS_ADMIN_UDPATE_COLUMN_column_to_updated"),r=document.getElementById("SETTINGS_ADMIN_UDPATE_COLUMN_new_data");if(a.value==""||r.value=="")U("Error Updating Column: empty inputs","error");else for(var c=X.length-1;c>=0;c--){const d=X[c];Yo(d,a.value,r.value)}})}let k;async function ft(){const e=await Ho();k=JSON.parse(e);const t=document.getElementById("usersTableInforRowsContainer");t.innerHTML="";for(let n=0;n<k.length;n++){const o=["Username","Email","UUID","Verified","Space_Used","Storage_Allowance","profile_picture_url","checkbox_number","Admin"],i=k[n].username,s=k[n].uuid,a=k[n].verified,r=k[n].email;let c=k[n].storage_allowance;c=Z(c);const d=k[n].admin,m=n;let p=k[n].storage_used;p=Z(p);let E=ho,y=k[n].profile_picture;y=`${I}/${y}/1/`;for(let u=0;u<o.length;u++){const g=o[u].toString(),b=new RegExp(`\\{${g}\\}`,"g");let v="";g==="Username"?v=i:g==="Email"?v=r:g==="UUID"?v=s:g==="Verified"?v=a:g==="Space_Used"?v=p:g==="Storage_Allowance"?v=c:g==="profile_picture_url"?v=y:g==="checkbox_number"?v=m:g==="Admin"&&(v=d),E=E.replace(b,v)}t.innerHTML+=E}t.addEventListener("change",function(n){n.target&&n.target.type==="checkbox"&&No()})}function No(){X=[];const t=usersTableEnvironment.querySelectorAll('input[type="checkbox"]'),n=[],o=document.getElementById("settings_admin_selected_items_visualition");t.forEach(function(i){if(i.checked){const r={id:i.id.replace("admin_users_table_check_box_",""),value:i.value};n.push(r)}}),n.forEach(function(i){const a=k[i.id].uuid;X.push(a)}),o.innerHTML=`Selected Items: ${X.length}`}async function jo(){const e=await xe("last_state"),t=JSON.parse(e),n=new Map;setInterval(s,1e4);let o=i(t);if(window.addEventListener("popstate",a),t!=null){const r=window.location.pathname;G(r),Hi(t)}else a();function i(r){return JSON.stringify(r)}function s(){const r=window.location.pathname,c=l,d=_,m=Ki();m.current_path=r,m.current_queue=c,m.current_index=d;const p=i(m);p!==o&&(Jo("last_state",m),o=p,n.set("playback_states",p))}function a(){G(currentPath)}}function Uo(){yt(),_t(),vo()}function ko(e){lt(),_t(),Ko(e)}function He(){lt(),yt(),xo()}const Ye={"/":Uo,"/new-project/":le,"/new-project":le,"/new/":le,"/new":le,"/projects/:projectID":ko,"/settings/":He,"/settings":He};function Go(){const e=window.location.pathname,t=document.getElementById("MAINcontentPages");setTimeout(n,4e3),t.innerHTML+=`
    <br><br>
    <br><br>
    <br><br>    
...
</div>`,Vo=`<div class="PROJECTview-projectTable-rowContainer" data-row-id="{PROJECTviewRow_projectID}" draggable="{PROJECTviewRow_contentEditable}" style="user-select: auto; pointer-events: auto;">
...
</div>`,x=[];let pe=!1,Qe=!0,f,Ee=!1;async function Ko(e){let t;Ee=!0,st()==!0?t={ProjectName:"..",ProjectContributors:"...",TimeCreated:0,PictureURL:"static/loading_img_text_dark"}:t={ProjectName:"..",ProjectContributors:"...",TimeCreated:0,PictureURL:"static/loading_img_text_light"},Xo(t),Oe("","blank"),sessionStorage.setItem("description","."),Ve(),document.getElementById("PROJECTviewMobileStickyHeaderBackButton").addEventListener("click",()=>{G("/")});const o=await ve(e);if(o=="")console.log(o);else{const s=JSON.parse(o);s.ProjectID=e,f=s,i(),Wo()}function i(){Be(),sessionStorage.setItem("description",f.Description),Ve(),Zo(),ti(),ni(),oi(),bt(),pi(),Tt(f.ProjectName),pt(f.ProjectID,"PROJECTviewDisplayImage","update_project_image"),ui(),Oe(f,"full")}}function yt(){const e=document.getElementById("MAINcontentPages");e.innerHTML="",Ee=!1}async function ye(){if(!Ee)return;const e=f.ProjectID,t=await ve(e);if(t!=""){const n=JSON.parse(t);n.ProjectID=e,f=n,bt();const o=document.getElementById("PROJECTviewDisplayImage_imgTag"),i=`${I}/${f.PictureURL}/5`;o.src=i,Oe(f,"full")}}function Be(){const e=document.getElementById("PROJECTviewDisplayTitleH1"),t=document.getElementById("PROJECTviewDisplayTitleH3"),n=document.getElementById("PROJECTviewDisplayImage_imgTag"),o=document.getElementById("PROJECTVIEW_DESCRIPTION_more_title"),i=document.getElementById("PROJECTVIEW_DESCRIPTION_more_artist_year"),s=`${I}/${f.PictureURL}/5`;e.innerText=f.ProjectName,t.innerText=f.ProjectContributors,n.src=s,o.innerText=f.ProjectName,i.innerText=`${f.ProjectContributors} | ${at(f.TimeCreated)}`}function Wo(){const e=document.getElementById("PROJECTviewDisplayTitleH1"),t=document.getElementById("PROJECTviewDisplayTitleH3");let n=document.getElementById("PROJECTviewDisplayTitleH1").innerText,o=document.getElementById("PROJECTviewDisplayTitleH3").innerText;e.addEventListener("blur",function(i){const s=e.innerText;s!==n&&(Tt(s),te(f.ProjectID,"project_name",s),f.ProjectName=s,Be())}),t.addEventListener("blur",function(i){const s=t.innerText;s!==o&&(te(f.ProjectID,"project_contributors",s),f.ProjectContributors=s,Be())})}function Xo(e){let t="MAINcontentPages",n=zo;for(const[i,s]of Object.entries(C)){const a=new RegExp(`\\{${i}\\}`,"g");n=n.replace(a,s)}const o=["PROJECTviewMOREtitle","PROJECTviewMOREartist","PROJECTviewMOREyear","PROJECTviewDisplayImage"];for(let i=0;i<o.length;i++){const s=o[i].toString(),a=new RegExp(`\\{${s}\\}`,"g");let r="";s==="PROJECTviewMOREtitle"?r=e.ProjectName:s==="PROJECTviewMOREartist"?r=e.ProjectContributors:s==="PROJECTviewMOREyear"?r=at(e.TimeCreated):s==="MOG_checkedDate"?r="checkedIndicator":s==="MOGI_placeholder_itemID"?r="temporaryIidentifier":s==="PROJECTviewDisplayImage"&&(r=`${I}/${e.PictureURL}/5`),n=n.replace(a,r)}document.getElementById(t).innerHTML=n}function Ve(){let e=sessionStorage.getItem("description");const t=document.getElementById("PROJECTviewDescriptionP");t.innerText=e}function Zo(){const e=document.getElementById("PROJECTviewDescriptionMoreButton"),t=document.getElementById("PROJECTviewDisplayDescription"),n=document.getElementById("PROJECTviewMOREdescriptionboxEnvironment"),o=document.querySelector("main");function i(){n.style.display="grid",D()&&(o.style.zIndex="40")}e.addEventListener("click",function(){i()}),t.addEventListener("dblclick",function(){i()});let s=0;t.addEventListener("touchend",function(a){const r=new Date().getTime();r-s<300&&(a.stopPropagation(),i()),s=r})}function ei(){const e=sessionStorage.getItem("description"),t=document.getElementById("PROJECTviewDescriptionP");t.innerText=e}function ti(){const e=sessionStorage.getItem("description");document.getElementById("PROJECTviewMOREdescriptionC");const t=document.getElementById("PROJECTviewMOREdescriptionP");t.innerText=e}function ni(){const e=document.getElementById("PROJECTviewMOREcloseButton"),t=document.getElementById("PROJECTviewMOREdescriptionboxEnvironment");e.addEventListener("click",function(){ze(f)}),t.addEventListener("click",function(n){n.target===t&&ze(f)})}function ze(e){const n=document.getElementById("PROJECTviewMOREdescriptionP").value,o=document.getElementById("PROJECTviewMOREdescriptionboxEnvironment"),i=document.querySelector("main");sessionStorage.setItem("description",n),te(e.ProjectID,"description",n),o.style.display="none",ei(),i.style.zIndex=""}async function oi(){const e=document.getElementById("PROJECTviewDescriptionTopPlayButton"),t=document.getElementById("PROJECTviewDescriptionTopShuffleButton"),n=document.getElementById("PROJECTviewDisplayMenuButton"),o=document.getElementById("PROJECTviewMobileStickyHeaderMenuButton");e.addEventListener("click",function(){Bt(f)}),t.addEventListener("click",function(){qi(f)}),n.addEventListener("click",function(){Ke(event)}),o.addEventListener("click",function(){Ke(event)})}function Ke(e){e.stopPropagation(),e.target;const t=f.ProjectID;let n;n=[{displayText:"Play next",optionalSVG:"icons_playlist",optionalParams:{PROJECT_ID:t,QUEUE_POSITION:"next"},function:"PLAYBACK_add_songs_to_queue"},{displayText:"Play later",optionalSVG:"icons_playlist",optionalParams:{PROJECT_ID:t,QUEUE_POSITION:"later"},function:"PLAYBACK_add_songs_to_queue"},{displayText:"Delete",optionalSVG:"None",function:"PROJECT_VIEW_delete_project",optionalParams:{PROJECT_ID:t},colour:"var(--whoopsie)"}],$(n,e)}async function ii(e){const t=`Are you sure that you want to delete <em><b>${f.ProjectName}</b></em>? This action is not reversable.`,n=await Et(t);if(n==="cancel")q();else if(n==="delete"){const o="/";await si(),q(),G(o)}else q()}async function si(e){const t=f.ProjectID;try{const o=await(await fetch(`${B}/projects/delete_project/${t}`,{method:"DELETE",headers:{"Content-Type":"application/json"},credentials:"include"})).json()}catch(n){console.error("Error:",n)}}function bt(){const e=document.getElementById("PROJECTview-projectTable");e!==null&&e.remove(),document.getElementById("PROJECTview_projectAreaContainer"),di();const t=document.getElementById("PROJECTview-projectTable"),n=f.ProjectJSON,o=to("--orange"),i=u=>`#${u.match(/^rgb\((\d+),\s*(\d+),\s*(\d+)\)$/).slice(1).map(g=>parseInt(g,10).toString(16).padStart(2,"0")).join("")}`;let s;if(n==null)return;const a=[];if(n)for(const u of n)a.push({img:f.PictureURL,songTitle:u.SongName,artistName:f.ProjectContributors,projectName:Z(u.FolderSize),songDuration:`${Math.floor(u.Duration/60)}:${(u.Duration%60).toString().padStart(2,"0")}`,songSequence:u.SongSequence,version:u.Version,url:u.URL});for(let u=0;u<a.length;u++){a[u].ProjectID=u;const g=a[u],b=li(g);t.insertAdjacentHTML("beforeend",b);const v=t.lastElementChild;v.addEventListener("dragstart",r),v.addEventListener("dragover",d),v.addEventListener("drop",m)}function r(u){u.dataTransfer.setData("text/plain",u.target.dataset.rowId),u.dataTransfer.getData("text/plain"),s=u.srcElement,Kn(u.srcElement)}const c=Wn(Xn,0);function d(u){u.preventDefault(),u.dataTransfer.dropEffect="move";const g=u.target.closest(".PROJECTview-projectTable-rowContainer");if(g!==s){const b=getComputedStyle(g).backgroundColor,v=i(b);c(g,v,o)}}function m(u){u.preventDefault(),s.style,s.style.backgroundColor="yellow !important";const g=u.dataTransfer.getData("text/plain"),b=document.querySelector(`[data-row-id="${g}"]`),v=u.target.closest(".PROJECTview-projectTable-rowContainer");if(v){const T=v.getAttribute("data-row-id");v.before(b);const N=`${g}|${T}`;setTimeout(async()=>{await te(f.ProjectID,"SongsTableChangeSongSequenceOrder",N),ye()},1)}}t.addEventListener("click",function(u){const g=u.target;if(u.stopPropagation(),g.tagName==="BUTTON"){const b=g.closest(".PROJECTview-projectTable-rowContainer");b&&(b.getAttribute("data-row-id"),ai(u))}});const p=t.querySelectorAll("[contenteditable]"),E=[],y=u=>{const b=u.target.closest(".PROJECTview-projectTable-rowContainer").getAttribute("data-row-id"),v=u.target.textContent,T=E.find(L=>L.dataRowIDField===b);if((T?T.currentText:"Row ID not found")==v)return;for(var S=E.length-1;S>=0;S--)E[S].dataRowIDField===b&&(E[S].currentText=v);const w=`${b}-${v}`;te(f.ProjectID,"project_song_title",w)};p.forEach(u=>{u.addEventListener("blur",y),E.push({dataRowIDField:u.parentElement.parentElement.getAttribute("data-row-id"),currentText:u.innerText})})}function ai(e){e.stopPropagation();const t=e.target,n=t.parentElement.parentElement.getAttribute("data-row-id"),o=t.parentElement.parentElement.firstElementChild.lastElementChild.innerText;let i;i=[{displayText:"Play Next",optionalSVG:"icons_playlist",function:"PROJECT_VIEW_add_song_to_queue",optionalParams:{songID:n,queuePosition:"next"}},{displayText:"Play Later",optionalSVG:"icons_playlist",function:"PROJECT_VIEW_add_song_to_queue",optionalParams:{songID:n,queuePosition:"later"}},{displayText:"Delete",optionalSVG:"None",function:"PROJECT_VIEW_delete_song",optionalParams:{songID:n,songName:o},colour:"var(--whoopsie)"}],$(i,e)}function ri(e){const n=e.songID.split("-")[0],o=e.queuePosition;let i=f;const s=i.ProjectJSON[n-1];i.ProjectJSON=[],i.ProjectJSON[0]=s,$i(i,o)}async function ci(e){const t=`Are you sure that you want to delete <em><strong>${e.songName}</strong></em>? This action is not reversable.`,n=await Et(t);n==="cancel"||(n==="delete"?(await qo(f.ProjectID,e.songID),q(),ye()):console.error("a statement was returned that isn't valid"))}function di(){let e="PROJECTview_projectAreaContainer",t=Qo;for(const[n,o]of Object.entries(C)){const i=new RegExp(`\\{${n}\\}`,"g");t=t.replace(i,o)}document.getElementById(e).innerHTML+=t}function li(e){let t=Vo;for(const[o,i]of Object.entries(C)){const s=new RegExp(`\\{${o}\\}`,"g");t=t.replace(s,i)}const n=["PROJECTviewRow_img","PROJECTviewRow_songTitle","PROJECTviewRow_artistName","PROJECTviewRow_projectName","PROJECTviewRow_songDuration","PROJECTviewRow_projectID","PROJECTviewRow_contentEditable"];for(let o=0;o<n.length;o++){const i=n[o].toString(),s=new RegExp(`\\{${i}\\}`,"g");let a="";i==="PROJECTviewRow_img"?a=`${I}/${e.img}/3`:i==="PROJECTviewRow_songTitle"?a=e.songTitle:i==="PROJECTviewRow_artistName"?a=e.artistName:i==="PROJECTviewRow_projectName"?a=e.projectName:i==="PROJECTviewRow_songDuration"?a=e.songDuration:i==="PROJECTviewRow_projectID"?a=`${e.songSequence}-${e.version}`:i==="PROJECTviewRow_contentEditable"&&Qe===!0?a=!0:i==="PROJECTviewRow_contentEditable"&&Qe===!1&&(a=!1),t=t.replace(s,a)}return t}function ui(){const e=document.getElementById("PROJECTview_dropArea");document.getElementById("PROJECTview_dropArea_submit_button"),e.addEventListener("dragenter",o=>{o.preventDefault(),e.classList.add("dragover")}),e.addEventListener("dragover",o=>{o.preventDefault()}),e.addEventListener("dragleave",()=>{e.classList.remove("dragover")}),e.addEventListener("drop",o=>{o.preventDefault(),e.classList.remove("dragover");const i=o.dataTransfer.files;n(i)});let t=[];e.addEventListener("click",o=>{const i=o.target.id,s=document.createElement("input");i!=="PROJECTview_dropArea_submit_button"?(s.type="file",s.accept="audio/*",s.multiple=!0,s.addEventListener("change",()=>{t=s.files}),s.click()):n(t)});function n(o,i){mi(o)}}async function ht(e,t){const n=new FormData,o=new XMLHttpRequest;pe=!0,uo(),n.append("file",e),n.append("project_id",t),o.upload.onprogress=function(i){if(i.lengthComputable){const s=i.loaded/i.total*100;de(s),s===100&&de(s)}},o.onload=async function(){if(o.responseText=="StorageLimit Reached"){U("Storage limit reached","error");for(var s=x.length-1;s>=0;s--)x.shift();pe=!1,je(),de(0)}if(pe=!1,x.shift(),je(),de(0),x.length>0){const a=x[0];await ht(a.file,a.ProjectID)}f.ProjectID==t&&Ee==!0&&ye()},o.onerror=function(){U("Upload Failed","error")},o.open("POST",`${B}/files/upload_audio/${t}`,!0),o.send(n)}async function mi(e,t){document.getElementById("uploadsContainer");for(const n of e){const o={ProjectID:f.ProjectID,file:n};if(x.push(o),!pe){const i=x[0];await ht(i.file,i.ProjectID)}}}function Tt(e){const t=document.getElementById("PROJECTviewMobileStickyHeaderProjectNameContainer");t.innerText=e}function pi(){const e=new IntersectionObserver(i,{threshold:.1}),t=document.querySelector(".PROJECTviewDisplayImage"),n=document.getElementById("PROJECTviewMobileStickyHeader"),o=document.getElementById("PROJECTviewMobileStickyHeaderProjectNameContainer");e.observe(t);function i(s,a){s.forEach(r=>{r.isIntersecting&&D()?(n.style.backdropFilter="none",n.style.backgroundColor="transparent",o.style.visibility="hidden"):r.isIntersecting&&!D()||!r.isIntersecting&&!D()?(n.style.backdropFilter="var(--PROJECTviewDesktopHeaderFilter)",o.style.visibility="hidden"):!r.isIntersecting&&D()&&(n.style.backdropFilter="blur(15px)",n.style.backgroundColor="var(--background-transparent)",o.style.visibility="visible")})}}const gi=`<button class="MENUmodalItemContainer" tabindex="0">
    <div class="MENUmodalTextArranger" style="color: {MENU_item_colour}">{MENU_item_text}</div>
    <div class="MENUmodalSVGcontainer">
        <img src="{MENU_item_image}" class="MENUmodalSVG">
    </div>
</button>`;async function _i(e,t,n){const o=new XMLHttpRequest,i=new FormData;i.append("file",e),o.upload.onprogress=function(s){s.lengthComputable&&s.loaded/s.total*100},o.onload=function(){o.status>=200&&o.status<300?(o.responseText=="StorageLimit Reached"&&U("Storage limit reached","error"),n!=="update_user_pfp"?bi():(hi(),location.reload())):console.error("Error during upload. Status:",o.status,"Response:",o.responseText)},o.onerror=function(){console.log("there was an error with the upload")},o.open("POST",`${B}/files/upload_photo?pi=${t}&mt=${n}`,!0),o.send(i)}async function fi(e,t,n){Array.isArray(e)||(e=[e]);for(const o of e)await _i(o,t,n)}const vi=`<div class="MENUmodalBody" id="MENUmodalBody">
</div>`;let _e,Y=!1;function $(e,t,n){n===void 0?yi(e,t):n!==void 0&&n==="update_project_image"?We(e,t,"update_project_image"):n!==void 0&&n==="update_user_pfp"?We(e,t,"update_user_pfp"):n!==void 0&&n==="lcd_mobile_body"?Ei():console.log("invalid menu display inputs")}function Ei(e){const t=document.querySelector("main"),n=document.querySelector(".topHalf-container"),o=document.getElementById("MENUmodalEnvironment");let i=ao;const s=document.getElementById("audio"),a=["LCD_mobile_body_container_l2","LCD_mobile_body_img","LCD_mobile_body_title_area_container","LCD_mobile_body_song_title","LCD_mobile_body_artist_title","LCD_mobile_body_progress_bar","LCD_mobile_body_menu","LCD_mobile_body_queue_container","LCD_mobile_body_secondary_seek_indicator"];let r=0,c=0;D()&&(t.style.zIndex="40",n.style.zIndex="0");for(const[O,A]of Object.entries(C)){const j=new RegExp(`\\{${O}\\}`,"g");i=i.replace(j,A)}o.style.display="block",o.innerHTML=i;const d=document.getElementById("LCD_mobile_body_song_title"),m=document.getElementById("LCD_mobile_body_artist_title"),p=document.getElementById("LCD_mobile_body_img"),E=s.duration,u=s.currentTime/E*100,g=document.getElementById("LCDMB_seek_input"),b=document.getElementById("LCDMB_seek_indicator");document.getElementById("LCDMB_menu_button");const v=document.getElementById("LCDMB_back"),T=document.getElementById("LCDMB_play"),N=document.getElementById("LCDMB_play_icon"),S=document.getElementById("LCDMB_next"),w=document.getElementById("LCDMB_queue_button");s.addEventListener("ended",()=>{L(),Y===!0&&J()}),L(),R(),b.style.width=`${u}%`,s.addEventListener("timeupdate",()=>{const O=s.duration,j=s.currentTime/O*100;b.style.width=`${j}%`}),g.addEventListener("input",function(){const O=s.duration,A=g.value;s.currentTime=O*(A/100)}),v.addEventListener("click",()=>{Mt(),L(),Y===!0&&J()}),T.addEventListener("click",()=>{he(),L(),R()}),S.addEventListener("click",()=>{St(),L(),Y===!0&&J()}),w.addEventListener("click",()=>{Y===!1?(De(),Y=!0):(Re(),Y=!1)}),Y===!0?De():Re(),o.addEventListener("touchstart",oe,!1),o.addEventListener("touchmove",ie,!1),o.addEventListener("touchend",se,!1);function L(){p.src=Lt,d.innerText=Pt,m.innerText=Ot}function R(){s.paused?N.src=C.icons_playButtonV2:N.src=C.icons_derpy}function J(){const O=document.getElementById("LCD_mobile_queue_content_container");O.innerHTML="";for(let A=_+1;A<l.length;A++){const j=l[A],ae=["queue_item_img","queue_item_song_name","queue_item_song_artist","icons_menuOptionsButton","QUEUE_item_timeIndicator"],W=j.img,Jt=j.song_name,qt=j.project_contributors;let Te=so;for(let Ie=0;Ie<ae.length;Ie++){const re=ae[Ie].toString(),Ht=new RegExp(`\\{${re}\\}`,"g");let ce="";re==="queue_item_img"?ce=`${I}/${W}/3`:re==="queue_item_song_name"?ce=Jt:re==="queue_item_song_artist"&&(ce=qt),Te=Te.replace(Ht,ce)}O.innerHTML+=Te}}function De(){function O(A){A.forEach(j=>{document.querySelectorAll("."+j).forEach(W=>{W.classList.add("queue_visible")})})}O(a),o.removeEventListener("touchstart",oe),o.removeEventListener("touchmove",ie),o.removeEventListener("touchend",se),J()}function Re(){function O(A){A.forEach(j=>{document.querySelectorAll("."+j).forEach(W=>{W.classList.remove("queue_visible")})})}O(a),o.addEventListener("touchstart",oe,!1),o.addEventListener("touchmove",ie,!1),o.addEventListener("touchend",se,!1)}function oe(O){Y===!1&&(r=O.touches[0].clientY)}function ie(O){O.preventDefault()}function se(O){c=O.changedTouches[0].clientY,c-r>70&&(q(),o.removeEventListener("touchstart",oe),o.removeEventListener("touchmove",ie),o.removeEventListener("touchend",se))}}function yi(e,t){_e=document.activeElement;let n=t.clientX,o=t.clientY;const i=document.querySelector("main"),s=document.querySelector(".topHalf-container");D()&&(i.style.zIndex="40",s.style.zIndex="0");const a=document.getElementById("MENUmodalEnvironment");a.innerHTML=vi,a.style.display="block";const r=document.getElementById("MENUmodalBody");let c=n+"px",d=o+"px";a.addEventListener("click",Ct),r.style.left=c,r.style.top=d;let m="mouse";if(t.webkitForce==1||t.webkitForce==0?t.webkitForce==0&&(m="keyboard"):t.pointerType!=="mouse"&&(m="keyboard"),m=="keyboard"){const T=_e.getBoundingClientRect();n=T.left+window.scrollX,o=T.top+window.scrollY;let N=n+"px",S=o+"px";r.style.left=N,r.style.top=S}for(let T=0;T<e.length;T++)Ti(e[T]);const E=r.children[0],y=r.offsetWidth,u=r.offsetHeight,g=It("MENUmodalBody"),b=r.getElementsByClassName("MENUmodalItemContainer");m==="keyboard"&&!D()?E.focus():m=="mouse"&&!D()&&(E.focus(),E.blur()),document.addEventListener("keydown",v),g.xOverflow==!0&&(c=n-y+"px",r.style.left=c),g.yOverflow==!0&&(d=o-u+"px",r.style.top=d);for(let T=0;T<b.length;T++){const N=b[T];N.setAttribute("data-menu-item-id",T),N.addEventListener("click",function(S){S.stopPropagation();const L=S.target.getAttribute("data-menu-item-id"),R=e[L].function,J=e[L].optionalParams;if(R=="TEST")console.log("the button worked",J);else if(R!="None"){Ii[R](J);return}else return})}function v(T){(T.key==="Escape"||T.keyCode===27)&&(document.removeEventListener("keydown",v),q())}}function We(e,t,n){const o=t.clientX,i=t.clientY,s=document.querySelector("main"),a=document.querySelector(".topHalf-container"),r=document.getElementById("MENUmodalEnvironment");let c=o+"px",d=i+"px";D()&&(s.style.zIndex="40",a.style.zIndex="0"),e.MenuType=n,s.style.zIndex="2",r.innerHTML=io,r.style.display="block",r.addEventListener("click",Ct);const m=document.getElementById("MENUmodalBody"),p=document.getElementById("MENUmodalBody_image_select_file_drop_area"),E=document.getElementById("MENUmodalBody_image_select_file_select_button"),y=document.getElementById("MENUmodalBody_image_select_preview_area"),u=document.getElementById("MENUmodalBody_image_select_submit_button"),g=document.getElementById("MENUmodalBody_image_select_submit_button_container");m.style.left=c,m.style.top=d;let b,v;function T(w,L){return function(){const R=this,J=arguments;clearTimeout(v),v=setTimeout(()=>{w.apply(R,J)},L)}}function N(w,L,R){T(fi,100)(w,L,R)}function S(w){if(b){const L=URL.createObjectURL(b),R=document.getElementById("MENUmodalBody_image_submit_area_loader_spinner");y.src=L,u.style.visibility="visible",g.style.outline="3px solid var(--primary)",u.addEventListener("click",()=>{N(b,w.project_id,w.MenuType),R.style.visibility="visible"})}else console.log("No file selected.")}p.addEventListener("dragover",w=>{w.preventDefault()}),p.addEventListener("drop",w=>{w.preventDefault(),b=w.dataTransfer.files[0],S(e)}),E.addEventListener("click",()=>{const w=document.createElement("input");w.type="file",w.accept="image/*",w.addEventListener("change",L=>{b=L.target.files[0],S(e)}),w.click()})}function bi(){const e=document.getElementById("MENUmodalBody_image_submit_area_loader_spinner");e.style.visibility="hidden",q(),ye()}function hi(){const e=document.getElementById("MENUmodalBody_image_submit_area_loader_spinner");e.style.visibility="hidden",q()}function It(e){const t=document.getElementById(e),n=document.documentElement.clientWidth,o=document.documentElement.clientHeight,i=t.offsetWidth,s=t.getBoundingClientRect().left,a=t.getBoundingClientRect().top,r=t.getBoundingClientRect().height,c=i+s,d=r+a;let m=!1,p=!1;return c>n&&(m=!0),d>o&&(p=!0),{xOverflow:m,yOverflow:p}}function Ti(e){const t=e.displayText,n=e.optionalSVG,o=document.getElementById("MENUmodalBody");let i;"colour"in e?i=e.colour:(i="var(--text)",D()&&(i="var(--text)"));let s=new RegExp("\\{MENU_item_text\\}","g"),a=gi.replace(s,t);if(s=new RegExp("\\{MENU_item_colour\\}","g"),a=a.replace(s,i),n!=="None"){s=new RegExp("\\{MENU_item_image\\}","g");const r="{"+n+"}";a=a.replace(s,r);for(const[c,d]of Object.entries(C)){const m=new RegExp(`\\{${c}\\}`,"g");a=a.replace(m,d)}o.innerHTML+=a;return}else{a=a.replace(/<img[^>]+>/g,""),o.innerHTML+=a;return}}function Ct(e){const t=document.getElementById("MENUmodalEnvironment"),n=document.querySelector("main"),o=window.matchMedia("screen and (orientation: portrait) and (max-width: 768px) and (pointer: coarse) "),i=document.querySelector(".topHalf-container");if(e.target===t){t.style.display="none",o.matches&&(n.style.zIndex="1",i.style.zIndex="10");return}}function q(){const e=document.getElementById("MENUmodalEnvironment"),t=document.querySelector("main"),n=window.matchMedia("screen and (orientation: portrait) and (max-width: 768px) and (pointer: coarse) "),o=document.querySelector(".topHalf-container");e.style.display="none",n.matches&&(t.style.zIndex="1",o.style.zIndex="10"),_e&&_e.focus()}const Ii={PROJECT_VIEW_delete_project(e){ii()},PLAYBACK_add_songs_to_queue(e){Yi(e)},SIGN_OUT_USER(e){Mo()},OPEN_SETTINGS_PAGE(e){G("/settings/")},PROJECT_VIEW_delete_song(e){ci(e)},PROJECT_VIEW_add_song_to_queue(e){ri(e)}};let F="hidden";function Ci(){Fn();const e=document.getElementById("queueButton"),t=document.getElementById("QUEUEclearQueueButton");Se(F),e.addEventListener("click",wi),t.addEventListener("click",Li),H()}function wi(){if(F==="hidden"){F="visible",Se(F);return}if(F==="visible"){F="hidden",Se(F);return}}function Se(e){document.getElementById("queueButton");const t=document.getElementById("queueIcon"),n=document.getElementById("QUEUEenvironment");if(e=="visible"){t.style.filter="var(--make-svg-grey)",document.documentElement.style.cssText="--TOPRIGHT-accountcontrols-queue-opacity: 100%",n.style.right="0%",st&&(t.style.filter="var(--make-svg-white)");return}if(e=="hidden"){t.style.filter="var(--make-svg-black)",document.documentElement.style.cssText="--TOPRIGHT-accountcontrols-queue-opacity: 0%",n.style.right="calc((var(--width-of-left-bar-fortop) + 5rem) * -1)";return}}function H(){const e=document.getElementById("QUEUEbottomContainer");e.innerHTML="";for(let t=_+1;t<l.length;t++){l[t].id=t;const n=l[t],o=Di(n),i=document.createElement("div");i.innerHTML=o,i.addEventListener("click",function(r){r.target.dataset.songId}),i.dataset.songId=n.id,i.addEventListener("click",xi),i.dataset.songId=n.id;const s=i.querySelector(".QUEUE-item-image-removeIndicator"),a=i.querySelector(".QUEUE-item-up-next-queue-item-context-call");s.addEventListener("click",Si),s.dataset.songID=n.id,a.dataset.songSet=n.id,a.addEventListener("click",function(r){r.target===a&&Mi(r)}),i.addEventListener("dragstart",Pi),i.addEventListener("dragover",Oi),i.addEventListener("drop",Bi),e.appendChild(i)}}function Li(){const e=_+1;e>=0&&e<l.length?l.splice(e):l.length=0,H()}function Pi(e){const t=e.target;e.dataTransfer.setData("text/plain",t.dataset.songId)}function Oi(e){e.preventDefault(),e.dataTransfer.dropEffect="move"}function Bi(e){e.preventDefault();const t=e.dataTransfer.getData("text/plain"),n=e.target,o=l.find(r=>r.id===parseInt(t)),i=l.find(r=>r.id===parseInt(n.dataset.songId)),s=l.indexOf(o),a=l.indexOf(i);s!==-1&&a!==-1&&(l.splice(s,1),l.splice(a,0,o),h.splice(s,1),h.splice(a,0,o),H())}function Si(e){e.stopPropagation();const t=e.target,n=parseInt(t.dataset.songID),o=l.findIndex(i=>i.id===n);o!==-1&&(l.splice(o,1),h.splice(o,1)),H()}function Mi(e){e.stopPropagation();const o=[{displayText:"Play next",optionalSVG:"icons_playlist",function:"MENU_ACTION_playNext",optionalParams:{queueID:e.target.getAttribute("data-song-set")}},{displayText:"Play later",optionalSVG:"icons_backButton",function:"None"},{displayText:"Love",optionalSVG:"None",function:"None"},{displayText:"Less like this",optionalSVG:"None",function:"None"},{displayText:"Rate",optionalSVG:"None",function:"None"}];$(o,e)}function xi(e){}function Di(e){const t=["QUEUE_item_image","QUEUE_item_title","QUEUE_item_artist","icons_menuOptionsButton","QUEUE_item_timeIndicator"],n=e.img,o=e.song_name,i=e.project_contributors,s=`${Math.floor(e.duration/60)}:${(e.duration%60).toString().padStart(2,"0")}`;let a=Qn;for(let c=0;c<t.length;c++){const d=t[c].toString(),m=new RegExp(`\\{${d}\\}`,"g");let p="";d==="QUEUE_item_image"?p=`${I}/${n}/3`:d==="QUEUE_item_title"?p=o:d==="QUEUE_item_artist"?p=i:d==="icons_menuOptionsButton"?p=it:d==="QUEUE_item_timeIndicator"&&(p=s),a=a.replace(m,p)}a=a.replace("<div",`<div data-song-id="${e.id}"`);const r=document.createElement("div");return r.querySelector(".QUEUE-item-image-removeIndicator"),r.innerHTML=a,r.innerHTML}const Ri=`<div class="LCDbody">
...
</div>`,ms=`<div class="SETTINGSmodalEnvironment" id="SETTINGSmodalID">
...
</div>`;function ps(){setTimeout(()=>{let e="MAINcontentPages",t=ms;document.getElementById(e).innerHTML+=t,document.getElementById("SETTINGSsignupForm").addEventListener("submit",gs)},1)}async function gs(e){console.log("the signup event was caught"),e.preventDefault(),_s();const t=document.getElementById("SETTINGSsignupForm"),n={};try{for(const i of t.elements)i.type==="email"&&(n[i.name]=i.value);const o=await fetch(`${B}/signup/`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(n)});if(o.ok){const i=await o.json();n.token=i.token;for(const a of t.elements)if(a.type==="file"){const r=a.files[0];if(r){const c=await convertImageToBase64(r);n[a.name]=c}}else n[a.name]=a.value;const s=await fetch(`${B}/signup/complete/`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(n)});if(s.ok){const a=await s.json();Le(),fs(),setTimeout(function(){console.log("signup very successful move to normal pages and stuff"),window.location.href="/"},2e3)}else{const a=await s.json();alert("There was an error, try again")}}else{const i=await o.json(),s="There was an error with the email, check that the details are correct.";Le(),Ze(),alert(s)}}catch{Le(),Ze(),alert("There was an error, try again")}}function _s(){const e=document.getElementById("spinner");e.style.display="block"}function Le(){const e=document.getElementById("spinner");e.style.display="none"}function fs(){const e=document.querySelector(".SETTINGSmodalStatusIndicatorOuterCircle");e.classList.remove("SETTINGSanimateError","SETTINGSanimateGreen"),e.classList.add("SETTINGSanimateGreen"),e.addEventListener("animationend",()=>{e.classList.remove("SETTINGSanimateGreen")})}function Ze(){const e=document.querySelector(".SETTINGSmodalStatusIndicatorOuterCircle");e.classList.remove("SETTINGSanimateError","SETTINGSanimateGreen"),e.classList.add("SETTINGSanimateError"),e.addEventListener("animationend",()=>{e.classList.remove("SETTINGSanimateError")})}let ue=!1,et=!1,tt=!1,nt=!1;async function vs(){await bs()?Gt():et||(Es(),et=!0)}function Es(){hs();const e=document.getElementById("SETTINGSmodalSignupButton");let t;fetch(`${B}/meta/are_signups_allowed`).then(s=>{if(!s.ok)throw new Error("Network response was not ok");return s.json()}).then(s=>{t=s.signups_allowed,t==="true"&&(e.style.display="inline-block",e.addEventListener("click",()=>{console.log("signup button was pressed"),ot(),ps()}))}).catch(s=>{console.error("Fetch error:",s)});const n=document.getElementById("SETTINGSloginForm"),o=document.getElementById("email"),i=document.getElementById("password");n.addEventListener("submit",async s=>{if(s.preventDefault(),ue)return!1;ue=!0;const a=o.value,r=i.value;try{await ys(a,r)?(nt=!0,U("Login Successful","success"),Gt(),ot()):(nt=!1,U("Error Logging In","error")),ue=!1}catch(c){console.error("Error:",c),ue=!1}return!1})}async function ys(e,t){try{return(await(await fetch(`${B}/users/login`,{method:"POST",headers:{"Content-Type":"application/json"},credentials:"include",body:JSON.stringify({email:e,password:t})})).json()).Authenticated===!0}catch(n){return n.toString()=="SyntaxError: Unexpected end of JSON input"?U("The server is down","error"):console.error(n),!1}}async function bs(){try{const e=await fetch(`${B}/users/prelogin`,{method:"GET",headers:{"Content-Type":"application/json"},credentials:"include"}),t=await e.json();return!e.ok&&e.status===401&&t.Authenticated==!1?!1:e.ok?e.ok&&t.Authenticated==!0?!0:e.ok?(console.log("The response was ok, but the correct data wasn't sent."),!1):(console.log("Catch all that shouldn't be needed."),!1):(console.log("There was an unknown error:",e),!1)}catch(e){e.toString()=="SyntaxError: Unexpected end of JSON input"&&U("The server is down","error")}}function hs(){let e="MAINcontentPages",t=us;document.getElementById(e).innerHTML+=t}function ot(){if(tt===!0)return;tt=!0;const e=document.getElementById("SETTINGSmodalID");try{e.remove()}catch{}}const B="/apis",I="/media";async function Gt(){Qi(),Yn(),$n(),Ai(),ns(),ls(),cs(),Oo(),Ci(),jo(),lo()}window.hasCodeRun||(vs(),window.hasCodeRun=!0);
