...
</button>`,Et=30;let ne=0;async function Mo(){try{const e=document.getElementById("MAINcontentPages");Do();const t=await Ct(Et,ne);ne+=t.length,So(t),D()&&wo()}catch(e){console.error("Error in initMusicObjectsGrid:",e)}}function yt(){ne=0;const e=document.getElementById("MAINcontentPages"),t=document.getElementById("MOGcontainer");t!==null&&t.removeEventListener("click",bt),e.innerHTML=""}function Do(){let e="MAINcontentPages",t=bo;for(const[n,o]of Object.entries(C)){const i=new RegExp(`\\{${n}\\}`,"g");t=t.replace(i,o)}document.getElementById(e).innerHTML+=t}function So(e){const t=document.getElementById("MOGgridContainer");t.innerHTML="";let n=Oo;for(const[a,r]of Object.entries(C)){const c=new RegExp(`\\{${a}\\}`,"g");n=n.replace(c,r)}t.innerHTML+=n,Ke(e);const o=document.getElementById("MOGcontainer");o.addEventListener("click",function(a){bt(a,e)});let i;o.addEventListener("touchstart",function(a){a.timeStamp,i=setTimeout(function(){s(a,e)},500)}),o.addEventListener("touchend",function(a){a.timeStamp,clearTimeout(i)});function s(a,r){navigator.vibrate(1e3);const d=a.target.id.split("-")[1],u=r[d].project_id;ht(a,u)}t.addEventListener("scroll",async function(){const a=t.scrollTop,r=t.scrollHeight,c=t.clientHeight;if(a>=r-c){const d=await Ct(Et,ne);ne+=d.length,d.length>0&&Ke(d)}})}function Ke(e){const t=document.getElementById("MOGgridContainer"),n=e.length;for(var o=0;o<=n-1;o++){const i=["MOG_image","MOG_text1","MOG_text2","MOG_checkedDate","MOGI_placeholder_itemID"],s=o,a=e[o].img,r=e[o].top,c=e[o].bottom,d=e[o].days,u=to(d);let p=Bo;for(const[E,y]of Object.entries(C)){const m=new RegExp(`\\{${E}\\}`,"g");p=p.replace(m,y)}for(let E=0;E<i.length;E++){const y=i[E].toString(),m=new RegExp(`\\{${y}\\}`,"g");let g="";y==="MOG_image"?g=`${I}/${a}/3`:y==="MOG_text1"?g=r:y==="MOG_text2"?g=c:y==="MOG_checkedDate"?g=u:y==="MOGI_placeholder_itemID"&&(g=s),p=p.replace(m,g)}t.innerHTML+=p}}async function bt(e,t){const n=e.target;if(n.classList.contains("MOG-item-controls-play")){const o=n.id.split("-")[1],i=t[o].project_id,s=await we(i),a=JSON.parse(s);a.ProjectID=i,At(a)}if(n.classList.contains("MOG-item-controls-menu")){const o=n.id.split("-")[1],i=t[o].project_id;ht(e,i)}if(n.classList.contains("MOG-itemContainer")&&n.id!=="MOGaddNewItem"){const o=n.id.split("-")[1],i=t[o].project_id;J(`/projects/${i}`)}n.id==="MOGaddNewItem"&&xo()}function ht(e,t){e.stopPropagation(),$([{displayText:"Play next",optionalSVG:"icons_playlist",optionalParams:{PROJECT_ID:t,QUEUE_POSITION:"next"},function:"PLAYBACK_add_songs_to_queue"},{displayText:"Play later",optionalSVG:"icons_playlist",optionalParams:{PROJECT_ID:t,QUEUE_POSITION:"later"},function:"PLAYBACK_add_songs_to_queue"}],e)}function xo(){J("/new-project/")}let We;function Je(e){return new Promise((t,n)=>{We=document.activeElement;let o="mouse";event.webkitForce==1||event.webkitForce==0?event.webkitForce==0&&(o="keyboard"):event.pointerType!=="mouse"&&(o="keyboard");const i=document.getElementById("confirmModal"),s=`
...
<p>You are not an admin user</p>`;function Tt(e,t,n){const o=document.getElementById(t);let i;o.addEventListener("touchstart",function(a){a.timeStamp,i=setTimeout(function(){s(a,e,n)},500)}),o.addEventListener("touchend",function(a){a.timeStamp,clearTimeout(i)}),o.addEventListener("dblclick",function(a){s(a,e,n)});function s(a,r,c){No(a,r,c)}}function No(e,t,n){e.target;const o={project_id:t};e.stopPropagation(),$(o,e,n)}const et=`<h1>User</h1>
...
</div>`;function Ho(){let e="MAINcontentPages",t=qo;document.getElementById(e).innerHTML=t,document.getElementById("SETTINGSsignupForm").addEventListener("submit",$o),document.getElementById("SIGNUPMODAL_return_to_login_button").addEventListener("click",function(){J("/")})}async function $o(e){e.preventDefault();const t=document.getElementById("SETTINGSsignupForm"),n={};try{for(const i of t.elements)n[i.name]=="Submit"||(n[i.name]=i.value);const o=await fetch(`${M}/users/signup`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(n)});if(!o.ok)O(`There was an error, ${o}`,"error");else{const i=o;O("Sign up Successful, Log in now","success"),J("/")}}catch{O("There was an error, try again","error")}}let Z=!1,ye=!1,Ue=!1,be=!1;async function Yo(){await Vo()?(Ft(),be=!0):ye||(It(),ye=!0)}async function Fo(){ye=!1,Z=!1,Ue=!1,It(),ye=!0}function It(){zo();const e=document.getElementById("SETTINGSmodalSignupButton");fetch(`${M}/meta/are_signups_allowed`).then(i=>{if(!i.ok)throw new Error("Network response was not ok");return i.json()}).then(i=>{i=="true"&&(e.style.display="inline-block",e.addEventListener("click",()=>{it(),Ho()}))}).catch(i=>{console.error("Fetch error:",i)});const t=document.getElementById("SETTINGSloginForm"),n=document.getElementById("email"),o=document.getElementById("password");t.addEventListener("submit",async i=>{if(i.preventDefault(),Z)return!1;Z=!0;const s=n.value,a=o.value;try{await Qo(s,a)?(be=!0,O("Login Successful","success"),Ft(),it()):(be=!1,O("Error Logging In","error")),Z=!1}catch(r){console.error("Error:",r),Z=!1}return!1})}async function Qo(e,t){try{return(await(await fetch(`${M}/users/login`,{method:"POST",headers:{"Content-Type":"application/json"},credentials:"include",body:JSON.stringify({email:e,password:t})})).json()).Authenticated===!0}catch(n){return n.toString()=="SyntaxError: Unexpected end of JSON input"?O("The server is down","error"):console.error(n),!1}}async function Vo(){try{const e=await fetch(`${M}/users/prelogin`,{method:"GET",headers:{"Content-Type":"application/json"},credentials:"include"}),t=await e.json();return!e.ok&&e.status===401&&t.Authenticated==!1?!1:e.ok?e.ok&&t.Authenticated==!0?!0:e.ok?(console.log("The response was ok, but the correct data wasn't sent."),!1):(console.log("Catch all that shouldn't be needed."),!1):(console.log("There was an unknown error:",e),!1)}catch(e){e.toString()=="SyntaxError: Unexpected end of JSON input"&&O("The server is down","error")}}function zo(){let e="MAINcontentPages",t=Jo;document.getElementById(e).innerHTML+=t}function it(){if(Ue===!0)return;Ue=!0;const e=document.getElementById("SETTINGSmodalID");try{e.remove()}catch{}}async function Ko(){const e=await Ce("last_state"),t=JSON.parse(e),n=new Map;setInterval(s,1e4);let o=i(t);if(window.addEventListener("popstate",a),t!=null){const r=window.location.pathname;J(r),os(t)}else a();function i(r){return JSON.stringify(r)}function s(){const r=window.location.pathname,c=l,d=_,u=ls();u.current_path=r,u.current_queue=c,u.current_index=d;const p=i(u);p!==o&&(ei("last_state",u),o=p,n.set("playback_states",p))}function a(){J(currentPath)}}function Wo(){be==!1?(Ae(),Fo()):(wt(),Ae(),Mo())}function Xo(e){yt(),Ae(),li(e)}function st(){yt(),wt(),ko()}const at={"/":Wo,"/new-project/":_e,"/new-project":_e,"/new/":_e,"/new":_e,"/projects/:projectID":Xo,"/settings/":st,"/settings":st};function Zo(){const e=window.location.pathname,t=document.getElementById("MAINcontentPages");setTimeout(n,4e3),t.innerHTML+=`
    <br><br>
    <br><br>
    <br><br>    
