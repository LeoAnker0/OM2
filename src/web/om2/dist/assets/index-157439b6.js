...
</div>`;function fn(e){return new Promise((t,n)=>{const o=new Image;o.crossOrigin="Anonymous",o.onload=()=>t(o),o.onerror=i=>n(i),o.src=e})}function _n(e){const t=document.createElement("canvas");t.width=e.width,t.height=e.height;const n=t.getContext("2d");return n.drawImage(e,0,0),n.getImageData(0,0,t.width,t.height).data}function vn(e,t,n){return`#${(1<<24|e<<16|t<<8|n).toString(16).slice(1)}`}function En(e,t,n){e/=255,t/=255,n/=255;const o=Math.max(e,t,n),i=Math.min(e,t,n);let s,a,r=(o+i)/2;if(o===i)s=a=0;else{const c=o-i;switch(a=r>.5?c/(2-o-i):c/(o+i),o){case e:s=(t-n)/c+(t<n?6:0);break;case t:s=(n-e)/c+2;break;case n:s=(e-t)/c+4;break}s/=6}return[s*360,a*100,r*100]}function hn(e,t){const n=[],o=new Array(t);for(let s=0;s<t;s++)n.push(e[Math.floor(Math.random()*e.length)]);let i=!0;for(;i;){i=!1;for(let s=0;s<t;s++)o[s]=[];for(const s of e){let a=1/0,r=-1;for(let c=0;c<t;c++){const d=yn(s,n[c]);d<a&&(a=d,r=c)}o[r].push(s)}for(let s=0;s<t;s++){const a=bn(o[s]);Tn(a,n[s])||(n[s]=a,i=!0)}}return n}function yn(e,t){return Math.sqrt(Math.pow(e[0]-t[0],2)+Math.pow(e[1]-t[1],2)+Math.pow(e[2]-t[2],2))}function bn(e){const t=e.reduce((n,o)=>(n[0]+=o[0],n[1]+=o[1],n[2]+=o[2],n),[0,0,0]);return[t[0]/e.length,t[1]/e.length,t[2]/e.length]}function Tn(e,t){return e[0]===t[0]&&e[1]===t[1]&&e[2]===t[2]}function In(e){return e.filter(([t,n,o])=>{const[i,s,a]=En(t,n,o);return a>10&&a<93})}function Cn(e,t=5){const n=[];for(let a=0;a<e.length;a+=4){const r=e[a],c=e[a+1],d=e[a+2];n.push([r,c,d])}const i=In(n);return hn(i,t).map(([a,r,c])=>vn(a,r,c))}async function wn(e,t=5){e=e.slice(0,-1)+"2";try{const n=await fn(e),o=_n(n);return Cn(o,t)}catch(n){console.error("Error loading image:",n)}}const Ze=1500;let It=0,Ue=[],Ne;function M(e,t){const o=new Date().getTime();Ue.push({notificationText:e,notificationType:t,time:o}),Ct()}function Ct(){const t=new Date().getTime(),n=Ue.at(It);Ue.length>1?t-Ne>Ze?(et(n.notificationText,n.notificationType),Ne=t):setTimeout(Ct,Ze):(et(n.notificationText,n.notificationType),Ne=t)}function et(e,t){const n=document.getElementById("noticationContainer");let o;It+=1,t=="error"?o="var(--whoopsie)":t=="success"?o="var(--success)":t=="background"?o="var(--background)":t=="orange"?o="var(--orange)":t=="primary"?o="var(--primary)":t=="secondary"&&(o="var(--secondary)");const i=document.createElement("div");i.style.backgroundColor=o,i.textContent=e,n.appendChild(i)}const Sn="/assets/volume_null-e39cf06f.svg",Pn="/assets/recently_added-a0a983c6.svg",On="/assets/volume_3-c8ab0a75.svg",Mn="/assets/orange_music_text_logo_black-12e7386c.svg",Ln="/assets/volume_2-cfdac9da.svg",Bn="/assets/browse_2-85030bba.svg",Dn="/assets/volume_1-27e93416.svg",xn="/assets/orange_music_logo_white-2a680ea2.svg",Rn="/assets/search_icon-4f5e4381.svg",An="/assets/orange_music_text_logo_black-91f9e706.png",Nn="/assets/up_next_queue_button-14fedba2.svg",jn="/assets/orange_music_logo_yellow-a109ff64.svg",Un="/assets/playlist-c6e9024f.svg",kn="/assets/loop_button-aef56865.svg",Jn="/assets/help_icon-867fec9d.svg",Gn="/assets/play_button-b1e2d3a4.svg",Hn="/assets/browse-14744f27.svg",wt="/assets/menu_options_button-a1d7bbe3.svg",Yn="/assets/orange_music_text_logo_white-7f0ba909.svg",$n="/assets/back_button-8128cade.svg",Fn="/assets/Albums-2e81dc74.svg",qn="/assets/songs-016b7188.svg",Qn="/assets/orange_music_logo_black-4d7e4591.svg",Vn="/assets/your_uploaded_songs-06535705.svg",zn="/assets/artist-ab677d43.svg",Kn="/assets/shuffle_button-c2f06bc4.svg",Wn="/assets/orange_music_text_logo_white-4907051e.png",Xn="/assets/listen_now-c7438154.svg",Zn="/assets/derpy-21c20ae5.svg",eo="/assets/next_button-9a850710.svg",to="/assets/recently_added-7ff28139.svg",no="/assets/play_button-5eeedbe6.svg",oo="/assets/browse-e8be8609.svg",io="/assets/albums-681507b8.svg",so="/assets/listen_now.2-bfa293ac.svg",ao="/assets/your_uploads-02e5c93c.svg",ro="/assets/play_button.2-fc90fac7.svg",co="/assets/listen_now-fb02ffce.svg",lo="/assets/browse.2-15b501dd.svg",uo="/assets/place_holder_image-d4006a96.svg",mo="/assets/icons_MOGitems_add-19e679f7.svg",go="/assets/back-9279721d.svg",po="/assets/forwards-605bd405.svg",fo="/assets/icons_close-57e87944.svg",_o="/assets/icons_pause-8012f8cc.svg",vo="/assets/icons_loop-32d1576c.svg",Eo="/assets/icons_loop_song-87f53dc7.svg",ho="/assets/icons_play-a5074c5b.svg",yo="/assets/icons_settings-793063fb.svg",bo="/assets/love-07ac5006.svg",To="/assets/upload-3bad9145.svg",L={icons_volumeNull:Sn,icons_recentlyAdded:Pn,icons_volume3:On,icons_orangeMusicTextLogoBlack:Mn,icons_volume2:Ln,icons_browse2:Bn,icons_volume1:Dn,icons_orangeMusicLogoWhite:xn,icons_searchIcon:Rn,icons_orangeMusicTextLogoBlackPng:An,icons_queueButton:Nn,icons_orangeMusicLogoYellow:jn,icons_playlist:Un,icons_loopButton:kn,icons_helpIcon:Jn,icons_playButton:Gn,icons_browse:Hn,icons_menuOptionsButton:wt,icons_orangeMusicTextLogoWhite:Yn,icons_backButton:$n,icons_Albums:Fn,icons_songs:qn,icons_orangeMusicLogoBlack:Qn,icons_yourUploadedSongs:Vn,icons_artist:zn,icons_shuffleButton:Kn,icons_orangeMusicTextLogoWhitePng:Wn,icons_listenNow:Xn,icons_derpy:Zn,icons_nextButton:eo,icons_recentlyAddedV2:to,icons_playButtonV2:no,icons_browseV2:oo,icons_albumsV2:io,icons_listenNow2V2:so,icons_yourUploads:ao,icons_playButton2:ro,icons_listenNowV2:co,icons_browse2V2:lo,v3_placeholder:uo,icons_MOGitems_add:mo,icons_back:go,icons_forwards:po,icons_close:fo,icons_pause:_o,icons_loop:vo,icons_loop_song:Eo,icons_play:ho,icons_settings:yo,current_year:new Date().getFullYear(),icons_love:bo,icons_upload:To};function R(){return!!window.matchMedia("screen and (orientation: portrait) and (max-width: 768px) and (pointer: coarse) ").matches}function St(){return!!(window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches)}function X(e){for(const[t,n]of Object.entries(L)){const o=new RegExp(`\\{${t}\\}`,"g");e=e.replace(o,n)}return e}function Ve(e,t){const n=t.itemsToReplace;for(var o=n.length-1;o>=0;o--){const i=n[o][0].toString(),s=n[o][1],a=new RegExp(`\\{${i}\\}`,"g");e=e.replace(a,s)}return e}function Io(e){for(let t=e.length-1;t>0;t--){const n=Math.floor(Math.random()*(t+1));[e[t],e[n]]=[e[n],e[t]]}}function tt(e){let t=0,n=0,o;return e=parseInt(e,10),e>60*60&&(t=parseInt(e/(60*60),10),e-=t*60*60),e>60&&(n=parseInt(e/60,10),e-=n*60),o=e,e=t>0?t+":":"",e+=n>0?(n<10&&t>0?"0":"")+n+":":"0:",e+=(o<10?"0":"")+o,e}function Co(e){const n=(Date.now()-e)/(1e3*60*60*24);let o;return n<.01||n<1?(o="Now",o):n<8?(o=Math.floor(n)+"d",o):n<29?(o=Math.floor(n/7)+"w",o):n<365?(o=Math.floor(n/28)+"m",o):(o=Math.floor(n/365)+"y",o)}function Pt(e){const n=(Date.now()-e)/1e3;if(n<60)return"Now";if(n<3600){const o=Math.floor(n/60);return`${o} minute${o>1?"s":""} ago`}else if(n<86400){const o=Math.floor(n/3600);return`${o} hour${o>1?"s":""} ago`}else{if(n<172800)return"Yesterday";if(n<31536e3){const o=Math.floor(n/86400);return`${o} day${o>1?"s":""} ago`}else return`${new Date(e).getFullYear()}`}}function ce(e){return e<1024?`${e} b`:e<1024*1024?`${(e/1024).toFixed(2)} kb`:`${(e/1024/1024).toFixed(2)} mb`}function wo(e){if(!e)return-1;var t=0;do t++;while(e=e.previousElementSibling);return t}function Ot(e,t){let n;return function(){const o=this,i=arguments;clearTimeout(n),n=setTimeout(function(){e.apply(o,i)},t)}}function So(e,t){let n;return function(...o){const i=this;clearTimeout(n),n=setTimeout(()=>{e.apply(i,o)},t)}}function ke(){const e=Math.random().toString(36).substr(2,6),t=Date.now().toString(36);return e+t}let be;const T=new Map;function Po(e,t,n){T.has(e)||T.set(e,{originalColor:t,isChanging:!1,animationFrameId:null});function o(){const a=Date.now()-i;if(!T.has(e))return;const r=Math.min(a/500,1);if(!T.has(e))return;const c=Mt(T.get(e).originalColor,r,n);e.style.backgroundColor=c,(r<1||T.get(e).isChanging)&&(T.get(e).animationFrameId=requestAnimationFrame(o)),r==1&&(e.style.backgroundColor="",T.delete(e))}clearTimeout(be),be=setTimeout(()=>{T.has(e)&&!T.get(e).isChanging&&(e.style.backgroundColor="",cancelAnimationFrame(T.get(e).animationFrameId),T.delete(e))},500),T.get(e).isChanging=!0;const i=Date.now();T.get(e).animationFrameId=requestAnimationFrame(o)}function Oo(e,t,n,o,i){const s=i||2500;T.has(e)||T.set(e,{originalColor:t,isChanging:!1,animationFrameId:null});function a(){const d=Date.now()-r;if(!T.has(e))return;const l=Math.min(d/(o==="hardNewToOld"?s*4/5:500),1);if(!T.has(e))return;let g;o==="hardNewToOld"&&l<1?g=n:g=Mt(T.get(e).originalColor,Math.min(l,1),n),e.style.backgroundColor=g,l<1||T.get(e).isChanging?T.get(e).animationFrameId=requestAnimationFrame(a):(e.style.backgroundColor="",T.delete(e)),l==1&&(e.style.backgroundColor="",T.delete(e))}clearTimeout(be),be=setTimeout(()=>{T.has(e)&&!T.get(e).isChanging&&(e.style.backgroundColor="",cancelAnimationFrame(T.get(e).animationFrameId),T.delete(e))},s),T.get(e).isChanging=!0;const r=Date.now();T.get(e).animationFrameId=requestAnimationFrame(a)}function Mo(e){const t=e.getBoundingClientRect(),n=window.innerHeight||document.documentElement.clientHeight;return t.top>=0&&t.bottom<=n}function Mt(e,t,n){return Lo(n,e,t)}function Lo(e,t,n){const o=function(u){return u=u.toString(16),u.length===1?"0"+u:u},i=parseInt(e.substring(1,3),16),s=parseInt(e.substring(3,5),16),a=parseInt(e.substring(5,7),16),r=parseInt(t.substring(1,3),16),c=parseInt(t.substring(3,5),16),d=parseInt(t.substring(5,7),16),l=Math.round(i*(1-n)+r*n),g=Math.round(s*(1-n)+c*n),I=Math.round(a*(1-n)+d*n);return"#"+o(l)+o(g)+o(I)}function Lt(e){const n=getComputedStyle(document.documentElement).getPropertyValue(e).trim().match(/hsl\((\d+),\s*(\d+)%,\s*(\d+)%\)/);let o,i,s;o=parseInt(n[1],10),i=parseInt(n[2],10),i=i/100,s=parseInt(n[3],10),s=s/100;const a=Bo(o,i,s),r=je(a[0]),c=je(a[1]),d=je(a[2]);return Do({r,g:c,b:d})}function Bo(e,t,n){let o=t*Math.min(n,1-n),i=(s,a=(s+e/30)%12)=>n-o*Math.max(Math.min(a-3,9-a,1),-1);return[i(0),i(8),i(4)]}function je(e){const t=Math.min(1,Math.max(0,e));return Math.round(t*255)}function Do(e){const t=n=>{const o=n.toString(16);return o.length===1?"0"+o:o};return"#"+t(e.r)+t(e.g)+t(e.b)}let _,k,_e,ve,Ee,ie;const ne={program:k,vertexShader:_e,fragmentShader:ve,positionBuffer:Ee};let Je=[];function xo(e,t){e.innerHTML="";const n=ke(),o=document.createElement("canvas");o.id=n,e.appendChild(o);const i=document.getElementById(n);if(_=i.getContext("webgl"),!_){console.error("WebGL not supported"),M("WebGL not supported","error");return}i.width=window.innerWidth,i.height=window.innerHeight,_.viewport(0,0,_.canvas.width,_.canvas.height);const s=`
...
`;let Me=!1;function ko(){const e=document.getElementById("MAINcontentContainer"),t=document.getElementById("uploadQueueModal"),n=document.getElementById("uploadQueueButton");e.innerHTML+=jo,n.addEventListener("click",function(o){Me==!1?Go(o):Te()}),t.innerHTML=Uo}function Jo(){const e=document.getElementById("UPLOAD_INDICATOR_container"),t=document.getElementById("uploadQueueButtonContainer");e.style.opacity="100%",t.style.visibility="visible"}function nt(){const e=document.getElementById("uploadQueueButtonContainer"),t=document.getElementById("UPLOAD_INDICATOR_container");t.style.opacity="",e.style.visibility="",Me==!0&&J.length>0||Te()}function ue(e){const t=document.getElementById("UPLOADQUEUEBOTTOM_songName"),n=document.getElementById("UPLOADQUEUEBOTTOM_fileSize");if(J.length>0){t.innerHTML=J[0].file.name,n.innerHTML=ce(J[0].file.size*1.75),Ho(document.getElementById("specificChart"),e,!0);const i=document.getElementById("UPLOADQUEUEbottomContainer");for(;i.childNodes.length>2;)i.removeChild(i.lastChild);let s="";for(var o=0;o<J.length;o++){const a=J[o].file.name,r=ce(J[o].file.size*2);s+=`<div class="UPLOADQUEUE-bottom-items-next"><div class="itemName">${a}</div><div class="itemSize">${r}</div></div>`}i.innerHTML+=s}if(e==100){const i=document.getElementById("UPLOADQUEUEBOTTOM_bottom_text");i.innerHTML='Processing<span id="UPLOADQUEUEBOTTOM_fileSize"><span class="ANIMATIONS-EllipsisLoader"></span></span>'}}let ot;function Go(e){Me=!0,ot=document.activeElement;let t=e.clientX,n=e.clientY;const o=document.getElementById("uploadQueueModal");let i=t+"px",s=n+"px";MENUmodalEnvironment.addEventListener("click",Te),o.style.left=i,o.style.top=s;let a="mouse";if(e.webkitForce==1||e.webkitForce==0?e.webkitForce==0&&(a="keyboard"):e.pointerType!=="mouse"&&(a="keyboard"),a=="keyboard"){const g=ot.getBoundingClientRect();t=g.left+window.scrollX,n=g.top+window.scrollY;let I=t+"px",u=n+"px";o.style.left=I,o.style.top=u}const r=o.offsetWidth,c=o.offsetHeight,d=$t("uploadQueueModal");o.style.visibility="visible",document.addEventListener("keydown",l),d.xOverflow==!0&&(i=t-r+"px",o.style.left=i),d.yOverflow==!0&&(s=n-c+"px",o.style.top=s);function l(g){(g.key==="Escape"||g.keyCode===27)&&(document.removeEventListener("keydown",l),Te())}}function Te(){Me=!1;const e=document.getElementById("uploadQueueModal");e.style.visibility=""}function Ho(e,t,n){t=Math.round(t),t>100?t=100:t<0&&(t=0);var o=Math.round(360*(t/100)),i=e.querySelector(".pie"),s=e.querySelector(".right-side");t>50?(i.style.clip="rect(auto, auto, auto, auto)",s.style.transform="rotate(180deg)"):(i.style.clip="rect(0, 1em, 1em, 0.5em)",s.style.transform="rotate(0deg)"),n?(s.style.borderWidth="0.1em",e.querySelector(".left-side").style.borderWidth="0.1em",e.querySelector(".shadow").style.borderWidth="0.1em"):(s.style.borderWidth="0.5em",e.querySelector(".left-side").style.borderWidth="0.5em",e.querySelector(".shadow").style.borderWidth="0.5em"),e.querySelector(".num").textContent=t,e.querySelector(".left-side").style.transform="rotate("+o+"deg)"}let Le;async function Yo(){const e=document.getElementById("TOPRIGHTaccountImg");try{const t=await Be("profile_picture"),n=`${S}/${t}/3`;Le=t;const o=document.getElementById("TOPRIGHTaccountImgButton");e.src=n,o.addEventListener("click",$o)}catch(t){console.error("Error initializing account image:",t)}}function $o(e){e.stopPropagation(),Fo(e)}async function Fo(e){const n=await V([{displayText:"Settings",optionalSVG:"icons_settings",condition:"settings",function:"True"},{displayText:"Sign Out",optionalSVG:"None",condition:"signOut",function:"True"}],e,"return_promise");n.condition=="settings"?A("/settings/"):n.condition=="signOut"&&Dt(),G()}async function Dt(){await Ci(),localStorage.clear(),location.reload()}function qo(){const e=document.getElementById("MOGgridContainer");let t=document.createElement("button");t.classList.add("MOG-Mobile-SettingsButton"),t.id="MOGmobileSettingsButton",t.innerHTML=`<div class="MOGM-imageContainer"><img src="${S}/${Le}/3"></div>`,e.prepend(t),document.getElementById("MOGmobileSettingsButton").addEventListener("click",Qo)}function Qo(e){e.stopPropagation(),Vo(e)}async function Vo(e){const n=await V([{displayText:"Settings",optionalSVG:"icons_settings",condition:"settings",function:"True"},{displayText:"Sign Out",optionalSVG:"None",condition:"signOut",function:"True"}],e,"return_promise");n.condition=="settings"?A("/settings/"):n.condition=="signOut"&&Dt(),G()}const zo=`<div class="MOG-container" id="MOGcontainer">
...
</button>`,xt=30;let de=0;async function Xo(){try{if(document.getElementById("MAINcontentPages").innerHTML+=X(zo),localStorage.getItem("MOGitems")!=null){const t=JSON.parse(localStorage.getItem("MOGitems"));de+=t.length,it(t)}const e=await kt(xt,0);JSON.stringify(e)!=localStorage.getItem("MOGitems")&&(de+=e.length,it(e),localStorage.setItem("MOGitems",JSON.stringify(e))),R()&&qo()}catch(e){console.error("Error in initMusicObjectsGrid:",e)}}function Rt(){de=0;const e=document.getElementById("MAINcontentPages"),t=document.getElementById("MOGcontainer");t!==null&&t.removeEventListener("click",At),e.innerHTML=""}function it(e){const t=document.getElementById("MOGgridContainer");t.innerHTML=X(Ko),st(e);const n=document.getElementById("MOGgridContainer");n.addEventListener("click",function(a){At(a,e)});let o,i=!1;n.addEventListener("touchstart",function(a){a.timeStamp,i=!1,o=setTimeout(function(){i||s(a,e)},500)}),n.addEventListener("touchend",function(a){a.timeStamp,clearTimeout(o)}),n.addEventListener("scroll",function(){i=!0,clearTimeout(o)});function s(a,r){navigator.vibrate(1e3);const d=a.target.id.split("-")[1],l=r[d].project_id;Nt(a,l)}t.addEventListener("scroll",async function(){const a=t.scrollTop,r=t.scrollHeight,c=t.clientHeight;if(a>=r-c){const d=await kt(xt,de);de+=d.length,d.length>0&&st(d)}})}function st(e){const t=document.getElementById("MOGgridContainer"),n=e.length,o=X(Wo);for(var i=0;i<=n-1;i++){const s=i,a=e[i].img,r=e[i].top,c=e[i].bottom,d=e[i].days,l=Co(d),g={itemsToReplace:[["MOG_image",`${S}/${a}/3`],["MOG_text1",`${r}`],["MOG_text2",`${c}`],["MOG_checkedDate",`${l}`],["MOGI_placeholder_itemID",`${s}`]]};t.innerHTML+=Ve(o,g)}}async function At(e,t){const n=e.target;if(n.classList.contains("MOG-item-controls-play")){const o=n.id.split("-")[1],i=t[o].project_id,s=await Ke(i),a=JSON.parse(s);a.ProjectID=i,Vt(a)}if(n.classList.contains("MOG-item-controls-menu")){const o=n.id.split("-")[1],i=t[o].project_id;Nt(e,i)}if(n.classList.contains("MOG-itemContainer")&&n.id!=="MOGaddNewItem"){const o=n.id.split("-")[1],i=t[o].project_id;A(`/projects/${i}`)}n.id==="MOGaddNewItem"&&A("/new-project/")}async function Nt(e,t){e.stopPropagation();const o=await V([{displayText:"Play next",optionalSVG:"icons_playlist",condition:"playNext",optionalParams:{PROJECT_ID:t,QUEUE_POSITION:"next"},function:"True"},{displayText:"Play later",optionalSVG:"icons_playlist",condition:"playLater",optionalParams:{PROJECT_ID:t,QUEUE_POSITION:"later"},function:"True"}],e,"return_promise");o.condition=="playNext",zt(o.optionalParams),G()}let at;function ze(e){return new Promise((t,n)=>{at=document.activeElement;let o="mouse";event.webkitForce==1||event.webkitForce==0?event.webkitForce==0&&(o="keyboard"):event.pointerType!=="mouse"&&(o="keyboard");const i=document.getElementById("confirmModal"),s=`
...
<p>You are not an admin user</p>`;function jt(e,t,n){const o=document.getElementById(t);let i;o.addEventListener("touchstart",function(a){a.timeStamp,i=setTimeout(function(){s(a,e,n)},500)}),o.addEventListener("touchend",function(a){a.timeStamp,clearTimeout(i)}),o.addEventListener("dblclick",function(a){s(a,e,n)});function s(a,r,c){ti(a,r,c)}}function ti(e,t,n){e.target;const o={project_id:t};e.stopPropagation(),V(o,e,n)}const dt=`<h1>User</h1>
...
</div>`;function ci(){let e="MAINcontentPages",t=ri;document.getElementById(e).innerHTML=t,document.getElementById("SETTINGSsignupForm").addEventListener("submit",di),document.getElementById("SIGNUPMODAL_return_to_login_button").addEventListener("click",function(){A("/")})}async function di(e){e.preventDefault();const t=document.getElementById("SETTINGSsignupForm"),n={};try{for(const i of t.elements)n[i.name]=="Submit"||(n[i.name]=i.value);const o=await fetch(`${B}/users/signup`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(n)});if(!o.ok)M(`There was an error, ${o}`,"error");else{const i=o;M("Sign up Successful, Log in now","success"),A("/")}}catch{M("There was an error, try again","error")}}let oe=!1,Ce=!1,Ye=!1,we=!1;async function li(){await gi()?(mn(),we=!0):Ce||(Ut(),Ce=!0)}async function ui(){Ce=!1,oe=!1,Ye=!1,Ut(),Ce=!0}function Ut(){pi();const e=document.getElementById("SETTINGSmodalSignupButton");fetch(`${B}/meta/are_signups_allowed`).then(i=>{if(!i.ok)throw new Error("Network response was not ok");return i.json()}).then(i=>{i=="true"&&(e.style.display="inline-block",e.addEventListener("click",()=>{gt(),ci()}))}).catch(i=>{console.error("Fetch error:",i)});const t=document.getElementById("SETTINGSloginForm"),n=document.getElementById("email"),o=document.getElementById("password");t.addEventListener("submit",async i=>{if(i.preventDefault(),oe)return!1;oe=!0;const s=n.value,a=o.value;try{await mi(s,a)?(we=!0,M("Login Successful","success"),mn(),gt()):(we=!1,M("Error Logging In","error")),oe=!1}catch(r){console.error("Error:",r),oe=!1}return!1})}async function mi(e,t){try{return(await(await fetch(`${B}/users/login`,{method:"POST",headers:{"Content-Type":"application/json"},credentials:"include",body:JSON.stringify({email:e,password:t})})).json()).Authenticated===!0}catch(n){return n.toString()=="SyntaxError: Unexpected end of JSON input"?M("The server is down","error"):console.error(n),!1}}async function gi(){try{const e=await fetch(`${B}/users/prelogin`,{method:"GET",headers:{"Content-Type":"application/json"},credentials:"include"}),t=await e.json();return!e.ok&&e.status===401&&t.Authenticated==!1?!1:e.ok?e.ok&&t.Authenticated==!0?!0:e.ok?(console.log("The response was ok, but the correct data wasn't sent."),!1):(console.log("Catch all that shouldn't be needed."),!1):(console.log("There was an unknown error:",e),!1)}catch(e){e.toString()=="SyntaxError: Unexpected end of JSON input"&&M("The server is down","error")}}function pi(){let e="MAINcontentPages",t=ai;document.getElementById(e).innerHTML+=t}function gt(){if(Ye===!0)return;Ye=!0;const e=document.getElementById("SETTINGSmodalID");try{e.remove()}catch{}}async function fi(){const e=await Be("last_state"),t=JSON.parse(e),n=new Map;setInterval(s,1e4);let o=i(t);if(window.addEventListener("popstate",a),t!=null){const r=window.location.pathname;A(r),ys(t)}else a();function i(r){return JSON.stringify(r)}function s(){const r=window.location.pathname,c=m,d=v,l=ws();l.current_path=r,l.current_queue=c,l.current_index=d;const g=i(l);g!==o&&(Ei("last_state",l),o=g,n.set("playback_states",g))}function a(){A(currentPath)}}function _i(){we==!1?(Ge(),ui()):(Jt(),Ge(),Xo())}function pt(e,t){Rt(),Ge(),t!==null?vt(e,t):vt(e)}function ft(){Rt(),Jt(),ii()}const _t={"/":_i,"/new-project/":fe,"/new-project":fe,"/new/":fe,"/new":fe,"/projects/:projectID":pt,"/projects/:projectID/:songURL":pt,"/settings/":ft,"/settings":ft};function vi(){const e=window.location.pathname,t=document.getElementById("MAINcontentPages");setTimeout(n,4e3),t.innerHTML+=`
    <br><br>
    <br><br>
    <br><br>    
...
</div>`,J=[];let De=!1,he=!1,Mi=!0,p;async function vt(e,t){De=!0;const n=localStorage.getItem(`project-${e}`);if(n!==null?p=JSON.parse(n):St()==!0?p={Description:"...",PictureURL:"static/loading_img_text_dark",ProjectContributors:"...",ProjectID:e,ProjectJSON:[],ProjectName:"..",TimeCreated:0}:p={Description:"...",PictureURL:"static/loading_img_text_light",ProjectContributors:"...",ProjectID:e,ProjectJSON:[],ProjectName:"..",TimeCreated:0},Di(p),$e("","blank"),sessionStorage.setItem("description",p.Description),Gt(),ye(),document.getElementById("PROJECTviewMobileStickyHeaderBackButton").addEventListener("click",()=>{A("/")}),await le(),Ht(p.ProjectName),Bi(),jt(p.ProjectID,"PROJECTviewDisplayImage","update_project_image"),Ui(),$e(p,"full"),t!=null){for(var i=p.ProjectJSON.length-1;i>=0;i--)if(p.ProjectJSON[i].URL==t){const a=`${p.ProjectJSON[i].SongSequence}-${p.ProjectJSON[i].Version}`;Li(a)}}}function Jt(){const e=document.getElementById("MAINcontentPages");e.innerHTML="",De=!1}async function le(){if(!De)return;const e=p.ProjectID,t=await Ke(e);if(t=="")return;const n=structuredClone(p),o=JSON.parse(t);if(o.ProjectID=e,p=o,localStorage.setItem(`project-${e}`,`${JSON.stringify(p)}`),n.Description!==p.Description){const s=document.getElementById("PROJECTVIEW_DESCRIPTION_more_title"),a=document.getElementById("PROJECTVIEW_DESCRIPTION_more_artist_year");s.innerText=p.ProjectName,a.innerText=`${p.ProjectContributors} | ${Pt(p.TimeCreated)}`,sessionStorage.setItem("description",p.Description),Gt()}if(n.PictureURL!==p.PictureURL){const s=document.getElementById("PROJECTviewDisplayImage_imgTag"),a=`${S}/${p.PictureURL}/5`;s.src=a}if(n.ProjectContributors!==p.ProjectContributors){const s=document.getElementById("PROJECTviewDisplayTitleH3");s.innerText=p.ProjectContributors}if(n.ProjectName!==p.ProjectName){const s=document.getElementById("PROJECTviewDisplayTitleH1");s.innerText=p.ProjectName}if(n.ProjectJSON!==p.ProjectJSON)if(n.ProjectJSON==null||p.ProjectJSON==null)ye();else if(n.ProjectJSON.length!==p.ProjectJSON.length)ye();else{let s=0;for(var i=p.ProjectJSON.length-1;i>=0;i--)p.ProjectJSON[i].URL!==n.ProjectJSON[i].URL&&(s+=1);s>0&&ye()}$e(p,"full")}function Li(e){const t=a=>`#${a.match(/^rgb\((\d+),\s*(\d+),\s*(\d+)\)$/).slice(1).map(r=>parseInt(r,10).toString(16).padStart(2,"0")).join("")}`,n=Ot(Oo,0),o=Lt("--orange"),i=document.getElementById("PROJECTview-projectTable");for(var s=i.children.length-1;s>=0;s--){const a=i.children[s].dataset.rowId;if(a!==null&&a==e){const r=i.children[s].closest(".PROJECTview-projectTable-rowContainer"),c=getComputedStyle(r).backgroundColor,d=t(c);n(r,d,o,"hardNewToOld",3500),Mo(r)||r.scrollIntoView({behavior:"smooth",block:"center",inline:"nearest"})}}}function Bi(){const e=document.getElementById("PROJECTviewDisplayTitleH1"),t=document.getElementById("PROJECTviewDisplayTitleH3");let n=document.getElementById("PROJECTviewDisplayTitleH1").innerText,o=document.getElementById("PROJECTviewDisplayTitleH3").innerText;const i=document.getElementById("PROJECTviewDescriptionMoreButton"),s=document.getElementById("PROJECTviewDisplayDescription"),a=document.getElementById("PROJECTviewMOREdescriptionboxEnvironment"),r=document.querySelector("main"),c=document.getElementById("PROJECTviewMOREcloseButton"),d=document.getElementById("PROJECTviewDescriptionTopPlayButton"),l=document.getElementById("PROJECTviewDescriptionTopShuffleButton"),g=document.getElementById("PROJECTviewDisplayMenuButton"),I=document.getElementById("PROJECTviewMobileStickyHeaderMenuButton"),u=document.querySelector(".PROJECTviewDisplayImage"),E=document.getElementById("PROJECTviewMobileStickyHeader"),f=document.getElementById("PROJECTviewMobileStickyHeaderProjectNameContainer");document.getElementById("PROJECTviewMOREdescriptionC");const y=document.getElementById("PROJECTviewMOREdescriptionP"),b=new IntersectionObserver(h,{threshold:.1}),$=sessionStorage.getItem("description");y.innerText=$,i.addEventListener("click",function(){U()}),s.addEventListener("dblclick",function(){U()});let N=0;s.addEventListener("touchend",function(P){const O=new Date().getTime();O-N<300&&(P.stopPropagation(),U()),N=O}),c.addEventListener("click",function(){D(p)}),a.addEventListener("click",function(P){P.target===a&&D(p)}),d.addEventListener("click",function(){Vt(p)}),l.addEventListener("click",function(){hs(p)}),g.addEventListener("click",function(){Et(event)}),I.addEventListener("click",function(){Et(event)}),b.observe(u),e.addEventListener("blur",function(P){const O=e.innerText;O!==n&&(Ht(O),ae(p.ProjectID,"project_name",O),p.ProjectName=O)}),t.addEventListener("blur",function(P){const O=t.innerText;O!==o&&(ae(p.ProjectID,"project_contributors",O),p.ProjectContributors=O)});function U(){a.style.display="grid",R()&&(r.style.zIndex="40")}function h(P,O){P.forEach(H=>{H.isIntersecting&&R()?(E.style.backdropFilter="none",E.style.backgroundColor="transparent",f.style.visibility="hidden"):H.isIntersecting&&!R()||!H.isIntersecting&&!R()?(E.style.backdropFilter="",E.style.backgroundColor="",f.style.visibility=""):!H.isIntersecting&&R()&&(E.style.backdropFilter="blur(15px)",E.style.backgroundColor="var(--background-transparent)",f.style.visibility="visible")})}function D(P){const O=y.value;sessionStorage.setItem("description",O),ae(P.ProjectID,"description",O),a.style.display="none",y.innerText=O,r.style.zIndex=""}}function Di(e){const t={itemsToReplace:[["PROJECTviewMOREtitle",`${e.ProjectName}`],["PROJECTviewMOREartist",`${e.ProjectContributors}`],["PROJECTviewMOREyear",`${Pt(e.TimeCreated)}`],["MOG_checkedDate","checkedIndicator"],["MOGI_placeholder_itemID","temporaryIidentifier"],["PROJECTviewDisplayImage",`${S}/${e.PictureURL}/5`]]};document.getElementById("MAINcontentPages").innerHTML=Ve(X(Oi),t)}function Gt(){let e=sessionStorage.getItem("description");const t=document.getElementById("PROJECTviewDescriptionP");t.innerText=e}function Ht(e){const t=document.getElementById("PROJECTviewMobileStickyHeaderProjectNameContainer");t.innerText=e}function Et(e){e.stopPropagation(),e.target;const t=p.ProjectID;let n;n=[{displayText:"Play next",optionalSVG:"icons_playlist",optionalParams:{PROJECT_ID:t,QUEUE_POSITION:"next"},function:"PLAYBACK_add_songs_to_queue"},{displayText:"Play later",optionalSVG:"icons_playlist",optionalParams:{PROJECT_ID:t,QUEUE_POSITION:"later"},function:"PLAYBACK_add_songs_to_queue"},{displayText:"Delete",optionalSVG:"None",function:"PROJECT_VIEW_delete_project",optionalParams:{PROJECT_ID:t},colour:"var(--whoopsie)"}],V(n,e)}async function xi(e){const t=`Are you sure that you want to delete <em><b>${p.ProjectName}</b></em>? This action is not reversable.`;if(await ze(t)==="delete"){await Ri(),G(),A("/");return}G()}async function Ri(){const e=p.ProjectID;localStorage.removeItem(`project-${e}`);try{const n=await(await fetch(`${B}/projects/delete_project/${e}`,{method:"DELETE",headers:{"Content-Type":"application/json"},credentials:"include"})).json()}catch(t){console.error("Error:",t)}}function ye(){const e=document.getElementById("PROJECTview-projectTable");e!==null&&e.remove(),document.getElementById("PROJECTview_projectAreaContainer").innerHTML+=X(Si);const t=document.getElementById("PROJECTview-projectTable");let n=structuredClone(p.ProjectJSON);const o=Lt("--orange"),i=u=>`#${u.match(/^rgb\((\d+),\s*(\d+),\s*(\d+)\)$/).slice(1).map(E=>parseInt(E,10).toString(16).padStart(2,"0")).join("")}`;let s;if(n==null)return;for(let u=0;u<n.length;u++){let E=X(Pi);const f=n[u],y={itemsToReplace:[["PROJECTviewRow_img",`${S}/${p.PictureURL}/3`],["PROJECTviewRow_songTitle",`${f.SongName}`],["PROJECTviewRow_artistName",`${p.ProjectContributors}`],["PROJECTviewRow_projectName",`${ce(f.FolderSize)}`],["PROJECTviewRow_songDuration",`${Math.floor(f.Duration/60)}:${(f.Duration%60).toString().padStart(2,"0")}`],["PROJECTviewRow_projectID",`${f.SongSequence}-${f.Version}`],["PROJECTviewRow_contentEditable",`${Mi}`]]};E=Ve(E,y),t.insertAdjacentHTML("beforeend",E);{const b=t.lastElementChild;b.addEventListener("dragstart",a),b.addEventListener("dragover",c),b.addEventListener("drop",d)}}function a(u){u.dataTransfer.setData("text/plain",u.target.dataset.rowId),u.dataTransfer.getData("text/plain"),s=u.srcElement,wo(u.srcElement)}const r=Ot(Po,0);function c(u){u.preventDefault(),u.dataTransfer.dropEffect="move";const E=u.target.closest(".PROJECTview-projectTable-rowContainer");if(E!==s){const f=getComputedStyle(E).backgroundColor,y=i(f);r(E,y,o)}}function d(u){u.preventDefault();const E=u.dataTransfer.getData("text/plain"),f=document.querySelector(`[data-row-id="${E}"]`),y=u.target.closest(".PROJECTview-projectTable-rowContainer");if(y){const $=structuredClone(p),N=y.getAttribute("data-row-id");y.before(f);const U=`${E}|${N}`;setTimeout(async()=>{await ae(p.ProjectID,"SongsTableChangeSongSequenceOrder",U),le()},1);let h=[];for(var b=0;b<t.children.length;b++){if(b==0)continue;const D=t.children[b],H=D.dataset.rowId.split("-")[0];let Z=$.ProjectJSON[H-1];Z.SongSequence=b,h.push(Z),D.style.backgroundColor="",D.dataset.rowId=`${b}-1`}p.ProjectJSON=h}}t.addEventListener("click",function(u){const E=u.target;if(u.stopPropagation(),E.tagName==="BUTTON"){const f=E.closest(".PROJECTview-projectTable-rowContainer");f&&(f.getAttribute("data-row-id"),Ai(u))}});const l=t.querySelectorAll("[contenteditable]"),g=[],I=u=>{const f=u.target.closest(".PROJECTview-projectTable-rowContainer").getAttribute("data-row-id"),y=u.target.textContent,b=g.find(h=>h.dataRowIDField===f);if((b?b.currentText:"Row ID not found")==y)return;for(var N=g.length-1;N>=0;N--)g[N].dataRowIDField===f&&(g[N].currentText=y);const U=`${f}-${y}`;ae(p.ProjectID,"project_song_title",U)};l.forEach(u=>{u.addEventListener("blur",I),g.push({dataRowIDField:u.parentElement.parentElement.getAttribute("data-row-id"),currentText:u.innerText})})}function Ai(e){e.stopPropagation();const t=e.target,n=t.parentElement.parentElement.getAttribute("data-row-id"),o=t.parentElement.parentElement.firstElementChild.lastElementChild.innerText;let i;i=[{displayText:"Play Next",optionalSVG:"icons_playlist",function:"PROJECT_VIEW_add_song_to_queue",optionalParams:{songID:n,queuePosition:"next"}},{displayText:"Play Later",optionalSVG:"icons_playlist",function:"PROJECT_VIEW_add_song_to_queue",optionalParams:{songID:n,queuePosition:"later"}},{displayText:"Delete",optionalSVG:"None",function:"PROJECT_VIEW_delete_song",optionalParams:{songID:n,songName:o},colour:"var(--whoopsie)"}],V(i,e)}function Ni(e){const n=e.songID.split("-")[0],o=e.queuePosition;let i=structuredClone(p);const s=i.ProjectJSON[n-1];i.ProjectJSON=[],i.ProjectJSON[0]=s,bs(i,o)}async function ji(e){const t=`Are you sure that you want to delete <em><strong>${e.songName}</strong></em>? This action is not reversable.`;await ze(t)==="delete"&&(await bi(p.ProjectID,e.songID),le()),G()}function Ui(){const e=document.getElementById("PROJECTview_dropArea");document.getElementById("PROJECTview_dropArea_submit_button"),e.addEventListener("dragenter",o=>{o.preventDefault(),e.classList.add("dragover")}),e.addEventListener("dragover",o=>{o.preventDefault()}),e.addEventListener("dragleave",()=>{e.classList.remove("dragover")}),e.addEventListener("drop",o=>{o.preventDefault(),e.classList.remove("dragover");const i=o.dataTransfer.files;n(i)});let t=[];e.addEventListener("click",o=>{const i=o.target.id,s=document.createElement("input");i!=="PROJECTview_dropArea_submit_button"?(s.type="file",s.accept="audio/*",s.multiple=!0,s.addEventListener("change",()=>{t=s.files}),s.click()):n(t)});function n(o,i){ki(o)}}async function Yt(){const e=J[0];let t=e.file,n=e.ProjectID;const o=new FormData,i=new XMLHttpRequest;he=!0,Jo(),o.append("file",t),o.append("project_id",n),i.upload.onprogress=function(s){if(s.lengthComputable){const a=s.loaded/s.total*100;ue(a),a===100&&ue(a)}},i.onload=async function(){if(i.responseText=="StorageLimit Reached"){M("Storage limit reached","error");for(var a=J.length-1;a>=0;a--)J.shift();he=!1,nt(),ue(0)}he=!1,J.shift(),nt(),ue(0),J.length>0&&await Yt(),p.ProjectID==n&&De==!0&&le()},i.onerror=function(){M("Upload Failed","error")},i.open("POST",`${B}/files/upload_audio/${n}`,!0),i.send(o)}async function ki(e,t){document.getElementById("uploadsContainer");for(const n of e){const o={ProjectID:p.ProjectID,file:n};J.push(o),he||await Yt()}}const Ji=`<button class="MENUmodalItemContainer" tabindex="0">
    <div class="MENUmodalTextArranger" style="color: {MENU_item_colour}">{MENU_item_text}</div>
    <div class="MENUmodalSVGcontainer">
        <img src="{MENU_item_image}" class="MENUmodalSVG">
    </div>
</button>`;async function Gi(e,t,n){const o=new XMLHttpRequest,i=new FormData;i.append("file",e),o.upload.onprogress=function(s){s.lengthComputable&&s.loaded/s.total*100},o.onload=function(){o.status>=200&&o.status<300?(o.responseText=="StorageLimit Reached"&&M("Storage limit reached","error"),n!=="update_user_pfp"?$i():(Fi(),location.reload())):console.error("Error during upload. Status:",o.status,"Response:",o.responseText)},o.onerror=function(){console.log("there was an error with the upload")},o.open("POST",`${B}/files/upload_photo?pi=${t}&mt=${n}`,!0),o.send(i)}async function Hi(e,t,n){Array.isArray(e)||(e=[e]);for(const o of e)await Gi(o,t,n)}const Yi=`<div class="MENUmodalBody" id="MENUmodalBody">
</div>`;let Se;async function V(e,t,n){if(n===void 0)ht(e,t,!1);else if(n!==void 0&&n==="update_project_image")yt(e,t,"update_project_image");else if(n!==void 0&&n==="update_user_pfp")yt(e,t,"update_user_pfp");else if(n!==void 0&&n==="return_promise")return await ht(e,t,!0)}async function ht(e,t,n){return new Promise((o,i)=>{Se=document.activeElement;let s=t.clientX,a=t.clientY;const r=document.querySelector("main"),c=document.querySelector(".topHalf-container");R()&&(r.style.zIndex="40",c.style.zIndex="0");const d=document.getElementById("MENUmodalEnvironment");d.innerHTML=Yi,d.style.display="block";const l=document.getElementById("MENUmodalBody");let g=s+"px",I=a+"px";d.addEventListener("click",Ft),l.style.left=g,l.style.top=I;let u="mouse";if(t.webkitForce==1||t.webkitForce==0?t.webkitForce==0&&(u="keyboard"):t.pointerType!=="mouse"&&(u="keyboard"),u==="keyboard"){const h=Se.getBoundingClientRect();s=h.left+window.scrollX,a=h.top+window.scrollY,g=s+"px",I=a+"px",l.style.left=g,l.style.top=I}for(let h=0;h<e.length;h++)qi(e[h]);const f=l.children[0],y=l.offsetWidth,b=l.offsetHeight,$=$t("MENUmodalBody"),N=l.getElementsByClassName("MENUmodalItemContainer");u==="keyboard"&&!R()?f.focus():u=="mouse"&&!R()&&(f.focus(),f.blur()),document.addEventListener("keydown",U),$.xOverflow===!0&&(g=s-y+"px",l.style.left=g),$.yOverflow===!0&&(I=a-b+"px",l.style.top=I);for(let h=0;h<N.length;h++){const D=N[h];D.setAttribute("data-menu-item-id",h),D.addEventListener("click",function(P){P.stopPropagation();const H=P.target.getAttribute("data-menu-item-id"),Z=e[H].function,Ae=e[H].optionalParams;if(Z=="TEST")console.log("the button worked",Ae);else if(Z!="None"){if(n===!0){const gn={condition:e[H].condition,optionalParams:Ae};o(gn);return}Qi[Z](Ae);return}else return})}function U(h){(h.key==="Escape"||h.keyCode===27)&&(document.removeEventListener("keydown",U),G())}})}function yt(e,t,n){const o=t.clientX,i=t.clientY,s=document.querySelector("main"),a=document.querySelector(".topHalf-container"),r=document.getElementById("MENUmodalEnvironment");let c=o+"px",d=i+"px";R()&&(s.style.zIndex="40",a.style.zIndex="0"),e.MenuType=n,s.style.zIndex="2",r.innerHTML=pn,r.style.display="block",r.addEventListener("click",Ft);const l=document.getElementById("MENUmodalBody"),g=document.getElementById("MENUmodalBody_image_select_file_drop_area"),I=document.getElementById("MENUmodalBody_image_select_file_select_button"),u=document.getElementById("MENUmodalBody_image_select_preview_area"),E=document.getElementById("MENUmodalBody_image_select_submit_button"),f=document.getElementById("MENUmodalBody_image_select_submit_button_container");l.style.left=c,l.style.top=d;let y,b;function $(h,D){return function(){const P=this,O=arguments;clearTimeout(b),b=setTimeout(()=>{h.apply(P,O)},D)}}function N(h,D,P){$(Hi,100)(h,D,P)}function U(h){if(y){const D=URL.createObjectURL(y),P=document.getElementById("MENUmodalBody_image_submit_area_loader_spinner");u.src=D,E.style.visibility="visible",f.style.outline="3px solid var(--primary)",E.addEventListener("click",()=>{N(y,h.project_id,h.MenuType),P.style.visibility="visible"})}else console.log("No file selected.")}g.addEventListener("dragover",h=>{h.preventDefault()}),g.addEventListener("drop",h=>{h.preventDefault(),y=h.dataTransfer.files[0],U(e)}),I.addEventListener("click",()=>{const h=document.createElement("input");h.type="file",h.accept="image/*",h.addEventListener("change",D=>{y=D.target.files[0],U(e)}),h.click()})}function $i(){const e=document.getElementById("MENUmodalBody_image_submit_area_loader_spinner");e.style.visibility="hidden",G(),le()}function Fi(){const e=document.getElementById("MENUmodalBody_image_submit_area_loader_spinner");e.style.visibility="hidden",G()}function $t(e){const t=document.getElementById(e),n=document.documentElement.clientWidth,o=document.documentElement.clientHeight,i=t.offsetWidth,s=t.getBoundingClientRect().left,a=t.getBoundingClientRect().top,r=t.getBoundingClientRect().height,c=i+s,d=r+a;let l=!1,g=!1;return c>n&&(l=!0),d>o&&(g=!0),{xOverflow:l,yOverflow:g}}function qi(e){const t=e.displayText,n=e.optionalSVG,o=document.getElementById("MENUmodalBody");let i="var(--text)";"colour"in e&&(i=e.colour);let s=new RegExp("\\{MENU_item_text\\}","g"),a=Ji.replace(s,t);if(s=new RegExp("\\{MENU_item_colour\\}","g"),a=a.replace(s,i),n!=="None"){s=new RegExp("\\{MENU_item_image\\}","g");const r="{"+n+"}";a=a.replace(s,r);for(const[c,d]of Object.entries(L)){const l=new RegExp(`\\{${c}\\}`,"g");a=a.replace(l,d)}o.innerHTML+=a;return}else{a=a.replace(/<img[^>]+>/g,""),o.innerHTML+=a;return}}function Ft(e){const t=document.getElementById("MENUmodalEnvironment"),n=document.querySelector("main"),o=window.matchMedia("screen and (orientation: portrait) and (max-width: 768px) and (pointer: coarse) "),i=document.querySelector(".topHalf-container");if(e.target===t){t.style.display="none",o.matches&&(n.style.zIndex="",i.style.zIndex="");return}}function G(){const e=document.getElementById("MENUmodalEnvironment"),t=document.querySelector("main"),n=window.matchMedia("screen and (orientation: portrait) and (max-width: 768px) and (pointer: coarse) "),o=document.querySelector(".topHalf-container");e.style.display="none",n.matches&&(t.style.zIndex="1",o.style.zIndex="10"),Se&&Se.focus()}const Qi={PROJECT_VIEW_delete_project(e){xi(),G()},PLAYBACK_add_songs_to_queue(e){zt(e),G()},PROJECT_VIEW_delete_song(e){ji(e)},PROJECT_VIEW_add_song_to_queue(e){Ni(e)}},Vi=`<div class="LCDbody">
...
</div>`;function is(){let e="topleftContentArea",t=ts;for(const[n,o]of Object.entries(L)){const i=new RegExp(`\\{${n}\\}`,"g");t=t.replace(i,o)}document.getElementById(e).innerHTML=t}function ss(){let e="toprightContentArea",t=ns;for(const[n,o]of Object.entries(L)){const i=new RegExp(`\\{${n}\\}`,"g");t=t.replace(i,o)}document.getElementById(e).innerHTML=t}function as(){let e="MAINcontentContainer",t=os;for(const[n,o]of Object.entries(L)){const i=new RegExp(`\\{${n}\\}`,"g");t=t.replace(i,o)}document.getElementById(e).innerHTML+=t}const rs=`<div class="QUEUE-item-container" draggable="true">
...
</div>`;let K=!1,Xe,Qe;function Us(){const e=document.getElementById("musicEnjoyEnvironment");e.innerHTML=X(js),document.getElementById("MUSICENJOYMODEexitButton").addEventListener("click",Js),document.getElementById("MusicEnjoyOpenButton").addEventListener("click",Tt),R()&&document.getElementById("LCDbody").addEventListener("click",Tt),x.on("playbackStateChange",c=>{K!=!1&&cn()}),x.on("progressStateChange",c=>{K!=!1}),x.on("newTrackStateChange",c=>{K!=!1&&rn()}),x.on("loopStateChange",c=>{K!=!1&&dn()}),x.on("shuffleStateChange",c=>{K!=!1&&ln()});const o=document.getElementById("MUSICENJOYMODEplaybackControlsButton_shuffle"),i=document.getElementById("MUSICENJOYMODEplaybackControlsButton_back"),s=document.getElementById("MUSICENJOYMODEplaybackControlsButton_play"),a=document.getElementById("MUSICENJOYMODEplaybackControlsButton_next"),r=document.getElementById("MUSICENJOYMODEplaybackControlsButton_loop");o.addEventListener("click",We),i.addEventListener("click",Wt),s.addEventListener("click",Re),a.addEventListener("click",Kt),r.addEventListener("click",Xt)}function rn(){const e=document.getElementById("MUSICENJOYMODEcoverImage1"),t=document.getElementById("MUSICENJOYMODEcoverImage2"),n=document.getElementById("MUSICENJOYMODEsongTitle1"),o=document.getElementById("MUSICENJOYMODEsongTitle2"),i=document.getElementById("MUSICENJOYMODEsongArtist");e.src=Pe,t.src=Pe,n.innerText=qe,o.innerText=qe,i.innerText=Qt,dn(),ln(),ks()}function cn(){const e=document.getElementById("MUSICENJOYMODEplaybackControlButton_play_icon");if(F=="playing"){e.src=L.icons_pause;return}if(F=="paused"){e.src=L.icons_play;return}}function dn(){const e=document.getElementById("MUSICENJOYMODEplaybackControlsButton_loop_icon");if(C==="off"){e.style.filter="var(--make-svg-white)",e.src=L.icons_loop;return}if(C==="on"){e.style.filter="var(--make-svg-grey-3)",e.src=L.icons_loop;return}if(C==="song"){e.style.filter="var(--make-svg-grey-3)",e.src=L.icons_loop_song;return}}function ln(){const e=document.getElementById("MUSICENJOYMODEplaybackControlsButton_shuffle_icon");if(Y==="on"){e.style.filter="var(--make-svg-grey-3)";return}if(Y==="off"){e.style.filter="var(--make-svg-white)";return}}async function Tt(){K=!0;const e=document.getElementById("musicEnjoyEnvironment");e.style.display="block",rn(),cn(),await un(),Qe=document.getElementById("MUSICENJOYMODEbackground"),xo(Qe,Xe)}async function un(){Xe=await wn(Pe)}async function ks(){await un(),No(Qe,Xe)}function Js(){const e=document.getElementById("musicEnjoyEnvironment");e.style.display="none",Ao(),K=!1}const B="/apis",S="/media";async function mn(){Is(),is(),ss(),zi(),Bs(),Rs(),Ds(),Yo(),cs(),fi(),ko(),Us()}window.hasCodeRun||(li(),window.hasCodeRun=!0);
