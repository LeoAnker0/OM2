...
</div>`;let V=!1,ye=!1,Te=!1;async function Ho(){await zo()?Ue():Te||(Yo(),Te=!0)}function Yo(){Qo();let e;const t=document.getElementById("SETTINGSmodalSignupButton");fetch(`${h}/status/are_signups_allowed/`).then(s=>{if(!s.ok)throw new Error("Network response was not ok");return s.json()}).then(s=>{e=s.signups_allowed,e&&(t.style.display="inline-block",t.addEventListener("click",()=>{console.log("signup button was pressed"),he(),ko()}))}).catch(s=>{console.error("Fetch error:",s)});const n=document.getElementById("SETTINGSloginForm"),o=document.getElementById("email"),i=document.getElementById("password");n.addEventListener("submit",async s=>{if(s.preventDefault(),V)return!1;V=!0;const a=o.value,c=i.value;try{await $o(a,c)?(ye=!0,Fo(),Ue(),setTimeout(he,2e3)):(ye=!1,Vo(),console.log("Login failed. Retry!")),V=!1}catch(r){console.error("Error:",r),V=!1}return!1})}async function $o(e,t){try{const o=await(await fetch(`${h}/login/`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:e,password:t})})).json();if(o.authenticated===!0){const i=o.jwt;localStorage.setItem("JWT",i)}return o.authenticated}catch(n){return console.error("Error:",n),!1}}async function zo(){try{if(localStorage.getItem("JWT")==null)return!1}catch(e){return console.error("Error accessing localStorage:",e),!1}try{const e=localStorage.getItem("JWT");return(await(await fetch(`${h}/prelogin/`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({jwt:e})})).json()).authenticated}catch(e){return console.error("Error:",e),!1}}function Qo(){let e="MAINcontentPages",t=qo;document.getElementById(e).innerHTML+=t}let be=!1;function he(){if(be===!0)return;document.getElementById("SETTINGSmodalID").remove(),be=!0}function Fo(){const e=document.querySelector(".SETTINGSmodalStatusIndicatorOuterCircle");e.classList.remove("SETTINGSanimateError","SETTINGSanimateGreen"),e.classList.add("SETTINGSanimateGreen"),e.addEventListener("animationend",()=>{e.classList.remove("SETTINGSanimateGreen")})}function Vo(){const e=document.querySelector(".SETTINGSmodalStatusIndicatorOuterCircle");e.classList.remove("SETTINGSanimateError","SETTINGSanimateGreen"),e.classList.add("SETTINGSanimateError"),e.addEventListener("animationend",()=>{e.classList.remove("SETTINGSanimateError")})}const h="MAIN_API_DOMAIN",E="MAIN_MEDIA_DOMAIN";async function Ue(){_o(),kt(),Jt(),io(),Co(),Do(),Mo(),Ro(),Qn(),un()}let ce=$e;for(const[e,t]of Object.entries(y)){const n=new RegExp(`\\{${e}\\}`,"g");ce=ce.replace(n,t)}document.getElementById("app").innerHTML=ce;Ho();
