...
</div>`,De="/assets/volume_null-e39cf06f.svg",je="/assets/recently_added-a0a983c6.svg",Ne="/assets/volume_3-c8ab0a75.svg",Ae="/assets/orange_music_text_logo_black-12e7386c.svg",ke="/assets/volume_2-cfdac9da.svg",Ge="/assets/browse_2-85030bba.svg",Je="/assets/volume_1-27e93416.svg",Ue="/assets/orange_music_logo_white-2a680ea2.svg",He="/assets/search_icon-4f5e4381.svg",Ye="/assets/orange_music_text_logo_black-91f9e706.png",$e="/assets/up_next_queue_button-14fedba2.svg",qe="/assets/orange_music_logo_yellow-a109ff64.svg",ze="/assets/playlist-c6e9024f.svg",Fe="/assets/loop_button-aef56865.svg",Qe="/assets/help_icon-867fec9d.svg",Ve="/assets/play_button-b1e2d3a4.svg",Ke="/assets/browse-14744f27.svg",me="/assets/menu_options_button-a1d7bbe3.svg",We="/assets/orange_music_text_logo_white-7f0ba909.svg",Ze="/assets/back_button-8128cade.svg",Xe="/assets/Albums-2e81dc74.svg",et="/assets/songs-016b7188.svg",tt="/assets/orange_music_logo_black-4d7e4591.svg",nt="/assets/your_uploaded_songs-06535705.svg",ot="/assets/artist-ab677d43.svg",it="/assets/shuffle_button-c2f06bc4.svg",st="/assets/orange_music_text_logo_white-4907051e.png",at="/assets/listen_now-c7438154.svg",ct="/assets/derpy-21c20ae5.svg",rt="/assets/next_button-9a850710.svg",lt="/assets/recently_added-7ff28139.svg",dt="/assets/play_button-5eeedbe6.svg",ut="/assets/browse-e8be8609.svg",mt="/assets/albums-681507b8.svg",pt="/assets/listen_now.2-bfa293ac.svg",gt="/assets/your_uploads-02e5c93c.svg",vt="/assets/play_button.2-fc90fac7.svg",ft="/assets/listen_now-fb02ffce.svg",Et="/assets/browse.2-15b501dd.svg",_t="/assets/place_holder_image-d4006a96.svg",yt="/assets/icons_MOGitems_add-19e679f7.svg",h={icons_volumeNull:De,icons_recentlyAdded:je,icons_volume3:Ne,icons_orangeMusicTextLogoBlack:Ae,icons_volume2:ke,icons_browse2:Ge,icons_volume1:Je,icons_orangeMusicLogoWhite:Ue,icons_searchIcon:He,icons_orangeMusicTextLogoBlackPng:Ye,icons_queueButton:$e,icons_orangeMusicLogoYellow:qe,icons_playlist:ze,icons_loopButton:Fe,icons_helpIcon:Qe,icons_playButton:Ve,icons_browse:Ke,icons_menuOptionsButton:me,icons_orangeMusicTextLogoWhite:We,icons_backButton:Ze,icons_Albums:Xe,icons_songs:et,icons_orangeMusicLogoBlack:tt,icons_yourUploadedSongs:nt,icons_artist:ot,icons_shuffleButton:it,icons_orangeMusicTextLogoWhitePng:st,icons_listenNow:at,icons_derpy:ct,icons_nextButton:rt,icons_recentlyAddedV2:lt,icons_playButtonV2:dt,icons_browseV2:ut,icons_albumsV2:mt,icons_listenNow2V2:pt,icons_yourUploads:gt,icons_playButton2:vt,icons_listenNowV2:ft,icons_browse2V2:Et,v3_placeholder:_t,icons_MOGitems_add:yt};function Tt(){let e="topleftContentArea",t=Se;for(const[n,i]of Object.entries(h)){const o=new RegExp(`\\{${n}\\}`,"g");t=t.replace(o,i)}document.getElementById(e).innerHTML=t}function It(){let e="toprightContentArea",t=Re;for(const[n,i]of Object.entries(h)){const o=new RegExp(`\\{${n}\\}`,"g");t=t.replace(o,i)}document.getElementById(e).innerHTML=t}function ht(){let e="MAINcontentContainer",t=xe;for(const[n,i]of Object.entries(h)){const o=new RegExp(`\\{${n}\\}`,"g");t=t.replace(o,i)}document.getElementById(e).innerHTML+=t}const Ct=`<div class="QUEUE-item-container" draggable="true">
...
</div>`;async function jt(){try{const e=localStorage.getItem("JWT");if(!e){console.log("no jwt");return}const t={"access-token":e},s=`/projects/${(await(await fetch(`${C}/projects/new-project-id/`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})).json()).projectID}`;M(s)}catch(e){console.error("Error:",e)}}async function H(e){try{const t=localStorage.getItem("JWT");if(!t){console.log("no jwt");return}const n={"access-token":t,project_id:e};return(await(await fetch(`${C}/projects/get-project-details/`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(n)})).json()).project_details}catch(t){console.error("Error:",t)}}async function Nt(e){setTimeout(async()=>{const i=window.location.pathname.replace(/^\/projects\//,""),o=await H(i);o.project_id=i,t(o),Gt(o)},1);function t(n){Jt(n);const i=n.description;sessionStorage.setItem("description",i),Ut(),Ht(),$t(),qt(n),zt(n),Vt(n),Wt(n),en(),Ee(n.project_name),tn(n.project_id)}}function At(){const e=document.getElementById("MAINcontentPages");e.innerHTML=""}async function kt(){ge();const t=window.location.pathname.replace(/^\/projects\//,""),n=document.getElementById("PROJECTviewDisplayImage_imgTag"),o=(await H(t)).picture_url,s=`${T}/${o}/5/`;n.src=s}function Gt(e){const t=document.getElementById("PROJECTviewDisplayTitleH1");t.addEventListener("blur",function(n){const i=t.innerText;Ee(i),pe(e.project_id,"project_name",i)})}function Jt(e){let t="MAINcontentPages",n=Rt;for(const[o,s]of Object.entries(h)){const a=new RegExp(`\\{${o}\\}`,"g");n=n.replace(a,s)}const i=["PROJECTviewMOREtitle","PROJECTviewMOREartist","PROJECTviewMOREyear","PROJECTviewDisplayImage"];for(let o=0;o<i.length;o++){const s=i[o].toString(),a=new RegExp(`\\{${s}\\}`,"g");let c="";s==="PROJECTviewMOREtitle"?c=e.project_name:s==="PROJECTviewMOREartist"?c=e.project_contributors:s==="PROJECTviewMOREyear"?c=e.time_created:s==="MOG_checkedDate"?c="checkedIndicator":s==="MOGI_placeholder_itemID"?c="temporaryIidentifier":s==="PROJECTviewDisplayImage"&&(c=`${T}/${e.picture_url}/5/`),n=n.replace(a,c)}document.getElementById(t).innerHTML=n}function Ut(){function e(){let n;return function(){cancelAnimationFrame(n),n=requestAnimationFrame(function(){q()})}}const t=e();window.addEventListener("resize",t),q()}function q(){let e=sessionStorage.getItem("description");const t=" ".repeat(120);e=e+t;const i=document.getElementById("PROJECTviewDescriptionP"),s=e.split(" "),a=[];i.textContent="";for(const f of s){const E=document.createElement("span");E.textContent=f+" ",i.appendChild(E);const _=E.getBoundingClientRect(),m=i.getBoundingClientRect();if(_.bottom<=m.bottom&&_.top>=m.top&&_.left>=m.left&&_.right<=m.right)a.unshift(f);else break}const r=a.reverse().join(" "),d=r.slice(-10),l=r.slice(0,-10),v=d.split("");let p=l;for(let f=0;f<v.length;f++){const E=v[f],_=`<span class="PROJECTopacity${9-f}">${E}</span>`;p=p+_}i.innerHTML=p}function Ht(){const e=document.getElementById("PROJECTviewDescriptionMoreButton"),t=document.getElementById("PROJECTviewDisplayDescription"),n=document.getElementById("PROJECTviewMOREdescriptionboxEnvironment"),i=document.querySelector("main");function o(){n.style.display="grid",B()&&(i.style.zIndex="40")}e.addEventListener("click",function(){o()}),t.addEventListener("dblclick",function(){o()});let s=0;t.addEventListener("touchend",function(a){const c=new Date().getTime();c-s<300&&(a.stopPropagation(),o()),s=c})}function Yt(){const e=sessionStorage.getItem("description"),t=document.getElementById("PROJECTviewDescriptionP");t.innerText=e}function $t(){const e=sessionStorage.getItem("description");document.getElementById("PROJECTviewMOREdescriptionC");const t=document.getElementById("PROJECTviewMOREdescriptionP");t.innerText=e}function qt(e){document.getElementById("PROJECTviewMOREcloseButton").addEventListener("click",function(){oe(e)});const n=document.getElementById("PROJECTviewMOREdescriptionboxEnvironment");n.addEventListener("click",function(i){i.target===n&&oe(e)})}function oe(e){const n=document.getElementById("PROJECTviewMOREdescriptionP").value;sessionStorage.setItem("description",n),pe(e.project_id,"description",n);const i=document.getElementById("PROJECTviewMOREdescriptionboxEnvironment");i.style.display="none",Yt(),q();const o=document.querySelector("main");o.style.zIndex="1"}async function zt(e){const t=document.getElementById("PROJECTviewDescriptionTopPlayButton"),n=document.getElementById("PROJECTviewDescriptionTopShuffleButton"),i=document.getElementById("PROJECTviewDisplayMenuButton"),o=document.getElementById("PROJECTviewMobileStickyHeaderMenuButton"),s=document.getElementById("PROJECTviewMobileStickyHeaderBackButton"),a=await H(e.project_id);t.addEventListener("click",function(){Te(a)}),n.addEventListener("click",function(){console.log("shuffleButton pressed")}),i.addEventListener("click",function(){ie(event)}),o.addEventListener("click",function(){ie(event)}),s.addEventListener("click",()=>{M("/")})}function ie(e,t){e.stopPropagation(),e.target;const i=window.location.pathname.replace(/^\/projects\//,"");P([{displayText:"Play next",optionalSVG:"icons_yourUploadedSongs",function:"None"},{displayText:"Play later",optionalSVG:"None",function:"None"},{displayText:"Delete",optionalSVG:"None",function:"PROJECT_VIEW_delete_project",optionalParams:{PROJECT_ID:i},colour:"hsl(180, 100%, 80%)"}],e)}function Ft(e){window.confirm("Are you sure you want to delete this project?")?(console.log("delete project id:",e),Qt(e),k(),M("/")):k()}async function Qt(e){try{const t=localStorage.getItem("JWT");if(!t){console.log("no jwt");return}const n={"access-token":t,project_id:e},o=await(await fetch(`${C}/projects/delete_project/`,{method:"DELETE",headers:{"Content-Type":"application/json"},body:JSON.stringify(n)})).json();console.log(o)}catch(t){console.error("Error:",t)}}function Vt(e){document.getElementById("PROJECTview_projectAreaContainer"),Kt();const t=document.getElementById("PROJECTview-projectTable"),n=e,i=n.project_json;if(i!=="{}"){const o=JSON.parse(i).songs_json,s=[];for(const a of o)s.push({img:n.picture_url,songTitle:a.song_name,artistName:n.project_contributors,projectName:"cheese",songDuration:`${Math.floor(a.duration/60)}:${(a.duration%60).toString().padStart(2,"0")}`,song_sequence:a.song_sequence,url:a.url});for(let a=0;a<s.length;a++){s[a].projectID=a;const c=s[a];fe(c)}t.addEventListener("click",function(a){const c=a.target;if(a.stopPropagation(),c.tagName==="BUTTON"){const r=c.closest(".PROJECTview-projectTable-rowContainer");if(r){const d=r.getAttribute("data-row-id");ve(a),console.log(`Button in row ${d} clicked.`)}}})}}async function ge(){const e=document.getElementById("PROJECTview-projectTable"),n=window.location.pathname.replace(/^\/projects\//,""),i=await H(n);i.project_id=n;const o=i,s=o.project_json,a=JSON.parse(s).songs_json,c=[];if(Array.isArray(a))for(const l of a)c.push({img:o.picture_url,songTitle:l.song_name,artistName:o.project_contributors,projectName:"cheese",songDuration:`${Math.floor(l.duration/60)}:${(l.duration%60).toString().padStart(2,"0")}`,song_sequence:l.song_sequence,url:l.url});const r=document.getElementById("PROJECTview-projectTable"),d=r.children;for(let l=d.length-1;l>0;l--)r.removeChild(d[l]);for(let l=0;l<c.length;l++){c[l].projectID=l;const v=c[l];fe(v)}e.addEventListener("click",function(l){const v=l.target;if(l.stopPropagation(),v.tagName==="BUTTON"){const p=v.closest(".PROJECTview-projectTable-rowContainer");if(p){const f=p.getAttribute("data-row-id");ve(l),console.log(`Button in row ${f} clicked.`)}}})}function ve(e){e.stopPropagation(),e.target,P([{displayText:"Play next",optionalSVG:"icons_yourUploadedSongs"},{displayText:"Play later",optionalSVG:"None"},{displayText:"Delete",optionalSVG:"None"}],e)}function Kt(){let e="PROJECTview_projectAreaContainer",t=xt;for(const[n,i]of Object.entries(h)){const o=new RegExp(`\\{${n}\\}`,"g");t=t.replace(o,i)}document.getElementById(e).innerHTML+=t}function fe(e){let t="PROJECTview-projectTable",n=Dt;for(const[o,s]of Object.entries(h)){const a=new RegExp(`\\{${o}\\}`,"g");n=n.replace(a,s)}const i=["PROJECTviewRow_img","PROJECTviewRow_songTitle","PROJECTviewRow_artistName","PROJECTviewRow_projectName","PROJECTviewRow_songDuration","PROJECTviewRow_projectID"];for(let o=0;o<i.length;o++){const s=i[o].toString(),a=new RegExp(`\\{${s}\\}`,"g");let c="";s==="PROJECTviewRow_img"?c=`${T}/${e.img}/2/`:s==="PROJECTviewRow_songTitle"?c=e.songTitle:s==="PROJECTviewRow_artistName"?c=e.artistName:s==="PROJECTviewRow_projectName"?c=e.projectName:s==="PROJECTviewRow_songDuration"?c=e.songDuration:s==="PROJECTviewRow_projectID"&&(c=e.projectID),n=n.replace(a,c)}document.getElementById(t).innerHTML+=n}function Wt(e){const t=document.getElementById("PROJECTview_dropArea");t.addEventListener("dragenter",i=>{i.preventDefault(),t.classList.add("dragover")}),t.addEventListener("dragover",i=>{i.preventDefault()}),t.addEventListener("dragleave",()=>{t.classList.remove("dragover")}),t.addEventListener("drop",i=>{i.preventDefault(),t.classList.remove("dragover");const o=i.dataTransfer.files;n(o,e)}),t.addEventListener("click",()=>{const i=document.createElement("input");i.type="file",i.accept="audio/*",i.multiple=!0,i.addEventListener("change",()=>{const o=i.files;n(o,e)}),i.click()});function n(i,o){for(const s of i);Xt(i,o)}}async function Zt(e,t,n,i){const o=new FormData;o.append("file",e),o.append("project_id",i.project_id);const s=localStorage.getItem("JWT");o.append("jwt",s);const a=new XMLHttpRequest,c=document.createElement("div");c.classList.add("progress-bar");const r=document.createElement("div");r.classList.add("progress-fill"),c.appendChild(r),t.appendChild(c),a.upload.onprogress=function(d){if(d.lengthComputable){const l=d.loaded/d.total*100;r.style.width=l+"%",l===100&&c.classList.add("opacity-animation")}},a.onload=function(){c.classList.remove("opacity-animation"),c.style.opacity="1",r.classList.add("complete"),n.textContent=`${e.name}`,ge(),setTimeout(()=>{t.classList.add("complete")},2e3),setTimeout(()=>{t.parentNode.removeChild(t)},3e3)},a.onerror=function(){c.classList.remove("opacity-animation"),c.style.opacity="1",r.style.backgroundColor="#e74c3c",setTimeout(()=>{t.parentNode.removeChild(t)},3e3)},a.open("POST",`${C}/files/upload/audio/`,!0),a.send(o)}async function Xt(e,t){const n=document.getElementById("uploadsContainer");for(const i of e){const o=document.createElement("div");o.classList.add("upload-box");const s=document.createElement("div");s.classList.add("PROJECTview_upload_nameLabel"),s.textContent=`${i.name}`,o.appendChild(s),n.appendChild(o),await Zt(i,o,s,t)}}function Ee(e){const t=document.getElementById("PROJECTviewMobileStickyHeaderProjectNameContainer");t.innerText=e}function en(){const e=new IntersectionObserver(o,{threshold:.1}),t=document.querySelector(".PROJECTviewDisplayImage"),n=document.getElementById("PROJECTviewMobileStickyHeader"),i=document.getElementById("PROJECTviewMobileStickyHeaderProjectNameContainer");e.observe(t);function o(s,a){s.forEach(c=>{B()&&console.log("media query matches"),c.isIntersecting&&B()?(n.style.backdropFilter="none",n.style.backgroundColor="transparent",i.style.visibility="hidden"):c.isIntersecting&&!B()||!c.isIntersecting&&!B()?(n.style.backdropFilter="var(--PROJECTviewDesktopHeaderFilter)",i.style.visibility="hidden"):!c.isIntersecting&&B()&&(n.style.backdropFilter="none",n.style.backgroundColor="var(--dgrey-7)",i.style.visibility="visible")})}}function tn(e){const t=document.getElementById("PROJECTviewDisplayImage");let n;t.addEventListener("touchstart",function(o){o.timeStamp,n=setTimeout(function(){i(o,e)},500)}),t.addEventListener("touchend",function(o){o.timeStamp,clearTimeout(n)}),t.addEventListener("dblclick",function(o){i(o,e)});function i(o,s){nn(o,s)}}function nn(e,t){e.stopPropagation(),e.target,P({project_id:t},e,"update_project_image")}function P(e,t,n){n===void 0&&sn(e,t),n!==void 0&&n==="update_project_image"&&an(e,t),n!==void 0&&n==="lcd_mobile_body"&&on()}function on(e){const t=document.querySelector("main"),n=document.querySelector(".topHalf-container");B()&&(t.style.zIndex="40",n.style.zIndex="0");const i=document.getElementById("MENUmodalEnvironment");i.style.display="block";let o=Bt;for(const[L,D]of Object.entries(h)){const N=new RegExp(`\\{${L}\\}`,"g");o=o.replace(N,D)}i.innerHTML=o;const s=document.getElementById("LCDMB_seek_input"),a=document.getElementById("LCDMB_seek_indicator");document.getElementById("LCDMB_menu_button");const c=document.getElementById("LCDMB_back"),r=document.getElementById("LCDMB_play"),d=document.getElementById("LCDMB_play_icon"),l=document.getElementById("LCDMB_next"),v=document.getElementById("LCDMB_queue_button"),p=document.getElementById("audio"),f=document.getElementById("LCD_mobile_body_song_title"),E=document.getElementById("LCD_mobile_body_artist_title"),_=document.getElementById("LCD_mobile_body_img");function m(){_.src=Q,f.innerText=V,E.innerText=K}p.addEventListener("ended",()=>{m()}),m();function y(){p.paused?(console.log("audio is paused"),d.src=h.icons_playButtonV2):(console.log("audio is playing"),d.src=h.icons_derpy)}y();const w=p.duration,j=p.currentTime/w*100;a.style.width=`${j}%`,p.addEventListener("timeupdate",()=>{const L=p.duration,N=p.currentTime/L*100;a.style.width=`${N}%`}),s.addEventListener("input",function(){const L=p.duration,D=s.value;p.currentTime=L*(D/100)}),c.addEventListener("click",()=>{he(),m()}),r.addEventListener("click",()=>{Y(),m(),y()}),l.addEventListener("click",()=>{Ie(),m()}),v.addEventListener("click",()=>{console.log("queueButton was clicked")}),i.addEventListener("touchstart",ee,!1),i.addEventListener("touchmove",te,!1),i.addEventListener("touchend",ne,!1);let Z=0,X=0;function ee(L){Z=L.touches[0].clientY}function te(L){L.preventDefault()}function ne(L){X=L.changedTouches[0].clientY,X-Z>70&&(console.log("Down swipe detected!"),k(),document.removeEventListener("touchstart",ee),document.removeEventListener("touchmove",te),document.removeEventListener("touchend",ne))}}function sn(e,t){const n=t.clientX,i=t.clientY,o=document.querySelector("main"),s=document.querySelector(".topHalf-container");B()&&(o.style.zIndex="40",s.style.zIndex="0");const a=document.getElementById("MENUmodalEnvironment");a.innerHTML=bt,a.style.display="block";const c=document.getElementById("MENUmodalBody");a.addEventListener("click",_e);let r=n+"px",d=i+"px";c.style.left=r,c.style.top=d;for(let E=0;E<e.length;E++)ln(e[E]);const l=c.offsetWidth,v=c.offsetHeight,p=rn("MENUmodalBody");p.xOverflow==!0&&(r=n-l+"px",c.style.left=r),p.yOverflow==!0&&(d=i-v+"px",c.style.top=d);const f=c.getElementsByClassName("MENUmodalItemContainer");for(let E=0;E<f.length;E++){const _=f[E];_.setAttribute("data-menu-item-id",E),_.addEventListener("click",function(m){m.stopPropagation();const w=m.target.getAttribute("data-menu-item-id"),b=e[w].function,j=e[w].optionalParams;if(b=="TEST")console.log("the button worked");else if(b!="None"){dn[b](j);return}else return})}}function an(e,t){const n=t.clientX,i=t.clientY,o=document.querySelector("main"),s=document.querySelector(".topHalf-container");B()&&(o.style.zIndex="40",s.style.zIndex="0");const a=document.getElementById("MENUmodalEnvironment");a.innerHTML=wt,a.style.display="block";const c=document.getElementById("MENUmodalBody");a.addEventListener("click",_e);let r=n+"px",d=i+"px";c.style.left=r,c.style.top=d;const l=document.getElementById("MENUmodalBody_image_select_file_drop_area"),v=document.getElementById("MENUmodalBody_image_select_file_select_button"),p=document.getElementById("MENUmodalBody_image_select_preview_area"),f=document.getElementById("MENUmodalBody_image_select_submit_button"),E=document.getElementById("MENUmodalBody_image_select_submit_button_container");function _(m,y){if(m){const w=URL.createObjectURL(m),b=document.getElementById("MENUmodalBody_image_submit_area_loader_spinner");p.src=w,f.style.visibility="visible",E.style.outline="1px solid red",f.addEventListener("click",()=>{Ot(m,y.project_id),b.style.visibility="visible"})}else console.log("No file selected.")}l.addEventListener("dragover",m=>{m.preventDefault()}),l.addEventListener("drop",m=>{m.preventDefault();const y=m.dataTransfer.files;_(y[0],e)}),v.addEventListener("click",()=>{const m=document.createElement("input");m.type="file",m.accept="image/*",m.addEventListener("change",y=>{const w=y.target.files[0];_(w,e)}),m.click()})}function cn(){const e=document.getElementById("MENUmodalBody_image_submit_area_loader_spinner");e.style.visibility="hidden",k(),kt()}function rn(e){const t=document.getElementById(e),n=document.documentElement.clientWidth,i=document.documentElement.clientHeight,o=t.offsetWidth,s=t.getBoundingClientRect().left,a=t.getBoundingClientRect().top,c=t.getBoundingClientRect().height,r=o+s,d=c+a;let l=!1,v=!1;return r>n&&(l=!0),d>i&&(v=!0),{xOverflow:l,yOverflow:v}}function ln(e){const t=e.displayText,n=e.optionalSVG;let i;"colour"in e?i=e.colour:i="white";const o=document.getElementById("MENUmodalBody");let s=new RegExp("\\{MENU_item_text\\}","g"),a=Lt.replace(s,t);if(s=new RegExp("\\{MENU_item_colour\\}","g"),a=a.replace(s,i),n!=="None"){s=new RegExp("\\{MENU_item_image\\}","g");const c="{"+n+"}";a=a.replace(s,c);for(const[r,d]of Object.entries(h)){const l=new RegExp(`\\{${r}\\}`,"g");a=a.replace(l,d)}o.innerHTML+=a;return}else{a=a.replace(/<img[^>]+>/g,""),o.innerHTML+=a;return}}function _e(e){const t=document.getElementById("MENUmodalEnvironment"),n=document.querySelector("main"),i=window.matchMedia("screen and (orientation: portrait) and (max-width: 768px) and (pointer: coarse) "),o=document.querySelector(".topHalf-container");if(e.target===t){t.style.display="none",i.matches&&(n.style.zIndex="1",o.style.zIndex="10");return}}function k(){const e=document.getElementById("MENUmodalEnvironment"),t=document.querySelector("main"),n=window.matchMedia("screen and (orientation: portrait) and (max-width: 768px) and (pointer: coarse) "),i=document.querySelector(".topHalf-container");e.style.display="none",n.matches&&(t.style.zIndex="1",i.style.zIndex="10")}const dn={MENU_ACTION_playNext(e){console.log(e)},MENU_ACTION_playLast(){console.log("meny aacction play next")},PROJECT_VIEW_delete_project(e){Ft(e)},PLAYBACK_add_songs_to_queue(e){On(e)}};let O="visible";function un(){ht();const e=document.getElementById("queueButton"),t=document.getElementById("QUEUEclearQueueButton");z(O),e.addEventListener("click",mn),t.addEventListener("click",pn),x()}function mn(){if(O==="hidden"){O="visible",z(O);return}if(O==="visible"){O="hidden",z(O);return}}function z(e){document.getElementById("queueButton");const t=document.getElementById("queueIcon"),n=document.getElementById("QUEUEenvironment");if(e=="visible"){t.style.filter="var(--make-svg-black)",document.documentElement.style.cssText="--TOPRIGHT-accountcontrols-queue-opacity: 100%",n.style.right="0%";return}if(e=="hidden"){t.style.filter="var(--make-svg-grey)",document.documentElement.style.cssText="--TOPRIGHT-accountcontrols-queue-opacity: 0%",n.style.right="calc((var(--width-of-left-bar-fortop) + 5rem) * -1)";return}}function x(){const e=document.getElementById("QUEUEbottomContainer");e.innerHTML="";for(let t=g+1;t<u.length;t++){u[t].id=t;const n=u[t],i=yn(n),o=document.createElement("div");o.innerHTML=i,o.addEventListener("click",function(c){const d=c.target.dataset.songId;se(d)}),o.dataset.songId=n.id,o.addEventListener("click",se),o.dataset.songId=n.id;const s=o.querySelector(".QUEUE-item-image-removeIndicator");s.addEventListener("click",En),s.dataset.songID=n.id;const a=o.querySelector(".QUEUE-item-up-next-queue-item-context-call");a.dataset.songSet=n.id,a.addEventListener("click",function(c){c.target===a&&_n(c)}),o.addEventListener("dragstart",gn),o.addEventListener("dragover",vn),o.addEventListener("drop",fn),e.appendChild(o)}}function pn(){const e=g+1;e>=0&&e<u.length?u.splice(e):u.length=0,x()}function gn(e){const t=e.target;e.dataTransfer.setData("text/plain",t.dataset.songId)}function vn(e){e.preventDefault(),e.dataTransfer.dropEffect="move"}function fn(e){e.preventDefault();const t=e.dataTransfer.getData("text/plain"),n=e.target,i=u.find(c=>c.id===parseInt(t)),o=u.find(c=>c.id===parseInt(n.dataset.songId)),s=u.indexOf(i),a=u.indexOf(o);s!==-1&&a!==-1&&(u.splice(s,1),u.splice(a,0,i),x())}function En(e){e.stopPropagation();const t=e.target,n=parseInt(t.dataset.songID),i=u.findIndex(o=>o.id===n);i!==-1&&u.splice(i,1),x()}function _n(e){e.stopPropagation();const i=[{displayText:"Play next",optionalSVG:"icons_playlist",function:"MENU_ACTION_playNext",optionalParams:{queueID:e.target.getAttribute("data-song-set")}},{displayText:"Play later",optionalSVG:"icons_backButton",function:"None"},{displayText:"Love",optionalSVG:"None",function:"None"},{displayText:"Less like this",optionalSVG:"None",function:"None"},{displayText:"Rate",optionalSVG:"None",function:"None"}];P(i,e)}function se(e){const t=songs.find(n=>n.id===parseInt(e));if(t){console.log("Clicked song:",t);return}}function yn(e){const t=["QUEUE_item_image","QUEUE_item_title","QUEUE_item_artist","icons_menuOptionsButton","QUEUE_item_timeIndicator"],n=e.img,i=e.song_name,o=e.project_contributors,s=`${Math.floor(e.duration/60)}:${(e.duration%60).toString().padStart(2,"0")}`;let a=Ct;for(let d=0;d<t.length;d++){const l=t[d].toString(),v=new RegExp(`\\{${l}\\}`,"g");let p="";l==="QUEUE_item_image"?p=`${T}/${n}/3/`:l==="QUEUE_item_title"?p=i:l==="QUEUE_item_artist"?p=o:l==="icons_menuOptionsButton"?p=me:l==="QUEUE_item_timeIndicator"&&(p=s),a=a.replace(v,p)}a=a.replace("<div",`<div data-song-id="${e.id}"`);const c=document.createElement("div");return c.innerHTML=a,c.querySelector(".QUEUE-item-image-removeIndicator").addEventListener("click",function(){console.log("Clicked remove indicator for song ID:",e.id)}),c.innerHTML}const Tn=`<div class="LCDbody">
...
</div>`;async function no(){try{const e=document.getElementById("MAINcontentPages");so();const t=await io();ao(t);return}catch(e){console.error("Error in initMusicObjectsGrid:",e)}}function oo(){const e=document.getElementById("MAINcontentPages"),t=document.getElementById("MOGcontainer");t!==null&&t.removeEventListener("click",Be),e.innerHTML=""}async function io(){try{const e=localStorage.getItem("JWT");if(!e)return console.log("no jwt"),[];const t={"access-token":e},o=(await(await fetch(`${C}/projects/get-projects/`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})).json()).projects;return Array.isArray(o)?o.map(a=>({img:a.picture_url,top:a.project_name,bottom:a.project_contributors,days:a.time_created,project_id:a.project_id})):(console.log("Projects is not an array:",o),[])}catch(e){return console.error("Error:",e),[]}}function so(){let e="MAINcontentPages",t=Xn;for(const[n,i]of Object.entries(h)){const o=new RegExp(`\\{${n}\\}`,"g");t=t.replace(o,i)}document.getElementById(e).innerHTML+=t}function ao(e){const t=document.getElementById("MOGgridContainer");t.innerHTML="";let n=to;for(const[r,d]of Object.entries(h)){const l=new RegExp(`\\{${r}\\}`,"g");n=n.replace(l,d)}t.innerHTML+=n;const i=e.length;for(var o=0;o<=i-1;o++){let r=eo;const d=["MOG_image","MOG_text1","MOG_text2","MOG_checkedDate","MOGI_placeholder_itemID"],l=o,v=e[o].img,p=e[o].top,f=e[o].bottom,E=e[o].days,_=ro(E);for(const[m,y]of Object.entries(h)){const w=new RegExp(`\\{${m}\\}`,"g");r=r.replace(w,y)}for(let m=0;m<d.length;m++){const y=d[m].toString(),w=new RegExp(`\\{${y}\\}`,"g");let b="";y==="MOG_image"?b=`${T}/${v}/4/`:y==="MOG_text1"?b=p:y==="MOG_text2"?b=f:y==="MOG_checkedDate"?b=_:y==="MOGI_placeholder_itemID"&&(b=l),r=r.replace(w,b)}t.innerHTML+=r}const s=document.getElementById("MOGcontainer");s.addEventListener("click",function(r){Be(r,e)});let a;s.addEventListener("touchstart",function(r){r.timeStamp,a=setTimeout(function(){c(r,e)},500)}),s.addEventListener("touchend",function(r){r.timeStamp,clearTimeout(a)});function c(r,d){navigator.vibrate(1e3);const v=r.target.id.split("-")[1],p=d[v].project_id;console.log(p),Pe(r,p)}}async function co(e){try{const t=localStorage.getItem("JWT");if(!t){console.log("no jwt");return}const n={"access-token":t,project_id:e};return(await(await fetch(`${C}/projects/get-project-details/`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(n)})).json()).project_details}catch(t){console.error("Error:",t)}}async function Be(e,t){const n=e.target;if(n.classList.contains("MOG-item-controls-play")){const i=n.id.split("-")[1],o=t[i].project_id,s=await co(o);Te(s)}if(n.classList.contains("MOG-item-controls-menu")){const i=n.id.split("-")[1],o=t[i].project_id;Pe(e,o)}if(n.classList.contains("MOG-itemContainer"))if(n.id!=="MOGaddNewItem"){const i=n.id.split("-")[1],o=t[i].project_id;M(`/projects/${o}`)}else n.id==="MOGaddNewItem"&&lo()}function Pe(e,t){e.stopPropagation(),P([{displayText:"Play next",optionalSVG:"icons_playlist",optionalParams:{PROJECT_ID:t,QUEUE_POSITION:"next"},function:"PLAYBACK_add_songs_to_queue"},{displayText:"Play later",optionalSVG:"icons_playlist",optionalParams:{PROJECT_ID:t,QUEUE_POSITION:"later"},function:"PLAYBACK_add_songs_to_queue"}],e)}function ro(e){const n=(Date.now()-e)/(1e3*60*60*24);let i;return n<.01||n<1?(i="Now",i):n<8?(i=Math.floor(n)+"d",i):n<29?(i=Math.floor(n/7)+"w",i):n<365?(i=Math.floor(n/28)+"m",i):(i=Math.floor(n/365)+"y",i)}function lo(){M("/new-project/")}const uo=`<div class="SETTINGSmodalEnvironment" id="SETTINGSmodalID">
...
</div>`;let A=!1,ce=!1,re=!1;async function Eo(){await To()?Oe():re||(_o(),re=!0)}function _o(){Io();let e;const t=document.getElementById("SETTINGSmodalSignupButton");fetch(`${C}/status/are_signups_allowed/`).then(s=>{if(!s.ok)throw new Error("Network response was not ok");return s.json()}).then(s=>{e=s.signups_allowed,e&&(t.style.display="inline-block",t.addEventListener("click",()=>{console.log("signup button was pressed"),de(),mo()}))}).catch(s=>{console.error("Fetch error:",s)});const n=document.getElementById("SETTINGSloginForm"),i=document.getElementById("email"),o=document.getElementById("password");n.addEventListener("submit",async s=>{if(s.preventDefault(),A)return!1;A=!0;const a=i.value,c=o.value;try{await yo(a,c)?(ce=!0,ho(),Oe(),setTimeout(de,2e3)):(ce=!1,Co(),console.log("Login failed. Retry!")),A=!1}catch(r){console.error("Error:",r),A=!1}return!1})}async function yo(e,t){try{const i=await(await fetch(`${C}/login/`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:e,password:t})})).json();if(i.authenticated===!0){const o=i.jwt;localStorage.setItem("JWT",o)}return i.authenticated}catch(n){return console.error("Error:",n),!1}}async function To(){try{if(localStorage.getItem("JWT")==null)return!1}catch(e){return console.error("Error accessing localStorage:",e),!1}try{const e=localStorage.getItem("JWT");return(await(await fetch(`${C}/prelogin/`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({jwt:e})})).json()).authenticated}catch(e){return console.error("Error:",e),!1}}function Io(){let e="MAINcontentPages",t=fo;document.getElementById(e).innerHTML+=t}let le=!1;function de(){if(le===!0)return;document.getElementById("SETTINGSmodalID").remove(),le=!0}function ho(){const e=document.querySelector(".SETTINGSmodalStatusIndicatorOuterCircle");e.classList.remove("SETTINGSanimateError","SETTINGSanimateGreen"),e.classList.add("SETTINGSanimateGreen"),e.addEventListener("animationend",()=>{e.classList.remove("SETTINGSanimateGreen")})}function Co(){const e=document.querySelector(".SETTINGSmodalStatusIndicatorOuterCircle");e.classList.remove("SETTINGSanimateError","SETTINGSanimateGreen"),e.classList.add("SETTINGSanimateError"),e.addEventListener("animationend",()=>{e.classList.remove("SETTINGSanimateError")})}const C="https://om2apis.la0.uk",T="https://om2media.la0.uk";async function Oe(){Sn(),Tt(),It(),In(),Jn(),Qn(),zn(),Vn(),un();function e(){const o=window.location.pathname;M(o)}window.addEventListener("popstate",e);const t=await St("last_state"),n=JSON.parse(t[0].last_state);if(n!=null){const o=n.current_path;M(o),Pn(n)}else e();function i(){const o=window.location.pathname,s=u,a=g,c=Dn();c.current_path=o,c.current_queue=s,c.current_index=a,Mt("last_state",c)}setInterval(i,2e4)}function bo(){At(),no()}function wo(e){oo(),Nt()}const ue={"/":bo,"/new-project/":jt,"/projects/:projectID":wo};function Lo(){console.log("notFoundHandler")}function M(e){const t=Object.keys(ue);for(const n of t){const i=new RegExp(`^${n.replace(/:[^\s/]+/g,"([^/]+)")}$`),o=e.match(i);if(o){const s=ue[n],a=o.slice(1);s(...a),e!=="/new-project/"&&history.pushState({},"",e);return}}Lo()}document.getElementById("app").innerHTML=Me;Eo();
