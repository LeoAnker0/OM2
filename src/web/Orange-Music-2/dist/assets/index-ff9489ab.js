...
</div>`,me="/assets/volume_null-e39cf06f.svg",pe="/assets/recently_added-a0a983c6.svg",ge="/assets/volume_3-c8ab0a75.svg",ve="/assets/orange_music_text_logo_black-12e7386c.svg",fe="/assets/volume_2-cfdac9da.svg",Ee="/assets/browse_2-85030bba.svg",ye="/assets/volume_1-27e93416.svg",Te="/assets/orange_music_logo_white-2a680ea2.svg",_e="/assets/search_icon-4f5e4381.svg",he="/assets/orange_music_text_logo_black-91f9e706.png",Ie="/assets/up_next_queue_button-14fedba2.svg",Ce="/assets/orange_music_logo_yellow-a109ff64.svg",we="/assets/playlist-c6e9024f.svg",be="/assets/loop_button-aef56865.svg",Le="/assets/help_icon-867fec9d.svg",Oe="/assets/play_button-b1e2d3a4.svg",Pe="/assets/browse-14744f27.svg",$="/assets/menu_options_button-a1d7bbe3.svg",Me="/assets/orange_music_text_logo_white-7f0ba909.svg",Re="/assets/back_button-8128cade.svg",Be="/assets/Albums-2e81dc74.svg",je="/assets/songs-016b7188.svg",xe="/assets/orange_music_logo_black-4d7e4591.svg",Se="/assets/your_uploaded_songs-06535705.svg",Ne="/assets/artist-ab677d43.svg",De="/assets/shuffle_button-c2f06bc4.svg",Ae="/assets/orange_music_text_logo_white-4907051e.png",ke="/assets/listen_now-c7438154.svg",Je="/assets/derpy-21c20ae5.svg",Ue="/assets/next_button-9a850710.svg",Ge="/assets/recently_added-7ff28139.svg",He="/assets/play_button-5eeedbe6.svg",Ye="/assets/browse-e8be8609.svg",qe="/assets/albums-681507b8.svg",ze="/assets/listen_now.2-bfa293ac.svg",Qe="/assets/your_uploads-02e5c93c.svg",$e="/assets/play_button.2-fc90fac7.svg",Ve="/assets/listen_now-fb02ffce.svg",Fe="/assets/browse.2-15b501dd.svg",We="/assets/place_holder_image-d4006a96.svg",Ke="/assets/icons_MOGitems_add-19e679f7.svg",y={icons_volumeNull:me,icons_recentlyAdded:pe,icons_volume3:ge,icons_orangeMusicTextLogoBlack:ve,icons_volume2:fe,icons_browse2:Ee,icons_volume1:ye,icons_orangeMusicLogoWhite:Te,icons_searchIcon:_e,icons_orangeMusicTextLogoBlackPng:he,icons_queueButton:Ie,icons_orangeMusicLogoYellow:Ce,icons_playlist:we,icons_loopButton:be,icons_helpIcon:Le,icons_playButton:Oe,icons_browse:Pe,icons_menuOptionsButton:$,icons_orangeMusicTextLogoWhite:Me,icons_backButton:Re,icons_Albums:Be,icons_songs:je,icons_orangeMusicLogoBlack:xe,icons_yourUploadedSongs:Se,icons_artist:Ne,icons_shuffleButton:De,icons_orangeMusicTextLogoWhitePng:Ae,icons_listenNow:ke,icons_derpy:Je,icons_nextButton:Ue,icons_recentlyAddedV2:Ge,icons_playButtonV2:He,icons_browseV2:Ye,icons_albumsV2:qe,icons_listenNow2V2:ze,icons_yourUploads:Qe,icons_playButton2:$e,icons_listenNowV2:Ve,icons_browse2V2:Fe,v3_placeholder:We,icons_MOGitems_add:Ke};function Ze(){let e="topleftContentArea",t=le;for(const[n,o]of Object.entries(y)){const i=new RegExp(`\\{${n}\\}`,"g");t=t.replace(i,o)}document.getElementById(e).innerHTML=t}function Xe(){let e="toprightContentArea",t=de;for(const[n,o]of Object.entries(y)){const i=new RegExp(`\\{${n}\\}`,"g");t=t.replace(i,o)}document.getElementById(e).innerHTML=t}function et(){let e="MAINcontentContainer",t=ue;for(const[n,o]of Object.entries(y)){const i=new RegExp(`\\{${n}\\}`,"g");t=t.replace(i,o)}document.getElementById(e).innerHTML+=t}const tt=`<div class="QUEUE-item-container" draggable="true">
...
</div>`;async function On(){try{const e=document.getElementById("MAINcontentPages");Rn();const t=await Mn();Bn(t);return}catch(e){console.error("Error in initMusicObjectsGrid:",e)}}function Pn(){const e=document.getElementById("MAINcontentPages"),t=document.getElementById("MOGcontainer");t!==null&&t.removeEventListener("click",oe),e.innerHTML=""}async function Mn(){try{const e=localStorage.getItem("JWT");if(!e)return console.log("no jwt"),[];const t={"access-token":e},i=(await(await fetch(`${C}/projects/get-projects/`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})).json()).projects;return Array.isArray(i)?i.map(c=>({img:c.picture_url,top:c.project_name,bottom:c.project_contributors,days:c.time_created,project_id:c.project_id})):(console.log("Projects is not an array:",i),[])}catch(e){return console.error("Error:",e),[]}}function Rn(){let e="MAINcontentPages",t=wn;for(const[n,o]of Object.entries(y)){const i=new RegExp(`\\{${n}\\}`,"g");t=t.replace(i,o)}document.getElementById(e).innerHTML+=t}function Bn(e){const t=document.getElementById("MOGgridContainer");t.innerHTML="";let n=Ln;for(const[r,d]of Object.entries(y)){const l=new RegExp(`\\{${r}\\}`,"g");n=n.replace(l,d)}t.innerHTML+=n;const o=e.length;for(var i=0;i<=o-1;i++){let r=bn;const d=["MOG_image","MOG_text1","MOG_text2","MOG_checkedDate","MOGI_placeholder_itemID"],l=i,p=e[i].img,m=e[i].top,g=e[i].bottom,f=e[i].days,v=xn(f);for(const[E,u]of Object.entries(y)){const w=new RegExp(`\\{${E}\\}`,"g");r=r.replace(w,u)}for(let E=0;E<d.length;E++){const u=d[E].toString(),w=new RegExp(`\\{${u}\\}`,"g");let _="";u==="MOG_image"?_=p:u==="MOG_text1"?_=m:u==="MOG_text2"?_=g:u==="MOG_checkedDate"?_=v:u==="MOGI_placeholder_itemID"&&(_=l),r=r.replace(w,_)}t.innerHTML+=r}const s=document.getElementById("MOGcontainer");s.addEventListener("click",function(r){oe(r,e)});let c;s.addEventListener("touchstart",function(r){r.timeStamp,c=setTimeout(function(){a(r,e)},500)}),s.addEventListener("touchend",function(r){r.timeStamp,clearTimeout(c)});function a(r,d){navigator.vibrate(1e3);const p=r.target.id.split("-")[1],m=d[p].project_id;console.log(m),ie(r)}}async function jn(e){try{const t=localStorage.getItem("JWT");if(!t){console.log("no jwt");return}const n={"access-token":t,project_id:e};return(await(await fetch(`${C}/projects/get-project-details/`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(n)})).json()).project_details}catch(t){console.error("Error:",t)}}async function oe(e,t){const n=e.target;if(n.classList.contains("MOG-item-controls-play")){const o=n.id.split("-")[1],i=t[o].project_id,s=await jn(i);ee(s)}if(n.classList.contains("MOG-item-controls-menu")){const o=n.id.split("-")[1];t[o].project_id,ie(e)}if(n.classList.contains("MOG-itemContainer"))if(n.id!=="MOGaddNewItem"){const o=n.id.split("-")[1],i=t[o].project_id;P(`/projects/${i}`)}else n.id==="MOGaddNewItem"&&Sn()}function ie(e){e.stopPropagation(),e.target,L([{displayText:"Play next",optionalSVG:"icons_playlist",function:"None"},{displayText:"Play later",optionalSVG:"icons_derpy",function:"None"}],e)}function xn(e){const n=(Date.now()-e)/(1e3*60*60*24);let o;return n<.01||n<1?(o="Now",o):n<8?(o=Math.floor(n)+"d",o):n<29?(o=Math.floor(n/7)+"w",o):n<365?(o=Math.floor(n/28)+"m",o):(o=Math.floor(n/365)+"y",o)}function Sn(){P("/new-project/")}const Nn=`<div class="SETTINGSmodalEnvironment" id="SETTINGSmodalID">
...
</div>`;let R=!1,Y=!1,q=!1;async function Dn(){await Jn()?ce():q||(An(),q=!0)}function An(){Un();const e=document.getElementById("SETTINGSloginForm"),t=document.getElementById("email"),n=document.getElementById("password");e.addEventListener("submit",async o=>{if(o.preventDefault(),R)return!1;R=!0;const i=t.value,s=n.value;try{await kn(i,s)?(Y=!0,Hn(),ce(),setTimeout(Gn,2e3)):(Y=!1,Yn(),console.log("Login failed. Retry!")),R=!1}catch(c){console.error("Error:",c),R=!1}return!1})}async function kn(e,t){try{const o=await(await fetch(`${C}/login/`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:e,password:t})})).json();if(o.authenticated===!0){const i=o.jwt;localStorage.setItem("JWT",i)}return o.authenticated}catch(n){return console.error("Error:",n),!1}}async function Jn(){try{if(localStorage.getItem("JWT")==null)return!1}catch(e){return console.error("Error accessing localStorage:",e),!1}try{const e=localStorage.getItem("JWT");return(await(await fetch(`${C}/prelogin/`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({jwt:e})})).json()).authenticated}catch(e){return console.error("Error:",e),!1}}function Un(){let e="MAINcontentPages",t=Nn;document.getElementById(e).innerHTML+=t}let z=!1;function Gn(){if(z===!0)return;document.getElementById("SETTINGSmodalID").remove(),z=!0}function Hn(){const e=document.querySelector(".SETTINGSmodalStatusIndicatorOuterCircle");e.classList.remove("SETTINGSanimateError","SETTINGSanimateGreen"),e.classList.add("SETTINGSanimateGreen"),e.addEventListener("animationend",()=>{e.classList.remove("SETTINGSanimateGreen")})}function Yn(){const e=document.querySelector(".SETTINGSmodalStatusIndicatorOuterCircle");e.classList.remove("SETTINGSanimateError","SETTINGSanimateGreen"),e.classList.add("SETTINGSanimateError"),e.addEventListener("animationend",()=>{e.classList.remove("SETTINGSanimateError")})}const C="https://om2apis.la0.uk",se="https://om2media.la0.uk";function ce(){nn(),Ze(),Xe(),$t(),un(),Tn(),En(),_n(),At();function e(){const t=window.location.pathname;P(t)}window.addEventListener("popstate",e),e()}function qn(){mt(),On()}function zn(e){Pn(),ut()}const Q={"/":qn,"/new-project/":dt,"/projects/:projectID":zn};function Qn(){console.log("notFoundHandler")}function P(e){const t=Object.keys(Q);for(const n of t){const o=new RegExp(`^${n.replace(/:[^\s/]+/g,"([^/]+)")}$`),i=e.match(o);if(i){const s=Q[n],c=i.slice(1);s(...c),e!=="/new-project/"&&history.pushState({},"",e);return}}Qn()}document.getElementById("app").innerHTML=re;Dn();
