...
</div>`;async function it(e,t){const n=new XMLHttpRequest,o=new FormData,i=localStorage.getItem("JWT");o.append("file",e),o.append("project_id",t),o.append("jwt",i),n.upload.onprogress=function(s){if(s.lengthComputable){const c=s.loaded/s.total*100;console.log("percentCompleted:	",c),c===100&&console.log("the file upload is finished")}},n.onload=function(){console.log("the file has been uplaoded")},n.onerror=function(){console.log("there was an error with the upload")},n.open("POST",`${w}/files/upload/photo/`,!0),n.send(o)}async function st(e,t){Array.isArray(e)||(e=[e]);for(const n of e)await it(n,t)}const ct=`<div class="MENUmodalItemContainer">
