...
</div>`;const w="MAIN_API_DOMAIN",y="MAIN_MEDIA_DOMAIN";async function rt(){Xo(),un(),mn(),qo(),ri(),fi(),gi(),An(),Mo(),Yn()}let pe=Si;for(const[e,t]of Object.entries(E)){const n=new RegExp(`\\{${e}\\}`,"g");pe=pe.replace(n,t)}document.getElementById("app").innerHTML=pe;Ii();
