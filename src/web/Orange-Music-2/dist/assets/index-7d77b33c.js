...
</div>`;let z=!1,Ee=!1,ye=!1;async function jo(){await ko()?Ue():ye||(No(),ye=!0)}function No(){Jo();let e;const t=document.getElementById("SETTINGSmodalSignupButton");fetch(`${C}/status/are_signups_allowed/`).then(s=>{if(!s.ok)throw new Error("Network response was not ok");return s.json()}).then(s=>{e=s.signups_allowed,e&&(t.style.display="inline-block",t.addEventListener("click",()=>{console.log("signup button was pressed"),he(),Mo()}))}).catch(s=>{console.error("Fetch error:",s)});const n=document.getElementById("SETTINGSloginForm"),o=document.getElementById("email"),i=document.getElementById("password");n.addEventListener("submit",async s=>{if(s.preventDefault(),z)return!1;z=!0;const a=o.value,c=i.value;try{await Ao(a,c)?(Ee=!0,Go(),Ue(),setTimeout(he,2e3)):(Ee=!1,Uo(),console.log("Login failed. Retry!")),z=!1}catch(r){console.error("Error:",r),z=!1}return!1})}async function Ao(e,t){try{const o=await(await fetch(`${C}/login/`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:e,password:t})})).json();if(o.authenticated===!0){const i=o.jwt;localStorage.setItem("JWT",i)}return o.authenticated}catch(n){return console.error("Error:",n),!1}}async function ko(){try{if(localStorage.getItem("JWT")==null)return!1}catch(e){return console.error("Error accessing localStorage:",e),!1}try{const e=localStorage.getItem("JWT");return(await(await fetch(`${C}/prelogin/`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({jwt:e})})).json()).authenticated}catch(e){return console.error("Error:",e),!1}}function Jo(){let e="MAINcontentPages",t=xo;document.getElementById(e).innerHTML+=t}let Te=!1;function he(){if(Te===!0)return;document.getElementById("SETTINGSmodalID").remove(),Te=!0}function Go(){const e=document.querySelector(".SETTINGSmodalStatusIndicatorOuterCircle");e.classList.remove("SETTINGSanimateError","SETTINGSanimateGreen"),e.classList.add("SETTINGSanimateGreen"),e.addEventListener("animationend",()=>{e.classList.remove("SETTINGSanimateGreen")})}function Uo(){const e=document.querySelector(".SETTINGSmodalStatusIndicatorOuterCircle");e.classList.remove("SETTINGSanimateError","SETTINGSanimateGreen"),e.classList.add("SETTINGSanimateError"),e.addEventListener("animationend",()=>{e.classList.remove("SETTINGSanimateError")})}const C="https://om2apis.la0.uk",T="https://om2media.la0.uk";async function Ue(){Vn(),jt(),Nt(),Jn(),io(),po(),uo(),go(),Pn();function e(){const i=window.location.pathname;D(i)}window.addEventListener("popstate",e);const t=await Qt("last_state"),n=JSON.parse(t[0].last_state);if(n!=null){const i=n.current_path;D(i),zn(n)}else e();function o(){const i=window.location.pathname,s=u,a=g,c=Zn();c.current_path=i,c.current_queue=s,c.current_index=a,zt("last_state",c)}setInterval(o,2e4)}function qo(){en(),ho()}function Ho(e){bo(),Xt()}const be={"/":qo,"/new-project/":Zt,"/projects/:projectID":Ho};function $o(){console.log("notFoundHandler")}function D(e){const t=Object.keys(be);for(const n of t){const o=new RegExp(`^${n.replace(/:[^\s/]+/g,"([^/]+)")}$`),i=e.match(o);if(i){const s=be[n],a=i.slice(1);s(...a),e!=="/new-project/"&&history.pushState({},"",e);return}}$o()}let ie=Ye;for(const[e,t]of Object.entries(h)){const n=new RegExp(`\\{${e}\\}`,"g");ie=ie.replace(n,t)}document.getElementById("app").innerHTML=ie;jo();
