...
</div>`;async function bn(){try{const e=document.getElementById("MAINcontentPages");Pn();const t=await Ln();Mn(t);return}catch(e){console.error("Error in initMusicObjectsGrid:",e)}}function On(){const e=document.getElementById("MAINcontentPages"),t=document.getElementById("MOGcontainer");t!==null&&t.removeEventListener("click",oe),e.innerHTML=""}async function Ln(){try{const e=localStorage.getItem("JWT");if(!e)return console.log("no jwt"),[];const t={"access-token":e},i=(await(await fetch(`${h}/projects/get-projects/`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})).json()).projects;return Array.isArray(i)?i.map(c=>({img:c.picture_url,top:c.project_name,bottom:c.project_contributors,days:c.time_created,project_id:c.project_id})):(console.log("Projects is not an array:",i),[])}catch(e){return console.error("Error:",e),[]}}function Pn(){let e="MAINcontentPages",t=hn;for(const[n,o]of Object.entries(v)){const i=new RegExp(`\\{${n}\\}`,"g");t=t.replace(i,o)}document.getElementById(e).innerHTML+=t}function Mn(e){const t=document.getElementById("MOGgridContainer");t.innerHTML="";let n=wn;for(const[r,d]of Object.entries(v)){const l=new RegExp(`\\{${r}\\}`,"g");n=n.replace(l,d)}t.innerHTML+=n;const o=e.length;for(var i=0;i<=o-1;i++){let r=Cn;const d=["MOG_image","MOG_text1","MOG_text2","MOG_checkedDate","MOGI_placeholder_itemID"],l=i,m=e[i].img,u=e[i].top,p=e[i].bottom,E=e[i].days,g=Bn(E);for(const[y,I]of Object.entries(v)){const M=new RegExp(`\\{${y}\\}`,"g");r=r.replace(M,I)}for(let y=0;y<d.length;y++){const I=d[y].toString(),M=new RegExp(`\\{${I}\\}`,"g");let C="";I==="MOG_image"?C=m:I==="MOG_text1"?C=u:I==="MOG_text2"?C=p:I==="MOG_checkedDate"?C=g:I==="MOGI_placeholder_itemID"&&(C=l),r=r.replace(M,C)}t.innerHTML+=r}const s=document.getElementById("MOGcontainer");s.addEventListener("click",function(r){oe(r,e)});let c;s.addEventListener("touchstart",function(r){r.timeStamp,c=setTimeout(function(){a(r,e)},500)}),s.addEventListener("touchend",function(r){r.timeStamp,clearTimeout(c)});function a(r,d){navigator.vibrate(1e3);const m=r.target.id.split("-")[1],u=d[m].project_id;console.log(u),ie(r)}}async function Rn(e){try{const t=localStorage.getItem("JWT");if(!t){console.log("no jwt");return}const n={"access-token":t,project_id:e};return(await(await fetch(`${h}/projects/get-project-details/`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(n)})).json()).project_details}catch(t){console.error("Error:",t)}}async function oe(e,t){const n=e.target;if(n.classList.contains("MOG-item-controls-play")){const o=n.id.split("-")[1],i=t[o].project_id,s=await Rn(i);ee(s)}if(n.classList.contains("MOG-item-controls-menu")){const o=n.id.split("-")[1];t[o].project_id,ie(e)}if(n.classList.contains("MOG-itemContainer"))if(n.id!=="MOGaddNewItem"){const o=n.id.split("-")[1],i=t[o].project_id;L(`/projects/${i}`)}else n.id==="MOGaddNewItem"&&jn()}function ie(e){e.stopPropagation(),e.target,b([{displayText:"Play next",optionalSVG:"icons_playlist",function:"None"},{displayText:"Play later",optionalSVG:"icons_derpy",function:"None"}],e)}function Bn(e){const n=(Date.now()-e)/(1e3*60*60*24);let o;return n<.01||n<1?(o="Now",o):n<8?(o=Math.floor(n)+"d",o):n<29?(o=Math.floor(n/7)+"w",o):n<365?(o=Math.floor(n/28)+"m",o):(o=Math.floor(n/365)+"y",o)}function jn(){L("/new-project/")}const xn=`<div class="SETTINGSmodalEnvironment" id="SETTINGSmodalID">
...
</div>`;let R=!1,Y=!1,z=!1;async function Sn(){await An()?ce():z||(Nn(),z=!0)}function Nn(){kn();const e=document.getElementById("SETTINGSloginForm"),t=document.getElementById("email"),n=document.getElementById("password");e.addEventListener("submit",async o=>{if(o.preventDefault(),R)return!1;R=!0;const i=t.value,s=n.value;try{await Dn(i,s)?(Y=!0,Gn(),ce(),setTimeout(Jn,2e3)):(Y=!1,Un(),console.log("Login failed. Retry!")),R=!1}catch(c){console.error("Error:",c),R=!1}return!1})}async function Dn(e,t){try{const o=await(await fetch(`${h}/login/`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:e,password:t})})).json();if(o.authenticated===!0){const i=o.jwt;localStorage.setItem("JWT",i)}return o.authenticated}catch(n){return console.error("Error:",n),!1}}async function An(){try{if(localStorage.getItem("JWT")==null)return!1}catch(e){return console.error("Error accessing localStorage:",e),!1}try{const e=localStorage.getItem("JWT");return(await(await fetch(`${h}/prelogin/`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({jwt:e})})).json()).authenticated}catch(e){return console.error("Error:",e),!1}}function kn(){let e="MAINcontentPages",t=xn;document.getElementById(e).innerHTML+=t}let q=!1;function Jn(){if(q===!0)return;document.getElementById("SETTINGSmodalID").remove(),q=!0}function Gn(){const e=document.querySelector(".SETTINGSmodalStatusIndicatorOuterCircle");e.classList.remove("SETTINGSanimateError","SETTINGSanimateGreen"),e.classList.add("SETTINGSanimateGreen"),e.addEventListener("animationend",()=>{e.classList.remove("SETTINGSanimateGreen")})}function Un(){const e=document.querySelector(".SETTINGSmodalStatusIndicatorOuterCircle");e.classList.remove("SETTINGSanimateError","SETTINGSanimateGreen"),e.classList.add("SETTINGSanimateError"),e.addEventListener("animationend",()=>{e.classList.remove("SETTINGSanimateError")})}const h="https://testom2apis.la0.uk",se="https://testom2media.la0.uk";function ce(){en(),Ze(),Xe(),qt(),ln(),En(),vn(),yn(),Nt();function e(){const t=window.location.pathname;L(t)}window.addEventListener("popstate",e),e()}function Hn(){dt(),bn()}function Yn(e){On(),lt()}const Q={"/":Hn,"/new-project/":rt,"/projects/:projectID":Yn};function zn(){console.log("notFoundHandler")}function L(e){const t=Object.keys(Q);for(const n of t){const o=new RegExp(`^${n.replace(/:[^\s/]+/g,"([^/]+)")}$`),i=e.match(o);if(i){const s=Q[n],c=i.slice(1);s(...c),e!=="/new-project/"&&history.pushState({},"",e);return}}zn()}document.getElementById("app").innerHTML=re;Sn();
