...
function PLAYERresumePlayback() {
    ...
    let playIcon = "assets/iconsv2/play%20button.2.svg";
    let pauseIcon = "assets/icons/derpy.svg";
...
function PLAYERinit() {
    ...
    nextEventTrigger.addEventListener('click', () => {
        ...
        if (GLOBALloopState == "song" && lengthOfQueue != (PLAYERqueueIndex + 1)) {
            ...
            loopIcon.src = "assets/icons/loop%20button.svg";
...
function loopState() {
    ...
    let loopNormal = "assets/icons/loop%20button.svg"
    let loopOther = "assets/icons/derpy.svg"
