...
`;let Te=!1;function Eo(){const e=document.getElementById("MAINcontentContainer"),t=document.getElementById("uploadQueueModal"),n=document.getElementById("uploadQueueButton");e.innerHTML+=fo,n.addEventListener("click",function(o){Te==!1?bo(o):ve()}),t.innerHTML=vo}function yo(){const e=document.getElementById("UPLOAD_INDICATOR_container"),t=document.getElementById("uploadQueueButtonContainer");e.style.opacity="100%",t.style.visibility="visible"}function Qe(){const e=document.getElementById("uploadQueueButtonContainer"),t=document.getElementById("UPLOAD_INDICATOR_container");t.style.opacity="",e.style.visibility="",Te==!0&&U.length>0||ve()}function ue(e){const t=document.getElementById("UPLOADQUEUEBOTTOM_songName"),n=document.getElementById("UPLOADQUEUEBOTTOM_fileSize");if(U.length>0){t.innerHTML=U[0].file.name,n.innerHTML=te(U[0].file.size*1.75),ho(document.getElementById("specificChart"),e,!0);const i=document.getElementById("UPLOADQUEUEbottomContainer");for(;i.childNodes.length>2;)i.removeChild(i.lastChild);let s="";for(var o=U.length-1;o>=1;o--){const a=U[o].file.name,r=te(U[o].file.size*1.75);s+=`<div class="UPLOADQUEUE-bottom-items-next"><div class="itemName">${a}</div><div class="itemSize">${r}</div></div>`}i.innerHTML+=s}if(e==100){const i=document.getElementById("UPLOADQUEUEBOTTOM_bottom_text");i.innerHTML='Processing<span id="UPLOADQUEUEBOTTOM_fileSize"><span class="ANIMATIONS-EllipsisLoader"></span></span>'}}let Ve;function bo(e){Te=!0,Ve=document.activeElement;let t=e.clientX,n=e.clientY;const o=document.getElementById("uploadQueueModal");let i=t+"px",s=n+"px";MENUmodalEnvironment.addEventListener("click",ve),o.style.left=i,o.style.top=s;let a="mouse";if(e.webkitForce==1||e.webkitForce==0?e.webkitForce==0&&(a="keyboard"):e.pointerType!=="mouse"&&(a="keyboard"),a=="keyboard"){const p=Ve.getBoundingClientRect();t=p.left+window.scrollX,n=p.top+window.scrollY;let E=t+"px",y=n+"px";o.style.left=E,o.style.top=y}const r=o.offsetWidth,c=o.offsetHeight,d=Mt("uploadQueueModal");o.style.visibility="visible",document.addEventListener("keydown",u),d.xOverflow==!0&&(i=t-r+"px",o.style.left=i),d.yOverflow==!0&&(s=n-c+"px",o.style.top=s);function u(p){(p.key==="Escape"||p.keyCode===27)&&(document.removeEventListener("keydown",u),ve())}}function ve(){Te=!1;const e=document.getElementById("uploadQueueModal");e.style.visibility=""}function ho(e,t,n){t=Math.round(t),t>100?t=100:t<0&&(t=0);var o=Math.round(360*(t/100)),i=e.querySelector(".pie"),s=e.querySelector(".right-side");t>50?(i.style.clip="rect(auto, auto, auto, auto)",s.style.transform="rotate(180deg)"):(i.style.clip="rect(0, 1em, 1em, 0.5em)",s.style.transform="rotate(0deg)"),n?(s.style.borderWidth="0.1em",e.querySelector(".left-side").style.borderWidth="0.1em",e.querySelector(".shadow").style.borderWidth="0.1em"):(s.style.borderWidth="0.5em",e.querySelector(".left-side").style.borderWidth="0.5em",e.querySelector(".shadow").style.borderWidth="0.5em"),e.querySelector(".num").textContent=t,e.querySelector(".left-side").style.transform="rotate("+o+"deg)"}const ze=1500;let vt=0,Re=[],xe;function O(e,t){const o=new Date().getTime();Re.push({notificationText:e,notificationType:t,time:o}),Et()}function Et(){const t=new Date().getTime(),n=Re.at(vt);Re.length>1?t-xe>ze?(Ke(n.notificationText,n.notificationType),xe=t):setTimeout(Et,ze):(Ke(n.notificationText,n.notificationType),xe=t)}function Ke(e,t){const n=document.getElementById("noticationContainer");let o;vt+=1,t=="error"?o="var(--whoopsie)":t=="success"?o="var(--success)":t=="background"?o="var(--background)":t=="orange"?o="var(--orange)":t=="primary"?o="var(--primary)":t=="secondary"&&(o="var(--secondary)");const i=document.createElement("div");i.style.backgroundColor=o,i.textContent=e,n.appendChild(i)}const To=`<div class="MOG-container" id="MOGcontainer">
...
</button>`,yt=30;let ne=0;async function Do(){try{const e=document.getElementById("MAINcontentPages");xo();const t=await wt(yt,ne);ne+=t.length,Ro(t),S()&&Po()}catch(e){console.error("Error in initMusicObjectsGrid:",e)}}function bt(){ne=0;const e=document.getElementById("MAINcontentPages"),t=document.getElementById("MOGcontainer");t!==null&&t.removeEventListener("click",ht),e.innerHTML=""}function xo(){let e="MAINcontentPages",t=To;for(const[n,o]of Object.entries(C)){const i=new RegExp(`\\{${n}\\}`,"g");t=t.replace(i,o)}document.getElementById(e).innerHTML+=t}function Ro(e){const t=document.getElementById("MOGgridContainer");t.innerHTML="";let n=Mo;for(const[a,r]of Object.entries(C)){const c=new RegExp(`\\{${a}\\}`,"g");n=n.replace(c,r)}t.innerHTML+=n,We(e);const o=document.getElementById("MOGcontainer");o.addEventListener("click",function(a){ht(a,e)});let i;o.addEventListener("touchstart",function(a){a.timeStamp,i=setTimeout(function(){s(a,e)},500)}),o.addEventListener("touchend",function(a){a.timeStamp,clearTimeout(i)});function s(a,r){navigator.vibrate(1e3);const d=a.target.id.split("-")[1],u=r[d].project_id;Tt(a,u)}t.addEventListener("scroll",async function(){const a=t.scrollTop,r=t.scrollHeight,c=t.clientHeight;if(a>=r-c){const d=await wt(yt,ne);ne+=d.length,d.length>0&&We(d)}})}function We(e){const t=document.getElementById("MOGgridContainer"),n=e.length;for(var o=0;o<=n-1;o++){const i=["MOG_image","MOG_text1","MOG_text2","MOG_checkedDate","MOGI_placeholder_itemID"],s=o,a=e[o].img,r=e[o].top,c=e[o].bottom,d=e[o].days,u=no(d);let p=So;for(const[E,y]of Object.entries(C)){const m=new RegExp(`\\{${E}\\}`,"g");p=p.replace(m,y)}for(let E=0;E<i.length;E++){const y=i[E].toString(),m=new RegExp(`\\{${y}\\}`,"g");let g="";y==="MOG_image"?g=`${I}/${a}/3`:y==="MOG_text1"?g=r:y==="MOG_text2"?g=c:y==="MOG_checkedDate"?g=u:y==="MOGI_placeholder_itemID"&&(g=s),p=p.replace(m,g)}t.innerHTML+=p}}async function ht(e,t){const n=e.target;if(n.classList.contains("MOG-item-controls-play")){const o=n.id.split("-")[1],i=t[o].project_id,s=await we(i),a=JSON.parse(s);a.ProjectID=i,Nt(a)}if(n.classList.contains("MOG-item-controls-menu")){const o=n.id.split("-")[1],i=t[o].project_id;Tt(e,i)}if(n.classList.contains("MOG-itemContainer")&&n.id!=="MOGaddNewItem"){const o=n.id.split("-")[1],i=t[o].project_id;J(`/projects/${i}`)}n.id==="MOGaddNewItem"&&Ao()}function Tt(e,t){e.stopPropagation(),$([{displayText:"Play next",optionalSVG:"icons_playlist",optionalParams:{PROJECT_ID:t,QUEUE_POSITION:"next"},function:"PLAYBACK_add_songs_to_queue"},{displayText:"Play later",optionalSVG:"icons_playlist",optionalParams:{PROJECT_ID:t,QUEUE_POSITION:"later"},function:"PLAYBACK_add_songs_to_queue"}],e)}function Ao(){J("/new-project/")}let Xe;function Je(e){return new Promise((t,n)=>{Xe=document.activeElement;let o="mouse";event.webkitForce==1||event.webkitForce==0?event.webkitForce==0&&(o="keyboard"):event.pointerType!=="mouse"&&(o="keyboard");const i=document.getElementById("confirmModal"),s=`
...
<br><br>
<br><br>
<br><br>`,et=`<h1>Admin</h1>
<p>You are not an admin user</p>`;function It(e,t,n){const o=document.getElementById(t);let i;o.addEventListener("touchstart",function(a){a.timeStamp,i=setTimeout(function(){s(a,e,n)},500)}),o.addEventListener("touchend",function(a){a.timeStamp,clearTimeout(i)}),o.addEventListener("dblclick",function(a){s(a,e,n)});function s(a,r,c){jo(a,r,c)}}function jo(e,t,n){e.target;const o={project_id:t};e.stopPropagation(),$(o,e,n)}const tt=`<h1>User</h1>
...
</div>`;let he,Y=!1;function $(e,t,n){n===void 0?Ai(e,t):n!==void 0&&n==="update_project_image"?mt(e,t,"update_project_image"):n!==void 0&&n==="update_user_pfp"?mt(e,t,"update_user_pfp"):n!==void 0&&n==="lcd_mobile_body"?Ri():console.log("invalid menu display inputs")}function Ri(e){const t=document.querySelector("main"),n=document.querySelector(".topHalf-container"),o=document.getElementById("MENUmodalEnvironment");let i=_o;const s=document.getElementById("audio"),a=["LCD_mobile_body_container_l2","LCD_mobile_body_img","LCD_mobile_body_title_area_container","LCD_mobile_body_song_title","LCD_mobile_body_artist_title","LCD_mobile_body_progress_bar","LCD_mobile_body_menu","LCD_mobile_body_queue_container","LCD_mobile_body_secondary_seek_indicator"];let r=0,c=0;S()&&(t.style.zIndex="40",n.style.zIndex="0");for(const[B,N]of Object.entries(C)){const G=new RegExp(`\\{${B}\\}`,"g");i=i.replace(G,N)}o.style.display="block",o.innerHTML=i;const d=document.getElementById("LCD_mobile_body_song_title"),u=document.getElementById("LCD_mobile_body_artist_title"),p=document.getElementById("LCD_mobile_body_img"),E=s.duration,m=s.currentTime/E*100,g=document.getElementById("LCDMB_seek_input"),b=document.getElementById("LCDMB_seek_indicator");document.getElementById("LCDMB_menu_button");const v=document.getElementById("LCDMB_back"),T=document.getElementById("LCDMB_play"),k=document.getElementById("LCDMB_play_icon"),D=document.getElementById("LCDMB_next"),w=document.getElementById("LCDMB_queue_button");s.addEventListener("ended",()=>{L(),Y===!0&&H()}),L(),A(),b.style.width=`${m}%`,s.addEventListener("timeupdate",()=>{const B=s.duration,G=s.currentTime/B*100;b.style.width=`${G}%`}),g.addEventListener("input",function(){const B=s.duration,N=g.value;s.currentTime=B*(N/100)}),v.addEventListener("click",()=>{jt(),L(),Y===!0&&H()}),T.addEventListener("click",()=>{Be(),L(),A()}),D.addEventListener("click",()=>{Ut(),L(),Y===!0&&H()}),w.addEventListener("click",()=>{Y===!1?(qe(),Y=!0):($e(),Y=!1)}),Y===!0?qe():$e(),o.addEventListener("touchstart",se,!1),o.addEventListener("touchmove",ae,!1),o.addEventListener("touchend",re,!1);function L(){p.src=xt,d.innerText=Rt,u.innerText=At}function A(){s.paused?k.src=C.icons_playButtonV2:k.src=C.icons_derpy}function H(){const B=document.getElementById("LCD_mobile_queue_content_container");B.innerHTML="";for(let N=_+1;N<l.length;N++){const G=l[N],ce=["queue_item_img","queue_item_song_name","queue_item_song_artist","icons_menuOptionsButton","QUEUE_item_timeIndicator"],X=G.img,Vt=G.song_name,zt=G.project_contributors;let Me=go;for(let Se=0;Se<ce.length;Se++){const de=ce[Se].toString(),Kt=new RegExp(`\\{${de}\\}`,"g");let le="";de==="queue_item_img"?le=`${I}/${X}/3`:de==="queue_item_song_name"?le=Vt:de==="queue_item_song_artist"&&(le=zt),Me=Me.replace(Kt,le)}B.innerHTML+=Me}}function qe(){function B(N){N.forEach(G=>{document.querySelectorAll("."+G).forEach(X=>{X.classList.add("queue_visible")})})}B(a),o.removeEventListener("touchstart",se),o.removeEventListener("touchmove",ae),o.removeEventListener("touchend",re),H()}function $e(){function B(N){N.forEach(G=>{document.querySelectorAll("."+G).forEach(X=>{X.classList.remove("queue_visible")})})}B(a),o.addEventListener("touchstart",se,!1),o.addEventListener("touchmove",ae,!1),o.addEventListener("touchend",re,!1)}function se(B){Y===!1&&(r=B.touches[0].clientY)}function ae(B){B.preventDefault()}function re(B){c=B.changedTouches[0].clientY,c-r>70&&(j(),o.removeEventListener("touchstart",se),o.removeEventListener("touchmove",ae),o.removeEventListener("touchend",re))}}function Ai(e,t){he=document.activeElement;let n=t.clientX,o=t.clientY;const i=document.querySelector("main"),s=document.querySelector(".topHalf-container");S()&&(i.style.zIndex="40",s.style.zIndex="0");const a=document.getElementById("MENUmodalEnvironment");a.innerHTML=xi,a.style.display="block";const r=document.getElementById("MENUmodalBody");let c=n+"px",d=o+"px";a.addEventListener("click",St),r.style.left=c,r.style.top=d;let u="mouse";if(t.webkitForce==1||t.webkitForce==0?t.webkitForce==0&&(u="keyboard"):t.pointerType!=="mouse"&&(u="keyboard"),u=="keyboard"){const T=he.getBoundingClientRect();n=T.left+window.scrollX,o=T.top+window.scrollY;let k=n+"px",D=o+"px";r.style.left=k,r.style.top=D}for(let T=0;T<e.length;T++)ji(e[T]);const E=r.children[0],y=r.offsetWidth,m=r.offsetHeight,g=Mt("MENUmodalBody"),b=r.getElementsByClassName("MENUmodalItemContainer");u==="keyboard"&&!S()?E.focus():u=="mouse"&&!S()&&(E.focus(),E.blur()),document.addEventListener("keydown",v),g.xOverflow==!0&&(c=n-y+"px",r.style.left=c),g.yOverflow==!0&&(d=o-m+"px",r.style.top=d);for(let T=0;T<b.length;T++){const k=b[T];k.setAttribute("data-menu-item-id",T),k.addEventListener("click",function(D){D.stopPropagation();const L=D.target.getAttribute("data-menu-item-id"),A=e[L].function,H=e[L].optionalParams;if(A=="TEST")console.log("the button worked",H);else if(A!="None"){ki[A](H);return}else return})}function v(T){(T.key==="Escape"||T.keyCode===27)&&(document.removeEventListener("keydown",v),j())}}function mt(e,t,n){const o=t.clientX,i=t.clientY,s=document.querySelector("main"),a=document.querySelector(".topHalf-container"),r=document.getElementById("MENUmodalEnvironment");let c=o+"px",d=i+"px";S()&&(s.style.zIndex="40",a.style.zIndex="0"),e.MenuType=n,s.style.zIndex="2",r.innerHTML=po,r.style.display="block",r.addEventListener("click",St);const u=document.getElementById("MENUmodalBody"),p=document.getElementById("MENUmodalBody_image_select_file_drop_area"),E=document.getElementById("MENUmodalBody_image_select_file_select_button"),y=document.getElementById("MENUmodalBody_image_select_preview_area"),m=document.getElementById("MENUmodalBody_image_select_submit_button"),g=document.getElementById("MENUmodalBody_image_select_submit_button_container");u.style.left=c,u.style.top=d;let b,v;function T(w,L){return function(){const A=this,H=arguments;clearTimeout(v),v=setTimeout(()=>{w.apply(A,H)},L)}}function k(w,L,A){T(Di,100)(w,L,A)}function D(w){if(b){const L=URL.createObjectURL(b),A=document.getElementById("MENUmodalBody_image_submit_area_loader_spinner");y.src=L,m.style.visibility="visible",g.style.outline="3px solid var(--primary)",m.addEventListener("click",()=>{k(b,w.project_id,w.MenuType),A.style.visibility="visible"})}else console.log("No file selected.")}p.addEventListener("dragover",w=>{w.preventDefault()}),p.addEventListener("drop",w=>{w.preventDefault(),b=w.dataTransfer.files[0],D(e)}),E.addEventListener("click",()=>{const w=document.createElement("input");w.type="file",w.accept="image/*",w.addEventListener("change",L=>{b=L.target.files[0],D(e)}),w.click()})}function Ni(){const e=document.getElementById("MENUmodalBody_image_submit_area_loader_spinner");e.style.visibility="hidden",j(),Pe()}function Ui(){const e=document.getElementById("MENUmodalBody_image_submit_area_loader_spinner");e.style.visibility="hidden",j()}function Mt(e){const t=document.getElementById(e),n=document.documentElement.clientWidth,o=document.documentElement.clientHeight,i=t.offsetWidth,s=t.getBoundingClientRect().left,a=t.getBoundingClientRect().top,r=t.getBoundingClientRect().height,c=i+s,d=r+a;let u=!1,p=!1;return c>n&&(u=!0),d>o&&(p=!0),{xOverflow:u,yOverflow:p}}function ji(e){const t=e.displayText,n=e.optionalSVG,o=document.getElementById("MENUmodalBody");let i="var(--text)";"colour"in e&&(i=e.colour);let s=new RegExp("\\{MENU_item_text\\}","g"),a=Mi.replace(s,t);if(s=new RegExp("\\{MENU_item_colour\\}","g"),a=a.replace(s,i),n!=="None"){s=new RegExp("\\{MENU_item_image\\}","g");const r="{"+n+"}";a=a.replace(s,r);for(const[c,d]of Object.entries(C)){const u=new RegExp(`\\{${c}\\}`,"g");a=a.replace(u,d)}o.innerHTML+=a;return}else{a=a.replace(/<img[^>]+>/g,""),o.innerHTML+=a;return}}function St(e){const t=document.getElementById("MENUmodalEnvironment"),n=document.querySelector("main"),o=window.matchMedia("screen and (orientation: portrait) and (max-width: 768px) and (pointer: coarse) "),i=document.querySelector(".topHalf-container");if(e.target===t){t.style.display="none",o.matches&&(n.style.zIndex="1",i.style.zIndex="10");return}}function j(){const e=document.getElementById("MENUmodalEnvironment"),t=document.querySelector("main"),n=window.matchMedia("screen and (orientation: portrait) and (max-width: 768px) and (pointer: coarse) "),o=document.querySelector(".topHalf-container");e.style.display="none",n.matches&&(t.style.zIndex="1",o.style.zIndex="10"),he&&he.focus()}const ki={PROJECT_VIEW_delete_project(e){bi(),j()},PLAYBACK_add_songs_to_queue(e){as(e),j()},SIGN_OUT_USER(e){j(),Lo()},OPEN_SETTINGS_PAGE(e){j(),J("/settings/")},PROJECT_VIEW_delete_song(e){Ci(e)},PROJECT_VIEW_add_song_to_queue(e){Ii(e)}};let Q="hidden";function Gi(){Zn();const e=document.getElementById("queueButton"),t=document.getElementById("QUEUEclearQueueButton");Ge(Q),e.addEventListener("click",Ji),t.addEventListener("click",Hi),q()}function Ji(){if(Q==="hidden"){Q="visible",Ge(Q);return}if(Q==="visible"){Q="hidden",Ge(Q);return}}function Ge(e){document.getElementById("queueButton");const t=document.getElementById("queueIcon"),n=document.getElementById("QUEUEenvironment");if(e=="visible"){t.style.filter="var(--make-svg-grey)",document.documentElement.style.cssText="--TOPRIGHT-accountcontrols-queue-opacity: 100%",n.style.right="0%",_t&&(t.style.filter="var(--make-svg-white)");return}if(e=="hidden"){t.style.filter="var(--make-svg-black)",document.documentElement.style.cssText="--TOPRIGHT-accountcontrols-queue-opacity: 0%",n.style.right="calc((var(--width-of-left-bar-fortop) + 5rem) * -1)";return}}function q(){const e=document.getElementById("QUEUEbottomContainer");e.innerHTML="";for(let t=_+1;t<l.length;t++){l[t].id=t;const n=l[t],o=zi(n),i=document.createElement("div");i.innerHTML=o,i.addEventListener("click",function(r){r.target.dataset.songId}),i.dataset.songId=n.id,i.addEventListener("click",Vi),i.dataset.songId=n.id;const s=i.querySelector(".QUEUE-item-image-removeIndicator"),a=i.querySelector(".QUEUE-item-up-next-queue-item-context-call");s.addEventListener("click",Fi),s.dataset.songID=n.id,a.dataset.songSet=n.id,a.addEventListener("click",function(r){r.target===a&&Qi(r)}),i.addEventListener("dragstart",qi),i.addEventListener("dragover",$i),i.addEventListener("drop",Yi),e.appendChild(i)}}function Hi(){const e=_+1;e>=0&&e<l.length?l.splice(e):l.length=0,q()}function qi(e){const t=e.target;e.dataTransfer.setData("text/plain",t.dataset.songId)}function $i(e){e.preventDefault(),e.dataTransfer.dropEffect="move"}function Yi(e){e.preventDefault();const t=e.dataTransfer.getData("text/plain"),n=e.target,o=l.find(r=>r.id===parseInt(t)),i=l.find(r=>r.id===parseInt(n.dataset.songId)),s=l.indexOf(o),a=l.indexOf(i);s!==-1&&a!==-1&&(l.splice(s,1),l.splice(a,0,o),h.splice(s,1),h.splice(a,0,o),q())}function Fi(e){e.stopPropagation();const t=e.target,n=parseInt(t.dataset.songID),o=l.findIndex(i=>i.id===n);o!==-1&&(l.splice(o,1),h.splice(o,1)),q()}function Qi(e){e.stopPropagation();const o=[{displayText:"Play next",optionalSVG:"icons_playlist",function:"MENU_ACTION_playNext",optionalParams:{queueID:e.target.getAttribute("data-song-set")}},{displayText:"Play later",optionalSVG:"icons_backButton",function:"None"},{displayText:"Love",optionalSVG:"None",function:"None"},{displayText:"Less like this",optionalSVG:"None",function:"None"},{displayText:"Rate",optionalSVG:"None",function:"None"}];$(o,e)}function Vi(e){}function zi(e){const t=["QUEUE_item_image","QUEUE_item_title","QUEUE_item_artist","icons_menuOptionsButton","QUEUE_item_timeIndicator"],n=e.img,o=e.song_name,i=e.project_contributors,s=`${Math.floor(e.duration/60)}:${(e.duration%60).toString().padStart(2,"0")}`;let a=eo;for(let c=0;c<t.length;c++){const d=t[c].toString(),u=new RegExp(`\\{${d}\\}`,"g");let p="";d==="QUEUE_item_image"?p=`${I}/${n}/3`:d==="QUEUE_item_title"?p=o:d==="QUEUE_item_artist"?p=i:d==="icons_menuOptionsButton"?p=gt:d==="QUEUE_item_timeIndicator"&&(p=s),a=a.replace(u,p)}a=a.replace("<div",`<div data-song-id="${e.id}"`);const r=document.createElement("div");return r.querySelector(".QUEUE-item-image-removeIndicator"),r.innerHTML=a,r.innerHTML}const Ki=`<div class="LCDbody">
