...
</button>`,He=15;let V=0;async function $n(){try{const e=document.getElementById("MAINcontentPages");qn();const t=await Ve(He,V);V+=t.length,Yn(t);return}catch(e){console.error("Error in initMusicObjectsGrid:",e)}}function $e(){V=0;const e=document.getElementById("MAINcontentPages"),t=document.getElementById("MOGcontainer");t!==null&&t.removeEventListener("click",qe),e.innerHTML=""}function qn(){let e="MAINcontentPages",t=Gn;for(const[n,o]of Object.entries(L)){const i=new RegExp(`\\{${n}\\}`,"g");t=t.replace(i,o)}document.getElementById(e).innerHTML+=t}function Yn(e){const t=document.getElementById("MOGgridContainer");t.innerHTML="";let n=Jn;for(const[a,c]of Object.entries(L)){const l=new RegExp(`\\{${a}\\}`,"g");n=n.replace(l,c)}t.innerHTML+=n,we(e);const o=document.getElementById("MOGcontainer");o.addEventListener("click",function(a){qe(a,e)});let i;o.addEventListener("touchstart",function(a){a.timeStamp,i=setTimeout(function(){s(a,e)},500)}),o.addEventListener("touchend",function(a){a.timeStamp,clearTimeout(i)});function s(a,c){navigator.vibrate(1e3);const r=a.target.id.split("-")[1],m=c[r].project_id;console.log(m),Ye(a,m)}t.addEventListener("scroll",async function(){const a=t.scrollTop,c=t.scrollHeight,l=t.clientHeight;if(a>=c-l){const r=await Ve(He,V);V+=r.length,r.length>0&&we(r)}})}function we(e){const t=document.getElementById("MOGgridContainer"),n=e.length;for(var o=0;o<=n-1;o++){const i=["MOG_image","MOG_text1","MOG_text2","MOG_checkedDate","MOGI_placeholder_itemID"],s=o,a=e[o].img,c=e[o].top,l=e[o].bottom,r=e[o].days,m=Pn(r);let p=Hn;for(const[b,E]of Object.entries(L)){const d=new RegExp(`\\{${b}\\}`,"g");p=p.replace(d,E)}for(let b=0;b<i.length;b++){const E=i[b].toString(),d=new RegExp(`\\{${E}\\}`,"g");let _="";E==="MOG_image"?_=`${w}/${a}/2`:E==="MOG_text1"?_=c:E==="MOG_text2"?_=l:E==="MOG_checkedDate"?_=m:E==="MOGI_placeholder_itemID"&&(_=s),p=p.replace(d,_)}t.innerHTML+=p}}async function qe(e,t){const n=e.target;if(n.classList.contains("MOG-item-controls-play")){const o=n.id.split("-")[1],i=t[o].project_id,s=await re(i);rt(s)}if(n.classList.contains("MOG-item-controls-menu")){const o=n.id.split("-")[1],i=t[o].project_id;Ye(e,i)}if(n.classList.contains("MOG-itemContainer")&&n.id!=="MOGaddNewItem"){const o=n.id.split("-")[1],i=t[o].project_id;j(`/projects/${i}`)}n.id==="MOGaddNewItem"&&Fn()}function Ye(e,t){e.stopPropagation(),J([{displayText:"Play next",optionalSVG:"icons_playlist",optionalParams:{PROJECT_ID:t,QUEUE_POSITION:"next"},function:"PLAYBACK_add_songs_to_queue"},{displayText:"Play later",optionalSVG:"icons_playlist",optionalParams:{PROJECT_ID:t,QUEUE_POSITION:"later"},function:"PLAYBACK_add_songs_to_queue"}],e)}function Fn(){j("/new-project/")}const Qn=`<div class="ADMINusersTableInfoRow">
    <div>
...
<p>You are not an admin user</p>`;function Fe(e,t,n){const o=document.getElementById(t);let i;o.addEventListener("touchstart",function(a){a.timeStamp,i=setTimeout(function(){s(a,e,n)},500)}),o.addEventListener("touchend",function(a){a.timeStamp,clearTimeout(i)}),o.addEventListener("dblclick",function(a){s(a,e,n)});function s(a,c,l){Kn(a,c,l)}}function Kn(e,t,n){e.target;const o={project_id:t};e.stopPropagation(),J(o,e,n)}const Wn=`<h1>General</h1>
...
</div>`;let fe;async function eo(){const e=document.getElementById("TOPRIGHTaccountImg");try{const t=await ve("profile_picture"),n=`${w}/${t}/1`;fe=t;const o=document.getElementById("TOPRIGHTaccountImgButton");e.src=n,o.addEventListener("click",to)}catch(t){console.error("Error initializing account image:",t)}}function to(e){e.stopPropagation(),no(e)}function no(e){J([{displayText:"Help",optionalSVG:"icons_helpIcon",function:"None"},{displayText:"Settings",optionalSVG:"icons_settings",function:"OPEN_SETTINGS_PAGE"},{displayText:"Sign Out",optionalSVG:"None",function:"SIGN_OUT_USER"}],e)}async function oo(){await vo()}let Qe="general";const ae=[{name:"general",markup:Wn,button_id:"settings_button_general",function:so},{name:"user",markup:Xn,button_id:"settings_button_user",function:ao},{name:"admin",markup:Vn,button_id:"settings_button_admin",function:co}];function io(){const e=document.getElementById("MAINcontentPages");let t=Zn;for(const[i,s]of Object.entries(L)){const a=new RegExp(`\\{${i}\\}`,"g");t=t.replace(a,s)}e.innerHTML=t;const n=document.getElementById("settings_go_to_other_content_button");Le(Qe);for(var o=ae.length-1;o>=0;o--){const i=ae[o].button_id;document.getElementById(i).addEventListener("click",function(a){const c=a.srcElement.id,r=ae.find(m=>m.button_id===c).name;Le(r)})}n.addEventListener("click",function(){j("/")})}function ze(){const e=document.getElementById("MAINcontentPages");e.innerHTML=""}function Le(e){Qe=e;const t=["users_img"],n=document.getElementById("view_container"),o=ae.find(s=>s.name===e);let i=o.markup;for(const[s,a]of Object.entries(L)){const c=new RegExp(`\\{${s}\\}`,"g");i=i.replace(c,a)}for(let s=0;s<t.length;s++){const a=t[s].toString(),c=new RegExp(`\\{${a}\\}`,"g");let l="";a==="users_img"&&(l=`${w}/${fe}/4/`),i=i.replace(c,l)}n.innerHTML=i,o.function()}function so(){}function ao(){Fe("user-id","settings_views_user_pfp_img","update_user_pfp")}async function co(){if((await ve("admin"))[0].admin!==!0)return;const n=["users_img"],o=document.getElementById("view_container");let i=zn,s=[];for(const[r,m]of Object.entries(L)){const p=new RegExp(`\\{${r}\\}`,"g");i=i.replace(p,m)}for(let r=0;r<n.length;r++){const m=n[r].toString(),p=new RegExp(`\\{${m}\\}`,"g");let b="";m==="users_img"&&(b=`${w}/${fe}/4/`),i=i.replace(p,b)}o.innerHTML=i;const a=await fo(),c=document.getElementById("usersTableInforRowsContainer");c.innerHTML="";for(let r=0;r<a.length;r++){const m=["Username","Email","UUID","Verified","Space_Used","profile_picture_url","checkbox_number","Admin"],p=a[r].username,b=a[r].uuid,E=a[r].verified,d=a[r].email,_=a[r].admin,g=r;let T=a[r].storage_used;T=Je(T);let y=Qn,O=a[r].profile_picture;O=`${w}/${O}/1/`;for(let P=0;P<m.length;P++){const f=m[P].toString(),I=new RegExp(`\\{${f}\\}`,"g");let C="";f==="Username"?C=p:f==="Email"?C=d:f==="UUID"?C=b:f==="Verified"?C=E:f==="Space_Used"?C=T:f==="profile_picture_url"?C=O:f==="checkbox_number"?C=g:f==="Admin"&&(C=_),y=y.replace(I,C)}c.innerHTML+=y}c.addEventListener("change",function(r){r.target&&r.target.type==="checkbox"&&l()});function l(){s=[];const m=c.querySelectorAll('input[type="checkbox"]'),p=[],b=document.getElementById("settings_admin_selected_items_visualition");m.forEach(function(E){if(E.checked){const g={id:E.id.replace("admin_users_table_check_box_",""),value:E.value};p.push(g)}}),p.forEach(function(E){const _=a[E.id].uuid;s.push(_)}),b.innerHTML=`Selected Items: ${s.length}`}}async function ro(){const e=await ve("last_state"),t=JSON.parse(e),n=new Map;setInterval(s,1e4);let o="";if(window.addEventListener("popstate",a),t!=null){const c=window.location.pathname;j(c),ui(t)}else a();function i(c){return JSON.stringify(c)}function s(){const c=window.location.pathname,l=u,r=v,m=vi();m.current_path=c,m.current_queue=l,m.current_index=r;const p=i(m);p!==o&&(po("last_state",m),o=p,n.set("playback_states",p))}function a(){j(currentPath)}}function lo(){Ke(),ze(),$n()}function uo(e){$e(),ze(),To(e)}function mo(){$e(),Ke(),io()}const Pe={"/":lo,"/new-project/":_o,"/projects/:projectID":uo,"/settings/":mo};function go(){const e=window.location.pathname,t=document.getElementById("MAINcontentPages");setTimeout(n,4e3),t.innerHTML+=`
    <br><br>
    <br><br>
    <br><br>    
...
</div>`,ce=[];let pe=!1,Be=!0,h;async function To(e){let t;Ge()==!0?t={ProjectName:"Loading...",ProjectContributors:"This might take a while",TimeCreated:0,PictureURL:"static/loading_img_text_dark"}:t={ProjectName:"Loading...",ProjectContributors:"This might take a while",TimeCreated:0,PictureURL:"static/loading_img_text_light"},Co(t),sessionStorage.setItem("description","Wonderful notes are loading..."),Me(),document.getElementById("PROJECTviewMobileStickyHeaderBackButton").addEventListener("click",()=>{j("/")});const o=await re(e);if(o=="")console.log(o);else{const s=JSON.parse(o);s.ProjectID=e,h=s,i(),Io()}function i(){ho(),sessionStorage.setItem("description",h.Description),Me(),wo(),Po(),Bo(),Mo(),We(),jo(),Ze(h.ProjectName),Fe(h.ProjectID,"PROJECTviewDisplayImage","update_project_image"),Ao()}}function Ke(){const e=document.getElementById("MAINcontentPages");e.innerHTML=""}async function Ee(){const e=h.ProjectID,t=await re(e);if(t=="")console.log(t);else{const n=JSON.parse(t);n.ProjectID=e,h=n,We();const o=document.getElementById("PROJECTviewDisplayImage_imgTag"),i=`${w}/${h.PictureURL}/5`;o.src=i}}function ho(){const e=document.getElementById("PROJECTviewDisplayTitleH1"),t=document.getElementById("PROJECTviewDisplayTitleH3"),n=document.getElementById("PROJECTviewDisplayImage_imgTag"),o=`${w}/${h.PictureURL}/5`;e.innerText=h.ProjectName,t.innerText=h.ProjectContributors,n.src=o}function Io(){const e=document.getElementById("PROJECTviewDisplayTitleH1"),t=document.getElementById("PROJECTviewDisplayTitleH3");let n=document.getElementById("PROJECTviewDisplayTitleH1").innerText,o=document.getElementById("PROJECTviewDisplayTitleH3").innerText;e.addEventListener("blur",function(i){const s=e.innerText;s!==n&&(Ze(s),K(h.ProjectID,"project_name",s),n=s)}),t.addEventListener("blur",function(i){const s=t.innerText;s!==o&&(K(h.ProjectID,"project_contributors",s),o=s)})}function Co(e){let t="MAINcontentPages",n=bo;for(const[i,s]of Object.entries(L)){const a=new RegExp(`\\{${i}\\}`,"g");n=n.replace(a,s)}const o=["PROJECTviewMOREtitle","PROJECTviewMOREartist","PROJECTviewMOREyear","PROJECTviewDisplayImage"];for(let i=0;i<o.length;i++){const s=o[i].toString(),a=new RegExp(`\\{${s}\\}`,"g");let c="";s==="PROJECTviewMOREtitle"?c=e.ProjectName:s==="PROJECTviewMOREartist"?c=e.ProjectContributors:s==="PROJECTviewMOREyear"?c=Bn(e.TimeCreated):s==="MOG_checkedDate"?c="checkedIndicator":s==="MOGI_placeholder_itemID"?c="temporaryIidentifier":s==="PROJECTviewDisplayImage"&&(c=`${w}/${e.PictureURL}/5`),n=n.replace(a,c)}document.getElementById(t).innerHTML=n}function Me(){let e=sessionStorage.getItem("description");const t=document.getElementById("PROJECTviewDescriptionP");t.innerText=e}function wo(){const e=document.getElementById("PROJECTviewDescriptionMoreButton"),t=document.getElementById("PROJECTviewDisplayDescription"),n=document.getElementById("PROJECTviewMOREdescriptionboxEnvironment"),o=document.querySelector("main");function i(){n.style.display="grid",N()&&(o.style.zIndex="40")}e.addEventListener("click",function(){i()}),t.addEventListener("dblclick",function(){i()});let s=0;t.addEventListener("touchend",function(a){const c=new Date().getTime();c-s<300&&(a.stopPropagation(),i()),s=c})}function Lo(){const e=sessionStorage.getItem("description"),t=document.getElementById("PROJECTviewDescriptionP");t.innerText=e}function Po(){const e=sessionStorage.getItem("description");document.getElementById("PROJECTviewMOREdescriptionC");const t=document.getElementById("PROJECTviewMOREdescriptionP");t.innerText=e}function Bo(){const e=document.getElementById("PROJECTviewMOREcloseButton"),t=document.getElementById("PROJECTviewMOREdescriptionboxEnvironment");e.addEventListener("click",function(){Oe(h)}),t.addEventListener("click",function(n){n.target===t&&Oe(h)})}function Oe(e){const n=document.getElementById("PROJECTviewMOREdescriptionP").value,o=document.getElementById("PROJECTviewMOREdescriptionboxEnvironment"),i=document.querySelector("main");sessionStorage.setItem("description",n),K(e.ProjectID,"description",n),o.style.display="none",Lo(),i.style.zIndex="1"}async function Mo(){const e=document.getElementById("PROJECTviewDescriptionTopPlayButton"),t=document.getElementById("PROJECTviewDescriptionTopShuffleButton"),n=document.getElementById("PROJECTviewDisplayMenuButton"),o=document.getElementById("PROJECTviewMobileStickyHeaderMenuButton");e.addEventListener("click",function(){rt(h)}),t.addEventListener("click",function(){di(h)}),n.addEventListener("click",function(){Se(event)}),o.addEventListener("click",function(){Se(event)})}function Se(e){e.stopPropagation(),e.target;const t=h.ProjectID;J([{displayText:"Play next",optionalSVG:"icons_playlist",optionalParams:{PROJECT_ID:t,QUEUE_POSITION:"next"},function:"PLAYBACK_add_songs_to_queue"},{displayText:"Play later",optionalSVG:"icons_playlist",optionalParams:{PROJECT_ID:t,QUEUE_POSITION:"later"},function:"PLAYBACK_add_songs_to_queue"},{displayText:"Delete",optionalSVG:"None",function:"PROJECT_VIEW_delete_project",optionalParams:{PROJECT_ID:t},colour:"hsl(0, 100%, 55%)"}],e)}function Oo(e){if(window.confirm("Are you sure you want to delete this project?")){const t="/";So(),F(),j(t)}else F()}async function So(e){const t=h.ProjectID;try{const o=await(await fetch(`${S}/projects/delete_project/${t}`,{method:"DELETE",headers:{"Content-Type":"application/json"},credentials:"include"})).json()}catch(n){console.error("Error:",n)}}function We(){const e=document.getElementById("PROJECTview-projectTable");e!==null&&e.remove(),document.getElementById("PROJECTview_projectAreaContainer"),Ro();const t=document.getElementById("PROJECTview-projectTable"),n=h.ProjectJSON,o=Dn("--orange"),i=d=>`#${d.match(/^rgb\((\d+),\s*(\d+),\s*(\d+)\)$/).slice(1).map(_=>parseInt(_,10).toString(16).padStart(2,"0")).join("")}`;let s;if(n==null)return;const a=[];if(n)for(const d of n)a.push({img:h.PictureURL,songTitle:d.SongName,artistName:h.ProjectContributors,projectName:Je(d.FolderSize),songDuration:`${Math.floor(d.Duration/60)}:${(d.Duration%60).toString().padStart(2,"0")}`,songSequence:d.SongSequence,version:d.Version,url:d.URL});for(let d=0;d<a.length;d++){a[d].ProjectID=d;const _=a[d],g=Do(_);t.insertAdjacentHTML("beforeend",g);const T=t.lastElementChild;T.addEventListener("dragstart",c),T.addEventListener("dragover",r),T.addEventListener("drop",m)}function c(d){d.dataTransfer.setData("text/plain",d.target.dataset.rowId),d.dataTransfer.getData("text/plain"),s=d.srcElement,Mn(d.srcElement)}const l=On(Sn,0);function r(d){d.preventDefault(),d.dataTransfer.dropEffect="move";const _=d.target.closest(".PROJECTview-projectTable-rowContainer");if(_!==s){const g=getComputedStyle(_).backgroundColor,T=i(g);l(_,T,o)}}function m(d){d.preventDefault(),s.style,s.style.backgroundColor="yellow !important";const _=d.dataTransfer.getData("text/plain"),g=document.querySelector(`[data-row-id="${_}"]`),T=d.target.closest(".PROJECTview-projectTable-rowContainer");if(T){const y=T.getAttribute("data-row-id");T.before(g);const O=`${_}|${y}`;setTimeout(async()=>{await K(h.ProjectID,"SongsTableChangeSongSequenceOrder",O),Ee()},1)}}t.addEventListener("click",function(d){const _=d.target;if(d.stopPropagation(),_.tagName==="BUTTON"){const g=_.closest(".PROJECTview-projectTable-rowContainer");g&&(g.getAttribute("data-row-id"),xo(d))}});const p=t.querySelectorAll("[contenteditable]"),b=[],E=d=>{const g=d.target.closest(".PROJECTview-projectTable-rowContainer").getAttribute("data-row-id"),T=d.target.textContent,y=b.find(I=>I.dataRowIDField===g);if((y?y.currentText:"Row ID not found")==T)return;for(var P=b.length-1;P>=0;P--)b[P].dataRowIDField===g&&(b[P].currentText=T);const f=`${g}-${T}`;K(h.ProjectID,"project_song_title",f)};p.forEach(d=>{d.addEventListener("blur",E),b.push({dataRowIDField:d.parentElement.parentElement.getAttribute("data-row-id"),currentText:d.innerText})})}function xo(e){e.stopPropagation(),e.target,J([{displayText:"Not Selected",optionalSVG:"icons_yourUploadedSongs",function:"TEST"}],e)}function Ro(){let e="PROJECTview_projectAreaContainer",t=Eo;for(const[n,o]of Object.entries(L)){const i=new RegExp(`\\{${n}\\}`,"g");t=t.replace(i,o)}document.getElementById(e).innerHTML+=t}function Do(e){let t=yo;for(const[o,i]of Object.entries(L)){const s=new RegExp(`\\{${o}\\}`,"g");t=t.replace(s,i)}const n=["PROJECTviewRow_img","PROJECTviewRow_songTitle","PROJECTviewRow_artistName","PROJECTviewRow_projectName","PROJECTviewRow_songDuration","PROJECTviewRow_projectID","PROJECTviewRow_contentEditable"];for(let o=0;o<n.length;o++){const i=n[o].toString(),s=new RegExp(`\\{${i}\\}`,"g");let a="";i==="PROJECTviewRow_img"?a=`${w}/${e.img}/3`:i==="PROJECTviewRow_songTitle"?a=e.songTitle:i==="PROJECTviewRow_artistName"?a=e.artistName:i==="PROJECTviewRow_projectName"?a=e.projectName:i==="PROJECTviewRow_songDuration"?a=e.songDuration:i==="PROJECTviewRow_projectID"?a=`${e.songSequence}-${e.version}`:i==="PROJECTviewRow_contentEditable"&&Be===!0?a=!0:i==="PROJECTviewRow_contentEditable"&&Be===!1&&(a=!1),t=t.replace(s,a)}return t}function Ao(){const e=document.getElementById("PROJECTview_dropArea");document.getElementById("PROJECTview_dropArea_submit_button"),e.addEventListener("dragenter",o=>{o.preventDefault(),e.classList.add("dragover")}),e.addEventListener("dragover",o=>{o.preventDefault()}),e.addEventListener("dragleave",()=>{e.classList.remove("dragover")}),e.addEventListener("drop",o=>{o.preventDefault(),e.classList.remove("dragover");const i=o.dataTransfer.files;n(i,h)});let t=[];e.addEventListener("click",o=>{const i=o.target.id,s=document.createElement("input");i!=="PROJECTview_dropArea_submit_button"?(s.type="file",s.accept="audio/*",s.multiple=!0,s.addEventListener("change",()=>{t=s.files,console.log(t)}),s.click()):(console.log("the submit files button was clicked ",t),n(t,h))});function n(o,i){for(const s of o);No(o,i)}}async function Xe(e,t){const n=new FormData,o=new XMLHttpRequest;pe=!0,n.append("file",e),n.append("project_id",t.project_id),o.upload.onprogress=function(i){if(i.lengthComputable){const s=i.loaded/i.total*100;console.log(s),s===100&&console.log("upload completed")}},o.onload=async function(){if(console.log("Upload fully complete"),pe=!1,ce.length>0){const i=ce.shift();await Xe(i.file,i.details)}Ee()},o.onerror=function(){console.log("Upload failed")},o.open("POST",`${S}/files/upload_audio/${h.ProjectID}`,!0),o.send(n)}async function No(e,t){document.getElementById("uploadsContainer");for(const n of e){const o={file:n,details:t};if(ce.push(o),!pe){const i=ce.shift();await Xe(i.file,i.details)}}}function Ze(e){const t=document.getElementById("PROJECTviewMobileStickyHeaderProjectNameContainer");t.innerText=e}function jo(){const e=new IntersectionObserver(i,{threshold:.1}),t=document.querySelector(".PROJECTviewDisplayImage"),n=document.getElementById("PROJECTviewMobileStickyHeader"),o=document.getElementById("PROJECTviewMobileStickyHeaderProjectNameContainer");e.observe(t);function i(s,a){s.forEach(c=>{c.isIntersecting&&N()?(n.style.backdropFilter="none",n.style.backgroundColor="transparent",o.style.visibility="hidden"):c.isIntersecting&&!N()||!c.isIntersecting&&!N()?(n.style.backdropFilter="var(--PROJECTviewDesktopHeaderFilter)",o.style.visibility="hidden"):!c.isIntersecting&&N()&&(n.style.backdropFilter="blur(15px)",n.style.backgroundColor="var(--background-transparent)",o.style.visibility="visible")})}}const ko=`<button class="MENUmodalItemContainer">
    <div class="MENUmodalTextArranger" style="color: {MENU_item_colour}">{MENU_item_text}</div>
    <div class="MENUmodalSVGcontainer">
        <img src="{MENU_item_image}" class="MENUmodalSVG">
    </div>
</button>`;async function Uo(e,t,n){const o=new XMLHttpRequest,i=new FormData;i.append("file",e),o.upload.onprogress=function(s){s.lengthComputable&&s.loaded/s.total*100},o.onload=function(){n!=="update_user_pfp"?qo():(Yo(),location.reload())},o.onerror=function(){console.log("there was an error with the upload")},o.open("POST",`${S}/files/upload_photo?pi=${t}&mt=${n}`,!0),o.send(i)}async function Go(e,t,n){Array.isArray(e)||(e=[e]);for(const o of e)await Uo(o,t,n)}const et='<div class="MENUmodalBody" id="MENUmodalBody"></div>';let q,U=!1;function J(e,t,n){n===void 0?$o(e,t):n!==void 0&&n==="update_project_image"?xe(e,t,"update_project_image"):n!==void 0&&n==="update_user_pfp"?xe(e,t,"update_user_pfp"):n!==void 0&&n==="lcd_mobile_body"?Ho():n!==void 0&&n==="notice"?Jo(e):console.log("invalid menu display inputs")}function Jo(e,t){let n=20,o=80;const i=document.querySelector("main"),s=document.querySelector(".topHalf-container");N()&&(i.style.zIndex="40",s.style.zIndex="0");const a=document.getElementById("MENUmodalEnvironment");a.innerHTML=et,a.style.display="block";const c=document.getElementById("MENUmodalBody");let l=n+"px",r=o+"px";if(a.addEventListener("click",ye),c.style.left=l,c.style.top=r,c.style.padding="5px",q&&pointerType===""){const g=q.getBoundingClientRect();n=g.left+window.scrollX,o=g.top+window.scrollY;let T=n+"px",y=o+"px";c.style.left=T,c.style.top=y}for(let g=0;g<e.length;g++)nt(e[g]);c.children[0];const p=c.offsetWidth,b=c.offsetHeight,E=tt("MENUmodalBody"),d=c.getElementsByClassName("MENUmodalItemContainer");document.addEventListener("keydown",_),E.xOverflow==!0&&(l=n-p+"px",c.style.left=l),E.yOverflow==!0&&(r=o-b+"px",c.style.top=r);for(let g=0;g<d.length;g++){const T=d[g];T.setAttribute("data-menu-item-id",g),T.addEventListener("click",function(y){y.stopPropagation();const P=y.target.getAttribute("data-menu-item-id"),f=e[P].function,I=e[P].optionalParams;if(f=="TEST")console.log("the button worked");else if(f!="None"){ot[f](I);return}else return})}function _(g){(g.key==="Escape"||g.keyCode===27)&&(document.removeEventListener("keydown",_),F())}}function Ho(e){const t=document.querySelector("main"),n=document.querySelector(".topHalf-container"),o=document.getElementById("MENUmodalEnvironment");let i=Un;const s=document.getElementById("audio"),a=["LCD_mobile_body_container_l2","LCD_mobile_body_img","LCD_mobile_body_title_area_container","LCD_mobile_body_song_title","LCD_mobile_body_artist_title","LCD_mobile_body_progress_bar","LCD_mobile_body_menu","LCD_mobile_body_queue_container","LCD_mobile_body_secondary_seek_indicator"];let c=0,l=0;N()&&(t.style.zIndex="40",n.style.zIndex="0");for(const[M,D]of Object.entries(L)){const A=new RegExp(`\\{${M}\\}`,"g");i=i.replace(A,D)}o.style.display="block",o.innerHTML=i;const r=document.getElementById("LCD_mobile_body_song_title"),m=document.getElementById("LCD_mobile_body_artist_title"),p=document.getElementById("LCD_mobile_body_img"),b=s.duration,d=s.currentTime/b*100,_=document.getElementById("LCDMB_seek_input"),g=document.getElementById("LCDMB_seek_indicator");document.getElementById("LCDMB_menu_button");const T=document.getElementById("LCDMB_back"),y=document.getElementById("LCDMB_play"),O=document.getElementById("LCDMB_play_icon"),P=document.getElementById("LCDMB_next"),f=document.getElementById("LCDMB_queue_button");s.addEventListener("ended",()=>{I(),U===!0&&k()}),I(),C(),g.style.width=`${d}%`,s.addEventListener("timeupdate",()=>{const M=s.duration,A=s.currentTime/M*100;g.style.width=`${A}%`}),_.addEventListener("input",function(){const M=s.duration,D=_.value;s.currentTime=M*(D/100)}),T.addEventListener("click",()=>{dt(),I(),U===!0&&k()}),y.addEventListener("click",()=>{le(),I(),C()}),P.addEventListener("click",()=>{lt(),I(),U===!0&&k()}),f.addEventListener("click",()=>{U===!1?(Te(),U=!0):(he(),U=!1)}),U===!0?Te():he(),o.addEventListener("touchstart",Z,!1),o.addEventListener("touchmove",ee,!1),o.addEventListener("touchend",te,!1);function I(){p.src=st,r.innerText=at,m.innerText=ct}function C(){s.paused?O.src=L.icons_playButtonV2:O.src=L.icons_derpy}function k(){const M=document.getElementById("LCD_mobile_queue_content_container");M.innerHTML="";for(let D=v+1;D<u.length;D++){const A=u[D],ne=["queue_item_img","queue_item_song_name","queue_item_song_artist","icons_menuOptionsButton","QUEUE_item_timeIndicator"],z=A.img,bt=A.song_name,Tt=A.project_contributors;let de=kn;for(let ue=0;ue<ne.length;ue++){const oe=ne[ue].toString(),ht=new RegExp(`\\{${oe}\\}`,"g");let ie="";oe==="queue_item_img"?ie=`${w}/${z}/3`:oe==="queue_item_song_name"?ie=bt:oe==="queue_item_song_artist"&&(ie=Tt),de=de.replace(ht,ie)}M.innerHTML+=de}}function Te(){function M(D){D.forEach(A=>{document.querySelectorAll("."+A).forEach(z=>{z.classList.add("queue_visible")})})}M(a),o.removeEventListener("touchstart",Z),o.removeEventListener("touchmove",ee),o.removeEventListener("touchend",te),k()}function he(){function M(D){D.forEach(A=>{document.querySelectorAll("."+A).forEach(z=>{z.classList.remove("queue_visible")})})}M(a),o.addEventListener("touchstart",Z,!1),o.addEventListener("touchmove",ee,!1),o.addEventListener("touchend",te,!1)}function Z(M){U===!1&&(c=M.touches[0].clientY)}function ee(M){M.preventDefault()}function te(M){l=M.changedTouches[0].clientY,l-c>70&&(F(),o.removeEventListener("touchstart",Z),o.removeEventListener("touchmove",ee),o.removeEventListener("touchend",te))}}function $o(e,t){q=document.activeElement;const n=t.pointerType;let o=t.clientX,i=t.clientY;const s=document.querySelector("main"),a=document.querySelector(".topHalf-container");N()&&(s.style.zIndex="40",a.style.zIndex="0");const c=document.getElementById("MENUmodalEnvironment");c.innerHTML=et,c.style.display="block";const l=document.getElementById("MENUmodalBody");let r=o+"px",m=i+"px";if(c.addEventListener("click",ye),l.style.left=r,l.style.top=m,q&&n===""){const y=q.getBoundingClientRect();o=y.left+window.scrollX,i=y.top+window.scrollY;let O=o+"px",P=i+"px";l.style.left=O,l.style.top=P}for(let y=0;y<e.length;y++)nt(e[y]);const b=l.children[0],E=l.offsetWidth,d=l.offsetHeight,_=tt("MENUmodalBody"),g=l.getElementsByClassName("MENUmodalItemContainer");n===""?b.focus():n==="mouse"&&(b.focus(),b.blur()),document.addEventListener("keydown",T),_.xOverflow==!0&&(r=o-E+"px",l.style.left=r),_.yOverflow==!0&&(m=i-d+"px",l.style.top=m);for(let y=0;y<g.length;y++){const O=g[y];O.setAttribute("data-menu-item-id",y),O.addEventListener("click",function(P){P.stopPropagation();const I=P.target.getAttribute("data-menu-item-id"),C=e[I].function,k=e[I].optionalParams;if(C=="TEST")console.log("the button worked");else if(C!="None"){ot[C](k);return}else return})}function T(y){(y.key==="Escape"||y.keyCode===27)&&(document.removeEventListener("keydown",T),F())}}function xe(e,t,n){const o=t.clientX,i=t.clientY,s=document.querySelector("main"),a=document.querySelector(".topHalf-container"),c=document.getElementById("MENUmodalEnvironment");let l=o+"px",r=i+"px";N()&&(s.style.zIndex="40",a.style.zIndex="0"),e.MenuType=n,s.style.zIndex="2",c.innerHTML=jn,c.style.display="block",c.addEventListener("click",ye);const m=document.getElementById("MENUmodalBody"),p=document.getElementById("MENUmodalBody_image_select_file_drop_area"),b=document.getElementById("MENUmodalBody_image_select_file_select_button"),E=document.getElementById("MENUmodalBody_image_select_preview_area"),d=document.getElementById("MENUmodalBody_image_select_submit_button"),_=document.getElementById("MENUmodalBody_image_select_submit_button_container");m.style.left=l,m.style.top=r;let g,T;function y(f,I){return function(){const C=this,k=arguments;clearTimeout(T),T=setTimeout(()=>{f.apply(C,k)},I)}}function O(f,I,C){y(Go,100)(f,I,C)}function P(f){if(g){const I=URL.createObjectURL(g),C=document.getElementById("MENUmodalBody_image_submit_area_loader_spinner");E.src=I,d.style.visibility="visible",_.style.outline="3px solid var(--primary)",d.addEventListener("click",()=>{O(g,f.project_id,f.MenuType),C.style.visibility="visible"})}else console.log("No file selected.")}p.addEventListener("dragover",f=>{f.preventDefault()}),p.addEventListener("drop",f=>{f.preventDefault(),g=f.dataTransfer.files[0],P(e)}),b.addEventListener("click",()=>{const f=document.createElement("input");f.type="file",f.accept="image/*",f.addEventListener("change",I=>{g=I.target.files[0],P(e)}),f.click()})}function qo(){const e=document.getElementById("MENUmodalBody_image_submit_area_loader_spinner");e.style.visibility="hidden",F(),Ee()}function Yo(){const e=document.getElementById("MENUmodalBody_image_submit_area_loader_spinner");e.style.visibility="hidden",F()}function tt(e){const t=document.getElementById(e),n=document.documentElement.clientWidth,o=document.documentElement.clientHeight,i=t.offsetWidth,s=t.getBoundingClientRect().left,a=t.getBoundingClientRect().top,c=t.getBoundingClientRect().height,l=i+s,r=c+a;let m=!1,p=!1;return l>n&&(m=!0),r>o&&(p=!0),{xOverflow:m,yOverflow:p}}function nt(e){const t=e.displayText,n=e.optionalSVG,o=document.getElementById("MENUmodalBody");let i;"colour"in e?i=e.colour:(i="var(--text)",N()&&(i="var(--text)"));let s=new RegExp("\\{MENU_item_text\\}","g"),a=ko.replace(s,t);if(s=new RegExp("\\{MENU_item_colour\\}","g"),a=a.replace(s,i),n!=="None"){s=new RegExp("\\{MENU_item_image\\}","g");const c="{"+n+"}";a=a.replace(s,c);for(const[l,r]of Object.entries(L)){const m=new RegExp(`\\{${l}\\}`,"g");a=a.replace(m,r)}o.innerHTML+=a;return}else{a=a.replace(/<img[^>]+>/g,""),o.innerHTML+=a;return}}function ye(e){const t=document.getElementById("MENUmodalEnvironment"),n=document.querySelector("main"),o=window.matchMedia("screen and (orientation: portrait) and (max-width: 768px) and (pointer: coarse) "),i=document.querySelector(".topHalf-container");if(e.target===t){t.style.display="none",o.matches&&(n.style.zIndex="1",i.style.zIndex="10");return}}function F(){const e=document.getElementById("MENUmodalEnvironment"),t=document.querySelector("main"),n=window.matchMedia("screen and (orientation: portrait) and (max-width: 768px) and (pointer: coarse) "),o=document.querySelector(".topHalf-container");e.style.display="none",n.matches&&(t.style.zIndex="1",o.style.zIndex="10"),q&&q.focus()}const ot={MENU_ACTION_playNext(e){console.log(e)},MENU_ACTION_playLast(){console.log("meny aacction play next")},PROJECT_VIEW_delete_project(e){Oo()},PLAYBACK_add_songs_to_queue(e){mi(e)},SIGN_OUT_USER(e){oo()},OPEN_SETTINGS_PAGE(e){j("/settings/")}};let H="hidden";function Fo(){Cn();const e=document.getElementById("queueButton"),t=document.getElementById("QUEUEclearQueueButton");_e(H),e.addEventListener("click",Qo),t.addEventListener("click",zo),G()}function Qo(){if(H==="hidden"){H="visible",_e(H);return}if(H==="visible"){H="hidden",_e(H);return}}function _e(e){document.getElementById("queueButton");const t=document.getElementById("queueIcon"),n=document.getElementById("QUEUEenvironment");if(e=="visible"){t.style.filter="var(--make-svg-grey)",document.documentElement.style.cssText="--TOPRIGHT-accountcontrols-queue-opacity: 100%",n.style.right="0%",Ge&&(t.style.filter="var(--make-svg-white)");return}if(e=="hidden"){t.style.filter="var(--make-svg-black)",document.documentElement.style.cssText="--TOPRIGHT-accountcontrols-queue-opacity: 0%",n.style.right="calc((var(--width-of-left-bar-fortop) + 5rem) * -1)";return}}function G(){const e=document.getElementById("QUEUEbottomContainer");e.innerHTML="";for(let t=v+1;t<u.length;t++){u[t].id=t;const n=u[t],o=ti(n),i=document.createElement("div");i.innerHTML=o,i.addEventListener("click",function(c){c.target.dataset.songId}),i.dataset.songId=n.id,i.addEventListener("click",ei),i.dataset.songId=n.id;const s=i.querySelector(".QUEUE-item-image-removeIndicator"),a=i.querySelector(".QUEUE-item-up-next-queue-item-context-call");s.addEventListener("click",Xo),s.dataset.songID=n.id,a.dataset.songSet=n.id,a.addEventListener("click",function(c){c.target===a&&Zo(c)}),i.addEventListener("dragstart",Vo),i.addEventListener("dragover",Ko),i.addEventListener("drop",Wo),e.appendChild(i)}}function zo(){const e=v+1;e>=0&&e<u.length?u.splice(e):u.length=0,G()}function Vo(e){const t=e.target;e.dataTransfer.setData("text/plain",t.dataset.songId)}function Ko(e){e.preventDefault(),e.dataTransfer.dropEffect="move"}function Wo(e){e.preventDefault();const t=e.dataTransfer.getData("text/plain"),n=e.target,o=u.find(c=>c.id===parseInt(t)),i=u.find(c=>c.id===parseInt(n.dataset.songId)),s=u.indexOf(o),a=u.indexOf(i);s!==-1&&a!==-1&&(u.splice(s,1),u.splice(a,0,o),R.splice(s,1),R.splice(a,0,o),G())}function Xo(e){e.stopPropagation();const t=e.target,n=parseInt(t.dataset.songID),o=u.findIndex(i=>i.id===n);o!==-1&&(u.splice(o,1),R.splice(o,1)),G()}function Zo(e){e.stopPropagation();const o=[{displayText:"Play next",optionalSVG:"icons_playlist",function:"MENU_ACTION_playNext",optionalParams:{queueID:e.target.getAttribute("data-song-set")}},{displayText:"Play later",optionalSVG:"icons_backButton",function:"None"},{displayText:"Love",optionalSVG:"None",function:"None"},{displayText:"Less like this",optionalSVG:"None",function:"None"},{displayText:"Rate",optionalSVG:"None",function:"None"}];J(o,e)}function ei(e){}function ti(e){const t=["QUEUE_item_image","QUEUE_item_title","QUEUE_item_artist","icons_menuOptionsButton","QUEUE_item_timeIndicator"],n=e.img,o=e.song_name,i=e.project_contributors,s=`${Math.floor(e.duration/60)}:${(e.duration%60).toString().padStart(2,"0")}`;let a=wn;for(let l=0;l<t.length;l++){const r=t[l].toString(),m=new RegExp(`\\{${r}\\}`,"g");let p="";r==="QUEUE_item_image"?p=`${w}/${n}/3`:r==="QUEUE_item_title"?p=o:r==="QUEUE_item_artist"?p=i:r==="icons_menuOptionsButton"?p=Ue:r==="QUEUE_item_timeIndicator"&&(p=s),a=a.replace(m,p)}a=a.replace("<div",`<div data-song-id="${e.id}"`);const c=document.createElement("div");return c.querySelector(".QUEUE-item-image-removeIndicator"),c.innerHTML=a,c.innerHTML}const ni=`<div class="LCDbody">
...
</div>`;const S="/apis",w="/media";async function yt(){pi(),hn(),In(),oi(),Ii(),Si(),Mi(),eo(),Fo(),ro()}if(!window.hasCodeRun){let e=Yi;for(const[t,n]of Object.entries(L)){const o=new RegExp(`\\{${t}\\}`,"g");e=e.replace(o,n)}document.getElementById("app").innerHTML=e,ki(),window.hasCodeRun=!0}
