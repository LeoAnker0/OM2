...
`;let Ye=!1;function Zo(){const e=document.getElementById("MAINcontentContainer"),t=document.getElementById("uploadQueueModal"),n=document.getElementById("uploadQueueButton");e.innerHTML+=Wo,n.addEventListener("click",function(o){Ye==!1?ti(o):Re()}),t.innerHTML=Xo}function ei(){const e=document.getElementById("UPLOAD_INDICATOR_container"),t=document.getElementById("uploadQueueButtonContainer");e.style.opacity="100%",t.style.visibility="visible"}function yt(){const e=document.getElementById("uploadQueueButtonContainer"),t=document.getElementById("UPLOAD_INDICATOR_container");t.style.opacity="",e.style.visibility="",Ye==!0&&H.length>0||Re()}function Ce(e){const t=document.getElementById("UPLOADQUEUEBOTTOM_songName"),n=document.getElementById("UPLOADQUEUEBOTTOM_fileSize");if(H.length>0){t.innerHTML=H[0].file.name,n.innerHTML=pe(H[0].file.size*1.75),ni(document.getElementById("specificChart"),e,!0);const i=document.getElementById("UPLOADQUEUEbottomContainer");for(;i.childNodes.length>2;)i.removeChild(i.lastChild);let s="";for(var o=0;o<H.length;o++){const a=H[o].file.name,r=pe(H[o].file.size*2);s+=`<div class="UPLOADQUEUE-bottom-items-next"><div class="itemName">${a}</div><div class="itemSize">${r}</div></div>`}i.innerHTML+=s}if(e==100){const i=document.getElementById("UPLOADQUEUEBOTTOM_bottom_text");i.innerHTML='Processing<span id="UPLOADQUEUEBOTTOM_fileSize"><span class="ANIMATIONS-EllipsisLoader"></span></span>'}}let ht;function ti(e){Ye=!0,ht=document.activeElement;let t=e.clientX,n=e.clientY;const o=document.getElementById("uploadQueueModal");let i=t+"px",s=n+"px";MENUmodalEnvironment.addEventListener("click",Re),o.style.left=i,o.style.top=s;let a="mouse";if(e.webkitForce==1||e.webkitForce==0?e.webkitForce==0&&(a="keyboard"):e.pointerType!=="mouse"&&(a="keyboard"),a=="keyboard"){const g=ht.getBoundingClientRect();t=g.left+window.scrollX,n=g.top+window.scrollY;let I=t+"px",u=n+"px";o.style.left=I,o.style.top=u}const r=o.offsetWidth,c=o.offsetHeight,d=rn("uploadQueueModal");o.style.visibility="visible",document.addEventListener("keydown",l),d.xOverflow==!0&&(i=t-r+"px",o.style.left=i),d.yOverflow==!0&&(s=n-c+"px",o.style.top=s);function l(g){(g.key==="Escape"||g.keyCode===27)&&(document.removeEventListener("keydown",l),Re())}}function Re(){Ye=!1;const e=document.getElementById("uploadQueueModal");e.style.visibility=""}function ni(e,t,n){t=Math.round(t),t>100?t=100:t<0&&(t=0);var o=Math.round(360*(t/100)),i=e.querySelector(".pie"),s=e.querySelector(".right-side");t>50?(i.style.clip="rect(auto, auto, auto, auto)",s.style.transform="rotate(180deg)"):(i.style.clip="rect(0, 1em, 1em, 0.5em)",s.style.transform="rotate(0deg)"),n?(s.style.borderWidth="0.1em",e.querySelector(".left-side").style.borderWidth="0.1em",e.querySelector(".shadow").style.borderWidth="0.1em"):(s.style.borderWidth="0.5em",e.querySelector(".left-side").style.borderWidth="0.5em",e.querySelector(".shadow").style.borderWidth="0.5em"),e.querySelector(".num").textContent=t,e.querySelector(".left-side").style.transform="rotate("+o+"deg)"}let He;async function oi(){const e=document.getElementById("TOPRIGHTaccountImg");try{const t=await $e("profile_picture"),n=`${M}/${t}/3`;He=t;const o=document.getElementById("TOPRIGHTaccountImgButton");e.src=n,o.addEventListener("click",ii)}catch(t){console.error("Error initializing account image:",t)}}function ii(e){e.stopPropagation(),si(e)}function si(e){X([{displayText:"Settings",optionalSVG:"icons_settings",function:"OPEN_SETTINGS_PAGE"},{displayText:"Sign Out",optionalSVG:"None",function:"SIGN_OUT_USER"}],e)}async function ai(){await ki(),localStorage.clear(),location.reload()}function ri(){const e=document.getElementById("MOGgridContainer");let t=document.createElement("button");t.classList.add("MOG-Mobile-SettingsButton"),t.id="MOGmobileSettingsButton",t.innerHTML=`<div class="MOGM-imageContainer"><img src="${M}/${He}/3"></div>`,e.prepend(t),document.getElementById("MOGmobileSettingsButton").addEventListener("click",ci)}function ci(e){e.stopPropagation(),di(e)}function di(e){X([{displayText:"Settings",optionalSVG:"icons_settings",function:"OPEN_SETTINGS_PAGE"},{displayText:"Sign Out",optionalSVG:"None",function:"SIGN_OUT_USER"}],e)}const li=`<div class="MOG-container" id="MOGcontainer">
    ...
    <div class="MOG-itemCheckedDate">
...
</button>`,zt=30;let _e=0;async function gi(){try{if(document.getElementById("MAINcontentPages").innerHTML+=ne(li),localStorage.getItem("MOGitems")!=null){const t=JSON.parse(localStorage.getItem("MOGitems"));_e+=t.length,bt(t)}const e=await tn(zt,0);JSON.stringify(e)!=localStorage.getItem("MOGitems")&&(_e+=e.length,bt(e),localStorage.setItem("MOGitems",JSON.stringify(e))),U()&&ri()}catch(e){console.error("Error in initMusicObjectsGrid:",e)}}function Kt(){_e=0;const e=document.getElementById("MAINcontentPages"),t=document.getElementById("MOGcontainer");t!==null&&t.removeEventListener("click",Wt),e.innerHTML=""}function bt(e){const t=document.getElementById("MOGgridContainer");t.innerHTML=ne(ui),Tt(e);const n=document.getElementById("MOGcontainer");n.addEventListener("click",function(s){Wt(s,e)});let o;n.addEventListener("touchstart",function(s){s.timeStamp,o=setTimeout(function(){i(s,e)},500)}),n.addEventListener("touchend",function(s){s.timeStamp,clearTimeout(o)});function i(s,a){navigator.vibrate(1e3);const c=s.target.id.split("-")[1],d=a[c].project_id;Xt(s,d)}t.addEventListener("scroll",async function(){const s=t.scrollTop,a=t.scrollHeight,r=t.clientHeight;if(s>=a-r){const c=await tn(zt,_e);_e+=c.length,c.length>0&&Tt(c)}})}function Tt(e){const t=document.getElementById("MOGgridContainer"),n=e.length,o=ne(mi);for(var i=0;i<=n-1;i++){const s=i,a=e[i].img,r=e[i].top,c=e[i].bottom,d=e[i].days,l=So(d),g={itemsToReplace:[["MOG_image",`${M}/${a}/3`],["MOG_text1",`${r}`],["MOG_text2",`${c}`],["MOG_checkedDate",`${l}`],["MOGI_placeholder_itemID",`${s}`]]};t.innerHTML+=rt(o,g)}}async function Wt(e,t){const n=e.target;if(n.classList.contains("MOG-item-controls-play")){const o=n.id.split("-")[1],i=t[o].project_id,s=await dt(i),a=JSON.parse(s);a.ProjectID=i,ln(a)}if(n.classList.contains("MOG-item-controls-menu")){const o=n.id.split("-")[1],i=t[o].project_id;Xt(e,i)}if(n.classList.contains("MOG-itemContainer")&&n.id!=="MOGaddNewItem"){const o=n.id.split("-")[1],i=t[o].project_id;G(`/projects/${i}`)}n.id==="MOGaddNewItem"&&G("/new-project/")}function Xt(e,t){e.stopPropagation(),X([{displayText:"Play next",optionalSVG:"icons_playlist",optionalParams:{PROJECT_ID:t,QUEUE_POSITION:"next"},function:"PLAYBACK_add_songs_to_queue"},{displayText:"Play later",optionalSVG:"icons_playlist",optionalParams:{PROJECT_ID:t,QUEUE_POSITION:"later"},function:"PLAYBACK_add_songs_to_queue"}],e)}let It;function ct(e){return new Promise((t,n)=>{It=document.activeElement;let o="mouse";event.webkitForce==1||event.webkitForce==0?event.webkitForce==0&&(o="keyboard"):event.pointerType!=="mouse"&&(o="keyboard");const i=document.getElementById("confirmModal"),s=`
        ...
        `;i.innerHTML=s,i.style.visibility="visible";const a=document.getElementById("CONFIRMmodalDeleteButton"),r=document.getElementById("CONFIRMmodalCancelButton");function c(){Ct(),t("delete")}function d(){It.focus(),Ct(),t("cancel")}i.addEventListener("click",l=>{const g=l.target;g===a?c():(g===r||g===i)&&d()}),o==="keyboard"&&!U()?r.focus():o=="mouse"&&!U()&&(F(),r.focus(),r.blur())})}function Ct(){const e=document.getElementById("confirmModal");e.style.visibility="hidden"}const pi=`<div class="ADMINusersTableInfoRow">
    <div>
...
</div>`;let Ne="general",W;async function Ei(){const e=await $e("admin");e=="true"&&!U()?(Ne="admin",W=[{name:"general",markup:we,button_id:"settings_button_general",function:Se},{name:"user",markup:Lt,button_id:"settings_button_user",function:Le},{name:"admin",markup:wt,button_id:"settings_button_admin",function:Ot}]):e=="false"&&!U()?W=[{name:"general",markup:we,button_id:"settings_button_general",function:Se},{name:"user",markup:Lt,button_id:"settings_button_user",function:Le}]:U()&&e=="true"?(Ne="admin",W=[{name:"general",markup:we,button_id:"settings_button_general",function:Se},{name:"user",markup:St,button_id:"settings_button_user",function:Le},{name:"admin",markup:wt,button_id:"settings_button_admin",function:Ot}]):W=[{name:"general",markup:we,button_id:"settings_button_general",function:Se},{name:"user",markup:St,button_id:"settings_button_user",function:Le}]}async function yi(){await Ei();const e=document.getElementById("MAINcontentPages");let t=vi;for(const[i,s]of Object.entries(B)){const a=new RegExp(`\\{${i}\\}`,"g");t=t.replace(a,s)}e.innerHTML=t;const n=document.getElementById("settings_go_to_other_content_button");Pt(Ne);for(var o=W.length-1;o>=0;o--){const i=W[o].button_id;document.getElementById(i).addEventListener("click",function(a){const r=a.srcElement.id,d=W.find(l=>l.button_id===r).name;Pt(d)})}n.addEventListener("click",function(){G("/")})}function tt(){const e=document.getElementById("MAINcontentPages");e.innerHTML=""}function Pt(e){Ne=e;const t=["users_img"],n=document.getElementById("view_container"),o=W.find(s=>s.name===e);let i=o.markup;for(const[s,a]of Object.entries(B)){const r=new RegExp(`\\{${s}\\}`,"g");i=i.replace(r,a)}for(let s=0;s<t.length;s++){const a=t[s].toString(),r=new RegExp(`\\{${a}\\}`,"g");let c="";a==="users_img"&&(c=`${M}/${He}/4/`),i=i.replace(r,c)}n.innerHTML=i,o.function()}function Se(){}function Le(){Zt("user-id","settings_views_user_pfp_img","update_user_pfp")}let ue=[];async function Ot(){if(await $e("admin")!=="true")return;const t=["users_img"],n=document.getElementById("view_container");let o=_i;for(const[a,r]of Object.entries(B)){const c=new RegExp(`\\{${a}\\}`,"g");o=o.replace(c,r)}for(let a=0;a<t.length;a++){const r=t[a].toString(),c=new RegExp(`\\{${r}\\}`,"g");let d="";r==="users_img"&&(d=`${M}/${He}/4/`),o=o.replace(c,d)}n.innerHTML=o,nt(),document.getElementById("SETTINGS_ADMIN_UPDATE_COLUMN_submit_button").addEventListener("click",function(a){const r=document.getElementById("SETTINGS_ADMIN_UDPATE_COLUMN_column_to_updated"),c=document.getElementById("SETTINGS_ADMIN_UDPATE_COLUMN_new_data");if(r.value==""||c.value=="")x("Error Updating Column: empty inputs","error");else for(var d=ue.length-1;d>=0;d--){const l=ue[d];console.log(l),ji(l,r.value,c.value)}}),document.getElementById("SETTINGS_ADMIN_DELETE_USER_submit_button").addEventListener("click",async function(a){const r=document.getElementById("SETTINGS_ADMIN_DELETE_USER_user_to_delete").value;if(r==""){x("Error Deleting User: user UUID is empty","error");return}let c=null;for(let g=0;g<J.length;g++)J[g].uuid==r&&(c=J[g].username);if(c===null){x("Error Deleting User: this uuid is not associated with a user","error");return}const d=`Are you sure that you want to delete this user <b><i>${c}</i></b>?`,l=await ct(d);l==="cancel"||l==="delete"&&((await Ri(r)).success=="success"?x("Successfully deleted the user","success"):x("Failed to delete the user","error"),nt())})}let J;async function nt(){const e=await Ui();J=JSON.parse(e);const t=document.getElementById("usersTableInforRowsContainer");t.innerHTML="";for(let n=0;n<J.length;n++){const o=["Username","Email","UUID","Verified","Space_Used","Storage_Allowance","profile_picture_url","checkbox_number","Admin"],i=J[n].username,s=J[n].uuid,a=J[n].verified,r=J[n].email;let c=J[n].storage_allowance;c=pe(c);const d=J[n].admin,l=n;let g=J[n].storage_used;g=pe(g);let I=pi,u=J[n].profile_picture;u=`${M}/${u}/3`;for(let f=0;f<o.length;f++){const _=o[f].toString(),y=new RegExp(`\\{${_}\\}`,"g");let h="";_==="Username"?h=i:_==="Email"?h=r:_==="UUID"?h=s:_==="Verified"?h=a:_==="Space_Used"?h=g:_==="Storage_Allowance"?h=c:_==="profile_picture_url"?h=u:_==="checkbox_number"?h=l:_==="Admin"&&(h=d),I=I.replace(y,h)}t.innerHTML+=I}t.addEventListener("change",function(n){n.target&&n.target.type==="checkbox"&&hi()})}function hi(){ue=[];const t=usersTableEnvironment.querySelectorAll('input[type="checkbox"]'),n=[],o=document.getElementById("settings_admin_selected_items_visualition");t.forEach(function(i){if(i.checked){const r={id:i.id.replace("admin_users_table_check_box_",""),value:i.value};n.push(r)}}),n.forEach(function(i){const a=J[i.id].uuid;ue.push(a)}),o.innerHTML=`Selected Users: ${ue.length}`}const bi=`<div class="SETTINGSmodalEnvironment" id="SETTINGSmodalID">
...
</div>`;let ee=!1,pt,at;function na(){const e=document.getElementById("musicEnjoyEnvironment");e.innerHTML=ne(ta),document.getElementById("MUSICENJOYMODEexitButton").addEventListener("click",ia),document.getElementById("MusicEnjoyOpenButton").addEventListener("click",We),U()&&document.getElementById("LCDbody").addEventListener("click",We),j.on("playbackStateChange",c=>{ee!=!1&&hn()}),j.on("progressStateChange",c=>{ee!=!1}),j.on("newTrackStateChange",c=>{ee!=!1&&yn()}),j.on("loopStateChange",c=>{ee!=!1&&bn()}),j.on("shuffleStateChange",c=>{ee!=!1&&Tn()});const o=document.getElementById("MUSICENJOYMODEplaybackControlsButton_shuffle"),i=document.getElementById("MUSICENJOYMODEplaybackControlsButton_back"),s=document.getElementById("MUSICENJOYMODEplaybackControlsButton_play"),a=document.getElementById("MUSICENJOYMODEplaybackControlsButton_next"),r=document.getElementById("MUSICENJOYMODEplaybackControlsButton_loop");o.addEventListener("click",gt),i.addEventListener("click",mt),s.addEventListener("click",ve),a.addEventListener("click",ut),r.addEventListener("click",un),setTimeout(function(){We()},150)}function yn(){const e=document.getElementById("MUSICENJOYMODEcoverImage1"),t=document.getElementById("MUSICENJOYMODEcoverImage2"),n=document.getElementById("MUSICENJOYMODEsongTitle1"),o=document.getElementById("MUSICENJOYMODEsongTitle2"),i=document.getElementById("MUSICENJOYMODEsongArtist");e.src=ie,t.src=ie,n.innerText=Je,o.innerText=Je,i.innerText=lt,bn(),Tn(),oa()}function hn(){const e=document.getElementById("MUSICENJOYMODEplaybackControlButton_play_icon");if(V=="playing"){e.src=B.icons_pause;return}if(V=="paused"){e.src=B.icons_play;return}}function bn(){const e=document.getElementById("MUSICENJOYMODEplaybackControlsButton_loop_icon");if(w==="off"){e.style.filter="var(--make-svg-white)",e.src=B.icons_loop;return}if(w==="on"){e.style.filter="var(--make-svg-grey-3)",e.src=B.icons_loop;return}if(w==="song"){e.style.filter="var(--make-svg-grey-3)",e.src=B.icons_loop_song;return}}function Tn(){const e=document.getElementById("MUSICENJOYMODEplaybackControlsButton_shuffle_icon");if(Q==="on"){e.style.filter="var(--make-svg-grey-3)";return}if(Q==="off"){e.style.filter="var(--make-svg-white)";return}}async function We(){ee=!0;const e=document.getElementById("musicEnjoyEnvironment");e.style.display="block",yn(),hn(),await In(),at=document.getElementById("MUSICENJOYMODEbackground"),Qt(at,pt)}async function In(){pt=await $t(ie)}async function oa(){await In(),Ko(at,pt)}function ia(){const e=document.getElementById("musicEnjoyEnvironment");e.style.display="none",zo(),ee=!1}const R="/apis",M="/media";async function Cn(){Gs(),bs(),Ts(),ms(),zs(),Xs(),Ks(),oi(),ws(),Mi(),Zo(),na()}window.hasCodeRun||(wi(),window.hasCodeRun=!0);
