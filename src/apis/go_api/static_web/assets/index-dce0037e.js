...
</button>`,Re=15;let z=0;async function Cn(){try{const e=document.getElementById("MAINcontentPages");Ln();const t=await Ue(Re,z);z+=t.length,Bn(t);return}catch(e){console.error("Error in initMusicObjectsGrid:",e)}}function De(){z=0;const e=document.getElementById("MAINcontentPages"),t=document.getElementById("MOGcontainer");t!==null&&t.removeEventListener("click",Ae),e.innerHTML=""}function Ln(){let e="MAINcontentPages",t=hn;for(const[n,o]of Object.entries(E)){const i=new RegExp(`\\{${n}\\}`,"g");t=t.replace(i,o)}document.getElementById(e).innerHTML+=t}function Bn(e){const t=document.getElementById("MOGgridContainer");t.innerHTML="";let n=In;for(const[s,c]of Object.entries(E)){const l=new RegExp(`\\{${s}\\}`,"g");n=n.replace(l,c)}t.innerHTML+=n,Te(e);const o=document.getElementById("MOGcontainer");o.addEventListener("click",function(s){Ae(s,e)});let i;o.addEventListener("touchstart",function(s){s.timeStamp,i=setTimeout(function(){a(s,e)},500)}),o.addEventListener("touchend",function(s){s.timeStamp,clearTimeout(i)});function a(s,c){navigator.vibrate(1e3);const r=s.target.id.split("-")[1],d=c[r].project_id;console.log(d),Ne(s,d)}t.addEventListener("scroll",async function(){const s=t.scrollTop,c=t.scrollHeight,l=t.clientHeight;if(s>=c-l){const r=await Ue(Re,z);z+=r.length,r.length>0&&Te(r)}})}function Te(e){const t=document.getElementById("MOGgridContainer"),n=e.length;for(var o=0;o<=n-1;o++){const i=["MOG_image","MOG_text1","MOG_text2","MOG_checkedDate","MOGI_placeholder_itemID"],a=o,s=e[o].img,c=e[o].top,l=e[o].bottom,r=e[o].days,d=vn(r);let m=wn;for(const[_,g]of Object.entries(E)){const B=new RegExp(`\\{${_}\\}`,"g");m=m.replace(B,g)}for(let _=0;_<i.length;_++){const g=i[_].toString(),B=new RegExp(`\\{${g}\\}`,"g");let b="";g==="MOG_image"?b=`${y}/${s}/4/`:g==="MOG_text1"?b=c:g==="MOG_text2"?b=l:g==="MOG_checkedDate"?b=d:g==="MOGI_placeholder_itemID"&&(b=a),m=m.replace(B,b)}t.innerHTML+=m}}async function Ae(e,t){const n=e.target;if(n.classList.contains("MOG-item-controls-play")){const o=n.id.split("-")[1],i=t[o].project_id,a=await H(i);We(a)}if(n.classList.contains("MOG-item-controls-menu")){const o=n.id.split("-")[1],i=t[o].project_id;Ne(e,i)}if(n.classList.contains("MOG-itemContainer")&&n.id!=="MOGaddNewItem"){const o=n.id.split("-")[1],i=t[o].project_id;A(`/projects/${i}`)}n.id==="MOGaddNewItem"&&Pn()}function Ne(e,t){e.stopPropagation(),k([{displayText:"Play next",optionalSVG:"icons_playlist",optionalParams:{PROJECT_ID:t,QUEUE_POSITION:"next"},function:"PLAYBACK_add_songs_to_queue"},{displayText:"Play later",optionalSVG:"icons_playlist",optionalParams:{PROJECT_ID:t,QUEUE_POSITION:"later"},function:"PLAYBACK_add_songs_to_queue"}],e)}function Pn(){A("/new-project/")}const Sn=`<div class="ADMINusersTableInfoRow">
    <div>
...
<p>There are currently no user settings, however this is coming.</p>`,Dn=`<div class="settings_container">
...
</div>`;let _e;async function An(){const e=document.getElementById("TOPRIGHTaccountImg");try{const n=(await fe("profile_picture"))[0].profile_picture;_e=n;const o=`${y}/${n}/1/`,i=document.getElementById("TOPRIGHTaccountImgButton");e.src=o,i.addEventListener("click",Nn)}catch(t){console.error("Error initializing account image:",t)}}function Nn(e){e.stopPropagation(),jn(e)}function jn(e){k([{displayText:"Help",optionalSVG:"icons_helpIcon",function:"None"},{displayText:"Settings",optionalSVG:"icons_settings",function:"OPEN_SETTINGS_PAGE"},{displayText:"Sign Out",optionalSVG:"None",function:"SIGN_OUT_USER"}],e)}function kn(){localStorage.clear(),location.reload()}let je="admin";const ie=[{name:"general",markup:xn,button_id:"settings_button_general",function:Gn},{name:"user",markup:Rn,button_id:"settings_button_user",function:Jn},{name:"admin",markup:Mn,button_id:"settings_button_admin",function:qn}];function Un(){const e=document.getElementById("MAINcontentPages");let t=Dn;for(const[i,a]of Object.entries(E)){const s=new RegExp(`\\{${i}\\}`,"g");t=t.replace(s,a)}e.innerHTML=t;const n=document.getElementById("settings_go_to_other_content_button");he(je);for(var o=ie.length-1;o>=0;o--){const i=ie[o].button_id;document.getElementById(i).addEventListener("click",function(s){const c=s.srcElement.id,r=ie.find(d=>d.button_id===c).name;he(r)})}n.addEventListener("click",function(){A("/")})}function ke(){const e=document.getElementById("MAINcontentPages");e.innerHTML=""}function he(e){je=e;const t=["users_img"],n=document.getElementById("view_container"),o=ie.find(a=>a.name===e);let i=o.markup;for(const[a,s]of Object.entries(E)){const c=new RegExp(`\\{${a}\\}`,"g");i=i.replace(c,s)}for(let a=0;a<t.length;a++){const s=t[a].toString(),c=new RegExp(`\\{${s}\\}`,"g");let l="";s==="users_img"&&(l=`${y}/${_e}/4/`),i=i.replace(c,l)}n.innerHTML=i,o.function()}function Gn(){console.log("general")}function Jn(){console.log("user")}async function qn(){if((await fe("admin"))[0].admin!==!0)return;const n=["users_img"],o=document.getElementById("view_container");let i=On,a=[];for(const[r,d]of Object.entries(E)){const m=new RegExp(`\\{${r}\\}`,"g");i=i.replace(m,d)}for(let r=0;r<n.length;r++){const d=n[r].toString(),m=new RegExp(`\\{${d}\\}`,"g");let _="";d==="users_img"&&(_=`${y}/${_e}/4/`),i=i.replace(m,_)}o.innerHTML=i;const s=await Vn(),c=document.getElementById("usersTableInforRowsContainer");c.innerHTML="";for(let r=0;r<s.length;r++){const d=["Username","Email","UUID","Verified","Space_Used","profile_picture_url","checkbox_number","Admin"],m=s[r].username,_=s[r].uuid,g=s[r].verified,B=s[r].email,b=s[r].admin,f=r;let C=s[r].storage_used;C=ge(C);let v=Sn,P=s[r].profile_picture;P=`${y}/${P}/1/`;for(let x=0;x<d.length;x++){const O=d[x].toString(),R=new RegExp(`\\{${O}\\}`,"g");let I="";O==="Username"?I=m:O==="Email"?I=B:O==="UUID"?I=_:O==="Verified"?I=g:O==="Space_Used"?I=C:O==="profile_picture_url"?I=P:O==="checkbox_number"?I=f:O==="Admin"&&(I=b),v=v.replace(R,I)}c.innerHTML+=v}c.addEventListener("change",function(r){r.target&&r.target.type==="checkbox"&&l()});function l(){a=[];const d=c.querySelectorAll('input[type="checkbox"]'),m=[],_=document.getElementById("settings_admin_selected_items_visualition");d.forEach(function(g){if(g.checked){const f={id:g.id.replace("admin_users_table_check_box_",""),value:g.value};m.push(f)}}),m.forEach(function(g){const b=s[g.id].uuid;a.push(b)}),_.innerHTML=`Selected Items: ${a.length}`}}async function Yn(){const e=await fe("last_state"),t=JSON.parse(e),n=new Map;setInterval(a,1e4);let o="";if(window.addEventListener("popstate",s),t!=null){const c=window.location.pathname;A(c),Vo(t)}else s();function i(c){return JSON.stringify(c)}function a(){const c=window.location.pathname,l=u,r=p,d=ni();d.current_path=c,d.current_queue=l,d.current_index=r;const m=i(d);m!==o&&(Fn("last_state",d),o=m,n.set("playback_states",m))}function s(){A(currentPath)}}function Hn(){Ge(),ke(),Cn()}function $n(e){De(),ke(),eo()}function Qn(){De(),Ge(),Un()}const Ie={"/":Hn,"/new-project/":Kn,"/projects/:projectID":$n,"/settings/":Qn};function zn(){const e=window.location.pathname,t=document.getElementById("MAINcontentPages");setTimeout(n,4e3),t.innerHTML+=`
    <br><br>
    <br><br>
    <br><br>    
    ...
    `;function n(){A("/")}}function A(e){const t=Object.keys(Ie);for(const n of t){const o=new RegExp(`^${n.replace(/:[^\s/]+/g,"([^/]+)")}$`),i=e.match(o);if(i){const a=Ie[n],s=i.slice(1);a(...s),e!=="/new-project/"&&history.pushState({},"",e);return}}zn()}async function Fn(e,t){try{const n=localStorage.getItem("JWT");if(!n){console.log("no jwt");return}const o={"access-token":n,column_to_be_updated:e,new_data:JSON.stringify(t)};if((await(await fetch(`${w}/users/update_user_details`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(o)})).json()).updated==="success")return;console.log("there was an error")}catch(n){console.error("Error:",n)}}async function fe(e){try{const t=localStorage.getItem("JWT");if(!t){console.log("no jwt");return}const n={"access-token":t,wanted_column:e};return(await(await fetch(`${w}/users/get_user_details`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(n)})).json()).response}catch(t){console.error("Error:",t)}}async function de(e,t,n){try{const o=localStorage.getItem("JWT");if(!o){console.log("no jwt");return}const i={"access-token":o,project_id:e,column_to_be_updated:t,new_data:n};if((await(await fetch(`${w}/projects/update_details/`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(i)})).json()).updated==="success")return;console.log("there was an error")}catch(o){console.error("Error:",o)}}async function H(e){try{const t=localStorage.getItem("JWT");if(!t){console.log("no jwt");return}const n={"access-token":t,project_id:e};return(await(await fetch(`${w}/projects/get-project-details/`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(n)})).json()).project_details}catch(t){console.error("Error:",t)}}async function Ue(e,t){try{const n=localStorage.getItem("JWT");if(!n)return console.log("no jwt"),[];const o={"access-token":n,library_items_to_request_at_a_time:e,no_library_datas_collected:t},s=(await(await fetch(`${w}/projects/get_projects`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(o)})).json()).projects;return Array.isArray(s)?s.map(l=>({img:l.PictureURL,top:l.ProjectName,bottom:l.ProjectContributors,days:l.TimeCreated,project_id:l.ProjectID})):(console.log("Projects is not an array:",s),[])}catch(n){return console.error("Error:",n),[]}}async function Kn(){try{const e=localStorage.getItem("JWT");if(!e){console.log("no jwt");return}const t={"access-token":e},a=`/projects/${(await(await fetch(`${w}/projects/new-project-id/`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})).json()).projectID}`;A(a)}catch(e){console.error("Error:",e)}}async function Vn(){try{const e=localStorage.getItem("JWT");if(!e){console.log("no jwt");return}const t={"access-token":e};return(await(await fetch(`${w}/admin/get_users_table/`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})).json()).response}catch(e){console.error("Error:",e)}}const Wn=`<div class="PROJECTview-projectTable" id="PROJECTview-projectTable">
...
</div>`,se=[];let ue=!1;async function eo(e){setTimeout(async()=>{const o=window.location.pathname.replace(/^\/projects\//,""),i=await H(o);i.project_id=o,t(i),no(i)},1);function t(n){oo(n);const o=n.description;sessionStorage.setItem("description",o),io(),so(),co(),ro(n),lo(n),po(n),_o(n),vo(),$e(n.project_name),Eo(n.project_id)}}function Ge(){const e=document.getElementById("MAINcontentPages");e.innerHTML=""}async function to(){Je();const t=window.location.pathname.replace(/^\/projects\//,""),n=document.getElementById("PROJECTviewDisplayImage_imgTag"),i=(await H(t)).picture_url,a=`${y}/${i}/5/`;n.src=a}function no(e){const t=document.getElementById("PROJECTviewDisplayTitleH1"),n=document.getElementById("PROJECTviewDisplayTitleH3");t.addEventListener("blur",function(o){const i=t.innerText;$e(i),de(e.project_id,"project_name",i)}),n.addEventListener("blur",function(o){const i=n.innerText;de(e.project_id,"project_contributors",i)})}function oo(e){let t="MAINcontentPages",n=Xn;for(const[i,a]of Object.entries(E)){const s=new RegExp(`\\{${i}\\}`,"g");n=n.replace(s,a)}const o=["PROJECTviewMOREtitle","PROJECTviewMOREartist","PROJECTviewMOREyear","PROJECTviewDisplayImage"];for(let i=0;i<o.length;i++){const a=o[i].toString(),s=new RegExp(`\\{${a}\\}`,"g");let c="";a==="PROJECTviewMOREtitle"?c=e.project_name:a==="PROJECTviewMOREartist"?c=e.project_contributors:a==="PROJECTviewMOREyear"?c=En(e.time_created):a==="MOG_checkedDate"?c="checkedIndicator":a==="MOGI_placeholder_itemID"?c="temporaryIidentifier":a==="PROJECTviewDisplayImage"&&(c=`${y}/${e.picture_url}/5/`),n=n.replace(s,c)}document.getElementById(t).innerHTML=n}function io(){let e=sessionStorage.getItem("description");const t=document.getElementById("PROJECTviewDescriptionP");t.innerText=e}function so(){const e=document.getElementById("PROJECTviewDescriptionMoreButton"),t=document.getElementById("PROJECTviewDisplayDescription"),n=document.getElementById("PROJECTviewMOREdescriptionboxEnvironment"),o=document.querySelector("main");function i(){n.style.display="grid",D()&&(o.style.zIndex="40")}e.addEventListener("click",function(){i()}),t.addEventListener("dblclick",function(){i()});let a=0;t.addEventListener("touchend",function(s){const c=new Date().getTime();c-a<300&&(s.stopPropagation(),i()),a=c})}function ao(){const e=sessionStorage.getItem("description"),t=document.getElementById("PROJECTviewDescriptionP");t.innerText=e}function co(){const e=sessionStorage.getItem("description");document.getElementById("PROJECTviewMOREdescriptionC");const t=document.getElementById("PROJECTviewMOREdescriptionP");t.innerText=e}function ro(e){const t=document.getElementById("PROJECTviewMOREcloseButton"),n=document.getElementById("PROJECTviewMOREdescriptionboxEnvironment");t.addEventListener("click",function(){we(e)}),n.addEventListener("click",function(o){o.target===n&&we(e)})}function we(e){const n=document.getElementById("PROJECTviewMOREdescriptionP").value,o=document.getElementById("PROJECTviewMOREdescriptionboxEnvironment"),i=document.querySelector("main");sessionStorage.setItem("description",n),de(e.project_id,"description",n),o.style.display="none",ao(),i.style.zIndex="1"}async function lo(e){const t=document.getElementById("PROJECTviewDescriptionTopPlayButton"),n=document.getElementById("PROJECTviewDescriptionTopShuffleButton"),o=document.getElementById("PROJECTviewDisplayMenuButton"),i=document.getElementById("PROJECTviewMobileStickyHeaderMenuButton"),a=document.getElementById("PROJECTviewMobileStickyHeaderBackButton"),s=await H(e.project_id);t.addEventListener("click",function(){We(s)}),n.addEventListener("click",function(){Ko(s)}),o.addEventListener("click",function(){Ce(event)}),i.addEventListener("click",function(){Ce(event)}),a.addEventListener("click",()=>{A("/")})}function Ce(e,t){e.stopPropagation(),e.target;const o=window.location.pathname.replace(/^\/projects\//,"");k([{displayText:"Play next",optionalSVG:"icons_playlist",optionalParams:{PROJECT_ID:o,QUEUE_POSITION:"next"},function:"PLAYBACK_add_songs_to_queue"},{displayText:"Play later",optionalSVG:"icons_playlist",optionalParams:{PROJECT_ID:o,QUEUE_POSITION:"later"},function:"PLAYBACK_add_songs_to_queue"},{displayText:"Delete",optionalSVG:"None",function:"PROJECT_VIEW_delete_project",optionalParams:{PROJECT_ID:o},colour:"hsl(0, 100%, 55%)"}],e)}function uo(e){if(window.confirm("Are you sure you want to delete this project?")){const t="/";mo(e),F(),A(t)}else F()}async function mo(e){try{const t=localStorage.getItem("JWT");if(!t){console.log("no jwt");return}const n={"access-token":t,project_id:e},i=await(await fetch(`${w}/projects/delete_project/`,{method:"DELETE",headers:{"Content-Type":"application/json"},body:JSON.stringify(n)})).json()}catch(t){console.error("Error:",t)}}function po(e){document.getElementById("PROJECTview_projectAreaContainer"),go();const t=document.getElementById("PROJECTview-projectTable"),n=e,o=n;if(o!=="{}"){const i=o.songs_json,a=[];if(i)for(const s of i)a.push({img:n.picture_url,songTitle:s.song_name,artistName:n.project_contributors,projectName:ge(s.song_size),songDuration:`${Math.floor(s.duration/60)}:${(s.duration%60).toString().padStart(2,"0")}`,song_sequence:s.song_sequence,url:s.url});for(let s=0;s<a.length;s++){a[s].projectID=s;const c=a[s];Ye(c)}t.addEventListener("click",function(s){const c=s.target;if(s.stopPropagation(),c.tagName==="BUTTON"){const l=c.closest(".PROJECTview-projectTable-rowContainer");l&&(l.getAttribute("data-row-id"),qe(s))}})}}async function Je(){const e=document.getElementById("PROJECTview-projectTable"),n=window.location.pathname.replace(/^\/projects\//,""),o=await H(n);o.project_id=n;const i=o,a=i.project_json,s=JSON.parse(a).songs_json,c=[];if(Array.isArray(s))for(const d of s)c.push({img:i.picture_url,songTitle:d.song_name,artistName:i.project_contributors,projectName:ge(d.song_size),songDuration:`${Math.floor(d.duration/60)}:${(d.duration%60).toString().padStart(2,"0")}`,song_sequence:d.song_sequence,url:d.url});const l=document.getElementById("PROJECTview-projectTable"),r=l.children;for(let d=r.length-1;d>0;d--)l.removeChild(r[d]);for(let d=0;d<c.length;d++){c[d].projectID=d;const m=c[d];Ye(m)}e.addEventListener("click",function(d){const m=d.target;if(d.stopPropagation(),m.tagName==="BUTTON"){const _=m.closest(".PROJECTview-projectTable-rowContainer");if(_){const g=_.getAttribute("data-row-id");qe(d),console.log(`Button in row ${g} clicked.`)}}})}function qe(e){e.stopPropagation(),e.target,k([{displayText:"Not Selected",optionalSVG:"icons_yourUploadedSongs",function:"TEST"}],e)}function go(){let e="PROJECTview_projectAreaContainer",t=Wn;for(const[n,o]of Object.entries(E)){const i=new RegExp(`\\{${n}\\}`,"g");t=t.replace(i,o)}document.getElementById(e).innerHTML+=t}function Ye(e){let t="PROJECTview-projectTable",n=Zn;for(const[i,a]of Object.entries(E)){const s=new RegExp(`\\{${i}\\}`,"g");n=n.replace(s,a)}const o=["PROJECTviewRow_img","PROJECTviewRow_songTitle","PROJECTviewRow_artistName","PROJECTviewRow_projectName","PROJECTviewRow_songDuration","PROJECTviewRow_projectID"];for(let i=0;i<o.length;i++){const a=o[i].toString(),s=new RegExp(`\\{${a}\\}`,"g");let c="";a==="PROJECTviewRow_img"?c=`${y}/${e.img}/3/`:a==="PROJECTviewRow_songTitle"?c=e.songTitle:a==="PROJECTviewRow_artistName"?c=e.artistName:a==="PROJECTviewRow_projectName"?c=e.projectName:a==="PROJECTviewRow_songDuration"?c=e.songDuration:a==="PROJECTviewRow_projectID"&&(c=e.projectID),n=n.replace(s,c)}document.getElementById(t).innerHTML+=n}function _o(e){const t=document.getElementById("PROJECTview_dropArea");t.addEventListener("dragenter",o=>{o.preventDefault(),t.classList.add("dragover")}),t.addEventListener("dragover",o=>{o.preventDefault()}),t.addEventListener("dragleave",()=>{t.classList.remove("dragover")}),t.addEventListener("drop",o=>{o.preventDefault(),t.classList.remove("dragover");const i=o.dataTransfer.files;n(i,e)}),t.addEventListener("click",()=>{const o=document.createElement("input");o.type="file",o.accept="audio/*",o.multiple=!0,o.addEventListener("change",()=>{const i=o.files;n(i,e)}),o.click()});function n(o,i){for(const a of o);fo(o,i)}}async function He(e,t,n,o){const i=new FormData,a=localStorage.getItem("JWT"),s=new XMLHttpRequest,c=document.createElement("div"),l=document.createElement("div");ue=!0,i.append("file",e),i.append("project_id",o.project_id),i.append("jwt",a),c.classList.add("progress-bar"),l.classList.add("progress-fill"),c.appendChild(l),t.appendChild(c),s.upload.onprogress=function(r){if(r.lengthComputable){const d=r.loaded/r.total*100;l.style.width=d+"%",d===100&&c.classList.add("opacity-animation")}},s.onload=async function(){if(c.classList.remove("opacity-animation"),c.style.opacity="1",l.classList.add("complete"),n.textContent=`${e.name}`,Je(),ue=!1,se.length>0){const r=se.shift();await He(r.file,r.uploadBox,r.fileNameLabel,r.details)}setTimeout(()=>{t.classList.add("complete")},2e3),setTimeout(()=>{t.parentNode.removeChild(t)},3e3)},s.onerror=function(){c.classList.remove("opacity-animation"),c.style.opacity="1",l.style.backgroundColor="#e74c3c",setTimeout(()=>{t.parentNode.removeChild(t)},3e3)},s.open("POST",`${w}/files/upload/audio/`,!0),s.send(i)}async function fo(e,t){const n=document.getElementById("uploadsContainer");for(const o of e){const i=document.createElement("div"),a=document.createElement("div");i.classList.add("upload-box"),a.classList.add("PROJECTview_upload_nameLabel"),a.textContent=`${o.name}`,i.appendChild(a),n.appendChild(i);const s={file:o,uploadBox:i,fileNameLabel:a,details:t};if(se.push(s),!ue){const c=se.shift();await He(c.file,c.uploadBox,c.fileNameLabel,c.details)}}}function $e(e){const t=document.getElementById("PROJECTviewMobileStickyHeaderProjectNameContainer");t.innerText=e}function vo(){const e=new IntersectionObserver(i,{threshold:.1}),t=document.querySelector(".PROJECTviewDisplayImage"),n=document.getElementById("PROJECTviewMobileStickyHeader"),o=document.getElementById("PROJECTviewMobileStickyHeaderProjectNameContainer");e.observe(t);function i(a,s){a.forEach(c=>{c.isIntersecting&&D()?(n.style.backdropFilter="none",n.style.backgroundColor="transparent",o.style.visibility="hidden"):c.isIntersecting&&!D()||!c.isIntersecting&&!D()?(n.style.backdropFilter="var(--PROJECTviewDesktopHeaderFilter)",o.style.visibility="hidden"):!c.isIntersecting&&D()&&(n.style.backdropFilter="blur(15px)",n.style.backgroundColor="var(--background-transparent)",o.style.visibility="visible")})}}function Eo(e){const t=document.getElementById("PROJECTviewDisplayImage");let n;t.addEventListener("touchstart",function(i){i.timeStamp,n=setTimeout(function(){o(i,e)},500)}),t.addEventListener("touchend",function(i){i.timeStamp,clearTimeout(n)}),t.addEventListener("dblclick",function(i){o(i,e)});function o(i,a){yo(i,a)}}function yo(e,t){e.target;const n="update_project_image",o={project_id:t};e.stopPropagation(),k(o,e,n)}const bo=`<button class="MENUmodalItemContainer">
    <div class="MENUmodalTextArranger" style="color: {MENU_item_colour}">{MENU_item_text}</div>
    <div class="MENUmodalSVGcontainer">
        <img src="{MENU_item_image}" class="MENUmodalSVG">
    </div>
</button>`;async function To(e,t){const n=new XMLHttpRequest,o=new FormData,i=localStorage.getItem("JWT");o.append("file",e),o.append("project_id",t),o.append("jwt",i),n.upload.onprogress=function(a){a.lengthComputable&&a.loaded/a.total*100},n.onload=function(){Bo()},n.onerror=function(){console.log("there was an error with the upload")},n.open("POST",`${w}/files/upload/photo/`,!0),n.send(o)}async function ho(e,t){Array.isArray(e)||(e=[e]);for(const n of e)await To(n,t)}const Io='<div class="MENUmodalBody" id="MENUmodalBody"></div>';let Q,N=!1;function k(e,t,n){n===void 0&&Co(e,t),n!==void 0&&n==="update_project_image"&&Lo(e,t),n!==void 0&&n==="lcd_mobile_body"&&wo()}function wo(e){const t=document.querySelector("main"),n=document.querySelector(".topHalf-container"),o=document.getElementById("MENUmodalEnvironment");let i=Tn;const a=document.getElementById("audio"),s=["LCD_mobile_body_container_l2","LCD_mobile_body_img","LCD_mobile_body_title_area_container","LCD_mobile_body_song_title","LCD_mobile_body_artist_title","LCD_mobile_body_progress_bar","LCD_mobile_body_menu","LCD_mobile_body_queue_container","LCD_mobile_body_secondary_seek_indicator"];let c=0,l=0;D()&&(t.style.zIndex="40",n.style.zIndex="0");for(const[h,S]of Object.entries(E)){const M=new RegExp(`\\{${h}\\}`,"g");i=i.replace(M,S)}o.style.display="block",o.innerHTML=i;const r=document.getElementById("LCD_mobile_body_song_title"),d=document.getElementById("LCD_mobile_body_artist_title"),m=document.getElementById("LCD_mobile_body_img"),_=a.duration,B=a.currentTime/_*100,b=document.getElementById("LCDMB_seek_input"),f=document.getElementById("LCDMB_seek_indicator");document.getElementById("LCDMB_menu_button");const C=document.getElementById("LCDMB_back"),v=document.getElementById("LCDMB_play"),P=document.getElementById("LCDMB_play_icon"),x=document.getElementById("LCDMB_next"),O=document.getElementById("LCDMB_queue_button");a.addEventListener("ended",()=>{R(),N===!0&&q()}),R(),I(),f.style.width=`${B}%`,a.addEventListener("timeupdate",()=>{const h=a.duration,M=a.currentTime/h*100;f.style.width=`${M}%`}),b.addEventListener("input",function(){const h=a.duration,S=b.value;a.currentTime=h*(S/100)}),C.addEventListener("click",()=>{Xe(),R(),N===!0&&q()}),v.addEventListener("click",()=>{ae(),R(),I()}),x.addEventListener("click",()=>{Ze(),R(),N===!0&&q()}),O.addEventListener("click",()=>{N===!1?(Ee(),N=!0):(ye(),N=!1)}),N===!0?Ee():ye(),o.addEventListener("touchstart",W,!1),o.addEventListener("touchmove",Z,!1),o.addEventListener("touchend",X,!1);function R(){m.src=Fe,r.innerText=Ke,d.innerText=Ve}function I(){a.paused?P.src=E.icons_playButtonV2:P.src=E.icons_derpy}function q(){const h=document.getElementById("LCD_mobile_queue_content_container");h.innerHTML="";for(let S=p+1;S<u.length;S++){const M=u[S],ee=["queue_item_img","queue_item_song_name","queue_item_song_artist","icons_menuOptionsButton","QUEUE_item_timeIndicator"],$=M.img,lt=M.song_name,dt=M.project_contributors;let ce=bn;for(let re=0;re<ee.length;re++){const te=ee[re].toString(),ut=new RegExp(`\\{${te}\\}`,"g");let ne="";te==="queue_item_img"?ne=`${y}/${$}/3/`:te==="queue_item_song_name"?ne=lt:te==="queue_item_song_artist"&&(ne=dt),ce=ce.replace(ut,ne)}h.innerHTML+=ce}}function Ee(){function h(S){S.forEach(M=>{document.querySelectorAll("."+M).forEach($=>{$.classList.add("queue_visible")})})}h(s),o.removeEventListener("touchstart",W),o.removeEventListener("touchmove",Z),o.removeEventListener("touchend",X),q()}function ye(){function h(S){S.forEach(M=>{document.querySelectorAll("."+M).forEach($=>{$.classList.remove("queue_visible")})})}h(s),o.addEventListener("touchstart",W,!1),o.addEventListener("touchmove",Z,!1),o.addEventListener("touchend",X,!1)}function W(h){N===!1&&(c=h.touches[0].clientY)}function Z(h){h.preventDefault()}function X(h){l=h.changedTouches[0].clientY,l-c>70&&(F(),o.removeEventListener("touchstart",W),o.removeEventListener("touchmove",Z),o.removeEventListener("touchend",X))}}function Co(e,t){Q=document.activeElement;const n=t.pointerType;let o=t.clientX,i=t.clientY;const a=document.querySelector("main"),s=document.querySelector(".topHalf-container");D()&&(a.style.zIndex="40",s.style.zIndex="0");const c=document.getElementById("MENUmodalEnvironment");c.innerHTML=Io,c.style.display="block";const l=document.getElementById("MENUmodalBody");let r=o+"px",d=i+"px";if(c.addEventListener("click",Qe),l.style.left=r,l.style.top=d,Q&&n===""){const v=Q.getBoundingClientRect();o=v.left+window.scrollX,i=v.top+window.scrollY;let P=o+"px",x=i+"px";l.style.left=P,l.style.top=x}for(let v=0;v<e.length;v++)So(e[v]);const _=l.children[0],g=l.offsetWidth,B=l.offsetHeight,b=Po("MENUmodalBody"),f=l.getElementsByClassName("MENUmodalItemContainer");n===""?_.focus():n==="mouse"&&(_.focus(),_.blur()),document.addEventListener("keydown",C),b.xOverflow==!0&&(r=o-g+"px",l.style.left=r),b.yOverflow==!0&&(d=i-B+"px",l.style.top=d);for(let v=0;v<f.length;v++){const P=f[v];P.setAttribute("data-menu-item-id",v),P.addEventListener("click",function(x){x.stopPropagation();const R=x.target.getAttribute("data-menu-item-id"),I=e[R].function,q=e[R].optionalParams;if(I=="TEST")console.log("the button worked");else if(I!="None"){Oo[I](q);return}else return})}function C(v){(v.key==="Escape"||v.keyCode===27)&&(document.removeEventListener("keydown",C),F())}}function Lo(e,t){const n=t.clientX,o=t.clientY,i=document.querySelector("main"),a=document.querySelector(".topHalf-container"),s=document.getElementById("MENUmodalEnvironment");let c=n+"px",l=o+"px";D()&&(i.style.zIndex="40",a.style.zIndex="0"),i.style.zIndex="2",s.innerHTML=yn,s.style.display="block",s.addEventListener("click",Qe);const r=document.getElementById("MENUmodalBody"),d=document.getElementById("MENUmodalBody_image_select_file_drop_area"),m=document.getElementById("MENUmodalBody_image_select_file_select_button"),_=document.getElementById("MENUmodalBody_image_select_preview_area"),g=document.getElementById("MENUmodalBody_image_select_submit_button"),B=document.getElementById("MENUmodalBody_image_select_submit_button_container");r.style.left=c,r.style.top=l;function b(f,C){if(f){const v=URL.createObjectURL(f),P=document.getElementById("MENUmodalBody_image_submit_area_loader_spinner");_.src=v,g.style.visibility="visible",B.style.outline="3px solid var(--primary)",g.addEventListener("click",()=>{ho(f,C.project_id),P.style.visibility="visible"})}else console.log("No file selected.")}d.addEventListener("dragover",f=>{f.preventDefault()}),d.addEventListener("drop",f=>{f.preventDefault();const C=f.dataTransfer.files;b(C[0],e)}),m.addEventListener("click",()=>{const f=document.createElement("input");f.type="file",f.accept="image/*",f.addEventListener("change",C=>{const v=C.target.files[0];b(v,e)}),f.click()})}function Bo(){const e=document.getElementById("MENUmodalBody_image_submit_area_loader_spinner");e.style.visibility="hidden",F(),to()}function Po(e){const t=document.getElementById(e),n=document.documentElement.clientWidth,o=document.documentElement.clientHeight,i=t.offsetWidth,a=t.getBoundingClientRect().left,s=t.getBoundingClientRect().top,c=t.getBoundingClientRect().height,l=i+a,r=c+s;let d=!1,m=!1;return l>n&&(d=!0),r>o&&(m=!0),{xOverflow:d,yOverflow:m}}function So(e){const t=e.displayText,n=e.optionalSVG,o=document.getElementById("MENUmodalBody");let i;"colour"in e?i=e.colour:(i="var(--text)",D()&&(i="var(--text)"));let a=new RegExp("\\{MENU_item_text\\}","g"),s=bo.replace(a,t);if(a=new RegExp("\\{MENU_item_colour\\}","g"),s=s.replace(a,i),n!=="None"){a=new RegExp("\\{MENU_item_image\\}","g");const c="{"+n+"}";s=s.replace(a,c);for(const[l,r]of Object.entries(E)){const d=new RegExp(`\\{${l}\\}`,"g");s=s.replace(d,r)}o.innerHTML+=s;return}else{s=s.replace(/<img[^>]+>/g,""),o.innerHTML+=s;return}}function Qe(e){const t=document.getElementById("MENUmodalEnvironment"),n=document.querySelector("main"),o=window.matchMedia("screen and (orientation: portrait) and (max-width: 768px) and (pointer: coarse) "),i=document.querySelector(".topHalf-container");if(e.target===t){t.style.display="none",o.matches&&(n.style.zIndex="1",i.style.zIndex="10");return}}function F(){const e=document.getElementById("MENUmodalEnvironment"),t=document.querySelector("main"),n=window.matchMedia("screen and (orientation: portrait) and (max-width: 768px) and (pointer: coarse) "),o=document.querySelector(".topHalf-container");e.style.display="none",n.matches&&(t.style.zIndex="1",o.style.zIndex="10"),Q&&Q.focus()}const Oo={MENU_ACTION_playNext(e){console.log(e)},MENU_ACTION_playLast(){console.log("meny aacction play next")},PROJECT_VIEW_delete_project(e){uo(e)},PLAYBACK_add_songs_to_queue(e){Wo(e)},SIGN_OUT_USER(e){kn()},OPEN_SETTINGS_PAGE(e){A("/settings/")}};let U="hidden";function Mo(){pn();const e=document.getElementById("queueButton"),t=document.getElementById("QUEUEclearQueueButton");me(U),e.addEventListener("click",xo),t.addEventListener("click",Ro),j()}function xo(){if(U==="hidden"){U="visible",me(U);return}if(U==="visible"){U="hidden",me(U);return}}function me(e){document.getElementById("queueButton");const t=document.getElementById("queueIcon"),n=document.getElementById("QUEUEenvironment");if(e=="visible"){t.style.filter="var(--make-svg-grey)",document.documentElement.style.cssText="--TOPRIGHT-accountcontrols-queue-opacity: 100%",n.style.right="0%",_n&&(t.style.filter="var(--make-svg-white)");return}if(e=="hidden"){t.style.filter="var(--make-svg-black)",document.documentElement.style.cssText="--TOPRIGHT-accountcontrols-queue-opacity: 0%",n.style.right="calc((var(--width-of-left-bar-fortop) + 5rem) * -1)";return}}function j(){const e=document.getElementById("QUEUEbottomContainer");e.innerHTML="";for(let t=p+1;t<u.length;t++){u[t].id=t;const n=u[t],o=Go(n),i=document.createElement("div");i.innerHTML=o,i.addEventListener("click",function(c){c.target.dataset.songId}),i.dataset.songId=n.id,i.addEventListener("click",Uo),i.dataset.songId=n.id;const a=i.querySelector(".QUEUE-item-image-removeIndicator"),s=i.querySelector(".QUEUE-item-up-next-queue-item-context-call");a.addEventListener("click",jo),a.dataset.songID=n.id,s.dataset.songSet=n.id,s.addEventListener("click",function(c){c.target===s&&ko(c)}),i.addEventListener("dragstart",Do),i.addEventListener("dragover",Ao),i.addEventListener("drop",No),e.appendChild(i)}}function Ro(){const e=p+1;e>=0&&e<u.length?u.splice(e):u.length=0,j()}function Do(e){const t=e.target;e.dataTransfer.setData("text/plain",t.dataset.songId)}function Ao(e){e.preventDefault(),e.dataTransfer.dropEffect="move"}function No(e){e.preventDefault();const t=e.dataTransfer.getData("text/plain"),n=e.target,o=u.find(c=>c.id===parseInt(t)),i=u.find(c=>c.id===parseInt(n.dataset.songId)),a=u.indexOf(o),s=u.indexOf(i);a!==-1&&s!==-1&&(u.splice(a,1),u.splice(s,0,o),L.splice(a,1),L.splice(s,0,o),j())}function jo(e){e.stopPropagation();const t=e.target,n=parseInt(t.dataset.songID),o=u.findIndex(i=>i.id===n);o!==-1&&(u.splice(o,1),L.splice(o,1)),j()}function ko(e){e.stopPropagation();const o=[{displayText:"Play next",optionalSVG:"icons_playlist",function:"MENU_ACTION_playNext",optionalParams:{queueID:e.target.getAttribute("data-song-set")}},{displayText:"Play later",optionalSVG:"icons_backButton",function:"None"},{displayText:"Love",optionalSVG:"None",function:"None"},{displayText:"Less like this",optionalSVG:"None",function:"None"},{displayText:"Rate",optionalSVG:"None",function:"None"}];k(o,e)}function Uo(e){}function Go(e){const t=["QUEUE_item_image","QUEUE_item_title","QUEUE_item_artist","icons_menuOptionsButton","QUEUE_item_timeIndicator"],n=e.img,o=e.song_name,i=e.project_contributors,a=`${Math.floor(e.duration/60)}:${(e.duration%60).toString().padStart(2,"0")}`;let s=gn;for(let l=0;l<t.length;l++){const r=t[l].toString(),d=new RegExp(`\\{${r}\\}`,"g");let m="";r==="QUEUE_item_image"?m=`${y}/${n}/3/`:r==="QUEUE_item_title"?m=o:r==="QUEUE_item_artist"?m=i:r==="icons_menuOptionsButton"?m=xe:r==="QUEUE_item_timeIndicator"&&(m=a),s=s.replace(d,m)}s=s.replace("<div",`<div data-song-id="${e.id}"`);const c=document.createElement("div");return c.querySelector(".QUEUE-item-image-removeIndicator"),c.innerHTML=s,c.innerHTML}const Jo=`<div class="LCDbody">
...
</div>`;const w="/apis",y="/media";async function rt(){Xo(),un(),mn(),qo(),ri(),fi(),gi(),An(),Mo(),Yn()}let pe=Oi;for(const[e,t]of Object.entries(E)){const n=new RegExp(`\\{${e}\\}`,"g");pe=pe.replace(n,t)}document.getElementById("app").innerHTML=pe;Ii();
