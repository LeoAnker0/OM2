...
</div>`;const w="/apis",y="/media";async function rt(){Xo(),un(),mn(),qo(),ri(),vi(),gi(),An(),So(),Yn()}let pe=Mi;for(const[e,t]of Object.entries(E)){const n=new RegExp(`\\{${e}\\}`,"g");pe=pe.replace(n,t)}document.getElementById("app").innerHTML=pe;Ii();
