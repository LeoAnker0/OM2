...
</button>`,xt=30;let de=0;async function Zo(){try{if(document.getElementById("MAINcontentPages").innerHTML+=X(Ko),localStorage.getItem("MOGitems")!=null){const t=JSON.parse(localStorage.getItem("MOGitems"));de+=t.length,ot(t)}const e=await kt(xt,0);JSON.stringify(e)!=localStorage.getItem("MOGitems")&&(de+=e.length,ot(e),localStorage.setItem("MOGitems",JSON.stringify(e))),R()&&Qo()}catch(e){console.error("Error in initMusicObjectsGrid:",e)}}function Rt(){de=0;const e=document.getElementById("MAINcontentPages"),t=document.getElementById("MOGcontainer");t!==null&&t.removeEventListener("click",At),e.innerHTML=""}function ot(e){const t=document.getElementById("MOGgridContainer");t.innerHTML=X(Wo),it(e);const n=document.getElementById("MOGgridContainer");n.addEventListener("click",function(a){At(a,e)});let o,i=!1;n.addEventListener("touchstart",function(a){a.timeStamp,i=!1,o=setTimeout(function(){i||s(a,e)},500)}),n.addEventListener("touchend",function(a){a.timeStamp,clearTimeout(o)}),n.addEventListener("scroll",function(){i=!0,clearTimeout(o)});function s(a,r){navigator.vibrate(1e3);const d=a.target.id.split("-")[1],l=r[d].project_id;Nt(a,l)}t.addEventListener("scroll",async function(){const a=t.scrollTop,r=t.scrollHeight,c=t.clientHeight;if(a>=r-c){const d=await kt(xt,de);de+=d.length,d.length>0&&it(d)}})}function it(e){const t=document.getElementById("MOGgridContainer"),n=e.length,o=X(Xo);for(var i=0;i<=n-1;i++){const s=i,a=e[i].img,r=e[i].top,c=e[i].bottom,d=e[i].days,l=wo(d),g={itemsToReplace:[["MOG_image",`${S}/${a}/3`],["MOG_text1",`${r}`],["MOG_text2",`${c}`],["MOG_checkedDate",`${l}`],["MOGI_placeholder_itemID",`${s}`]]};t.innerHTML+=Qe(o,g)}}async function At(e,t){const n=e.target;if(n.classList.contains("MOG-item-controls-play")){const o=n.id.split("-")[1],i=t[o].project_id,s=await ze(i),a=JSON.parse(s);a.ProjectID=i,zt(a)}if(n.classList.contains("MOG-item-controls-menu")){const o=n.id.split("-")[1],i=t[o].project_id;Nt(e,i)}if(n.classList.contains("MOG-itemContainer")&&n.id!=="MOGaddNewItem"){const o=n.id.split("-")[1],i=t[o].project_id;A(`/projects/${i}`)}n.id==="MOGaddNewItem"&&A("/new-project/")}async function Nt(e,t){e.stopPropagation();const o=await V([{displayText:"Play next",optionalSVG:"icons_playlist",condition:"playNext",optionalParams:{PROJECT_ID:t,QUEUE_POSITION:"next"},function:"True"},{displayText:"Play later",optionalSVG:"icons_playlist",condition:"playLater",optionalParams:{PROJECT_ID:t,QUEUE_POSITION:"later"},function:"True"}],e,"return_promise");o.condition=="playNext",Kt(o.optionalParams),G()}let st;function Ve(e){return new Promise((t,n)=>{st=document.activeElement;let o="mouse";event.webkitForce==1||event.webkitForce==0?event.webkitForce==0&&(o="keyboard"):event.pointerType!=="mouse"&&(o="keyboard");const i=document.getElementById("confirmModal"),s=`
...
<p>You are not an admin user</p>`;function jt(e,t,n){const o=document.getElementById(t);let i;o.addEventListener("touchstart",function(a){a.timeStamp,i=setTimeout(function(){s(a,e,n)},500)}),o.addEventListener("touchend",function(a){a.timeStamp,clearTimeout(i)}),o.addEventListener("dblclick",function(a){s(a,e,n)});function s(a,r,c){ni(a,r,c)}}function ni(e,t,n){e.target;const o={project_id:t};e.stopPropagation(),V(o,e,n)}const ct=`<h1>User</h1>
...
</div>`;let K=!1,We,qe;function Us(){const e=document.getElementById("musicEnjoyEnvironment");e.innerHTML=X(js),document.getElementById("MUSICENJOYMODEexitButton").addEventListener("click",Js),document.getElementById("MusicEnjoyOpenButton").addEventListener("click",Tt),R()&&document.getElementById("LCDbody").addEventListener("click",Tt),x.on("playbackStateChange",c=>{K!=!1&&dn()}),x.on("progressStateChange",c=>{K!=!1}),x.on("newTrackStateChange",c=>{K!=!1&&cn()}),x.on("loopStateChange",c=>{K!=!1&&ln()}),x.on("shuffleStateChange",c=>{K!=!1&&un()});const o=document.getElementById("MUSICENJOYMODEplaybackControlsButton_shuffle"),i=document.getElementById("MUSICENJOYMODEplaybackControlsButton_back"),s=document.getElementById("MUSICENJOYMODEplaybackControlsButton_play"),a=document.getElementById("MUSICENJOYMODEplaybackControlsButton_next"),r=document.getElementById("MUSICENJOYMODEplaybackControlsButton_loop");o.addEventListener("click",Ke),i.addEventListener("click",Xt),s.addEventListener("click",Re),a.addEventListener("click",Wt),r.addEventListener("click",Zt)}function cn(){const e=document.getElementById("MUSICENJOYMODEcoverImage1"),t=document.getElementById("MUSICENJOYMODEcoverImage2"),n=document.getElementById("MUSICENJOYMODEsongTitle1");document.getElementById("MUSICENJOYMODEsongTitle2");const o=document.getElementById("MUSICENJOYMODEsongArtist");e.src=Pe,t.src=Pe,n.innerText=Qt,o.innerText=Vt,ln(),un(),ks()}function dn(){const e=document.getElementById("MUSICENJOYMODEplaybackControlButton_play_icon");if(F=="playing"){e.src=M.icons_pause;return}if(F=="paused"){e.src=M.icons_play;return}}function ln(){const e=document.getElementById("MUSICENJOYMODEplaybackControlsButton_loop_icon");if(C==="off"){e.style.filter="var(--make-svg-white)",e.src=M.icons_loop;return}if(C==="on"){e.style.filter="var(--make-svg-grey-3)",e.src=M.icons_loop;return}if(C==="song"){e.style.filter="var(--make-svg-grey-3)",e.src=M.icons_loop_song;return}}function un(){const e=document.getElementById("MUSICENJOYMODEplaybackControlsButton_shuffle_icon");if(Y==="on"){e.style.filter="var(--make-svg-grey-3)";return}if(Y==="off"){e.style.filter="var(--make-svg-white)";return}}async function Tt(){K=!0;const e=document.getElementById("musicEnjoyEnvironment");e.style.display="block",cn(),dn(),await mn(),qe=document.getElementById("MUSICENJOYMODEbackground"),Ro(qe,We)}async function mn(){We=await Sn(Pe)}async function ks(){await mn(),jo(qe,We)}function Js(){const e=document.getElementById("musicEnjoyEnvironment");e.style.display="none",No(),K=!1}const B="/apis",S="/media";async function gn(){Is(),is(),ss(),Ki(),Bs(),Rs(),Ds(),$o(),cs(),_i(),Jo(),Us()}window.hasCodeRun||(ui(),window.hasCodeRun=!0);
