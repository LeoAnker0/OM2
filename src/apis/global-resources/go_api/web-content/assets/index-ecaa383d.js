...
<p>You are not an admin user</p>`;function Ut(e,t,n){const o=document.getElementById(t);let i;o.addEventListener("touchstart",function(a){a.timeStamp,i=setTimeout(function(){s(a,e,n)},500)}),o.addEventListener("touchend",function(a){a.timeStamp,clearTimeout(i)}),o.addEventListener("dblclick",function(a){s(a,e,n)});function s(a,r,c){si(a,r,c)}}function si(e,t,n){e.target;const o={project_id:t};e.stopPropagation(),V(o,e,n)}const dt=`<h1>User</h1>
