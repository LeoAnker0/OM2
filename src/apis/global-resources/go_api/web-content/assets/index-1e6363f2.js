...
</div>`,os=`<div class="TOPRIGHT-topHalf-right-content">
    <!-- playback controls -->
...
</div>`,is=`<div class="QUEUE-environment" id="QUEUEenvironment">
...
</div>`;function ss(){let e="topleftContentArea",t=ns;for(const[n,o]of Object.entries(M)){const i=new RegExp(`\\{${n}\\}`,"g");t=t.replace(i,o)}document.getElementById(e).innerHTML=t}function as(){let e="toprightContentArea",t=os;for(const[n,o]of Object.entries(M)){const i=new RegExp(`\\{${n}\\}`,"g");t=t.replace(i,o)}document.getElementById(e).innerHTML=t}function rs(){let e="MAINcontentContainer",t=is;for(const[n,o]of Object.entries(M)){const i=new RegExp(`\\{${n}\\}`,"g");t=t.replace(i,o)}document.getElementById(e).innerHTML+=t}const cs=`<div class="QUEUE-item-container" draggable="true">
